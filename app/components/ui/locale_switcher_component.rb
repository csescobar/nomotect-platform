module Ui
  class LocaleSwitcherComponent < BaseComponent
    ...
    def call
      form_with(url: @action, method: :patch, html: merged_html_options(class: "locale-switcher")) do |form|
        safe_join([
          form.label(:locale, I18n.t("localization.label"), class: "locale-switcher__label"),
          form.select(
            :locale,
