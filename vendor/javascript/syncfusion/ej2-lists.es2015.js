...
(function (ListBase) {
    ...
    function anchorTag(createElement, dataSource, fields, text, innerElements, isFullNavigation, options) {
        ...
        let anchorTag;
        const curOpt = extend({}, defaultListBaseOptions, options);
        const safeText = getSanitizedText(text, curOpt);
        if (!isFullNavigation) {
...
let ListView = class ListView extends Component {
    ...
    header(text, showBack, prop) {
        if (this.headerEle === undefined && this.showHeader) {
            ...
            const curOpt = this.listBaseOption || {
...
let Sortable = Sortable_1 = class Sortable extends Base {
    constructor(element, options) {
        ...
        this.onDragStop = (e) => {
            ...
            const sortableTargetElement = this.getSortableElement(e.target, dropInst) || e.target.querySelector('.e-grabbed');
            const isDroppedOnContainer = dropInst.element === e.target && !sortableTargetElement;
