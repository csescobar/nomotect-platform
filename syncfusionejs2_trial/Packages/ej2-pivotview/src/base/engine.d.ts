...
export declare class PivotEngine {
    ...
    private levelMap;
    private isTabularMultiValueRowAxis;
    /** @hidden */
    ...
    private extractRunningTotalValue;
    private isRowSubtotal;
    ...
    private drillDownLevel;
    private drillUpLevel;
    private updateRowMaxLevel;
