...
export interface GridSettingsModel {
    ...
    /**
     * Allows the item and field labels to be repeated in the pivot table.
     * When set to `true`, the item and field labels will be repeated for each hierarchical level
     * within a field, making every row and column header consistently visible when expanded.
     * This mimics the "Repeat Item Labels" feature in Microsoft Excel.
