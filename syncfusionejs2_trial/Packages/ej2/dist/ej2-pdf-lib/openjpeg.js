...
var OpenJpegModule = ( () => {
    ...
    return (function(OpenJpegModule ={}) {
        var Module = typeof OpenJpegModule  != "undefined" ? OpenJpegModule  : {};
        ...
        function findWasmBinary() {
            var wasmBinaryFile;
            if (OpenJpegModule.url) {
                wasmBinaryFile = OpenJpegModule.url + '/openjpeg.wasm';
            }
            else {
                wasmBinaryFile = 'openjpeg.wasm';
            }
        ...
        async function createWasm() {
            ...
            try {
                ...
                var exports = receiveInstantiationResult(result);
                        var ___wasm_call_ctors = exports["t"];
        var _malloc = Module["_malloc"] = exports["u"];
        var _free = Module["_free"] = exports["v"];
        var _jp2_decode = Module["_jp2_decode"] = exports["w"];
                return exports
            } catch (e) {
                readyPromiseReject(e);
        ...
        preInit();
        run();
        return OpenJpegModule.ready
    }
    );
}
)();
if (typeof exports === 'object' && typeof module === 'object')
    module.exports = OpenJpegModule;
else if (typeof define === 'function' && define['amd'])
    define([], function () {
        return OpenJpegModule;
    });
else if (typeof exports === 'object')
    exports["OpenJpegModule"] = OpenJpegModule;