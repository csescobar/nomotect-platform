...
var GridComponent = vueDefineComponent({
    ...
    methods: {
        ...
        changeDataSource: function (dataSource, columns, properties) {
        ...
        destroyTemplate: function (propertyNames, index, callback) {
        ...
        getSelectedCellRecords: function () {
        ...
        reorderColumnByModel: function (fromColumn, toColumn) {
