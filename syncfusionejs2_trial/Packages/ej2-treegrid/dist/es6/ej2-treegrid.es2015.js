...
class BatchEdit {
    ...
    batchAdd(e) {
        if (this.parent.editSettings.newRowPosition !== 'Bottom') {
            ...
            if (this.parent.editModule['isAddedRowByMethod'] && !isNullOrUndefined(this.parent.editModule['addRowIndex']) &&
                ...
                const index = this.getInsertedRowIndex(newlyAddedRecords.length - 1);
    ...
    getInsertedRowIndex(elementIndex) {
        const header = this.parent.getHeaderTable().getElementsByClassName('e-insertedrow')[parseInt(elementIndex.toString(), 10)];
        const content = this.parent.getContentTable().getElementsByClassName('e-insertedrow')[parseInt(elementIndex.toString(), 10)];
            ...
            if (this.parent.editSettings.newRowPosition !== 'Bottom' && !Object.hasOwnProperty.call(args, 'updatedRecords')) {
                ...
                if (this.parent.editModule['isAddedRowByMethod'] && addRecords.length && !isNullOrUndefined(this.parent.editModule['addRowIndex']) && !this.parent.editModule['isAddedRowByContextMenu']) {
                    ...
                    for (let i = 0; i < addRecords.length; i++) {
                        const index = this.getInsertedRowIndex(parseInt(i.toString(), 10));
...
class Edit {
     ...
     * @hidden
     */
    lastRowValidation(args) {
        if (!this.parent.enableVirtualization) {
            return;
        }
        const { isBeginEdit, isAddedRow, isLastRow } = args;
        const newRowPosition = this.parent.editSettings.newRowPosition;
