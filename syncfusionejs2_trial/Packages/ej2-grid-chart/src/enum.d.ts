 ...
 * ```
 */
export declare type ChartExportItem = 'Print' | 'JPEG' | 'PNG' | 'SVG' | 'PDF' | 'XLSX' | 'CSV';
export declare type TitleSection = 'Title' | 'Subtitle';
export declare type Axes = 'Category' | 'Value';
