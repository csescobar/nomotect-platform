 ...
 * @hidden
 */
export declare function isColorExistsInPresets(colorPicker: any, colorPickerValue: string): boolean;
/**
 ...
 * @hidden
 */
export declare function toggleButtonDisableState(buttonInstance: Button, state: boolean): void;
