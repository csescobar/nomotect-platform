...
export declare class RichTextEditor extends Component<HTMLElement> implements INotifyPropertyChanged {
    ...
    private encode;
    private toolbarStatusUpdateOnLoad;
    /**
    ...
    private setCloneValue;
    private handleInternalFocus;
    private initSaveInterval;
    private resetToolbarOnFocus;
