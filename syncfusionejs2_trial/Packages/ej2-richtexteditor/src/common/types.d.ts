 ...
 * @hidden
 */
export declare type QuickToolbarType = 'Audio' | 'Image' | 'Inline' | 'Link' | 'Table' | 'Text' | 'Video';
/**
 * Defines the type of the popup.
 *
 * @hidden
 */
export declare type MediaType = 'Audios' | 'Images' | 'Videos';
/**
 * Defines the Quick toolbar collision type.
 *
 * @hidden
 */
export declare type QuickToolbarCollision = 'ViewPort' | 'ParentElement' | 'ScrollableContainer' | 'Hidden';
/**
 ...
 * @hidden
 */
export declare type TriggerType = 'keyup' | 'contextmenu' | 'mouseup' | 'trippleclick' | 'none' | 'scroll';
/**
 ...
 *
 */
export declare type TipPointerPosition = 'Top-Left' | 'Top-LeftMiddle' | 'Top-Center' | 'Top-RightMiddle' | 'Top-Right' | 'Bottom-Left' | 'Bottom-LeftMiddle' | 'Bottom-Center' | 'Bottom-RightMiddle' | 'Bottom-Right' | 'None';
/**
 * Indicates whether the editor is exporting to PDF or Word.
 */
export declare type ExportDocumentType = 'PDF' | 'Word';
