 ...
 */
export declare type AdornmentsDirection = 'Horizontal' | 'Vertical';
export declare class TextArea extends Component<HTMLTextAreaElement> implements INotifyPropertyChanged {
     ...
     */
    render(): void;
    private updatePrependTemplate;
    private updateAppendTemplate;
    private templateComplier;
    private createPrependTemplate;
    private createAppendTemplate;
    private handleAdornmentDirection;
    private handleAdornmentFloatLabel;
    private removePrependTemplate;
    private removeAppendTemplate;
