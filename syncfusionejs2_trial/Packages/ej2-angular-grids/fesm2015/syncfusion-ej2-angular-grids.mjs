...
import { Grid, Filter, Page, Selection, Sort, Group, Reorder, RowDD, DetailRow, Toolbar, Aggregate, Search, VirtualScroll, Edit, Resize, ExcelExport, PdfExport, CommandColumn, ContextMenu, Freeze, ColumnMenu, ColumnChooser, ForeignKey, InfiniteScroll, LazyLoadGroup, DomVirtualization, Pager } from '@syncfusion/ej2-grids';
...
const DomVirtualizationService = { provide: 'GridsDomVirtualization', useValue: DomVirtualization };
/**
