...
let ScheduleComponent = vueDefineComponent({
    ...
    methods: {
        ...
        setResourceCollections(resourceCol, isEventDataRefresh) {
...
const properties$1 = ['isLazyUpdate', 'plugins', 'calendarMode', 'cssClass', 'dateFormat', 'enablePersistence', 'enableRtl', 'endTypes', 'firstDayOfWeek', 'frequencies', 'locale', 'maxDate', 'minDate', 'selectedType', 'startDate', 'value', 'change', 'created', 'destroyed'];
const modelProps$1 = [];
