 ...
 */
export declare type ResponseBlock = TextBlock | ToolBlock | ThinkingBlock;
/**
 ...
 *
 */
export declare enum ThinkingContextType {
    /**
 ...
 *
 */
export declare enum ThinkingContextBadge {
    /**
 ...
 *
 */
export declare enum ThinkingStageStatus {
    /**
