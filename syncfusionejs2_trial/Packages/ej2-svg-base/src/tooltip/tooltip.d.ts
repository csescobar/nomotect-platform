...
export declare class Tooltip extends Component<HTMLElement> implements INotifyPropertyChanged {
    ...
    private revert;
    private outOfBounds;
    private splitTooltipRectCollection;
     ...
     * @private
     */
    private calculateAutoPositions;
    /**
     ...
     * @private
     */
    private configureSplitTooltipElements;
    private drawMarker;
