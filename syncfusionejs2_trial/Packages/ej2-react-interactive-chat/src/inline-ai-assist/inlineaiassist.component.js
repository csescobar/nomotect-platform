 ...
 * ```
 */
var InlineAIAssistComponent = /** @class */ (function (_super) {
    __extends(InlineAIAssistComponent, _super);
    function InlineAIAssistComponent(props) {
    ...
    InlineAIAssistComponent.prototype.render = function () {
    ...
    return InlineAIAssistComponent;
}(InlineAIAssist));
