 ...
 */
export declare type ContentProperties = ITextContentSettings | ILinkContentSettings | IMentionContentSettings | ILabelContentSettings;
export declare type Styles = Partial<Record<keyof StyleModel, string | boolean>>;
/**
 ...
 */
export declare type ITextContentSettings = BaseStylesProp;
/**
