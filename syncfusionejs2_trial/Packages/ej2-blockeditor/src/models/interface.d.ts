...
export declare type CollaborationAdapter = YjsAdapter;
...
export interface IVersionHistory {
     ...
     */
    restoreSnapshot(snapshotId: string): Promise<VersionSnapshot>;
    /**
     ...
     */
    exportSnapshot(snapshotId: string): ExportedVersion | null;
    /**
