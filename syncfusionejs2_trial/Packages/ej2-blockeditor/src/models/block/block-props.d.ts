 ...
 */
export declare type BlockProperties = IChecklistBlockSettings | IBulletListBlockSettings | INumberedListBlockSettings | IParagraphBlockSettings | IHeadingBlockSettings | IQuoteBlockSettings | ICollapsibleBlockSettings | ICollapsibleHeadingBlockSettings | ICalloutBlockSettings | IDividerBlockSettings | IImageBlockSettings | ICodeBlockSettings | ITableBlockSettings;
/**
 ...
 */
export declare type IBulletListBlockSettings = BasePlaceholderProp;
/**
 * Properties for numbered list blocks.
 */
export declare type INumberedListBlockSettings = BasePlaceholderProp;
/**
 * Properties for paragraph blocks.
 */
export declare type IParagraphBlockSettings = BasePlaceholderProp;
/**
 ...
 */
export declare type ICollapsibleHeadingBlockSettings = ICollapsibleBlockSettings & IHeadingBlockSettings;
/**
 * Properties for callout blocks with nested children.
 */
export declare type ICalloutBlockSettings = BaseChildrenProp;
/**
 * Properties for divider blocks
 */
export declare type IDividerBlockSettings = {};
/**
