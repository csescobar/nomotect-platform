export declare type Origin = any;
export interface ID {
    client: number;
    clock: number;
}
...
export declare type TextDelta = TextDeltaItem[];
...
export declare type XmlDelta = XmlDeltaItem[];
...
export declare function createRelativePositionFromTypeIndex(type: AbstractType<any>, index: number, assoc?: number): RelativePosition;
export declare function createAbsolutePositionFromRelativePosition(relativePosition: RelativePosition, doc: Doc | null): AbsolutePosition | null;
