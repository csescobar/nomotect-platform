 ...
 * @private
 */
export declare function renderStackHighlighter(element: DiagramElement, isVertical: boolean, position: PointModel, diagram: Diagram, isUml?: boolean, isSwimlane?: boolean, isErEntity?: boolean): void;
/**
 ...
 * @private
 */
export declare function hideErFieldInsertionIndicator(diagram: Diagram): void;
/**
