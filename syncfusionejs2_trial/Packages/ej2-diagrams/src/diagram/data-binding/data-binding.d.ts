import { BasicShapeModel, BpmnShapeModel, FlowShapeModel, PathModel } from '../objects/node-model';
...
export interface FlowChartData {
    ...
    imageLabelPos?: string | undefined;
    width?: number;
    height?: number;
    annotationMargin?: {
        left?: number;
    ...
    cornerRadius?: number;
    sourceDecorators?: string[];
    sourceDecoratorPathDatas?: string[];
    targetDecorators?: string[];
    targetDecoratorPathDatas?: string[];
    clickUrl?: string;
    clickTooltip?: string;
    clickTarget?: string;
    textColor?: string;
