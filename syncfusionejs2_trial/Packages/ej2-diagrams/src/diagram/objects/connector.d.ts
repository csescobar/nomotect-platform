...
import { ErRelationshipTypes } from './er-objects';
 ...
 */
export declare class ErConnectorShape extends ConnectorShape {
    /**
...
export declare class Connector extends NodeBase implements IElement {
    ...
    inEdges: string[];
    /** @private */
    sourceCentralConnection: boolean;
    /** @private */
    targetCentralConnection: boolean;
    constructor(parent: any, propName: string, defaultValue: Object, isArray?: boolean);
    private setPortID;
    /** @private */
