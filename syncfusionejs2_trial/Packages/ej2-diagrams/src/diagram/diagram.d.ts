...
export declare class Diagram extends Component<HTMLElement> implements INotifyPropertyChanged {
     ...
     * @returns { void }
     */
    updateDirtyState(isModified: boolean): void;
    /**
     ...
     * @private
     */
    setCleanHistoryIndex(index: number): void;
    /**
     ...
     * @private
     */
    private markDirtyForPropertyChanges;
    /**
     ...
     */
    addErField(node: NodeModel, field: ErFieldModel, index?: number): boolean;
    /**
     ...
     */
    removeErField(node: NodeModel, field: ErFieldModel): boolean;
    /**
