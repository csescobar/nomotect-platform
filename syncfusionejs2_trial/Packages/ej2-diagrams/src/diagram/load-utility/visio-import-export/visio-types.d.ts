 ...
 * @private
 */
export declare type VisioColorTransform = {
    type: 'lumMod';
    val: number;
} | {
    type: 'lumOff';
 ...
 * @private
 */
export declare type FlatTransform = Partial<Record<VisioColorTransform['type'], number>>;
/**
 ...
 * @private
 */
export declare type AnnotationAlignmentConfig = {
