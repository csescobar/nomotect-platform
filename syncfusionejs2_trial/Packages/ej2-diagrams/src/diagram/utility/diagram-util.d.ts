 ...
 * @private
 */
export declare function updateStyle(changedObject: TextStyleModel, target: DiagramElement, isTransactionChild?: boolean, isEvent?: boolean, isGroupNode?: boolean): void;
/**
