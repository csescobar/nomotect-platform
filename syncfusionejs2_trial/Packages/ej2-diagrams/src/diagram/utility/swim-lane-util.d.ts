 ...
 * @private
 */
export declare function addObjectToGrid(diagram: Diagram, grid: GridPanel, parent: NodeModel, object: NodeModel, isHeader?: boolean, isPhase?: boolean, isLane?: boolean, canvas?: string, isLaneHeader?: boolean): GroupableView;
/**
 * headerDefine method \
 *
 ...
 * @private
 */
export declare function arrangeChildInGrid(diagram: Diagram, nextCell: GridCell, gridCell: GridCell, rect: Rect, parentWrapper: GroupableView, orientation: boolean, prevCell?: GridCell): void;
/**
 ...
 * @private
 */
export declare function getNodeBoundsWithPaddingConstraints(diagram: Diagram, node: NodeModel, padding: number): Rect;
/**
