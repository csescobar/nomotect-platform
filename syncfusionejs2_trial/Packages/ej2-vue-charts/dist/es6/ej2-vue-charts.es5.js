...
var SankeyNodesCollectionDirective = vueDefineComponent({
    inject: { custom: { default: null } },
    render: function (createElement) {
        if (!isExecute) {
            var h = !isExecute ? gh : createElement;
...
var SankeyNodesCollectionPlugin = {
    name: 'e-sankey-nodes',
    install: function (Vue) {
 ...
 * ```
 */
var SankeyNodeDirective = vueDefineComponent({
    render: function () {
        return;
    },
    methods: {
...
var SankeyLinksCollectionDirective = vueDefineComponent({
    inject: { custom: { default: null } },
    render: function (createElement) {
        if (!isExecute) {
            var h = !isExecute ? gh : createElement;
...
var SankeyLinksCollectionPlugin = {
    name: 'e-sankey-links',
    install: function (Vue) {
 ...
 * ```
 */
var SankeyLinkDirective = vueDefineComponent({
    render: function () {
        return;
    },
    methods: {
 ...
 * ```
 */
var SankeyComponent = vueDefineComponent({
