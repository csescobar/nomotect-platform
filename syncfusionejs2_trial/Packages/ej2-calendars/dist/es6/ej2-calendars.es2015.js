...
let CalendarBase = class CalendarBase extends Component {
    ...
    keyActionHandle(e, value, multiSelection) {
        ...
        switch (e.action) {
            ...
            case 'tab':
                if (this.getModuleName() === 'datepicker' || this.getModuleName() === 'datetimepicker') {
                    const popupEl = this.popupWrapper;
                    if (!isNullOrUndefined(popupEl)) {
                        const focusable = this.getPopupFocusableElements(popupEl);
    ...
    getPopupFocusableElements(container) {
        const selector = [
        ...
        return Array.from(container.querySelectorAll(selector))
            .filter((el) => !isNullOrUndefined(el.offsetParent));
    }
