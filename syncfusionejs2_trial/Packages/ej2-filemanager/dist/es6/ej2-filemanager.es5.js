...
function performReadOperation(parent, result, fn, data, event, operation, targetPath, beforeSendArgs) {
    ...
    if (!isNullOrUndefined(result.files) && (event === 'path-changed' || event === 'finalize-end' || event === 'open-end' || event === 'drop-path' || event === 'delete-end')) {
...
var LargeIconsView = /** @__PURE__ @class */ (function () {
    ...
    LargeIconsView.prototype.getFirstItem = function () {
        return !isNullOrUndefined(this.itemList) && this.itemList.length > 0 ? this.itemList[0] : null;
    };
...
var DetailsView = /** @__PURE__ @class */ (function () {
    ...
    DetailsView.prototype.adjustHeight = function () {
        ...
        if (isNullOrUndefined(pane) || isNullOrUndefined(bar) || isNullOrUndefined(gridHeader)) {
            return;
        }
    ...
    DetailsView.prototype.onDataBound = function () {
        ...
        if (typeof this.nextFocusIndex === 'number') {
            if (!isNullOrUndefined(this.gridObj.getRows())) {
