...
class SankeyNodesCollectionDirective extends ComplexBase {
}
...
class SankeyLinksCollectionDirective extends ComplexBase {
}
 ...
 * ```
 */
class SankeyComponent extends Sankey {
    constructor(props) {
        super(props);
        this.initRenderCalled = false;
        this.checkInjectedModules = true;
        this.directivekeys = { 'sankeyNodesCollection': 'sankeyNode', 'sankeyLinksCollection': 'sankeyLink' };
        this.statelessTemplateProps = null;
        this.templateProps = null;
        this.immediateRender = false;
        this.isReactMock = true;
