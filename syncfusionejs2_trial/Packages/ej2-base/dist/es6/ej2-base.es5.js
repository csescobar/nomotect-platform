...
var gridSDKComponents = ['schedule', 'gantt', 'richtexteditor', 'diagram', 'blockeditor', 'kanban', 'spreadsheet', 'DocumentEditor', 'PdfViewer', 'pdf', 'pdf-extract'];
var fileManagerSDKComponents = ['schedule', 'gantt', 'richtexteditor', 'diagram', 'blockeditor', 'kanban', 'spreadsheet', 'DocumentEditor', 'PdfViewer', 'pdf', 'pdf-extract'];
var chartsSDKComponents = ['schedule', 'gantt', 'richtexteditor', 'diagram', 'blockeditor', 'kanban', 'spreadsheet', 'DocumentEditor', 'PdfViewer', 'pdf', 'pdf-extract'];
var rteSDKComponents = ['chart', 'treegrid', 'pivotview', 'maps', 'schedule', 'gantt', 'kanban', 'diagram', 'spreadsheet', 'DocumentEditor', 'PdfViewer', 'pdf', 'pdf-extract'];
var diagramSDKComponents = ['grid', 'treegrid', 'pivotview', 'chart', 'maps', 'schedule', 'gantt', 'richtexteditor', 'kanban', 'filemanager', 'blockeditor', 'spreadsheet', 'DocumentEditor', 'PdfViewer', 'pdf', 'pdf-extract'];
var ganttSDKComponents = ['chart', 'pivotview', 'schedule', 'diagram', 'blockeditor', 'spreadsheet', 'DocumentEditor', 'PdfViewer', 'pdf', 'pdf-extract'];
var schedulerSDKComponents = ['grid', 'treegrid', 'pivotview', 'chart', 'maps', 'gantt', 'richtexteditor', 'kanban', 'filemanager', 'diagram', 'blockeditor', 'spreadsheet', 'DocumentEditor', 'PdfViewer', 'pdf', 'pdf-extract'];
var essentialUISDKComponents = ['schedule', 'gantt', 'richtexteditor', 'diagram', 'blockeditor', 'kanban', 'spreadsheet', 'DocumentEditor', 'PdfViewer', 'pdf', 'pdf-extract'];
var bypassKey = [115, 121, 110, 99, 102, 117, 115, 105,
    111, 110, 46, 105, 115, 76, 105, 99, 86, 97, 108,
    105, 100, 97, 116, 101, 100];
var bypassKey2 = [115, 121, 110, 99, 102, 117, 115, 105,
    111, 110, 46, 105, 115, 69, 83, 85, 73, 76, 105, 99, 86, 97, 108, 105, 100, 97, 116, 101, 100];
var bypassKey3 = [115, 121, 110, 99, 102, 117, 115, 105,
...
var LicenseValidator = /** @__PURE__ @class */ (function () {
    function LicenseValidator(key) {
         ...
         * @private
         */
        this.prefixRegex = /essentialui|essentialuisdk_v34|pdfviewersdk|documentsdk|spreadsheeteditorsdk|schedulersdk|ganttsdk|diagramsdk|richtexteditorsdk|gridsdk|chartsdk|filemanagersdk|docxeditorsdk/i;
        /**
         * @private
         */
        ...
        if ((containerObject && !getValue(convertToChar(bypassKey), containerObject) && !getValue('Blazor', containerObject))) {
            ...
            if (validateMsg && typeof document !== 'undefined' && !isNullOrUndefined(document)) {
                if (component !== 'pdf' && component !== 'pdf-extract') {
                    if (banner) {
                        accountURL = (validateURL && validateURL !== '') ? validateURL : 'https://www.syncfusion.com/account/claim-license-key?pl=SmF2YVNjcmlwdA==&vs=MzQ=&utm_source=es_license_validation_banner&utm_medium=listing&utm_campaign=license-information';
                        ...
                        errorDiv_1.setAttribute('style', "position: fixed;\n                    top: 10px;\n                    left: 10px;\n                    right: 10px;\n                    font-size: 14px;\n                    background: #EEF2FF;\n                    color: #222222;\n                    z-index: 999999999;\n                    text-align: left;\n                    border: 1px solid #EEEEEE;\n                    padding: 10px 40px 10px 50px;\n                    border-radius: 8px;\n                    font-family: Helvetica Neue, Helvetica, Arial;");
                        var closeButton = errorDiv_1.querySelector('.license-banner-close');
                        if (closeButton) {
                            closeButton.addEventListener('click', function () {
                                errorDiv_1.remove();
                            });
                        }
                        document.body.appendChild(errorDiv_1);
                        banner = false;
                    }
                }
                this.isLicensed = false;
    ...
    LicenseValidator.prototype.restrictComponent = function (component, platform) {
        ...
        if (platform === 'essentialui') {
            return ignoreList.indexOf(component) === -1 ? null : this.errors.uiSuite;
        }
        if (platform === 'documentsdk') {
            ...
            return this.errors.documentSdk;
        }
        var errorMap = {
            gridsdk: this.errors.gridSdk,
            filemanagersdk: this.errors.filemanagerSdk,
            chartsdk: this.errors.chartSdk,
            richtexteditorsdk: this.errors.rteSdk,
            diagramsdk: this.errors.diagaramSdk,
            ganttsdk: this.errors.ganttSdk,
            schedulersdk: this.errors.schedulerSdk,
            pdfviewersdk: this.errors.pdfSdk,
            docxeditorsdk: this.errors.docxEditorSdk,
            spreadsheeteditorsdk: this.errors.spreadSheetSdk,
            essentialuisdk_v34: this.errors.essentialUISdk
        };
        // eslint-disable-next-line security/detect-object-injection
        var list = this.allowedComponentsMap[platform] || [];
...
var validateLicense = function (component, key) {
    ...
    if (containerObject) {
        var val2 = getValue(convertToChar(bypassKey2), containerObject);
        var val3 = getValue(convertToChar(bypassKey3), containerObject);
...
var Draggable = /** @__PURE__ @class */ (function (_super) {
    ...
    Draggable.prototype.intDragStop = function (evt) {
        ...
        var isCancelled = evt.isCancelled === true;
        if (!isCancelled) {
            var eleObj = this.checkTargetElement(evt);
            if (eleObj.target && eleObj.instance) {
   ...
   * @private
   */
    Draggable.prototype.intEscapeCancel = function (evt) {
...
export { Ajax, Animation, Base, Browser, ChildProperty, Collection, CollectionFactory, Complex, ComplexFactory, Component, CreateBuilder, Draggable, Droppable, Event$1 as Event, EventHandler, Fetch, GlobalAnimationMode, HijriParser, Internationalization, IntlBase, KeyboardEvents, L10n, ModuleLoader, NotifyPropertyChanges, Observer, Position, Property, SanitizeHtmlHelper, SwipeSettings, Touch, addClass, addInstance, animationMode, append, attributes, blazorCultureFormats, blazorTemplates, chartsSDKComponents, classList, cldrData, cloneNode, closest, compareElementParent, compile$1 as compile, componentList, containerObject, containsClass, createElement, createInstance, createLicenseOverlay, debounce, defaultCulture, defaultCurrencyCode, deleteObject, detach, diagramSDKComponents, disableBlazorMode, enableBlazorMode, enableRipple, enableRtl, enableVersionBasedPersistence, essentialUISDKComponents, extend, fileManagerSDKComponents, formatUnit, ganttSDKComponents, getAttributeOrDefault, getComponent, getDefaultDateObject, getElement, getEnumValue, getInstance, getNumberDependable, getNumericObject, getRandomId, getTemplateEngine, getUniqueID, getValue, getVersion, gridSDKComponents, includeInnerHTML, initializeCSPTemplate, isBlazor, isNullOrUndefined, isObject, isObjectArray, isRippleEnabled, isUndefined, isVisible, loadCldr, matches, merge, onIntlChange, pdfViewerSDKComponents, prepend, print, proxyToRaw, queryParams, registerLicense, remove, removeChildInstance, removeClass, resetBlazorTemplate, rightToLeft, rippleEffect, rteSDKComponents, schedulerSDKComponents, select, selectAll, setCulture, setCurrencyCode, setDateFormat, setDefaultCurrencyCode, setGlobalAnimation, setImmediate, setNumberFormat, setProxyToRaw, setStyleAttribute, setTemplateEngine, setValue, siblings, spreadsheetEditorSDKComponents, throwError, uniqueID, updateBlazorTemplate, updateCSSText, validateLicense, versionBasedStatePersistence, wordEditorSDKComponents };
