...
var CHECK = 'e-check';
var DISABLED = 'e-checkbox-disabled e-disabled';
var FRAME = 'e-frame';
...
var CheckBox = /** @__PURE__ @class */ (function (_super) {
    ...
    CheckBox.prototype.onPropertyChanged = function (newProp, oldProp) {
        var _a;
        var wrapper = this.getWrapper();
        for (var _i = 0, _b = Object.keys(newProp); _i < _b.length; _i++) {
            var prop = _b[_i];
            switch (prop) {
                case 'checked':
                    this.indeterminate = false;
                ...
                case 'disabled':
                    if (newProp.disabled) {
                        ...
                        (_a = wrapper.classList).remove.apply(_a, DISABLED.split(' '));
    ...
    CheckBox.prototype.setDisabled = function () {
        ...
        (_a = wrapper.classList).add.apply(_a, DISABLED.split(' '));
...
var RadioButton = /** @__PURE__ @class */ (function (_super) {
    ...
    RadioButton.prototype.observeDomAttributeChanges = function () {
        var _this = this;
        this.mutationObserver = new MutationObserver(function (mutations) {
            var isDomDisabled = _this.element.hasAttribute('disabled');
            if (isDomDisabled !== _this.disabled) {
...
var DISABLED$2 = 'e-switch-disabled e-disabled';
...
var Switch = /** @__PURE__ @class */ (function (_super) {
            ...
            switch (prop) {
                ...
                case 'disabled':
                    if (newProp.disabled) {
                        ...
                        this.element.disabled = false;
                        (_a = wrapper.classList).remove.apply(_a, DISABLED$2.split(' '));
                        wrapper.setAttribute('aria-disabled', 'false');
    ...
    Switch.prototype.setDisabled = function () {
        ...
        var wrapper = this.getWrapper();
        this.element.disabled = true;
        (_a = wrapper.classList).add.apply(_a, DISABLED$2.split(' '));
        wrapper.setAttribute('aria-disabled', 'true');
    };
