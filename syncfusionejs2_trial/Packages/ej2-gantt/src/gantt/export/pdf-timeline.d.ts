...
export declare class PdfTimeline {
     ...
     * @returns {void}
     */
    drawTimeline(page: PdfPage, startPoint: PointF, detail: TimelineDetails, pageIndex: number): void;
    /**
     *
     * @param {PdfPage} page .
     * @param {PointF} startPoint .
     ...
     * @private
     */
    drawPageTimeline(page: PdfPage, startPoint: PointF, detail: TimelineDetails, pageIndex: number): void;
    /**
