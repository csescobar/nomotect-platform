export declare type MarkedToken = (TokenBlockquote | TokenBr | TokenCode | TokenCodespan | TokenDef | TokenDel | TokenEm | TokenEscape | TokenHeading | TokenHr | TokenHTML | TokenImage | TokenLink | TokenList | TokenListItem | TokenParagraph | TokenSpace | TokenStrong | TokenTable | TokenTag | TokenText);
export declare type Token = (MarkedToken | TokenGeneric);
...
export declare type Links = Record<string, Pick<TokenLink | TokenImage, 'href' | 'title'>>;
export declare type TokensList = Token[] & {
    links: Links;
};
