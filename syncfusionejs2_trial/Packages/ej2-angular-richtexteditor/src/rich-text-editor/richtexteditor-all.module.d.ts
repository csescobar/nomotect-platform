...
export declare const ClipBoardCleanupService: ValueProvider;
export declare const AutoFormatService: ValueProvider;
export declare const AIAssistantService: ValueProvider;
/**
