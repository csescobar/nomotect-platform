...
function getProjectStyleFile(project, extension) {
    var _a, _b;
    const buildTarget = ((_a = project.architect) === null || _a === void 0 ? void 0 : _a['build']) || ((_b = project.targets) === null || _b === void 0 ? void 0 : _b['build']);
...
function assertDefaultBuildersConfigured(project) {
    ...
    const modernApplicationBuilder = '@angular/build:application';
    const defaultTestBuilder = '@angular-devkit/build-angular:karma';
    const modernTestBuilder = '@angular/build:unit-test';
    const hasDefaultBuilders = project.architect &&
        project.architect['build'] &&
        (project.architect['build']['builder'] === defaultBuilder ||
            project.architect['build']['builder'] === defaultApplicationBuilder ||
            project.architect['build']['builder'] === modernApplicationBuilder) &&
        project.architect['test'] &&
        (project.architect['test']['builder'] === defaultTestBuilder ||
            project.architect['test']['builder'] === modernTestBuilder);
