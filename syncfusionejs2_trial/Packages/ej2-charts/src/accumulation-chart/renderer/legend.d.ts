...
export declare class AccumulationLegend extends BaseLegend {
    ...
    legendRenderArgFill: number[];
    /**
     * Internal object for multi-series legend grouping by mappingKey.
     * Each key is a mappingKey value, and each value contains all matching points across series.
     *
     * @private
     */
    private legendItemMap;
    /**
    ...
    private getMatchingPointsForLegendItem;
    /**
     ...
     */
    findLegendCollectionIndex(seriesIndex: number, pointIndex: number): number;
    /**
     ...
     * @returns {void}
     */
    private sliceVisibilityForSeries;
    /**
