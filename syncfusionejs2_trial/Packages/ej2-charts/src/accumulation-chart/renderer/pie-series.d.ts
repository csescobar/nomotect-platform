...
export declare class PieSeries extends PieBase {
    ...
    findSeries(e: MouseEvent | PointerEvent | TouchEvent, borderRadius: number): void;
    toggleInnerPoint(event: MouseEvent | PointerEvent | TouchEvent, radius: number, innerRadius: number, borderRadius: number, hoverSeriesIndex?: number): void;
