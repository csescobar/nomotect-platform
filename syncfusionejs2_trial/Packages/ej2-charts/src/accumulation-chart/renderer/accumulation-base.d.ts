...
export declare class AccumulationBase {
    ...
    */
     ...
     * @returns {void}
     */
    invokeExplode(seriesIndex?: number): void;
    /**
     ...
     * @returns {void}
     */
    deExplodeAll(index: number, animationDuration: number, seriesIndex?: number): void;
    /**
     ...
     * @returns {void}
     */
    explodePoints(index: number, chart: AccumulationChart, explode?: boolean, pointAnimation?: boolean, seriesIndex?: number): void;
    private getSum;
