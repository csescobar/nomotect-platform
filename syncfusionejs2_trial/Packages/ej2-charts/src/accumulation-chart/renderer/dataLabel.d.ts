...
export declare class AccumulationDataLabel extends AccumulationBase {
     ...
     * @returns {void}
     */
    getDataLabelPosition(point: AccPoints, dataLabel: AccumulationDataLabelSettingsModel, textSize: Size, points: AccPoints[], seriesIndex?: number): void;
    /**
     ...
     * @private
     */
    calculateLabelCollection(point: AccPoints, dataLabel: AccumulationDataLabelSettingsModel, seriesIndex?: number): void;
    /**
     ...
     * @private
     */
    calculateLabelSize(isTemplate: boolean, childElement: HTMLElement, point: AccPoints, points: AccPoints[], argsData: IAccTextRenderEventArgs, datalabelGroup: Element, id: string, dataLabel: AccumulationDataLabelSettingsModel, redraw?: boolean, clientRect?: ClientRect, isReactCallback?: boolean, series?: number): void;
    /**
