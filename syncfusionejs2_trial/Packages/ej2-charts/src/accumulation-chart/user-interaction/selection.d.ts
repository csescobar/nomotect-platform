...
export declare class AccumulationSelection extends BaseSelection {
     ...
     * @private
     */
    private multiSeriesSelectionState;
    /**
     * @private
     */
    private multiSeriesHighlightState;
     ...
     * @returns {void}
     */
    protected performSelection(index: Index, accumulation: AccumulationChart, element?: Element): void;
    /**
     ...
     */
    private findMatchingPointsByMappingKey;
    legendSelectionForMappedPoints(accumulation: AccumulationChart, matchingPoints: {
        seriesIndex: number;
        pointIndex: number;
     ...
     * @returns {void}
     */
    protected blurEffect(pieId: string, visibleSeries: AccumulationSeries[]): void;
    /**
     ...
     */
    private checkEquals;
    private findMatchingPointsForHighlight;
    /**
     ...
     * @returns {void}
     */
    private highlightMatchingPoints;
    /**
