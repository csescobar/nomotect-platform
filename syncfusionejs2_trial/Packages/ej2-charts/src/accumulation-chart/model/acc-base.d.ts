...
export declare class AccumulationSeries extends ChildProperty<AccumulationSeries> {
    ...
    /**
     * Pre-calculated radius value for multi-series rendering.
     * Set by normalizeSeriesRadius() in AccumulationBase.
     *
     * @private
     */
    _calculatedRadius: number;
    /**
     * Pre-calculated inner radius value for multi-series rendering.
     * Set by normalizeSeriesRadius() in AccumulationBase.
     *
     * @private
     */
    _calculatedInnerRadius: number;
    /**
