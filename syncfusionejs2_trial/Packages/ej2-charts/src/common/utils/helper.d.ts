 ...
 * @returns {void}
 */
export declare function createTooltip(id: string, text: string, top: number, left: number, fontSize: string, chartId: string): void;
/**
 ...
 */
export declare function textTrim(maxWidth: number, text: string, font: FontModel, isRtlEnabled: boolean, themeFontStyle?: FontModel, templateSize?: Size): string;
/**
 ...
 * @returns {void}
 */
export declare function calculateSize(chart: Chart | AccumulationChart | RangeNavigator | StockChart | Chart3D | CircularChart3D | Sankey): void;
/**
 ...
 * @returns {void}
 */
export declare function createSvg(chart: Chart | AccumulationChart | RangeNavigator | Chart3D | CircularChart3D | Sankey): void;
/**
 ...
 */
export declare function getAncestorElement(event: MouseEvent | Event, legendID: string): string;
/**
 ...
 */
export declare function measureLegendTemplateSize(legendID: string, chart: Chart | AccumulationChart | StockChart, index: number, point?: AccPoints): Size;
/**
 ...
 * @public
 */
export declare function lightenColor(color: string, lighten: number): string;
/**
 ...
 * @public
 */
export declare function brightenColor(color: string, brighten: number): string;
/**
 ...
 * @public
 */
export declare function normalizeGradientStops(stops: GradientColorStopModel[]): GradientColorStopModel[];
/**
 ...
 * @public
 */
export declare function sanitizeGradientColor(color: string): string;
/**
 ...
 * @public
 */
export declare function getOrCreateSvgDefs(svgObject: Element): SVGDefsElement;
/**
 ...
 * @public
 */
export declare function removePreviousGradient(defs: SVGDefsElement, gradientId: string): void;
/**
 ...
 * @public
 */
export declare function createLinearGradient(series: Series, gradient: LinearGradientModel, svgObject: Element, chartElement: Element): void;
/**
 ...
 * @public
 */
export declare function createRadialGradient(series: Series, gradient: RadialGradientModel, svgObject: Element, chartElement: Element): void;
/**
 ...
 * @returns {void}
 */
export declare function applyGradientsToSeries(svgObject: Element, enableCanvas: boolean, visibleSeries: Series[], chartElement: Element): void;
