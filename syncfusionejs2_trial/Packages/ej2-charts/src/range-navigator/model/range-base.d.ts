...
import { BorderModel, AnimationModel, FontModel, CornerRadiusModel, SeriesAccessibilityModel } from '../../common/model/base-model';
...
export declare class RangeNavigatorSeries extends ChildProperty<RangeNavigatorSeries> {
     ...
     * @private
     */
    setPointColor(_point: DataPoint, color: string): string;
    /**
     ...
     * @private
     */
    setBorderColor(_point: DataPoint, border: BorderModel): BorderModel;
    /**
     ...
     * @private
     */
    formatAccessibilityDescription(point: DataPoint): string;
}
/**
 * Thumb settings
 */
