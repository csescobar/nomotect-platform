...
import { IStockLegendRenderEventArgs, IStockLegendClickEventArgs, IBeforeIndicatorChangeEventArgs, IIndicatorChangedEventArgs } from './model/base';
...
export declare class StockChart extends Component<HTMLElement> implements INotifyPropertyChanged {
    ...
    /**
     * Triggers before an indicator add/remove mutation is applied.
     *
     * This event is cancelable. Set the `cancel` property to `true` to prevent the mutation.
     *
     * @event beforeIndicatorChange
     */
    beforeIndicatorChange: EmitType<IBeforeIndicatorChangeEventArgs>;
    /**
     * Triggers after an indicator add/remove mutation has been successfully applied. This event is not triggered when beforeIndicatorChange event is cancelled.
     *
     * @event indicatorChanged
     */
    indicatorChanged: EmitType<IIndicatorChangedEventArgs>;
    /**
