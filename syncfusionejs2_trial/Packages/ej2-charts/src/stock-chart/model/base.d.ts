...
export interface IIndicatorChangedEventArgs {
    /** Defines the name of the event. */
    name: string;
    /** The type of the technical indicator (e.g., 'Ema', 'Rsi', 'Macd'). */
    type: TechnicalIndicators;
    /** True if adding indicator, false if removing. */
    isAdd: boolean;
}
export interface IBeforeIndicatorChangeEventArgs extends IIndicatorChangedEventArgs {
    /**
     * Set to `true` to cancel the indicator add or remove operation.
     */
    cancel: boolean;
}
