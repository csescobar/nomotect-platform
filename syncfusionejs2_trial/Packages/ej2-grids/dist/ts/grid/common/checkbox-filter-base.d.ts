...
export declare class CheckBoxFilterBase {
    ...
    applyImmediateSearchToGrid(searchValue: string): void;
    private dataSuccess;
     ...
     * @returns {void}
     */
    private applyImmediateCheckboxFilter;
