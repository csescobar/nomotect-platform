...
export declare class RowModelGenerator implements IModelGenerator<Column> {
     ...
     * @hidden
     */
    generatePinnedTopRows(data: Object): Row<Column>[];
    protected ensurePinnedColumns(): Cell<Column>[];
    protected ensureColumns(): Cell<Column>[];
    protected generateRow(data: Object, index: number, cssClass?: string, indent?: number, pid?: number, tIndex?: number, parentUid?: string, groupDataIndex?: number): Row<Column>;
