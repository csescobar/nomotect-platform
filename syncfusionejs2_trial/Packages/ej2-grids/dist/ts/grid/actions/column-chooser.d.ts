...
export declare class ColumnChooser implements IAction {
    ...
    private toggleQueue;
    private flushToggleTimer;
    private isEscapePressed;
    /** @hidden */
    parent: IGrid;
    /** @hidden */
    ...
    private sortColumnChooser;
    private updateIfiniteSelectAll;
    private wireEvents;
    private unWireEvents;
    private checkBoxClickHandler;
    private applyImmediateColumnToggle;
    private flushImmediateToggles;
    ...
    private extendInfiniteRemoveElements;
