...
export declare class FocusStrategy {
    ...
    private focusKey;
    private suppressCellFocusEvent;
    ...
    private triggerCellFocusEvent;
    private getFocusCellType;
    private shouldTriggerCellFocusEvent;
    ...
    filterfocus(args?: NotifyArgs): void;
