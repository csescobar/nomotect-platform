 ...
 */
export declare type RowSelectable = (data: Object, columns: ColumnModel[]) => boolean;
/**
 ...
 */
export declare type PinRow = (data: Object, columns: ColumnModel[]) => boolean;
/**
 ...
 */
export declare type SetRowHeight = (row: Object) => number;
