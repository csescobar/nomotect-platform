...
import { SelectionType, GridLine, SortDirection, SelectionMode, PrintMode, FilterType, FilterBarMode, FilterMode } from './enum';
 ...
 */
export declare class DomVirtualizationSettings extends ChildProperty<DomVirtualizationSettings> {
    /**
...
export declare class Grid extends Component<HTMLElement> implements INotifyPropertyChanged {
    ...
    /** @hidden */
    readonly domVirtualClearActions: string[];
    /** @hidden */
