 ...
 * ```
 */
export declare type Action = 'paging' | 'refresh' | 'sorting' | 'selection' | 'filtering' | 'searching' | 'rowdraganddrop' | 'reorder' | 'grouping' | 'ungrouping' | 'batchsave' | 'virtualscroll' | 'print' | 'beginEdit' | 'save' | 'delete' | 'cancel' | 'add' | 'refresh-aggregate-on-save' | 'filterBeforeOpen' | 'filterchoicerequest' | 'filterAfterOpen' | 'filterSearchBegin' | 'columnstate' | 'infiniteScroll' | 'stringfilterrequest' | 'booleanfilterrequest' | 'batchDelete' | 'batchCancel' | 'pin-row' | 'unpin-row' | 'dom-virtualscroll';
/**
 ...
 * ```
 */
export declare type FilterMode = 'OnEnter' | 'Default' | 'Immediate';
/**
 ...
 * ```
 */
export declare type ContextMenuItem = 'AutoFitAll' | 'AutoFit' | 'Group' | 'Ungroup' | 'Edit' | 'Delete' | 'Save' | 'Cancel' | 'Copy' | 'PdfExport' | 'ExcelExport' | 'CsvExport' | 'SortAscending' | 'SortDescending' | 'FirstPage' | 'PrevPage' | 'LastPage' | 'NextPage' | 'PinRow' | 'UnpinRow' | ChartType;
/**
 ...
 * ```
 */
export declare type EditMode = 'Normal' | 'Dialog' | 'Batch' | 'Cell';
/**
