 ...
 * @hidden
 */
export declare function ensureFirstRow(row: Element, rowTop: number, gridObj?: IGrid): boolean;
/**
 ...
 * @hidden
 */
export declare function isMatDialogContainer(gObj: IGrid, dialogObj: Dialog): void;
/**
 * @param {IGrid} gObj - Defines the grid
 * @returns {boolean} Returns true if the Grid is inside a MatDialog container
 * @hidden
 */
export declare function isAngularMatContainer(gObj: IGrid): boolean;
/**
 * @param {IGrid} gObj - Defines the grid
 * @param {Dialog} dlgObj - Defines the dialog
 ...
 * @hidden
 */
export declare function parseViewportHeight(height: string | number): number;
