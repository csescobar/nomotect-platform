...
export const blockEditorAppRoutes: Object[] = [
    ...
    { path: ':theme/block-editor/pasteSettings', component: BlockEditorPasteSettingsComponent, name: 'Paste Cleanup', description: 'This demo covers important Paste Settings of the JS Block control.', category: 'Block Editor', order: '01', sourceFiles: [
    ...
    { path: ':theme/block-editor/events', component: BlockEditorEventsComponent, name: 'Events', description: 'This demo showcases how to handle and interact with various event actions provided by the Block Editor component.', category: 'Block Editor', order: '01', sourceFiles: [
        ...
        { path: ':theme/block-editor/template-gallery', component: TemplateGalleryblock, name: 'Template Gallery', description: 'This demo covers fully-featured Template Gallery built with the Block Editor', category: 'Use Cases', order: '02', sourceFiles: [
    ...
    { path: ':theme/block-editor/MarkdownBlocks', component: MarkdownBlocksEditor, name: 'Markdown Blocks', description: 'This demo covers fully-featured documentation viewer built with the Block Editor', category: 'Use Cases', order: '02', sourceFiles: [
