...
export const timePickerAppRoutes: Object[] = [
    ...
    { path: ':theme/timepicker/input-mask', component: MaskSupportTimePickerComponent, name: 'Mask Support', description: 'This example demonstrates how to render the date time format in the input field using enableMask in a angular TimePicker', category: 'TimePicker' },
    {
