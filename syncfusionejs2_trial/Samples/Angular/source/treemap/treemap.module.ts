...
export const treemapAppRoutes: Object[] = [
    ...
    { path: ':theme/treemap/layout', component: TreemapLayoutComponent,  name: 'Layout', order: '01', category: 'TreeMap', description: 'This demo for Essential JS2 TreeMap control illustrates the GDP nominal of top 10 countries in the year 2015. The layout of the TreeMap can also be changed.' },
    { path: ':theme/treemap/drilldown', component: TreemapDrillDownComponent, name: 'Drilldown', order: '01', category: 'TreeMap', description: 'This demo for Essential JS2 TreeMap control demonstrates drill-down with the continents at the top level followed by regions and countries.' },
