...
export const tabAppRoutes: Object[] = [
    ...
    { path: ':theme/tab/orientation', component: OrientationTabComponent, name: 'Orientation', description: 'The sample demonstrates how to customize the orientation of Tab component along with feasibility to customize the Tab header styles in Angular platform.', category: 'Tabs' },
    { path: ':theme/tab/responsive-modes', component: ResponsiveTabComponent, name: 'Responsive Modes', description: 'The sample illustrates that responsive mode of Tab component that aligns tab items in a  scrollable or popup mode in Angular platform.', category: 'Tabs' },
    ...
    { path: ':theme/tab/drag-and-drop', component: DragAndDropComponent, name: 'Drag And Drop', description: 'This example demonstrates how to reorder the loaded tabs and how to add a new tab from the external source.', category: 'Tabs' },
    { path: ':theme/tab/keyboard-interaction', component: KeyboardTabComponent, name: 'Keyboard Interaction', description: 'This example showcases the keyboard shortcuts applicable on Tab component in Angular platform', category: 'Tabs' }
];
