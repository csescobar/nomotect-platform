...
import { DataMatrixGenerator, BarcodeGeneratorModule } from '@syncfusion/ej2-angular-barcode-generator';
...
export class CodabarComponenet
 {
  ...
  //public formObject: FormValidator = new FormValidator('#form-element', this.options());
