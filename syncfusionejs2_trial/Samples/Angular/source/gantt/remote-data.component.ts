...
import { DayMarkersService, GanttModule, SelectionService, VirtualScrollService } from '@syncfusion/ej2-angular-gantt';
import { SBActionDescriptionComponent } from '../common/adp.component';
@Component({
  selector: 'ej2-ganttremotedata',
  templateUrl: 'remote-data.html',
  standalone: true,
  providers: [SelectionService, VirtualScrollService, DayMarkersService],
...
export class GanttRemoteDataComponent implements OnInit {
  ...
  public loadGanttData(): void {
    this.data = new DataManager({
      url: `https://services.syncfusion.com/angular/production/api/GanttWebApiRemoteData?count=${this.recordCount}`,
