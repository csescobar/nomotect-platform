...
import { AdornmentNumericTextbox } from './adornments.component';
...
export const numericAppRoutes: Object[] = [
    ...
    { path: ':theme/numerictextbox/adornments', component: AdornmentNumericTextbox, name: 'Adornments', category: 'Numeric Textbox', description: "The example exposes a Angular Numeric TextBox with adornments support. It helps to render custom elements before or after the input element." }
];
