...
export const fileManagerAppRoutes: Object[] = [
    ...
    { path: ':theme/file-manager/sequential-upload', component: SequentialUploadController, name: 'Sequential upload', order: '01', category: 'File Manager', description: 'Angular FileManager component with sequential upload feature to upload files in the order they were added.' },
    ...
    { path: ':theme/file-manager/template', component: TemplateController, name: 'Template', order: '01', category: 'File Manager', description: 'This example demonstrates how to use the template property to customize the navigation pane, large icons, and details view in a Angular File Manager component.' },
