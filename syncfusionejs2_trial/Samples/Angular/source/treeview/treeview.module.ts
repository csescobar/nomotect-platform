...
export const treeAppRoutes: Object[] = [
    ...
    { path: ':theme/treeview/treeview-checkbox', component: CheckboxTreeViewComponent, name: 'Checkbox', order: '01', category: 'TreeView',  description: "This demo demonstrates the tree view with checkbox functionality, this allows the user to check more than one tree nodes." },
