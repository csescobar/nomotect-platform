...
import { AdornmentMaskedTextbox } from './adornments.component';
...
export const maskedTextBoxAppRoutes: Object[] = [
    ...
    { path: ':theme/maskedtextbox/adornments', component: AdornmentMaskedTextbox, name: 'Adornments', category: 'Input Mask', description: "The example exposes a Angular Masked TextBox with adornments support. It helps to render custom elements before or after the input element." }
];
