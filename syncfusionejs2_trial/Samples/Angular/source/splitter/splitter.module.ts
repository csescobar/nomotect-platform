...
export const splitterAppRoutes: Object[] = [
    ...
    { path: ':theme/splitter/outlook-style-layout', component: OutlookSplitterComponent, name: 'Outlook-style Layout', ignoreOnBuild: true, order: '02', category: 'Use Case', description: 'The example explains how to construct an outlook style layout using Angular Splitter, TreeView, ListView, and Rich Text Editor with multiple panes.' },
