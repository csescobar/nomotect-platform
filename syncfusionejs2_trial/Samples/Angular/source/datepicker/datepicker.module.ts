...
export const datePickerAppRoutes: Object[] = [
    ...
    { path: ':theme/datepicker/date-format', component: FormatDatePickerComponent, name: 'Format', description: 'The InputFormats feature allows users to define multiple input formats, automatically converting typed values to the display format for a seamless experience.', category: 'DatePicker' },
