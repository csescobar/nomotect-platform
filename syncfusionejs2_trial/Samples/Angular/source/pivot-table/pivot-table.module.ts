...
import { PivotTableExportComponent } from './pivot-table-exporting.component';
import { PivotChartFieldListComponent } from './pivot-chart-fieldlist.component';
import { ExternalDataBasedFilteringComponent } from './external-data-based-filtering.component';
...
export const pivottableRouteConfig: Object[] = [
    ...
    { 'path': ':theme/pivot-table/classic-layout', 'description': 'This sample demonstrates the classic (also known as tabular) layout view option of the pivot table.', component: ClassicLayoutComponent, 'name': 'Classic Layout', order: '01', category: 'Pivot Table', type: "update" },
    ...
    { 'path': ':theme/pivot-table/dynamic-binding', 'description': 'Pivot Table demo for dynamic data loading from JSON, CSV, and OLAP(XMLA) sources, with toolbar options to save and reload reports as JSON files.', component: DynamicBindingComponent, 'name': 'Dynamic Binding', order: '02', category: 'Data Binding' },
    ...
    { 'path': ':theme/pivot-table/pivot-chart-fieldlist', 'description': 'This demo for Essential<sup>®</sup> JS2 Pivot Table control demonstrate the basic rendering of the pivot table data into a simple pivot chart with static field list', component: PivotChartFieldListComponent, 'name': 'Pivot Chart with Field List', order: '04', category: 'Integration' },
    ...
    { 'path': ':theme/pivot-table/sparkline', 'description': 'This sample demonstrates how to embed sparkline charts inside Pivot Table cells to provide a visual representation of trends.', component: SparklineComponent, 'name': 'Sparkline Chart', order: '04', category: 'Integration' },
    { 'path': ':theme/pivot-table/field-list', 'description': 'This demo for Essential<sup>®</sup> JS2 Pivot Table control demonstrate the field list feature of the pivot table', component: FieldListComponent, 'name': 'Field List', order: '05', category: 'User Interaction', type: "update" },
    ...
    { 'path': ':theme/pivot-table/aggregation', 'description': 'This demo for Essential<sup>®</sup> JS2 Pivot Table control shows different types of aggregation for value fields', component: AggregationComponent, 'name': 'Aggregation', order: '07', category: 'Formula', type: "update" },
    ...
    { 'path': ':theme/pivot-table/value-filtering', 'description': 'This demo for Essential<sup>®</sup> JS2 Pivot Table control demonstrate the filtering of field headers based on the grand total (value based)', component: ValueFilterComponent, 'name': 'Value Filtering', order: '09', category: 'Filtering', type: "update" },
    { 'path': ':theme/pivot-table/external-data-based-filtering', 'description': 'This sample demonstrates how to externally filter data using a date range in the Pivot Table', component: ExternalDataBasedFilteringComponent, 'name': 'External Filtering', order: '09', category: 'Filtering' },
    ...
    { 'path': ':theme/pivot-table/exporting', 'description': 'This demo for Essential<sup>®</sup> JS2 Pivot Table control demonstrate client-side exporting of the pivot table to Excel, CSV and PDF formats', component: ExportingComponent, 'name': 'Default Export', order: '14', category: 'Exporting' },
    { 'path': ':theme/pivot-table/pivot-table-exporting', 'description': 'This demo for Essential<sup>®</sup> JS2 Pivot Table control demonstrate server-side exporting of the pivot table to Excel, CSV and PDF formats', component: PivotTableExportComponent, 'name': 'Export as Pivot', order: '14', category: 'Exporting' }
];
