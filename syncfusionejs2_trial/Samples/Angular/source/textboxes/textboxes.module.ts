...
import { AdornmentTextbox } from './adornments.component';
...
export const textboxesAppRoutes: Object[] = [
    ...
    { path: ':theme/textboxes/adornments', component: AdornmentTextbox, name: 'Adornments', category: 'TextBox', description: 'The example exposes a Angular TextBox with adornments support. It helps to render custom elements before or after the input element.'},
