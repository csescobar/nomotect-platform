...
@Component({
    selector: 'app-scheduler-with-chart',
    standalone: true,
    imports: [
        CommonModule,
        ScheduleModule,
    ...
    templateUrl: './scheduler-with-chart.html',
    styleUrls: ['./scheduler-with-chart.css']
})
export class SchedulerWithChartComponent implements OnInit {
