...
import { EmployeeShiftManagement } from './employee-shift-management.component';
import { TechEventOrganizerComponent } from './tech-event-organizer.component';
import {IntegrationWithChartComponent } from './integration-with-chart.component';
import { LimitConcurrentEventsComponent } from './limit-concurrent-events.component';
import { TaskProgressTrackerComponent } from './task-progress-tracker.component';
import { ActionEventButtonsComponent } from './action-event-buttons.component';
...
export const scheduleRouteConfig: Record<string, any>[] = [
  ...
  { path: ':theme/schedule/event-calendar', ignoreOnBuild: true, component: EventCalendarComponent, name: 'Event Calendar', order: '15', category: 'Product Use Case', description: 'This demo shows the way to organize and filter multiple types of events such as Personal, Birthdays, Work, and Holidays in the Angular scheduler.' },
  ...
  { path: ':theme/schedule/employee-shift-management', component: EmployeeShiftManagement, name: 'Shift Management',hideOnDevice: true, order: '15', category: 'Product Use Case', description: 'This demo show the efficient employee shift management using the scheduler, including shift scheduling, swapping, highlighting staff unavailablity, and seamlessly assigning leave replacements using drag-and-drop.' },
  { path: ':theme/schedule/tech-event-organizer', component: TechEventOrganizerComponent, name: 'Tech Event Organizer',hideOnDevice: true, order: '15', category: 'Product Use Case', description: 'This demo illustrates a tech event management tool built with the Scheduler. It has session-based room allocation, drag-and-drop scheduling, conflict prevention, and room-based filtering' },
  { path: ':theme/schedule/task-progress-tracker', component: TaskProgressTrackerComponent, name: 'Task Progress Tracker', type:'new', order: '15', category: 'Product Use Case', description: 'This demo presents a task-oriented Scheduler view with customized event rendering, featuring status indicators and progress tracking for effective project monitoring.' },
  { path: ':theme/schedule/integration-with-chart', ignoreOnBuild: true, component: IntegrationWithChartComponent, name: 'Integration with Chart', hideOnDevice: true, order: '15',type:'new', category: 'Product Use Case', description: 'This demo shows driver and truck details in a scheduler, with a chart that toggles to summarize each driver capacity or trip count.' },
  { path: ':theme/schedule/action-event-buttons', component: ActionEventButtonsComponent, name: 'Action Event Buttons', type: 'new', order: '15', category: 'Product Use Case', description: 'This demo showcases the event action buttons for editing and deleting events in day and week views. Click the edit or delete icons to manage your events.' },
  ...
  { path: ':theme/schedule/search-events', ignoreOnBuild: true, component: SearchEventsComponent, name: 'Search Events', order: '03', category: 'Appointments', description: 'This example shows how to filter the appointments or events of the Angular Scheduler based on a search string in a particular field or all fields.' },
  ...
  { path: ':theme/schedule/overlap-events', component: OverlapEventsComponent, name: 'Conflict Free Event', order: '03', category: 'Appointments', description: 'This demo explains how to restrict overlapping appointments within the same time range in Angular Scheduler.' },
  ...
  { path: ':theme/schedule/grid-to-schedule', ignoreOnBuild: true, component: EventsGridFromScheduleComponent, name: 'Drag Events From DataGrid', order: '04', category: 'Drag and Drop', description: 'This example illustrates how to drag and drop events between the DataGrid and the schedule. You can drag and drop events from the schedule to the DataGrid and from the DataGrid to in the Angular Scheduler.' },
  ...
  { path: ':theme/schedule/limit-concurrent-events', component: LimitConcurrentEventsComponent, name: 'Limit Concurrent Events', type: 'new', order: '06', category: 'Views', description: 'This demo illustrates how to limit the number of concurrent events displayed within a single time slot on the Scheduler component.' },
  ...
  { path: ':theme/schedule/recurrence-editor-generate-rule', ignoreOnBuild: true, component: RecGeneraterComponent, name: 'Rule Generator', order: '12', category: 'Recurrence Editor', description: 'This demo showcases how to generate various recurrence pattern rules, such as daily, weekly, monthly, and yearly, using the Recurrence Editor.' },
