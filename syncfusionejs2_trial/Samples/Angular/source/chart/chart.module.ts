...
import { DonutWithGradient } from './donut-with-gradient.component';
...
export const chartAppRoutes: Object[] = [
 ...
 order: '02', category: 'Line Charts' },
    ...
    { path: ':theme/chart/zooming', component: ZoomingChartComponent, name: 'Zooming and Panning', description: "This demo for Essential<sup>®</sup> JS2 Chart control demonstrates the zooming and panning behavior in chart.", order: '16', category: 'User Interaction' },
    { path: ':theme/chart/pagination', component: PaginationComponent, name: 'Pagination', description: "This demo for Essential<sup>®</sup> JS2 Chart control demonstrates the pagination behavior in chart.", order: '16', category: 'User Interaction' },
