...
import { AIAssistantEditorComponent } from './ai-assistant.component';

export const rteAppRoutes: Object[] = [
    { path: ':theme/rich-text-editor/tools', component: FullFeatureComponent, name: 'Overview', type: 'update', description: 'This demo describes basic and advanced features of the angular rich text editor component (WYSIWYG HTML Editor) with all its tools and functionalities.', order: '01', category: 'Rich Text Editor' },
    ...
    { path: ':theme/rich-text-editor/ai-assistant', component: AIAssistantEditorComponent, name : 'AI Assistant', description: 'This demo showcases the Built in AI Assistant interface of the Rich Text Editor component.', order: '01', category: 'Rich Text Editor'},
    ...
    { path: ':theme/rich-text-editor/insert-media', component: InsertMediaComponent, name: 'Insert Media', description: 'This demo shows how to insert audio and video, Embed video, upload audio and video, and more in Insert Media.', order: '01', category: 'Rich Text Editor', type: 'update' },
    ...
    { path: ':theme/rich-text-editor/iframe', component: IFrameComponent, name: 'IFrame', description: 'This demo shows how to render a classic angular rich text editor (iframe editor) that was designed by using the iframe element covering all tool functionalities.', order: '01', category: 'Rich Text Editor', type: 'update' },
    ...
    { path: ':theme/rich-text-editor/types', component: ToolbarTypeComponent, name: 'Type', description: 'This demo demonstrates different types and behaviors of a toolbar used in the angular HTML Editor such as expand/collapse, multirow,floating and popup.', order: '04', category: 'Toolbar' },
    { path: ':theme/rich-text-editor/bottom-toolbar', component: BottomToolbarComponent, name: 'Bottom Toolbar', description: 'The demo demonstrates how to add special characters or symbols into the rich content in vue Rich Text Editor using a custom toolbar command.', order: '04', category: 'Toolbar'},
