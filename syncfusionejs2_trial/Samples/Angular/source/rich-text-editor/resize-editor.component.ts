...
import { ToolbarService, LinkService, ImageService, ResizeService, HtmlEditorService, RichTextEditorModule, QuickToolbarService, PasteCleanupService, VideoService, AudioService, TableService, ClipBoardCleanupService, AutoFormatService } from '@syncfusion/ej2-angular-richtexteditor';
...
@Component({
    ...
    providers: [ToolbarService, LinkService, ImageService, ResizeService, HtmlEditorService,QuickToolbarService, PasteCleanupService, VideoService, AudioService, TableService, ClipBoardCleanupService, AutoFormatService],
    standalone: true,
