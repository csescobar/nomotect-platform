...
@Component({
  ...
  styleUrls: ['generative-ui.component.css'],
...
export class AIAssistGenerativeUIComponent implements AfterViewInit {
  constructor(@Inject('sourceFiles') private sourceFiles: any) {
    sourceFiles.files = ['generative-ui.component.css'];
  }
  ...
  private weatherTemplate(args: any): string {
    const defaults = {
  ...
  private registerTools(): void {
    ...
    (this.generativeAIAssistView as any).registerToolUI({
      ...
      template: (args: any) => this.weatherTemplate(args),
    });
