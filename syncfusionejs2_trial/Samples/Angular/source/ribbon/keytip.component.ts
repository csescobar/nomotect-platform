...
@Component({
    ...
    templateUrl: 'keytip.html',
    styleUrls: ['keytip.component.css'],
    encapsulation: ViewEncapsulation.None,
    standalone: true,
    imports: [RibbonModule, RibbonAllModule, ToastAllModule, ListViewAllModule, SBActionDescriptionComponent, SBDescriptionComponent]
})
export class RibbonKeyTipComponent {
  @ViewChild('toast') toastObj: ToastComponent;
  @ViewChild('keytipRibbon')
  public ribbonObj: Ribbon;

  constructor(@Inject('sourceFiles') private sourceFiles: any) {
    sourceFiles.files = ['keytip.component.css'];
  }
  ...
  public pictureSettings: RibbonDropDownSettingsModel = { iconCss: "e-icons e-image", content: "Picture", target:'#keytip-pictureList' };
