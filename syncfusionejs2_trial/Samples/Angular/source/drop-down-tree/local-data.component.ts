...
export class LocalDropDownTreeComponent {
    ...
    public fields: object = { dataSource: this.continents, value: 'code', text: 'name', child: 'countries' };
    ...
    public listfields: Object = { dataSource: this.localData, value: 'id', parentValue: 'pid', text: 'name', hasChildren: 'hasChild' };
}