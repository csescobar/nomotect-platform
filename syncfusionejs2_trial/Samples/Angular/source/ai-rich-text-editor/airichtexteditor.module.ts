...
export const AIRichTextEditorAppRoutes: Object[] = [
    { path: ':theme/ai-rich-text-editor/rich-text-editor', component: SmartRichTextEditor, name: 'AI Assistant', description: 'This demo showcases the Rich Text Editor AI feature.', category: 'Rich Text Editor', 'order': '09' }
];
