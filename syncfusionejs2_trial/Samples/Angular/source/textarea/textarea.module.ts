...
import { AdornmentTextArea } from './adornments.component';
...
export const textareasAppRoutes: Object[] = [
    ...
    { path: ':theme/textarea/adornments', component: AdornmentTextArea, name: 'Adornments', category: 'TextArea', description: 'The example exposes a Angular textarea with adornments support. It helps to render custom elements before or after the textarea element.'},
