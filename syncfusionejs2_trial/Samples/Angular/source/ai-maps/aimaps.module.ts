...
export const AIMapsAppRoutes: Object[] = [
    { path: ':theme/ai-maps/weather-prediction', component: WeatherPredictionComponent, name: 'Weather Prediction', description: 'This demo showcases the Maps AI feature.', category: 'Maps', 'order': '06' }
];
