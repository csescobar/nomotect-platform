ej.base.enableRipple(window.ripple)
    ...
    var chatUser = new ej.interactivechat.ChatUI({
        headerText: 'Paul Wilson (You)',
        headerIconCss: "chat_user_avatar",
        user: { id: 'user1', user: 'Paul Wilson', avatarUrl: '//ej2.syncfusion.com/javascript/demos/src/chat-ui/images/paul_wilson.png' },
