ej.base.enableRipple(window.ripple)
    ...
    var dropDownListObj = new ej.dropdowns.DropDownList({
        ...
        itemTemplate: '<div><img class="empImage" src="//ej2.syncfusion.com/javascript/demos/src/drop-down-list/Employees/${Eimg}.png" alt="employee"/>' +
        ...
        valueTemplate: '<div style="width:100%;height:100%;">' +
            '<img class="value" src="//ej2.syncfusion.com/javascript/demos/src/drop-down-list/Employees/${Eimg}.png" height="26px" width="26px" alt="employee"/>' +
