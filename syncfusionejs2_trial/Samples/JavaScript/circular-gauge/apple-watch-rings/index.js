        ...
        var circulargauge1 = new ej.circulargauge.CircularGauge({
            ...
            axes: [{
                annotations: [{
                    ...
                    content: '<div id="annotation1"><img style="width:22px;height:22px;" alt="Red arrow" src="//ej2.syncfusion.com/javascript/demos/src/circular-gauge/images/image1.svg" /></div>'
                }, {
                    description:'The Gauge is indicated with a green arrow',
                    angle: 11, radius: '58%', zIndex: '1',
                    content: '<div id="annotation2"><img style="width:20px;height:20px;" alt="Green arrow" src="//ej2.syncfusion.com/javascript/demos/src/circular-gauge/images/image2.svg" /></div>'
                }, {
                    description:'The Gauge is indicated with a blue arrow',
                    angle: 16, radius: '36%', zIndex: '1',
                    content: '<div id="annotation3"><img style="width:22px;height:22px;" alt="Blue arrow" src="//ej2.syncfusion.com/javascript/demos/src/circular-gauge/images/image3.svg" /></div>'
                }],
                startAngle: 0,
                endAngle: 360,
                labelStyle: {
        ...
        var circulargauge2 = new ej.circulargauge.CircularGauge({            
            ...
            // custom code start
                ...
                if (selectedTheme2.indexOf('highcontrast') !== -1 || selectedTheme2.indexOf('dark') !== -1) {
                    args.gauge.axes[0].annotations[0].content =
                        '<div class="annotation4"><img style="width:17px;height:17px;" src="//ej2.syncfusion.com/javascript/demos/src/circular-gauge/images/image4.svg" /></div>';
                }
            // custom code end
            },       
            height: '65px',
            ...
            axes: [{
                annotations: [{
                    ...
                    content: '<div class="annotation4"><img style="width:17px;height:17px;" alt="Arrow placed within the small red gauge" src="//ej2.syncfusion.com/javascript/demos/src/circular-gauge/images/image1.svg" /></div>'
                }],
                lineStyle: { width: 0 },
        ...
        var circulargauge3 = new ej.circulargauge.CircularGauge({            
            ...
            // custom code start
                ...
                if (selectedTheme3.indexOf('highcontrast') > -1 || selectedTheme3.indexOf('dark') > -1) {
                    args.gauge.axes[0].annotations[0].content =
                        '<div class="annotation5"><img style="width:15px;height:15px;" src="//ej2.syncfusion.com/javascript/demos/src/circular-gauge/images/image5.svg" /></div>';
                }
            // custom code end
            },
            height: '65px',
            ...
            axes: [{
                annotations: [{
                    ...
                    angle: 0, radius: '0%', zIndex: '1',
                    content: '<div class="annotation5"><img style="width:15px;height:15px;" alt="Arrow placed within the small green gauge" src="//ej2.syncfusion.com/javascript/demos/src/circular-gauge/images/image2.svg" /></div>'
                }],
                startAngle: 0, endAngle: 360,
                lineStyle: { width: 0 },
                majorTicks: { height: 0, }, minorTicks: { height: 0 },
        ...
        var circulargauge4 = new ej.circulargauge.CircularGauge({
            ...
            // custom code start
                ...
                if (selectedTheme4.indexOf('highcontrast') !== -1 || selectedTheme4.indexOf('dark') !== -1) {
                    args.gauge.axes[0].annotations[0].content =
                        '<div class="annotation6"><img style="width:17px;height:17px;" src="//ej2.syncfusion.com/javascript/demos/src/circular-gauge/images/image6.svg" /></div>';
                }
            // custom code end
            },
            height: '65px',
            ...
            axes: [{
                annotations: [{
                    ...
                    angle: 0, radius: '0%', zIndex: '1',
                    content: '<div class="annotation6"><img style="width:17px;height:17px;" alt="Arrow placed within the small blue gauge" src="//ej2.syncfusion.com/javascript/demos/src/circular-gauge/images/image3.svg" /></div>'
                }],
                startAngle: 0, endAngle: 360,
                lineStyle: { width: 0 },
                labelStyle: {
