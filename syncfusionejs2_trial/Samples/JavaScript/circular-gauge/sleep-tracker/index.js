    ...
    var circulargauge = new ej.circulargauge.CircularGauge({
        ...
        axes: [{
            ...
            pointers: [{
                ...
                markerWidth: 28,
                markerHeight: 28,
                imageUrl: '//ej2.syncfusion.com/javascript/demos/src/circular-gauge/images/sun-icon.png',
                animation: {
                    enable: false
                },
            },
            {
                ...
                markerWidth: 28,
                markerHeight: 28,
                imageUrl: '//ej2.syncfusion.com/javascript/demos/src/circular-gauge/images/moon-icon.png',
                animation: {
                    enable: false,
                },
            }
