    ...
    var circulargauge = new ej.circulargauge.CircularGauge({
        ...
        axes: [{
            ...
            annotations: [{
                ...
                radius: '0%',
                zIndex: '1',
                content: '<div style="margin-top: -37%;display: flex;justify-content: center;"><img alt="Axis background image" src="//ej2.syncfusion.com/javascript/demos/src/circular-gauge/images/axis-background.png" height="400" width="400" /></div>'
            },
            {
