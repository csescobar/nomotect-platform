        ...
        layers: [
            {
                ...
                markerSettings: [
                    {
                        visible: true,
                        template: '<div><img alt="Group image" src="//ej2.syncfusion.com/javascript/demos/src/maps/images/group.svg" style="height:15px;width:15px;"></img></div>',
                        dataSource: [{
                                name: 'Mexico City',
                                latitude: 23.6445,
                                longitude: -102.832
                    ...
                    {
                        visible: true,
                        template: '<div><img alt="Ballon image" src="//ej2.syncfusion.com/javascript/demos/src/maps/images/ballon.png" style="height:30px;width:20px;"></img></div>',
                        dataSource: [{
                                name: 'Mexico City',
                                latitude: 24.2005,
                                longitude: -102.832
                    ...
                    {
                        visible: true,
                        template: '<div><img alt="Oval image" src="//ej2.syncfusion.com/javascript/demos/src/maps/images/oval.svg" style="height:15px;width:15px;"></img></div>',
                        dataSource: [{
                                name: 'Los Angeles',
                                latitude: 34.0522,
                                longitude: -118.2437
                    ...
                    {
                        visible: true,
                        template: '<div><img alt="Map tooltip" src="//ej2.syncfusion.com/javascript/demos/src/maps/images/map-tooltip.svg" style="height:50px;width:100px;"></img></div>',
                        dataSource: [{
                                latitude: 28.5,
                                longitude: -110.400
                            }],
