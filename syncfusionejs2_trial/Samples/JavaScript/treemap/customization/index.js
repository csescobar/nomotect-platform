ej.base.enableRipple(window.ripple)
    ...
    var treemap = new ej.treemap.TreeMap({
        ...
        leafItemSettings: {
            ...
            labelTemplate: '<div style="pointer-events: none;"><img alt="Custom label template for illustrations" src="//ej2.syncfusion.com/javascript/demos/src/treemap/image/{{:GameImage}}"' +
