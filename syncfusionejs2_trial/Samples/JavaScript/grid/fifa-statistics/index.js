ej.base.enableRipple(window.ripple)
        ...
        if (value) {
            switch (field) {
                case 'Host':
                    ...
                    imageSource = '//ej2.syncfusion.com/javascript/demos/src/grid/images/country/' + (window.webpfiles.indexOf(value) > -1 ? value + '.webp' : value + '.png');
                ...
                case 'Coach':
                    if (args.target.tagName === 'IMG') {
                        ...
                        imageSource = '//ej2.syncfusion.com/javascript/demos/src/grid/images/coach/' + value + (value === 'Aymoré Moreira' ? '.png' : '.jpg');
    ...
    function renderImage(rowDetails, field) {
        ...
        var src = '//ej2.syncfusion.com/javascript/demos/src/grid/images/country/' + (window.webpfiles.indexOf(value) > -1 ? value + '.webp' : value + '.png');
