ej.base.enableRipple(window.ripple)
    ...
    window.renderEmptyImg = function () {
        ...
        if (document.body.classList.value.indexOf('dark') > -1 || document.body.classList.value.indexOf('highcontrast') > -1) {
            img.src = "//ej2.syncfusion.com/javascript/demos/src/grid/images/emptyRecordTemplate_dark.svg";
        } else {
            img.src = "//ej2.syncfusion.com/javascript/demos/src/grid/images/emptyRecordTemplate_light.svg";
        }
