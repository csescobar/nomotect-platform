ej.base.enableRipple(window.ripple)
    ...
    var carouselObj = new ej.navigations.Carousel({
        ...
        dataSource: [
            { imagePath: '//ej2.syncfusion.com/javascript/demos/src/ai-assistview/images/moscow.jpg', suggestion: 'How do I prioritize tasks effectively?'  },
            { imagePath: '//ej2.syncfusion.com/javascript/demos/src/ai-assistview/images/bridge.jpg', suggestion: 'How do I set daily goals in my work day?'  },
            { imagePath: '//ej2.syncfusion.com/javascript/demos/src/ai-assistview/images/london.jpg', suggestion: 'Steps to publish a e-book with marketing strategy'  },
            { imagePath: '//ej2.syncfusion.com/javascript/demos/src/ai-assistview/images/tokyo.jpg', suggestion: 'What tools or apps can help me prioritize tasks?'  }
        ],
