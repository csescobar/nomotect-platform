window.defaultPromptResponseData = [
    {
...
window.promptsData = [
    {
        ...
        blocks: window.chartBlockData
    }
];

window.toolSystemPrompt = `
