ej.base.enableRipple(window.ripple)
    ...
    var progressLoad = function (args) {
        ...
        if (args.progressBar.element.id === 'label-container') {
            ...
            args.progressBar.annotations[0].content = '<img src="//ej2.syncfusion.com/javascript/demos/src/progress-bar/images/' + customTheme.replace(/-/i, '') + '-Download.svg" alt="Download Icon"></img>';
        }
        else {
            args.progressBar.annotations[0].content = '<img src="//ej2.syncfusion.com/javascript/demos/src/progress-bar/images/' + customTheme.replace(/-/i, '') + '-pause.svg" alt="Pause Icon"></img>';
        }
    };
    var pausePlay = new ej.progressbar.ProgressBar({
        ...
        progressCompleted: function (args) {
            ...
            clearTimeout1 = setTimeout(function () {
                pausePlay.annotations[0].content = '<img src="//ej2.syncfusion.com/javascript/demos/src/progress-bar/images/' + (pausePlay.theme).toLowerCase() + '-Play.svg" alt=\"Play Icon\"></img>';
                pausePlay.dataBind();
            }, 2000);
        },
        annotations: [
    ...
    var downloadProgress = new ej.progressbar.ProgressBar({
        ...
        progressCompleted: function (args) {
            ...
            clearTimeout2 = setTimeout(function () {
                downloadProgress.annotations[0].content = '<img src="//ej2.syncfusion.com/javascript/demos/src/progress-bar/images/' + (downloadProgress.theme).toLowerCase() + '-Tick.svg" alt=\"Tick Icon\"></img>';
