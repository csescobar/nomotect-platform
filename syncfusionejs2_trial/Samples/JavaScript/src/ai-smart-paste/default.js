...
this.default = function () {
    ...
    var textArea1 = new ej.inputs.TextArea({
    ...
    var textArea2 = new ej.inputs.TextArea({
    ...
    var resetButton = new ej.buttons.Button({
        content: 'Reset',
    ...
    // Initialize Button component.
    var button = new ej.buttons.SmartPasteButton({
        content: 'Smart Paste',
        iconCss: "e-icons e-paste",
        aiAssistHandler: window.serverAIRequest
    });
    // Render initialized Button.
    ...
    var copyButton = new ej.buttons.Button({
        content: 'Copy',
