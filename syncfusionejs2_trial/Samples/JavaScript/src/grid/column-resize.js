this.default = function () {
    var grid = new ej.grids.Grid({
        ...
        autoFit: true,
        columns: [
            { field: 'OrderID', headerText: 'Order ID', minWidth: 115, textAlign: 'Right', maxWidth: 200, width: 140, isPrimaryKey: true, validationRules: { required: true, number: true }},
            { field: 'CustomerName', headerText: 'Customer Name', minWidth: 115, width: 150, validationRules: { required: true, minLength: 5 } },
            { field: 'Freight', width: 160, minWidth: 115, format: 'C2', textAlign: 'Right', editType: 'numericedit', validationRules: { required: true, min: 0 } },
            {
