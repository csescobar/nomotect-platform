this.default = function() {
    ...
    var defaultAiAssistView = new ej.interactivechat.AIAssistView({
        ...
        promptRequest: promptRequested
    });
    defaultAiAssistView.appendTo('#aiAssistView');

    function promptRequested(args) {
        setTimeout(function () {
            ...
            defaultAiAssistView.promptSuggestions = foundPrompt?.suggestions || suggestions;
    ...
    function bannerContent() {
        return `<div class="banner-content">
                    <div class="e-icons e-assist-icon"></div>
                    <h3>AI Assistance</h3>
