this.default = function() {
    ...
    var copiedTextArea = document.querySelector('.copied-content');

    var overviewAiAssist = new ej.interactivechat.AIAssistView({
        ...
        promptRequest: function (args) {
            setTimeout(function () {
                ...
                if (foundPrompt) {
                    ...
                    overviewAiAssist.promptSuggestions = foundPrompt.suggestionData;
                }
                else { 
