ej.base.enableRipple(window.ripple)
    ...
    var listObj = new ej.dropdowns.MultiSelect({
        ...
        itemTemplate: '<div><img class="empImage" src="//ej2.syncfusion.com/javascript/demos/src/multi-select/Employees/${Eimg}.png" alt="employee"/>' +
        '<div class="ename"> ${Name} </div><div class="job"> ${Designation} </div></div>',
        // set the template content for displays the selected items in input element.
        valueTemplate: '<div style="width:100%;height:100%;">' +
            '<img class="value" src="//ej2.syncfusion.com/javascript/demos/src/multi-select/Employees/${Eimg}.png" height="26px" width="26px" alt="employee"/>' +
