 ...
 var stockData = [
    ...
    for (var i = 0; i < stockData1.length; i++) {
        if (stockData1[i]['x'].getDate() !== date1.getDate()) {
            var randomLow1 = Math.random() * 5 + stockData1[i]['low'] - 5;
            var randomHigh1 = Math.random() * 5 + stockData1[i]['high'];
...
window.defaultData = rawData.map(function(data){
    return {
        x: new Date(data[0]),
        open: data[1],
        high: data[2],
