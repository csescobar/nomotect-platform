...
function createNode(
    ...
    return {
        ...
        constraints: ej.diagrams.NodeConstraints.PointerEvents | ej.diagrams.NodeConstraints.Tooltip | ej.diagrams.NodeConstraints.ReadOnly,
        tooltip: {
            relativeMode: 'Mouse',
            position: 'TopCenter',
        ...
        ports: [{ id: 'port', offset: { x: (portX !== undefined ? portX : 0.9), y: 0.8 } }],
    };
}
...
function createLabelNode(
    id, width, height, fill,
    offsetX, offsetY, iconClass, description
) {
    return {
        id: id,
        ...
        constraints: ej.diagrams.NodeConstraints.InConnect
    };
}
...
function createConnector(
    ...
    p1x, p1y, p2x, p2y, sourcePortID
) {
    return {
        sourceID: sourceID,
        sourcePortID: sourcePortID || 'port',
        targetID: targetID,
