  ...
  var imageEditorObj = new ej.imageeditor.ImageEditor({
	...
	created: function () {
		if (ej.base.Browser.isDevice) {
			imageEditorObj.open('//ej2.syncfusion.com/javascript/demos/src/image-editor/images/flower.png');
		} else {
			imageEditorObj.open('//ej2.syncfusion.com/javascript/demos/src/image-editor/images/default.png');
		}
