 ...
 */
    ...
    var chart = new ej.charts.Chart({
        ...
        annotations: [{
                content: '<div id="chart_cloud"><img src="//ej2.syncfusion.com/javascript/demos/src/chart/images/cloud.png" alt="Cloud Picture" style="width: 41px; height: 41px"/></div>',
                x: 'Sun', y: 70, coordinateUnits: 'Point', verticalAlignment: 'Top'
            }, {
                content: '<div id="chart_cloud"><img src="//ej2.syncfusion.com/javascript/demos/src/chart/images/sunny.png" alt="Sunny Picture" style="width: 41px; height: 41px"/></div>',
