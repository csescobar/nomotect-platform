 ...
 */
    ...
    var clickInstance = {
        ...
        series: [
            ...
            '<img src="//ej2.syncfusion.com/javascript/demos/src/chart/images/back.png" id="back" alt="Back Icon"/>', region: 'Series', x: '50%', y: '50%'
    ...
    var pointClick = function (args) {
        ...
        if (ej.charts.getElement(pie.element.id + '_Series_' + index.series + '_Point_' + index.point)) {
            ...
            if (selectedTheme.indexOf('highContrast') > -1 || selectedTheme.indexOf('dark') > -1) {
                pie.annotations = [{
                    content: '<div id= "white" style="cursor:pointer;padding:3px;width:30px; height:30px;"><img src="//ej2.syncfusion.com/javascript/demos/src/chart/images/white.png" id="back" alt="White Icon"/><div>', region: 'Series', x: '50%', y: '50%'
                }];
            }
            else {
                pie.annotations = [{
                    content: '<div id="back" style="cursor:pointer; padding: 3px; width: 30px; height: 30px;">' + '<img src="//ej2.syncfusion.com/javascript/demos/src/chart/images/back.png" id="imgback" alt="Back Icon"/>', region: 'Series', x: '50%', y: '50%'
                }];
            }
            pie.series[0].animation.enable = false;
