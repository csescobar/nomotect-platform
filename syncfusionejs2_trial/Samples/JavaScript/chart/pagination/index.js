 ...
 */
    ...
    var chartData = [
        ...
        var chart = new ej.charts.Chart({
            ...
            annotations: [
                {
                    content: '<div id="chart_image"><img src="//ej2.syncfusion.com/javascript/demos/src/chart/images/cloudy.png" alt="Cloud Picture" style="width: 70px; height: 70px"/></div>',
            ...
            annotationRender: function (args) {
                if (args.content.id === 'container_Annotation_0') {
                    args.content.innerHTML = '<div id="chart_cloud" align="center"><img src="//ej2.syncfusion.com/javascript/demos/src/chart/images/' + image + '.png" alt="Cloud Picture" style="width: 70px; height: 70px; margin-right: 10px;"/></div>';
                }
