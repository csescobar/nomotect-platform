...
define(["require", "exports"], function (require, exports) {
    ...
    var getOpenAiModelRTE = function (subQuery, promptQuery) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    visitorId = _a.sent();
                    return [4, fetch('https://ai-samples-server-f5hta2h9g5aqhcfg.southindia-01.azurewebsites.net/api/rte', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
    ...
    var OpenAiModelKanban = function (promptQuery) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    visitorId = _a.sent();
                    return [4, fetch('https://ai-samples-server-f5hta2h9g5aqhcfg.southindia-01.azurewebsites.net/api/kanban', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
    ...
    function getFileExtension(fileName) {
        var _a, _b;
        return (_b = (_a = fileName.split('.').pop()) === null || _a === void 0 ? void 0 : _a.toLowerCase()) !== null && _b !== void 0 ? _b : '';
    }
    ...
    function getFileContext(attachedFiles) {
        return __awaiter(this, void 0, void 0, function () {
            var fileContents, filePromises;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fileContents = [];
                        filePromises = attachedFiles.map(function (file) {
                            return new Promise(function (resolve, reject) {
                                ...
                                reader.onload = function (e) {
                                    ...
                                    fileContents.push({
                                        ...
                                        type: file.type,
                                        fileType: fileType,
                                        content: (_b = (_a = e.target) === null || _a === void 0 ? void 0 : _a.result) !== null && _b !== void 0 ? _b : null
                                    });
                                    resolve();
                                };
                                reader.onerror = function () {
                                    reject(new Error("Error reading file: ".concat(fileName)));
                                };
    ...
    function getAIResponse(args, abortController) {
        return __awaiter(this, void 0, void 0, function () {
            var aiPrompt, fileContents, attachedFileContext_1, userID, abortSignal, systemPrompt, requestBody, response, errorData, result, aiResponse, error_5, bannerElement, headerElement;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 8, , 9]);
                        ...
                        fileContents = [];
                        if (!(args.attachedFiles && args.attachedFiles.length > 0)) return [3, 2];
                        return [4, getFileContext(args.attachedFiles)];
                    case 1:
                        ...
                        fileContents.forEach(function (file) {
                            ...
                            if (file.fileType === 'text') {
                                ...
                                attachedFileContext_1 += '[Image file: ' + file.name + ' - Base64 encoded data available]\n';
                                attachedFileContext_1 += file.content + '\n';
                            }
                            else {
                                attachedFileContext_1 += '[Binary file: ' + file.name + ' - Please process this file]\n';
                                attachedFileContext_1 += file.content.substring(0, 500) + '...\n';
                            }
                        });
                        aiPrompt = attachedFileContext_1 + '\n\nUser Prompt: ' + args.prompt;
                        _a.label = 2;
                    case 2: return [4, getUserID()];
                    case 3:
                        userID = _a.sent();
                        if (!userID) {
                            return [2, 'Failed to generate user ID. Please try again later.'];
                        }
                        ...
                        return [4, fetch(exports.AI_SERVICE_URL + '/api/chat', {
                                method: 'POST',
                                headers: {
                                    "Content-Type": "application/json"
                                },
                    ...
                    case 8:
                        ...
                        if (error_5.name === "AbortError") {
                            ...
                            return [2, error_5.message];
                        }
                        else if (error_5.message.includes('Failed to fetch')) {
                            console.warn("To test these samples locally, configure and use your own API key.");
                        }
                        return [2, 'We could not reach the AI service; please try again later.'];
                    case 9: return [2];
                }
            });
        });
