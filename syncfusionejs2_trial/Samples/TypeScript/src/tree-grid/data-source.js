define(["require", "exports"], function (require, exports) {
    ...
    exports.foodMenu = [
        ...
        },
        {
            ...
            "newPrice": 8.99,
            "originalPrice": 10.99,
            "Image": "src/tree-grid/images/cheese-burger.png",
            "FoodId": 16,
            "CategoryId": 15,
            "Rating": 4.5,
            "TotalReviews": 90,
        ...
        },
        {
            ...
            "newPrice": 5.99,
            "originalPrice": 7.99,
            "Image": "src/tree-grid/images/classic-hot-dog.png",
            "FoodId": 26,
            "CategoryId": 25,
            "Rating": 4.6,
            "TotalReviews": 60,
        ...
        },
        {
            ...
            "newPrice": 6.99,
            "originalPrice": 8.99,
            "Image": "src/tree-grid/images/cheese-hot-dog.png",
            "FoodId": 30,
            "CategoryId": 25,
            "Rating": 4.6,
            "TotalReviews": 60,
        ...
        },
        {
            ...
            "newPrice": 13.99,
            "originalPrice": 0,
            "Image": "src/tree-grid/images/paneer-chowmein.png",
            "FoodId": 35,
            "CategoryId": 32,
            "Rating": 4.2,
            "TotalReviews": 40,
        ...
        },
        {
            ...
            "newPrice": 13.49,
            "originalPrice": 15.49,
            "Image": "src/tree-grid/images/sichuan-chowmein.png",
            "FoodId": 40,
            "CategoryId": 32,
            "Rating": 4.1,
            "TotalReviews": 30,
    ...
    exports.virtualScrollData = [];
    exports.parentMap = new Map();
    var virtualDataSource = function () {
        if (exports.virtualScrollData.length > 0)
            return;
        var Names = [
        ...
        for (var i = 1; i <= 2000; i++) {
            ...
            exports.virtualScrollData.push(parent_1);
            exports.parentMap.set(parent_1.TaskID, parent_1);
            for (var j = 1; j <= 4; j++) {
                var childIndex = ((i + j) % 100);
                var child = {
                    TaskID: ++RecordID,
                    ParentID: parent_1.TaskID,
                ...
                exports.virtualScrollData.push(child);
                exports.parentMap.set(child.TaskID, child);
            }
        }
    };
    exports.virtualDataSource = virtualDataSource;
});
