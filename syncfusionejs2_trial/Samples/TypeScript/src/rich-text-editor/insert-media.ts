 ...
 */
import { RichTextEditor, Toolbar, Link, Image, HtmlEditor, QuickToolbar, Audio , Video, PasteCleanup, Table, ClipBoardCleanup, AutoFormat } from '@syncfusion/ej2-richtexteditor';
RichTextEditor.Inject(Toolbar, Link, Image, HtmlEditor, QuickToolbar, Audio , Video, PasteCleanup, Table, ClipBoardCleanup, AutoFormat);
