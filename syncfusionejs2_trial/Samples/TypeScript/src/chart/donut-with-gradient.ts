...
import { AccumulationChart, AccumulationLegend, PieSeries, IAccLoadedEventArgs,
    AccumulationDataLabel, AccumulationTooltip, IAccPointRenderEventArgs
...
(window as any).default = (): void => {
    ...
    const baseColors: string[] = ['#39B9E6', '#2E79CF', '#4960CF', '#5E47C6', '#8A44C9', '#C24F86', '#D8584E', '#E07245', '#F09A4A'];
