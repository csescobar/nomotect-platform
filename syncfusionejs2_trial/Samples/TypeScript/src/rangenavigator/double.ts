...
let backgroundColor: string = (theme as any) === 'Highcontrast' ? 'black' : 'white';
...
(window as any).default = (): void => {
    ...
    xhttp.open('GET', location.origin + location.pathname + 'src/rangenavigator/data-source/double.json', true);
    xhttp.send();
};
