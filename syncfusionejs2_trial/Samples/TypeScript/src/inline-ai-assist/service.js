...
define(["require", "exports", "express", "cors", "openai"], function (require, exports, express_1, cors_1, openai_1) {
    "use strict";
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    return [4, client.chat.completions.create({
                            model: 'MODEL_NAME',
                            stream: true,
                            stream_options: {
                                include_usage: true
                ...
                case 5:
                    if (!(stream_1_1 = _e.sent(), !stream_1_1.done)) return [3, 7];
                ...
                case 9:
                    ...
                    if (!(stream_1_1 && !stream_1_1.done && (_a = stream_1.return))) return [3, 11];
