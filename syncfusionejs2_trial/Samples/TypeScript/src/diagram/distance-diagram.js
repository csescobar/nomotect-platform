define(["require", "exports", "@syncfusion/ej2-diagrams", "../common/culture-loader", "@syncfusion/ej2-dropdowns"], function (require, exports, ej2_diagrams_1, culture_loader_1, ej2_dropdowns_1) {
    "use strict";
    ...
    window.default = function () {
        ...
        function createWallConnector(id, startX, startY, endX, endY, color, thickness) {
            ...
            var constraints = id.includes('WallOuter')
                ? ej2_diagrams_1.ConnectorConstraints.None
                : (ej2_diagrams_1.ConnectorConstraints.Default | ej2_diagrams_1.ConnectorConstraints.ReadOnly) &
                    ~(ej2_diagrams_1.ConnectorConstraints.Drag | ej2_diagrams_1.ConnectorConstraints.DragSourceEnd);
            switch (id) {
                case 'WallOuterLeft':
        ...
        function createItem(id, x, y, width, height, pathData, options) {
            var item = {
                ...
                flip: options.flip || ej2_diagrams_1.FlipDirection.None,
            };
            nodes.push(item);
        }
        function createBedroomItem(id, x, y, width, height, pathData, color) {
            var options = {
                fill: '#E8F4FD',
                strokeColor: '#2E86AB',
            };
            ...
            if (id === 'bedroomDoor2') {
                options.flip = ej2_diagrams_1.FlipDirection.Horizontal;
                options.fill = '#F0F8E8';
                options.strokeColor = '#228B22';
            }
            createItem(id, x, y, width, height, pathData, options);
        }
        function createKitchenItem(id, x, y, width, height, pathData, color) {
            var options = {
                fill: color,
                strokeColor: '#333',
            };
        ...
        function createLivingRoomItem(id, x, y, width, height, pathData, color) {
            var options = {
                fill: '#FFF8DC',
                strokeColor: '#B8860B',
            };
        ...
        function createRestroomSeparator() {
            createWallConnector('RestroomSeparator', 780, 610, 780, 480, '#333333', 5);
        ...
        function createHallSeparator() {
            createWallConnector('HallSeparator', 540, 610, 540, 410, '#333333', 5);
        ...
        function createInitialLayout() {
            createWallConnector('WallOuterTop', 299, 150, 901, 150, '#333333', 3);
            createWallConnector('WallOuterLeft', 300, 150, 300, 610, '#333333', 3);
            createWallConnector('WallOuterBottom', 299, 610, 901, 610, '#333333', 3);
            createWallConnector('WallOuterRight', 900, 150, 900, 610, '#333333', 3);
            createWallConnector('Separator1', 900, 430, 670, 430, '#333333', 5);
            createWallConnector('Separator2', 628, 150, 628, 313, '#333333', 5);
            createWallConnector('Separator3', 300, 310, 560, 310, '#333333', 5);
            createWallConnector('Separator4', 900, 310, 700, 310, '#333333', 5);
            ...
            createBedroomItem('bedroomDoor1', 593, 285, 60, 50, 'M 0 26.92 L 0 30 L 28 30 L 28 26.92 M 0 26.92 L 28 26.92 M 0 26.92 C 0 12.05 12.36 0 27.61 0 L 28 0 L 28 26.92', '#FFD700');
            createBedroomItem('bedroomDoor2', 664, 285, 60, 50, 'M 0 26.92 L 0 30 L 28 30 L 28 26.92 M 0 26.92 L 28 26.92 M 0 26.92 C 0 12.05 12.36 0 27.61 0 L 28 0 L 28 26.92', '#FFD700');
            ...
            createLivingRoomItem('TVStand', 420, 368, 90, 40, 'M55 23H4C2.34315 23 1 24.3431 1 26V40H58V26C58 24.3431 56.6569 23 55 23ZM55 23L48.1968 4.29128C47.4783 2.31534 45.6004 1 43.4979 1H16.5021C14.3996 1 12.5217 2.31533 11.8032 4.29128L5 23H55ZM16 1V23M25 1V23M34 1V23M43 1V23M1 36.5H58', '#8B4513');
            ...
            createLivingRoomItem('MainDoor', 630, 586, 90, 40, 'M 76 56.54 L 76 63 L 0 63 L 0 56.54 M 76 56.54 L 0 56.54 M 76 56.54 L 76 0 L 75.46 0 C 54.77 0 38 25.31 38 56.54 M 76 56.54 L 38 56.54 M 0 56.54 L 0 0 L 0.54 0 C 21.23 0 38 25.31 38 56.54 M 0 56.54 L 38 56.54 M 38 62.6 L 38 56.54', '#FFD700');
            createRestroomSeparator();
            createBathroomDoor('bathDoor1', 802, 456, 45, 45, 'M 0 26.92 L 0 30 L 28 30 L 28 26.92 M 0 26.92 L 28 26.92 M 0 26.92 C 0 12.05 12.36 0 27.61 0 L 28 0 L 28 26.92', '#FFD700');
            createHallSeparator();
        ...
        function createDimensionConnector(id, startX, startY, endX, endY, dimensionText, isHorizontal) {
            var dimensionLine = {
                ...
                targetPoint: { x: endX, y: endY },
                type: 'Straight',
                constraints: ej2_diagrams_1.ConnectorConstraints.None,
        ...
        function createBathroomDoor(id, x, y, width, height, pathData, color) {
            var options = {
                fill: '#E6E6FA',
                strokeColor: '#9370DB',
                rotateAngle: 270,
                flip: ej2_diagrams_1.FlipDirection.Vertical
            };
            createItem(id, x, y, width, height, pathData, options);
        }
        ...
        function addMeasurementConnectorsRuntime() {
            ...
            allSeparators.forEach(addSpecificSeparatorMeasurement);
        }
        function addOverallMeasurementConnectors() {
            ...
            if (wallOuterTop && wallOuterLeft && wallOuterBottom && wallOuterRight) {
                ...
                createDimensionConnector('TotalWidthMeasurement', wallOuterLeft.sourcePoint.x, wallOuterTop.sourcePoint.y - 50, wallOuterRight.targetPoint.x, wallOuterTop.sourcePoint.y - 50, widthText, true);
                ...
                createDimensionConnector('TotalHeightMeasurement', wallOuterLeft.sourcePoint.x - 70, wallOuterTop.sourcePoint.y, wallOuterLeft.sourcePoint.x - 70, wallOuterBottom.targetPoint.y, heightText, false);
            }
        }
        function addSpecificSeparatorMeasurement(separator) {
            var wallOuterTop = connectors.find(function (c) { return c.id === 'WallOuterTop'; });
            var wallOuterBottom = connectors.find(function (c) { return c.id === 'WallOuterBottom'; });
            var wallOuterRight = connectors.find(function (c) { return c.id === 'WallOuterRight'; });
            var distance;
            switch (separator.id) {
                case 'Separator1':
                    ...
                    createDimensionConnector(separator.id + 'Measurement', separator.sourcePoint.x, wallOuterBottom.sourcePoint.y + 40, separator.targetPoint.x, wallOuterBottom.sourcePoint.y + 40, formatMeasurement(convertPixelsToSelectedUnit(distance)), true);
                    break;
                case 'Separator3':
                    distance = Math.abs(separator.targetPoint.x - separator.sourcePoint.x);
                    createDimensionConnector(separator.id + 'Measurement', separator.sourcePoint.x, wallOuterBottom.sourcePoint.y + 20, separator.targetPoint.x, wallOuterBottom.sourcePoint.y + 20, formatMeasurement(convertPixelsToSelectedUnit(distance)), true);
                    break;
                case 'HallSeparator':
                    distance = Math.abs(separator.targetPoint.y - separator.sourcePoint.y);
                    createDimensionConnector(separator.id + 'Measurement', 270, separator.sourcePoint.y, 270, separator.targetPoint.y, formatMeasurement(convertPixelsToSelectedUnit(distance)), false);
                    break;
                case 'Separator4':
                    distance = Math.abs(separator.targetPoint.x - separator.sourcePoint.x);
                    createDimensionConnector(separator.id + 'Measurement', separator.sourcePoint.x, wallOuterTop.sourcePoint.y - 20, separator.targetPoint.x, wallOuterTop.sourcePoint.y - 20, formatMeasurement(convertPixelsToSelectedUnit(distance)), true);
                    break;
                case 'Separator2':
                    distance = Math.abs(separator.targetPoint.y - separator.sourcePoint.y);
                    createDimensionConnector(separator.id + 'Measurement', wallOuterRight.sourcePoint.x + 30, separator.sourcePoint.y, wallOuterRight.sourcePoint.x + 30, separator.targetPoint.y, formatMeasurement(convertPixelsToSelectedUnit(distance)), false);
                    break;
                case 'RestroomSeparator':
                    distance = Math.abs(separator.targetPoint.y - separator.sourcePoint.y);
                    createDimensionConnector(separator.id + 'Measurement', wallOuterRight.sourcePoint.x + 60, separator.sourcePoint.y, wallOuterRight.sourcePoint.x + 60, separator.targetPoint.y, formatMeasurement(convertPixelsToSelectedUnit(distance)), false);
                    break;
            }
        }
        ...
        function onConnectionPointChanged(args) {
        ...
        diagram = new ej2_diagrams_1.Diagram({
            ...
            constraints: ej2_diagrams_1.DiagramConstraints.Default & ~ej2_diagrams_1.DiagramConstraints.UndoRedo,
            tool: ej2_diagrams_1.DiagramTools.SingleSelect,
            snapSettings: {
                constraints: ej2_diagrams_1.SnapConstraints.ShowLines,
                gridType: 'Dots',
                horizontalGridlines: { dotIntervals: [1, 30, 1, 30, 1, 30] },
                verticalGridlines: { dotIntervals: [1, 30, 1, 30, 1, 30] },
            },
            rulerSettings: { showRulers: true },
            sourcePointChange: onConnectionPointChanged,
            targetPointChange: onConnectionPointChanged,
            getNodeDefaults: function (node) {
                node.constraints = ej2_diagrams_1.NodeConstraints.None;
                return node;
            },
            created: function () {
                diagramCreated = true;
