...
/**
 * Tournament Bracket Diagram - UEFA Champions League 2023-24
 */

import {
    Diagram, NodeModel, ConnectorModel, SnapConstraints, NodeConstraints, DiagramTools} from '@syncfusion/ej2-diagrams';
