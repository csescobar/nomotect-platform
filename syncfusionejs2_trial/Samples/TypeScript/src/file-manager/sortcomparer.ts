...
import { sortComparer } from '@syncfusion/ej2-filemanager/src/file-manager/common/utility';
...
(window as any).default = (): void => {
    ...
    let fileObject: FileManager = new FileManager({
        ...
        detailsViewSettings: {
            columns: [
                {
                    field: 'name', headerText: 'Name', customAttributes: { class: 'e-fe-grid-name' }, sortComparer: sortComparer
                },
                {
