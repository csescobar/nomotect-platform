...
import { Diagram, NodeModel, UndoRedo, ConnectorModel, PointPortModel, IDragEnterEventArgs, Node, UmlSequenceDiagramModel, UmlSequenceMessageType, UmlSequenceFragmentType, UmlSequenceParticipant, UmlSequenceFragment} from '@syncfusion/ej2-diagrams';
import { Button, Fab } from '@syncfusion/ej2/buttons';
import { DataManager } from '@syncfusion/ej2/data';
import { Connector, ConnectorConstraints, DataBinding, DiagramTools, FileFormats, IExportOptions, IScrollChangeEventArgs, ISelectionChangeEventArgs, NodeConstraints, PrintAndExport, Rect, SelectorModel } from '@syncfusion/ej2/diagrams';
...
Diagram.Inject(UndoRedo, DataBinding, PrintAndExport);


const sequenceModel: UmlSequenceDiagramModel = {
...
(window as any).default = (): void => {
    ...
    async function convertTextToUmlSequence(inputText: string) {
        showLoading();
        const options = {
            messages: [
                {
