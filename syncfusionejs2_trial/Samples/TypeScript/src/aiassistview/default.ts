...
function onPromptRequest(args: PromptRequestEventArgs) {
    setTimeout(() => {
        ...
        defaultAIAssistView.promptSuggestions = foundPrompt?.suggestions || (window as any).defaultSuggestions;
...
function toolbarItemClicked(args: ToolbarItemClickedEventArgs) {
    if (args.item.iconCss === 'e-icons e-refresh') {
        ...
        defaultAIAssistView.promptSuggestions = (window as any).defaultSuggestions;
    }
}
