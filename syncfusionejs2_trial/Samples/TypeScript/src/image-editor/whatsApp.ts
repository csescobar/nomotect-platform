...
(window as any).default = (): void => {
    ...
    button = new Button({ iconCss: 'e-icons e-send-1' });
    ...
    let toolbarObj: Toolbar = new Toolbar({
        items: [
            ...
            {
                id: 'ok', prefixIcon: 'e-icons e-send-1', tooltipText: 'Send', align: 'Right' }
        ],
    ...
    toolbarObj = new Toolbar({
        items: [
            ...
            {
                id: 'rotateLeft', prefixIcon: 'e-icons e-anti-clock-wise', tooltipText: 'Rotate Left', align: 'Center', visible: false },
            {
                id: 'rotateRight', prefixIcon: 'e-icons e-clock-wise', tooltipText: 'Rotate Right', align: 'Center', visible: false },
            {
                id: 'addText', prefixIcon: 'e-icons e-add-text', tooltipText: 'Text', align: 'Center' },
            {
    ...
    function buildMessage(text: string | HTMLImageElement): HTMLDivElement {
        ...
        if (typeof text === 'string') {
            element.innerHTML = `<div class="account-info"> <img src= "./images/sunset.jpg" alt="Receiver Avatar" class="avatar"> <span class="date-time">${formattedDate} ${formattedTime}</span> <br> ${text}</div>`;
        } else {
            imgCount++;
            element.innerHTML = `<div class="account-info"> <img src= "./images/sunset.jpg" alt="Receiver Avatar" class="avatar"> <span class="date-time">${formattedDate} ${formattedTime}</span> <br> </div>`;
    ...
    function refreshToolbar(type: string, isEvent?: boolean): void {
        ...
        for (let i: number = 0; i < topToolbar.items.length; i++) {
            if (topToolbar.items[i as number].id === 'ok') {
                if (type === 'main') {
                    topToolbar.items[i as number].prefixIcon = 'e-icons e-send-1';
