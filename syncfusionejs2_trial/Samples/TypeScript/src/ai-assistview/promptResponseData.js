define(["require", "exports"], function (require, exports) {
    ...
    exports.iconMapByIndex = exports.notionSuggestions = exports.modelIcons = exports.toolSystemPrompt = exports.gridBlockData = exports.cardBlockData = exports.promptsData = exports.chartBlockData = exports.generativeSuggestions = exports.assistantResponses = exports.assistantSuggestions = exports.streamingSuggestions = exports.streamingData = exports.overviewSuggestions = exports.defaultSuggestions = exports.defaultPromptResponseData = void 0;
    ...
    exports.assistantSuggestions = [
        "How is AI used in everyday life?",
        "C# console app to manage library books"
    ];
    exports.assistantResponses = [
        {
    ...
    exports.promptsData = [
        {
            ...
            blocks: exports.chartBlockData
        }
    ];
    exports.cardBlockData = [
        {
            blockType: 'text',
    ...
    exports.notionSuggestions = [
        'Summarize this page',
        'Translate this page',
        'Analyze for insights',
        'Create a task tracker',
    ];
    exports.iconMapByIndex = {
