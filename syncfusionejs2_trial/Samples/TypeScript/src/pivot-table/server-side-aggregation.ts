...
import { PivotView, GroupingBar, FieldList, VirtualScroll , Toolbar, PDFExport, ExcelExport, ToolbarArgs, BeforeExportEventArgs} from '@syncfusion/ej2-pivotview';
...
(window as any).default = (): void => {
    ...
    let pivotObj: PivotView = new PivotView({
        ...
        toolbar: ['Export', 'FieldList'] as ItemModel[],
        dataBound: function () {
