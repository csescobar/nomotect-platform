...
let container: DocumentEditorContainer = new DocumentEditorContainer({ enableToolbar: true, height: '100%',width:'100%', serviceUrl: 'https://ej2services.syncfusion.com/js/development/api/documenteditor/' });
container.created = () => {
