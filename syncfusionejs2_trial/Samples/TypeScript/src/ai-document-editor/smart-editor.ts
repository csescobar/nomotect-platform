...
(window as any).default = (): void => {
    ...
    let container: DocumentEditorContainer = new DocumentEditorContainer({ enableToolbar: true, height: '99%', width: '100%', serviceUrl: 'https://ej2services.syncfusion.com/js/development/api/documenteditor/' });
    container.created = () => {
