export declare let communityMessageAdmin: {
    user: string;
    id: string;
    statusIconCss: string;
};
export declare let communityMessageUser1: {
    user: string;
    id: string;
    avatarBgColor: string;
    statusIconCss: string;
};
export declare let communityMessageUser2: {
    user: string;
    id: string;
    avatarUrl: string;
    statusIconCss: string;
};
export declare let communityMessageUser3: {
    user: string;
    id: string;
    avatarBgColor: string;
    avatarUrl: string;
...
export declare let communityMessageUser4: {
    user: string;
    id: string;
    statusIconCss: string;
};
