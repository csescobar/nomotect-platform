...
(window as any).default = (): void => {
    ...
    barcode.appendTo('#barcode_code128C');
    ...
    let options: FormValidatorModel = {
        ...
        focusout(args: any): void {
            displayText.value = barcode.value = (document.getElementById('barcodeValue_code128C') as HTMLInputElement).value;
            barcode.dataBind();
        },
    ...
    function updatePosition(value: string): void {
        let positionValue: TextBox = ((document.getElementById('textPosition_code128C') as any).ej2_instances[0]) as TextBox;
        barcode.displayText.position = (positionValue.value) as TextPosition;
    }
    function updateAlignt(value: string): void {
        let positionValue: TextBox = ((document.getElementById('textAlignment_code128C') as any).ej2_instances[0]) as TextBox;
    ...
    textPosition.appendTo('#textPosition_code128C');
    ...
    textAlign.appendTo('#textAlignment_code128C');
    ...
    barcodeValue.appendTo('#barcodeValue_code128C');

    let input = document.getElementById("barcodeValue_code128C");
    ...
    bgColor.appendTo('#bgColor_code128C');
    ...
    displayText.appendTo('#displayText_code128C');
    ...
    foreColor.appendTo('#foreColor_code128C');
    ...
    barcodeWidth.appendTo('#width_code128C');
    ...
    barcodeHeight.appendTo('#height_code128C');
    ...
    marginLeft.appendTo('#marginLeft_code128C');
    ...
    marginRight.appendTo('#MarginRight_code128C');
    ...
    marginTop.appendTo('#marginTop_code128C');
    ...
    marginBottom.appendTo('#MarginBottom_code128C');
    ...
    textVisibility.appendTo('#textVisibility_code128C');
    ...
    svgMode.appendTo('#svgMode_code128C');
    ...
    textmarginLeft.appendTo('#TextmarginLeft_code128C');
    ...
    textMarginRight.appendTo('#TextMarginRight_code128C');
    ...
    textmarginTop.appendTo('#TextmarginTop_code128C');
    ...
    textMarginBottom.appendTo('#TextMarginBottom_code128C');
