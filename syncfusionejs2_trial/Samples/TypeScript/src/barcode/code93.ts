...
(window as any).default = (): void => {
    ...
    barcode.appendTo('#barcode_code93');
    ...
    let options: FormValidatorModel = {
        ...
        focusout(args: any): void {
            displayText.value = barcode.value = (document.getElementById('barcodeValue_code93') as HTMLInputElement).value;
            barcode.dataBind();
        },
    ...
    function updatePosition(value: string): void {
        let positionValue: TextBox = ((document.getElementById('textPosition_code93') as any).ej2_instances[0]) as TextBox;
        barcode.displayText.position = (positionValue.value) as TextPosition;
    }
    function updateAlignt(value: string): void {
        let positionValue: TextBox = ((document.getElementById('textAlignment_code93') as any).ej2_instances[0]) as TextBox;
    ...
    textPosition.appendTo('#textPosition_code93');
    ...
    textAlign.appendTo('#textAlignment_code93');
    ...
    barcodeValue.appendTo('#barcodeValue_code93');

    let input = document.getElementById("barcodeValue_code93");
    ...
    bgColor.appendTo('#bgColor_code93');
    ...
    displayText.appendTo('#displayText_code93');
    ...
    foreColor.appendTo('#foreColor_code93');
    ...
    barcodeWidth.appendTo('#width_code93');
    ...
    barcodeHeight.appendTo('#height_code93');
    ...
    marginLeft.appendTo('#marginLeft_code93');
    ...
    marginRight.appendTo('#MarginRight_code93');
    ...
    marginTop.appendTo('#marginTop_code93');
    ...
    marginBottom.appendTo('#MarginBottom_code93');
    ...
    textVisibility.appendTo('#textVisibility_code93');
    ...
    svgMode.appendTo('#svgMode_code93');
    ...
    textmarginLeft.appendTo('#TextmarginLeft_code93');
    ...
    textMarginRight.appendTo('#TextMarginRight_code93');
    ...
    textmarginTop.appendTo('#TextmarginTop_code93');
    ...
    textMarginBottom.appendTo('#TextMarginBottom_code93');
    const downloadButton = new Button({});
    downloadButton.appendTo('#downloadBtn5_code93');
    document.getElementById('downloadBtn5_code93').onclick = function () {
