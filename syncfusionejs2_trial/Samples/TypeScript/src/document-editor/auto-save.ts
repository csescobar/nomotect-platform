...
(window as any).default = (): void => {
    loadCultureFiles();
    let hostUrl: string = 'https://ej2services.syncfusion.com/js/development/api/documenteditor/';
    let contentChanged: boolean = false;
    let container: DocumentEditorContainer = new DocumentEditorContainer({  serviceUrl:hostUrl,enableToolbar: true, height: '590px',toolbarMode: 'Ribbon', documentEditorSettings: { showRuler: true } });
