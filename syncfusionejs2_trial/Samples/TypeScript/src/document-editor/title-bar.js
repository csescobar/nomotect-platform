define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-buttons", "@syncfusion/ej2-splitbuttons"], function (require, exports, ej2_base_1, ej2_buttons_1, ej2_splitbuttons_1) {
    ...
    var TitleBar = (function () {
        ...
        TitleBar.prototype.initializeRibbonSwitch = function (container) {
            var obj = this;
            var switchObj = new ej2_buttons_1.Switch({
                value: 'Toolbar Mode',
                checked: true,
            ...
            switchObj.change = function (args) {
                ...
                obj.showButtons(container.toolbarMode !== 'Ribbon');
            };
        };
        TitleBar.prototype.showButtons = function (show) {
