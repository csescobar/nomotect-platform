...
/******/ 	var installedChunks = {
/******/ 		"./samples/chart/nested-donut/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/chart/nested-donut/index.ts","charts.min"]);
...
/***/ "./samples/chart/nested-donut/index.ts":
/*!*********************************************!*\
  !*** ./samples/chart/nested-donut/index.ts ***!
  \*********************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-charts */ \"./node_modules/@syncfusion/ej2-charts/index.js\"), __webpack_require__(/*! @syncfusion/ej2/base */ \"./node_modules/@syncfusion/ej2/base.ts\"), __webpack_require__(/*! ./theme-color */ \"./samples/chart/nested-donut/theme-color.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_charts_1, base_1, theme_color_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_charts_1.AccumulationChart.Inject(ej2_charts_1.AccumulationLegend, ej2_charts_1.PieSeries, ej2_charts_1.AccumulationTooltip, ej2_charts_1.AccumulationDataLabel);\n    var regionColors = {\n        \"South Asia\": \"#1f4e8c\",\n        \"Middle East\": \"#7a3b8f\",\n        \"S.E. Asia\": \"#e91e63\",\n        \"Africa\": \"#f4c20d\",\n        \"Others\": \"#66a99c\"\n    };\n    var regionData = [\n        { x: 'South Asia', y: 55.85, color: regionColors[\"South Asia\"], text: base_1.Browser.isDevice ? 'SA' : 'South Asia' },\n        { x: 'Middle East', y: 16.15, color: regionColors[\"Middle East\"], text: base_1.Browser.isDevice ? 'ME' : 'Middle East' },\n        { x: 'S.E. Asia', y: 7.36, color: regionColors[\"S.E. Asia\"], text: base_1.Browser.isDevice ? 'SEA' : 'S.E. Asia' },\n        { x: 'Africa', y: 11.25, color: regionColors[\"Africa\"], text: base_1.Browser.isDevice ? 'AF' : 'Africa' },\n        { x: 'Others', y: 9.39, color: regionColors[\"Others\"], text: base_1.Browser.isDevice ? 'Others' : 'Others' }\n    ];\n    var countryData = [\n        { x: \"India\", y: 21.8, color: regionColors[\"South Asia\"], text: base_1.Browser.isDevice ? 'IND' : 'India' },\n        { x: \"Bangladesh\", y: 12.5, color: regionColors[\"South Asia\"], text: base_1.Browser.isDevice ? 'BGD' : 'Bangladesh' },\n        { x: \"Nepal\", y: 12.5, color: regionColors[\"South Asia\"], text: base_1.Browser.isDevice ? 'NPL' : 'Nepal' },\n        { x: \"Pakistan\", y: 4.7, color: regionColors[\"South Asia\"], text: base_1.Browser.isDevice ? 'PAK' : 'Pakistan' },\n        { x: \"Sri Lanka\", y: 4.35, color: regionColors[\"South Asia\"], text: base_1.Browser.isDevice ? 'LKA' : 'Sri Lanka' },\n        { x: \"Qatar\", y: 10.5, color: regionColors[\"Middle East\"], text: base_1.Browser.isDevice ? 'QAT' : 'Qatar' },\n        { x: \"Iran\", y: 1.0, color: regionColors[\"Middle East\"], text: base_1.Browser.isDevice ? 'IRN' : 'Iran' },\n        { x: \"Jordan\", y: 1.6, color: regionColors[\"Middle East\"], text: base_1.Browser.isDevice ? 'JOR' : 'Jordan' },\n        { x: \"Syria\", y: 1.8, color: regionColors[\"Middle East\"], text: base_1.Browser.isDevice ? 'SYR' : 'Syria' },\n        { x: \"Lebanon\", y: 1.25, color: regionColors[\"Middle East\"], text: base_1.Browser.isDevice ? 'LBN' : 'Lebanon' },\n        { x: \"Philippines\", y: 7.36, color: regionColors[\"S.E. Asia\"], text: base_1.Browser.isDevice ? 'PHL' : 'Philippines' },\n        { x: \"Sudan\", y: 1.9, color: regionColors[\"Africa\"], text: base_1.Browser.isDevice ? 'SDN' : 'Sudan' },\n        { x: \"Egypt\", y: 9.35, color: regionColors[\"Africa\"], text: base_1.Browser.isDevice ? 'EGY' : 'Egypt' },\n        { x: 'Others', y: 9.39, color: regionColors[\"Others\"], text: base_1.Browser.isDevice ? 'Others' : 'Others' }\n    ];\n    var pie = new ej2_charts_1.AccumulationChart({\n        series: [\n            {\n                dataSource: countryData,\n                type: 'Pie',\n                xName: 'x',\n                yName: 'y',\n                pointColorMapping: 'color',\n                radius: '90%',\n                innerRadius: '75%',\n                border: { color: '#fff', width: 2 },\n                dataLabel: {\n                    visible: true,\n                    name: 'text',\n                    position: 'Outside'\n                },\n                animation: {\n                    enable: false\n                }\n            },\n            {\n                dataSource: regionData,\n                type: 'Pie',\n                xName: 'x',\n                yName: 'y',\n                pointColorMapping: 'color',\n                radius: '67%',\n                innerRadius: '35%',\n                border: { color: '#fff', width: 2 },\n                dataLabel: {\n                    visible: true,\n                    name: 'text',\n                    position: 'Inside'\n                },\n                animation: {\n                    enable: false\n                }\n            }\n        ],\n        enableBorderOnMouseMove: false,\n        centerLabel: {\n            text: 'Qatar Population<br><b>3.1 Million</b>',\n            textStyle: {\n                size: '12px',\n                fontWeight: 'bold'\n            }\n        },\n        title: 'The Population of Qatar by Nationality',\n        tooltip: {\n            enable: true,\n            format: '<b>${point.x}</b><br/>Population: <b>${point.y}%</b>',\n            textStyle: { fontWeight: 'bold' }\n        },\n        legendSettings: {\n            visible: true,\n            mappingKey: 'x'\n        },\n        load: function (args) {\n            (0, theme_color_1.loadAccumulationChartTheme)(args);\n        }\n    });\n    pie.appendTo('#container');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/chart/nested-donut/index.ts?");

/***/ }),

/***/ "./samples/chart/nested-donut/theme-color.ts":
/*!***************************************************!*\
  !*** ./samples/chart/nested-donut/theme-color.ts ***!
  \***************************************************/
/*! no static exports found */
