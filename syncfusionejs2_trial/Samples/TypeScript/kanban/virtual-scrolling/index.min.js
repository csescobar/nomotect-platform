...
/******/ 	var installedChunks = {
/******/ 		"./samples/kanban/virtual-scrolling/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/kanban/virtual-scrolling/index.ts","kanban.min"]);
...
/***/ "./samples/kanban/virtual-scrolling/data.ts":
/*!**************************************************!*\
  !*** ./samples/kanban/virtual-scrolling/data.ts ***!
  \**************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-kanban */ \"./node_modules/@syncfusion/ej2-kanban/index.js\"), __webpack_require__(/*! ./data */ \"./samples/kanban/virtual-scrolling/data.ts\"), __webpack_require__(/*! @syncfusion/ej2/base */ \"./node_modules/@syncfusion/ej2/base.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_kanban_1, data_1, base_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    var kanbanObj = new ej2_kanban_1.Kanban({\n        enableVirtualization: true,\n        dataSource: (0, data_1.generateKanbanDataVirtualScrollData)(),\n        keyField: 'Status',\n        enableTooltip: true,\n        columns: [\n            { headerText: 'To Do', keyField: 'Open' },\n            { headerText: 'In Progress', keyField: 'InProgress' },\n            { headerText: 'Code Review', keyField: 'Review' },\n            { headerText: 'Done', keyField: 'Close' }\n        ],\n        cardSettings: {\n            headerField: 'Id',\n            template: '#cardTemplate',\n            selectionType: 'Multiple'\n        },\n        dialogSettings: {\n            fields: [\n                { key: 'Id', text: 'ID', type: 'TextBox' },\n                { key: 'Status', text: 'Status', type: 'DropDown' },\n                { key: 'StoryPoints', text: 'Story Points', type: 'Numeric' },\n                { key: 'Summary', text: 'Summary', type: 'TextArea' }\n            ]\n        },\n        cardRendered: function (args) {\n            var val = (args.data).Priority.toLowerCase();\n            (0, base_1.addClass)([args.element], val);\n        }\n    });\n    kanbanObj.appendTo('#KanbanVirtualScrolling');\n    window.getString = function (assignee) {\n        return assignee.match(/\\b(\\w)/g).join('').toUpperCase();\n    };\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/kanban/virtual-scrolling/index.ts?");
