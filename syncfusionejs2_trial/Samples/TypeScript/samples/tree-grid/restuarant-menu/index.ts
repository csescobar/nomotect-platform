        ...
        toolbar: [
            {
                template: `
                    <div style="display:flex;align-items:center;cursor:auto;">
                        <img src="//npmci.syncfusion.com/development/demos/src/tree-grid/images/male.png" alt="avatar" style="width:40px;height:40px;border-radius:50%;margin-right:14px;">
                        <div>
