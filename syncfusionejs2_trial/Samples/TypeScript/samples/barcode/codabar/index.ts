...
// tslint:disable-next-line:max-func-body-length
    ...
    barcode.appendTo('#barcode_codabar');
    ...
    let options: FormValidatorModel = {
        ...
        focusout(args: any): void {
            displayText.value = barcode.value = (document.getElementById('barcodeValue_codabar') as HTMLInputElement).value;
            barcode.dataBind();
        },
    ...
    function updatePosition(value: string): void {
        let positionValue: TextBox = ((document.getElementById('textPosition_codabar') as any).ej2_instances[0]) as TextBox;
        barcode.displayText.position = (positionValue.value) as TextPosition;
    }
    function updateAlignt(value: string): void {
        let positionValue: TextBox = ((document.getElementById('textAlignment_codabar') as any).ej2_instances[0]) as TextBox;
    ...
    textPosition.appendTo('#textPosition_codabar');
    ...
    textAlign.appendTo('#textAlignment_codabar');
    ...
    barcodeValue.appendTo('#barcodeValue_codabar');

    let input = document.getElementById("barcodeValue_codabar");
    ...
    bgColor.appendTo('#bgColor_codabar');
    ...
    displayText.appendTo('#displayText_codabar');
    ...
    foreColor.appendTo('#foreColor_codabar');
    ...
    barcodeWidth.appendTo('#width_codabar');
    ...
    barcodeHeight.appendTo('#height_codabar');
    ...
    marginLeft.appendTo('#marginLeft_codabar');
    ...
    marginRight.appendTo('#MarginRight_codabar');
    ...
    marginTop.appendTo('#marginTop_codabar');
    ...
    marginBottom.appendTo('#MarginBottom_codabar');
    ...
    textVisibility.appendTo('#textVisibility_codabar');
    ...
    svgMode.appendTo('#svgMode_codabar');
    ...
    textmarginLeft.appendTo('#TextmarginLeft_codabar');
    ...
    textMarginRight.appendTo('#TextMarginRight_codabar');
    ...
    textmarginTop.appendTo('#TextmarginTop_codabar');
    ...
    textMarginBottom.appendTo('#TextMarginBottom_codabar');
