...
// tslint:disable-next-line:max-func-body-length
    ...
    barcode.appendTo('#barcode_code39Extd');
    ...
    let options: FormValidatorModel = {
        ...
        focusout(args: any): void {
            displayText.value = barcode.value = (document.getElementById('barcodeValue_code39Extd') as HTMLInputElement).value;
            barcode.dataBind();
        },
    ...
    function updatePosition(value: string): void {
        let positionValue: TextBox = ((document.getElementById('textPosition_code39Extd') as any).ej2_instances[0]) as TextBox;
        barcode.displayText.position = (positionValue.value) as TextPosition;
    }
    function updateAlignt(value: string): void {
        let positionValue: TextBox = ((document.getElementById('textAlignment_code39Extd') as any).ej2_instances[0]) as TextBox;
    ...
    textPosition.appendTo('#textPosition_code39Extd');
    ...
    textAlign.appendTo('#textAlignment_code39Extd');
    ...
    barcodeValue.appendTo('#barcodeValue_code39Extd');

    let input = document.getElementById("barcodeValue_code39Extd");
    ...
    bgColor.appendTo('#bgColor_code39Extd');
    ...
    displayText.appendTo('#displayText_code39Extd');
    ...
    foreColor.appendTo('#foreColor_code39Extd');
    ...
    barcodeWidth.appendTo('#width_code39Extd');
    ...
    barcodeHeight.appendTo('#height_code39Extd');
    ...
    marginLeft.appendTo('#marginLeft_code39Extd');
    ...
    marginRight.appendTo('#MarginRight_code39Extd');
    ...
    marginTop.appendTo('#marginTop_code39Extd');
    ...
    marginBottom.appendTo('#MarginBottom_code39Extd');
    ...
    textVisibility.appendTo('#textVisibility_code39Extd');
    ...
    svgMode.appendTo('#svgMode_code39Extd');
    ...
    textmarginLeft.appendTo('#TextmarginLeft_code39Extd');
    ...
    textMarginRight.appendTo('#TextMarginRight_code39Extd');
    ...
    textmarginTop.appendTo('#TextmarginTop_code39Extd');
    ...
    textMarginBottom.appendTo('#TextMarginBottom_code39Extd');
