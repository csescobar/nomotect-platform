...
// tslint:disable-next-line:max-func-body-length
    ...
    barcode.appendTo('#barcode_code128A');
    ...
    let options: FormValidatorModel = {
        ...
        focusout(args: any): void {
            displayText.value = barcode.value = (document.getElementById('barcodeValue_code128A') as HTMLInputElement).value;
            barcode.dataBind();
        },
    ...
    function updatePosition(value: string): void {
        let positionValue: TextBox = ((document.getElementById('textPosition_code128A') as any).ej2_instances[0]) as TextBox;
        barcode.displayText.position = (positionValue.value) as TextPosition;
    }
    function updateAlignt(value: string): void {
        let positionValue: TextBox = ((document.getElementById('textAlignment_code128A') as any).ej2_instances[0]) as TextBox;
    ...
    textPosition.appendTo('#textPosition_code128A');
    ...
    textAlign.appendTo('#textAlignment_code128A');
    ...
    barcodeValue.appendTo('#barcodeValue_code128A');

    let input = document.getElementById("barcodeValue_code128A");
    ...
    bgColor.appendTo('#bgColor_code128A');
    ...
    displayText.appendTo('#displayText_code128A');
    ...
    foreColor.appendTo('#foreColor_code128A');
    ...
    barcodeWidth.appendTo('#width_code128A');
    ...
    barcodeHeight.appendTo('#height_code128A');
    ...
    marginLeft.appendTo('#marginLeft_code128A');
    ...
    marginRight.appendTo('#MarginRight_code128A');
    ...
    marginTop.appendTo('#marginTop_code128A');
    ...
    marginBottom.appendTo('#MarginBottom_code128A');
    ...
    textVisibility.appendTo('#textVisibility_code128A');
    ...
    svgMode.appendTo('#svgMode_code128A');
    ...
    textmarginLeft.appendTo('#TextmarginLeft_code128A');
    ...
    textMarginRight.appendTo('#TextMarginRight_code128A');
    ...
    textmarginTop.appendTo('#TextmarginTop_code128A');
    ...
    textMarginBottom.appendTo('#TextMarginBottom_code128A');
