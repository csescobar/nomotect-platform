export let defaultPromptResponseData: any = [
    {
...
export let overviewSuggestions: any = [
...
export let assistantResponses : any = [
    {
...
export let generativeSuggestions: any = [
    "What is the weather in New York?",
    "How do smartphone sales perform across regions?"
];

export let chartBlockData: any = [
    {
        blockType: 'text',
        content:
            ...
            'It highlights the variations in consumption, investment, trade, and overall economic growth trends.'
    }, {
        blockType: 'tool',
        toolName: 'chart-tool',
        props: {
...
export let promptsData: any = [
    {
        prompt: "What are France's GDP growth trends?",
        blocks: chartBlockData
    }
];

export let cardBlockData: any = [
    {
        blockType: 'text',
...
export let gridBlockData: any = [
    {
        blockType: 'text',
        content: '**Smartphone Sales Performance Comparison**<p>Smartphone sales delivery performance shows high variation when compared across different regions.</p>'
    }, {
        blockType: 'tool',
        toolName: 'sales-grid',
        props: {
            gridData: [
                { Region: 'North America', Sales: 21, Growth: '8.5', Status: 'On Track' },
                { Region: 'Europe', Sales: 24, Growth: '14.2', Status: 'Exceeding' },
                { Region: 'Asia Pacific', Sales: 36, Growth: '50.0', Status: 'Exceeding' },
                { Region: 'Latin America', Sales: 38, Growth: '5.5', Status: 'On Track' },
                { Region: 'Middle East', Sales: 54, Growth: '42.1', Status: 'Exceeding' },
                { Region: 'Africa', Sales: 57, Growth: '5.5', Status: 'On Track' },
                { Region: 'Oceania', Sales: 70, Growth: '22.8', Status: 'Exceeding' },
                { Region: 'Central Asia', Sales: 65, Growth: '-7.1', Status: 'Below Target' }
            ]
        }
    }, {
        blockType: 'text',
        content: '**Key Insights:** The smartphone market analysis identified performance differences across these regions, with high instability in business operations, inconsistent performance results, and a lack of improvement in overall service delivery.'
    }
]


export let modelIcons: any = {
    'Auto': 'e-icons e-assistview-icon',
    'Sonnet 4.6': 'model-sonet',
    'Opus 4.6': 'model-opus',
    'Gemini 3.1 Pro': 'model-gemini',
    'GPT 5.2': 'model-gpt',
};

export let notionSuggestions: any = [
    'Summarize this page',
    'Translate this page',
