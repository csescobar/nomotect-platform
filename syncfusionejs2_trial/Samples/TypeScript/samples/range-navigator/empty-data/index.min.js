...
/******/ 	var installedChunks = {
/******/ 		"./samples/range-navigator/empty-data/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/range-navigator/empty-data/index.ts","charts.min"]);
...
/***/ "./samples/range-navigator/empty-data/index.ts":
/*!*****************************************************!*\
  !*** ./samples/range-navigator/empty-data/index.ts ***!
  \*****************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-charts */ \"./node_modules/@syncfusion/ej2-charts/index.js\"), __webpack_require__(/*! @syncfusion/ej2-charts */ \"./node_modules/@syncfusion/ej2-charts/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! ./theme-colors */ \"./samples/range-navigator/empty-data/theme-colors.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_charts_1, ej2_charts_2, ej2_base_2, theme_colors_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_charts_1.Chart.Inject(ej2_charts_1.AreaSeries, ej2_charts_1.DateTime, ej2_charts_1.CandleSeries, ej2_charts_1.Crosshair, ej2_charts_2.Tooltip);\n    ej2_charts_1.RangeNavigator.Inject(ej2_charts_1.AreaSeries, ej2_charts_1.DateTime, ej2_charts_2.RangeTooltip);\n    var startDate = new Date(2012, 4, 2);\n    var theme = (0, theme_colors_1.loadRangeNavigatorTheme)();\n    var dataSrc;\n    var stockData = [];\n    var fetchApi = new ej2_base_2.Fetch('./src/range-navigator/data-source/empty-data.json', 'GET');\n    fetchApi.send().then();\n    fetchApi.onSuccess = function (data) {\n        dataSrc = data;\n        dataSrc.map(function (data) {\n            data['x'] = new Date(data['x']);\n        });\n        for (var i = 0; i <= 250; i++) {\n            stockData.push(dataSrc[i]);\n            if (i > 45 && 50 > i) {\n                stockData[i].open = null;\n            }\n            else if (i > 95 && 100 > i) {\n                stockData[i].open = null;\n            }\n            else if (i > 145 && 150 > i) {\n                stockData[i].open = null;\n            }\n            else if (i > 195 && 200 > i) {\n                stockData[i].open = null;\n            }\n            else if (i > 245 && 250 > i) {\n                stockData[i].open = null;\n            }\n        }\n        var chart = new ej2_charts_1.Chart({\n            primaryXAxis: {\n                valueType: 'DateTime', crosshairTooltip: { enable: true },\n                edgeLabelPlacement: 'Shift', majorGridLines: { width: 0 }\n            },\n            series: [{\n                    dataSource: stockData, xName: 'x', yName: 'open', type: 'Area', name: 'AAPL',\n                    fill: 'url(#' + theme.toLowerCase() + '-gradient-chart)',\n                    border: { width: 2, color: theme_colors_1.borderColor[theme_colors_1.themes.indexOf(theme.toLowerCase())] }\n                }],\n            chartArea: { border: { width: 0 } },\n            primaryYAxis: {\n                labelFormat: '${value}', minimum: 40, maximum: 140, interval: 20,\n                majorTickLines: { width: 0 }, lineStyle: { width: 0 }\n            },\n            tooltip: { enable: true, shared: true },\n            height: '350', legendSettings: { visible: false },\n            width: ej2_base_2.Browser.isDevice ? '100%' : '80%',\n            theme: theme\n        });\n        chart.appendTo('#chart');\n        var range = new ej2_charts_1.RangeNavigator({\n            labelPosition: 'Outside',\n            valueType: 'DateTime',\n            majorTickLines: {\n                width: 0\n            },\n            majorGridLines: {\n                width: 0\n            },\n            tooltip: { enable: true, displayMode: 'Always' },\n            value: [new Date('2013-12-27'), new Date('2015-03-23')],\n            navigatorBorder: { width: 0 },\n            series: [{\n                    dataSource: stockData, xName: 'x', yName: 'open', type: 'Area', width: 2, animation: { enable: false },\n                    fill: 'url(#' + theme.toLowerCase() + '-gradient-chart)',\n                    border: { width: 2, color: theme_colors_1.borderColor[theme_colors_1.themes.indexOf(theme.toLowerCase())] }\n                }],\n            changed: function (args) {\n                chart.primaryXAxis.zoomFactor = args.zoomFactor;\n                chart.primaryXAxis.zoomPosition = args.zoomPosition;\n                chart.dataBind();\n            },\n            width: ej2_base_2.Browser.isDevice ? '100%' : '80%',\n            theme: theme\n        });\n        range.appendTo('#container');\n    };\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/range-navigator/empty-data/index.ts?");

/***/ }),

/***/ "./samples/range-navigator/empty-data/theme-colors.ts":
/*!************************************************************!*\
  !*** ./samples/range-navigator/empty-data/theme-colors.ts ***!
  \************************************************************/
/*! no static exports found */
