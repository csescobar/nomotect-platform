...
import { Diagram, Node, NodeConstraints, NodeModel, AnnotationConstraints, ConnectorConstraints, ConnectorModel, SnapConstraints, IClickEventArgs, IMouseEventArgs } from '@syncfusion/ej2-diagrams';


    

const dashIntervals: Map<string, any> = new Map();
...
function onMouseLeave(args: IMouseEventArgs): void {
    if (previousNode) {
