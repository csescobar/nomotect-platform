...
export let infiniteTimelineScrollData: Object[] = [
...

    {
        ...
        EndDate: new Date('03/20/2026'),
        subtasks: [
            { TaskID: 12, TaskName: 'Unit testing', StartDate: new Date('03/06/2026'), Duration: 5 },
            { TaskID: 13, TaskName: 'Integration testing', StartDate: new Date('03/10/2026'), Duration: 7, Predecessor: "10" }
        ]
    },
    {
        TaskID: 14,
        TaskName: 'Release',
        StartDate: new Date('03/21/2026'),
        EndDate: new Date('03/31/2026'),
        subtasks: [
            { TaskID: 15, TaskName: 'Beta release', StartDate: new Date('03/21/2026'), Duration: 3 },
            { TaskID: 16, TaskName: 'Production deployment', StartDate: new Date('03/28/2026'), Duration: 0, Predecessor: "15" }
        ]
    }
];
