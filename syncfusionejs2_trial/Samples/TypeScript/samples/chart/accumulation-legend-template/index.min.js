...
/******/ 	var installedChunks = {
/******/ 		"./samples/chart/accumulation-legend-template/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/chart/accumulation-legend-template/index.ts","charts.min"]);
...
/***/ "./samples/chart/accumulation-legend-template/index.ts":
/*!*************************************************************!*\
  !*** ./samples/chart/accumulation-legend-template/index.ts ***!
  \*************************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-charts */ \"./node_modules/@syncfusion/ej2-charts/index.js\"), __webpack_require__(/*! ./theme-color */ \"./samples/chart/accumulation-legend-template/theme-color.ts\"), __webpack_require__(/*! @syncfusion/ej2/base */ \"./node_modules/@syncfusion/ej2/base.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_charts_1, theme_color_1, base_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_charts_1.AccumulationChart.Inject(ej2_charts_1.AccumulationDataLabel, ej2_charts_1.PieSeries, ej2_charts_1.AccumulationLegend, ej2_charts_1.AccumulationTooltip);\n    var data = [\n        { x: 'United States', y: 29.55, image: 'United States', text: base_1.Browser.isDevice ? 'USA: 29.55%' : 'United States: 29.55%', description: '13.4M barrels per day', tooltip: '13.4M' },\n        { x: 'Saudi Arabia', y: 23.83, text: base_1.Browser.isDevice ? 'SAU: 23.83%' : 'Saudi Arabia: 23.83%', image: 'Saudi Arabia', description: '10.8M barrels per day', tooltip: '10.8M' },\n        { x: 'Russia', y: 23.69, text: base_1.Browser.isDevice ? 'RUS: 23.69%' : 'Russia: 23.69%', image: 'Russia', description: '10.8M barrels per day', tooltip: '10.8M' },\n        { x: 'Canada', y: 12.12, text: base_1.Browser.isDevice ? 'CAN: 12.12%' : 'Canada: 12.12%', image: 'Canada', description: '5.5M barrels per day', tooltip: '5.5M' },\n        { x: 'China', y: 10.83, text: base_1.Browser.isDevice ? 'CHN: 10.83%' : 'China: 10.83%', image: 'China', description: '4.9M barrels per day', tooltip: '4.9M' }\n    ];\n    var chart = new ej2_charts_1.AccumulationChart({\n        title: 'Top 5 Oil Producing Countries (2023)',\n        subTitle: 'Source: Wikipedia.org',\n        titleStyle: {\n            position: 'Custom',\n            x: base_1.Browser.isDevice ? 150 : 492,\n            y: 22.75\n        },\n        series: [\n            {\n                type: 'Pie',\n                dataSource: data,\n                xName: 'x',\n                yName: 'y',\n                animation: { enable: false },\n                tooltipMappingName: 'tooltip',\n                border: { color: '#ffffff', width: 1 },\n                radius: base_1.Browser.isDevice ? '65%' : '70%',\n                innerRadius: '0%',\n                dataLabel: {\n                    visible: true,\n                    position: base_1.Browser.isDevice ? 'Inside' : 'Outside',\n                    name: base_1.Browser.isDevice ? '' : 'text',\n                    format: base_1.Browser.isDevice ? '{value}%' : '',\n                    enableRotation: base_1.Browser.isDevice ? true : false,\n                    font: { size: base_1.Browser.isDevice ? '8px' : '12px', fontWeight: '600' },\n                    connectorStyle: { type: 'Line' }\n                }\n            }\n        ],\n        tooltip: {\n            enable: true,\n            header: '<b>${point.x}</b>',\n            format: 'Production: <b>${point.tooltip}</b> barrels/day'\n        },\n        enableBorderOnMouseMove: false,\n        legendSettings: {\n            visible: true,\n            width: base_1.Browser.isDevice ? '35%' : '20%',\n            position: 'Right',\n            itemPadding: 15,\n            template: '<div class=\"legend-template\" style=\"display:flex; align-items:flex-start; gap:' + (base_1.Browser.isDevice ? '6px' : '8px') + '; opacity:1; max-width:' + (base_1.Browser.isDevice ? '160px' : '280px') + '; box-sizing:border-box;\">' +\n                '<img class=\"e-legend-img\" src=\"\" width=\"' + (base_1.Browser.isDevice ? '24' : '36') + '\" height=\"' + (base_1.Browser.isDevice ? '24' : '36') + '\" style=\"flex:0 0 ' + (base_1.Browser.isDevice ? '24px' : '36px') + '; margin-top:' + (base_1.Browser.isDevice ? '0px' : '2px') + ';\" />' +\n                '<div style=\"display:flex; flex-direction:column; min-width:0; text-align:left;\">' +\n                '<span class=\"e-legend-label\" style=\"font-weight:600; font-size:' + (base_1.Browser.isDevice ? '10px' : '13px') + '; color:LABEL_COLOR; line-height:' + (base_1.Browser.isDevice ? '12px' : '18px') + '; white-space:normal; overflow-wrap:break-word; word-break:break-word; max-width:' + (base_1.Browser.isDevice ? '130px' : '220px') + ';\"></span>' +\n                '<span class=\"e-legend-desc\" style=\"font-size:' + (base_1.Browser.isDevice ? '10px' : '12px') + '; margin-top:' + (base_1.Browser.isDevice ? '0px' : '2px') + '; line-height:' + (base_1.Browser.isDevice ? '12px' : '15px') + '; white-space:normal; overflow-wrap:break-word; word-break:break-word; max-width:' + (base_1.Browser.isDevice ? '130px' : '220px') + ';\"></span>' +\n                '</div>' +\n                '</div>'\n        },\n        legendRender: function (args) {\n            var desc = data.find(function (d) { return d.x === args.text; }).description;\n            var matchedPoint = chart.series[0].points.find(function (p) { return p.x === args.text; });\n            var opacity = matchedPoint && !matchedPoint.visible ? '0.5' : '1';\n            args.template = args.template\n                .replace('opacity:1;', 'opacity:' + opacity + ';')\n                .replace('LABEL_COLOR', args.fill)\n                .replace('src=\"\"', 'src=\"//ej2.syncfusion.com/demos/src/chart/images/' + args.text + '.png\"')\n                .replace('></span>', '>' + args.text + '</span>')\n                .replace(/<span class=\"e-legend-desc\"([^>]*)><\\/span>/, '<span class=\"e-legend-desc\"$1>' + desc + '</span>');\n        },\n        load: function (args) {\n            (0, theme_color_1.loadAccumulationChartTheme)(args);\n        }\n    });\n    chart.appendTo('#container');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/chart/accumulation-legend-template/index.ts?");

/***/ }),

/***/ "./samples/chart/accumulation-legend-template/theme-color.ts":
/*!*******************************************************************!*\
  !*** ./samples/chart/accumulation-legend-template/theme-color.ts ***!
  \*******************************************************************/
/*! no static exports found */
