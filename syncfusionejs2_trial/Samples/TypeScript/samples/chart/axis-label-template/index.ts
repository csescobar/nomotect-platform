...
// App entry
  ...
  const chart = new Chart({
    ...
    annotations: [
      {
        content: '<img style="margin-top:15px;height:150px;width:220px;opacity:0.5" src="//npmci.syncfusion.com/development/demos/src/chart/images/medals.png" alt="Medals" />', x: 'Netherlands', y: Browser.isDevice ? '90' : '110', coordinateUnits: 'Point'
      }
    ],
    primaryXAxis: {
      valueType: 'Category',
