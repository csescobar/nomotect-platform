...
/******/ 	var installedChunks = {
/******/ 		"./samples/chat-ui/template/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/chat-ui/template/index.ts","interactive.min"]);
...
/***/ "./samples/chat-ui/template/index.ts":
/*!*******************************************!*\
  !*** ./samples/chat-ui/template/index.ts ***!
  \*******************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-interactive-chat */ \"./node_modules/@syncfusion/ej2-interactive-chat/index.js\"), __webpack_require__(/*! ./messageData */ \"./samples/chat-ui/template/messageData.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_interactive_chat_1, messageData_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    var templateChatUI = new ej2_interactive_chat_1.ChatUI({\n        headerText: 'Order Assistant',\n        headerIconCss: 'chat-bot',\n        showTimeBreak: true,\n        showFooter: false,\n        user: { id: 'admin', user: 'Admin', avatarUrl: '//ej2.syncfusion.com/demos/src/chat-ui/images/bot.png' },\n        emptyChatTemplate: '#emptyChatTemplate',\n        messageTemplate: function (context) { return messageTemplate(context); },\n        timeBreakTemplate: function (context) { return timeBreakTemplate(context); },\n        messageSend: function () {\n            setTimeout(function () {\n                var defaultResponse = \"Unfortunately, I don't have information on that. Use any real-time data streaming service to provide chat updates.\";\n                var message = {\n                    author: { id: 'bot', user: 'Bot', avatarUrl: '//ej2.syncfusion.com/demos/src/chat-ui/images/bot.png' },\n                    text: defaultResponse\n                };\n                templateChatUI.addMessage(message);\n            }, 500);\n        },\n    });\n    templateChatUI.appendTo('#chatTemplate');\n    function messageTemplate(context) {\n        var isAdmin = context.message.author.id === 'admin';\n        var userImage = !isAdmin ? \"<img class=\\\"message-user\\\" src=\\\"\".concat(context.message.author.avatarUrl, \"\\\" alt=\\\"\").concat(context.message.author.user, \"\\\">\") : '';\n        var suggestions = context.message.suggestions && context.message.suggestions.length > 0 && !isAdmin ?\n            \"<div class=\\\"message-suggestions\\\">\".concat(context.message.suggestions.map(function (suggestion) { return \"<button class=\\\"suggestion-button e-btn e-primary e-outline\\\">\".concat(suggestion, \"</button>\"); }).join(''), \"</div>\") : '';\n        return \"<div class=\\\"message-wrapper\\\">\\n                <div class=\\\"message-template\\\">\\n                    \".concat(userImage, \"\\n                    <div class=\\\"message-items e-card\\\">\\n                        <div class=\\\"message-text\\\">\").concat(context.message.text, \"</div>\\n                    </div>\\n                </div>\\n                <div class=\\\"suggestion-container\\\">\\n                    \").concat(suggestions, \"\\n                </div>\\n            </div>\");\n    }\n    function timeBreakTemplate(context) {\n        var dateText = context.messageDate;\n        if (context.messageDate.toDateString() === new Date().toDateString()) {\n            dateText = 'Today';\n        }\n        return \"<div class=\\\"timebreak-template\\\">\".concat(dateText, \"</div>\");\n    }\n    function bindClickAction() {\n        templateChatUI.element.querySelectorAll('.suggestion-button').forEach(function (suggestion) {\n            suggestion.addEventListener('click', function () { return handleSuggestionClick(suggestion); });\n        });\n    }\n    function handleSuggestionClick(suggestion) {\n        var message = messageData_1.templateMessagedata.find(function (message) { return message.text === suggestion.innerText; });\n        if (message) {\n            templateChatUI.addMessage(message.text);\n            setTimeout(function () {\n                var messageModel = {\n                    author: { id: 'bot', user: 'Bot', avatarUrl: '//ej2.syncfusion.com/demos/src/chat-ui/images/bot.png' },\n                    text: message.reply,\n                    suggestions: message.suggestions\n                };\n                templateChatUI.addMessage(messageModel);\n                bindClickAction();\n                if (message.suggestions.length === 0) {\n                    templateChatUI.showFooter = true;\n                }\n            }, 500);\n            suggestion.parentElement.innerHTML = '';\n        }\n    }\n    setTimeout(function () {\n        var message = {\n            author: { id: 'bot', user: 'Bot', avatarUrl: '//ej2.syncfusion.com/demos/src/chat-ui/images/bot.png' },\n            text: messageData_1.templateMessagedata[0].text,\n            suggestions: messageData_1.templateMessagedata[0].suggestions\n        };\n        templateChatUI.addMessage(message);\n        bindClickAction();\n    }, 1500);\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/chat-ui/template/index.ts?");

/***/ }),

/***/ "./samples/chat-ui/template/messageData.ts":
/*!*************************************************!*\
  !*** ./samples/chat-ui/template/messageData.ts ***!
  \*************************************************/
/*! no static exports found */
