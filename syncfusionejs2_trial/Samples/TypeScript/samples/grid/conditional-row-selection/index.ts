 ...
 */
    ...
    (<{ productTemplate?: Function }>window).productTemplate = (e: any): any => {
        ...
        imgElement.src = '//npmci.syncfusion.com/development/demos/src/grid/images/product/' + e.Product + '.png';
    ...
    (<{ statusTemplate?: Function }>window).statusTemplate = (e: any): any => {
        ...
        const imgElement = document.createElement('img');
        imgElement.src = '//npmci.syncfusion.com/development/demos/src/grid/images/status/' + e.Status + '.svg';
