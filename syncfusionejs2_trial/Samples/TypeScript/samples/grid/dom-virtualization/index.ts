...
(<{ locationDetail?: Function }>window).locationDetail = (e: any): any => {
    ...
    const code: string = countryCodeMap[e.Location] || 'un';
    const container: HTMLDivElement = document.createElement('div');
    container.className = 'country-cell';
...
let urlapi: DataManager = new DataManager({
    ...
    columns: [
        { field: 'EmployeeID', visible: true, headerText: 'Employee ID', isPrimaryKey: true, width: '150' },
        {
