...
/******/ 	var installedChunks = {
/******/ 		"./samples/sparkline/range-band/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/sparkline/range-band/index.ts","charts.min"]);
...
/***/ "./samples/sparkline/range-band/index.ts":
/*!***********************************************!*\
  !*** ./samples/sparkline/range-band/index.ts ***!
  \***********************************************/
/*! no static exports found */
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-grids */ \"./node_modules/@syncfusion/ej2-grids/index.js\"), __webpack_require__(/*! @syncfusion/ej2-data */ \"./node_modules/@syncfusion/ej2-data/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! ./data-source */ \"./samples/sparkline/range-band/data-source.ts\"), __webpack_require__(/*! @syncfusion/ej2-charts */ \"./node_modules/@syncfusion/ej2-charts/index.js\"), __webpack_require__(/*! @syncfusion/ej2-inputs */ \"./node_modules/@syncfusion/ej2-inputs/index.js\"), __webpack_require__(/*! ./theme-color */ \"./samples/sparkline/range-band/theme-color.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_grids_1, ej2_data_1, ej2_base_2, data_source_1, ej2_charts_1, ej2_inputs_1, theme_color_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    exports.lineData = exports.sparkload = void 0;\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_grids_1.Grid.Inject(ej2_grids_1.Selection);\n    var sparkload = function (args) {\n        (0, theme_color_1.loadSparkLineTheme)(args);\n    };\n    exports.sparkload = sparkload;\n    exports.lineData = [\n        [0, 6, 4, 1, 3, 2, 5],\n        [5, 4, 6, 3, 1, 2, 0],\n        [6, 4, 0, 3, 2, 5, 1],\n        [4, 6, 3, 0, 1, 2, 5],\n        [3, 5, 6, 4, 0, 1, 2],\n        [1, 3, 4, 2, 5, 0, 6],\n        [2, 4, 0, 3, 5, 6, 1],\n        [5, 4, 6, 3, 1, 2, 0],\n        [0, 6, 4, 1, 3, 2, 5],\n        [6, 4, 0, 3, 2, 5, 1],\n        [4, 6, 3, 0, 1, 2, 5],\n        [3, 5, 6, 4, 0, 1, 2],\n        [1, 3, 4, 2, 5, 0, 6],\n        [2, 4, 0, 3, 5, 6, 1],\n        [5, 4, 6, 3, 1, 2, 0],\n        [0, 6, 4, 1, 3, 2, 5],\n        [6, 4, 0, 3, 2, 5, 1],\n        [4, 6, 3, 0, 1, 2, 5],\n        [2, 4, 0, 3, 5, 6, 1],\n        [3, 5, 6, 4, 0, 1, 2],\n        [1, 3, 4, 2, 5, 0, 6]\n    ];\n    var grid = new ej2_grids_1.Grid({\n        dataSource: new ej2_data_1.DataManager(data_source_1.products).executeLocal(new ej2_data_1.Query()),\n        allowSelection: false,\n        enableHover: true,\n        height: 400,\n        columns: [\n            { field: 'name', headerText: 'Name', textAlign: 'Right', width: 50 },\n            { headerText: '2010', template: '#columnTemplate1', textAlign: 'Center', width: 100 },\n            { headerText: '2011', template: '#columnTemplate2', textAlign: 'Center', width: 100 },\n        ],\n    });\n    grid.appendTo('#Grid');\n    var sparkline = {\n        height: '50px',\n        width: '150px', load: exports.sparkload,\n        lineWidth: 2,\n        fill: '#0d3c9b',\n        dataSource: exports.lineData[0],\n        rangeBandSettings: [\n            {\n                startRange: 1, endRange: 3, color: '#bfd4fc'\n            }\n        ]\n    };\n    setTimeout(function () {\n        for (var i = 1; i < 6; i++) {\n            var first = new ej2_charts_1.Sparkline(sparkline);\n            first.dataSource = exports.lineData[i];\n            first.appendTo('#sparkline2010' + i);\n            var second = new ej2_charts_1.Sparkline(sparkline);\n            second.dataSource = exports.lineData[i + 5];\n            second.appendTo('#sparkline2011' + i);\n        }\n    }, 500);\n    var sliderChange1;\n    var sliderChange2;\n    var slider1 = new ej2_inputs_1.Slider({\n        value: 1,\n        change: sliderChange1,\n        max: 6, min: 0, type: 'MinRange',\n    }, '#range-min');\n    var slider2 = new ej2_inputs_1.Slider({\n        value: 3,\n        change: sliderChange2,\n        max: 6, min: 0, type: 'MinRange',\n    }, '#range-max');\n    slider1.change = sliderChange1 = function (e) {\n        changeRangeMin(e.value);\n    };\n    slider2.change = sliderChange2 = function (e) {\n        changeRangeMax(e.value);\n    };\n    var changeRangeMin = function (min) {\n        for (var i = 1; i < 6; i++) {\n            var first = (0, ej2_base_2.getInstance)('#sparkline2010' + i, ej2_charts_1.Sparkline);\n            var second = (0, ej2_base_2.getInstance)('#sparkline2011' + i, ej2_charts_1.Sparkline);\n            first.rangeBandSettings[0].startRange = min;\n            second.rangeBandSettings[0].startRange = min;\n            first.refresh();\n            second.refresh();\n            document.getElementById('rmin').innerHTML = min.toString();\n        }\n    };\n    var changeRangeMax = function (max) {\n        for (var i = 1; i < 6; i++) {\n            var first = (0, ej2_base_2.getInstance)('#sparkline2010' + i, ej2_charts_1.Sparkline);\n            var second = (0, ej2_base_2.getInstance)('#sparkline2011' + i, ej2_charts_1.Sparkline);\n            first.rangeBandSettings[0].endRange = max;\n            second.rangeBandSettings[0].endRange = max;\n            first.refresh();\n            second.refresh();\n            document.getElementById('rmax').innerHTML = max.toString();\n        }\n    };\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/sparkline/range-band/index.ts?");
