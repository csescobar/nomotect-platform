...
exports.sequenceModel = exports.connectorSymbols = exports.exportItems = exports.flowShapes = exports.toolbarItems = exports.flowchartData = exports.menuItems = exports.zoomMenuItems = exports.data = void 0;
...
function getFlowShape(id, shapeType, tooltipContent) {
    var flowshape = { id: id, shape: { type: 'Flow', shape: shapeType }, tooltip: { content: tooltipContent } };
    return flowshape;
}
