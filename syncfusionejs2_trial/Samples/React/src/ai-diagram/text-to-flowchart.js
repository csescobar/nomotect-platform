...
var ai_text_to_flowchart_1 = require("./ai-text-to-flowchart");
/* custom code start*/
...
var SmartFlowchart = /** @class */ (function (_super) {
    ...
    SmartFlowchart.prototype.componentDidMount = function () {
        (0, sample_base_2.updateAISampleSection)();
    };
    SmartFlowchart.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement(ai_text_to_flowchart_1.default, null)),
