...
import { DiagramComponent, Node, DataBinding, PrintAndExport, FlowchartLayout, Inject, SymbolPaletteComponent, NodeConstraints } from '@syncfusion/ej2-react-diagrams';
    ...
    return (<>
            ...
            removeUrl: 'https://services.syncfusion.com/js/production/api/FileUploader/Remove'
                        ...
                        <div className="db-toolbar-container">
                            <ToolbarComponent id="toolbarEditor" ref={toolbarEditor => toolbarObj = toolbarEditor} clicked={toolbarClick} width='100%' height={49}>
                                <ItemsDirective>
                                    ...
                                    <ItemDirective type='Input' tooltipText='Export Diagram' template={() => <DropDownButtonComponent id="exportBtn" style={{ width: '100%' }} items={exportItems} iconCss='ai-e-ddb-icons e-export' select={function (args) { onselectExport(args); }}></DropDownButtonComponent>}/>
                    ...
                    <div id="diagram-space" className="sb-mobile-diagram">
                        <DiagramComponent ref={diagramObj => diagram = diagramObj} id="diagram" width="100%" height="900px" rulerSettings={{ showRulers: true }} tool={DiagramTools.Default} snapSettings={{ horizontalGridlines: gridlines, verticalGridlines: gridlines }} scrollSettings={{ scrollLimit: 'Diagram' }} layout={{
            type: 'Flowchart',
            ...
            return connector;
                ...
                <div id='container'>
                    <DialogComponent ref={dialogObj => dialog = dialogObj} id='dialog' header='<span class="e-icons e-assistview-icon" style="color: black;width:20px; font-size: 16px;"></span> AI Assist' showCloseIcon={true} isModal={true} content={dialogContent} target='#diagram-space' width='540px' visible={false} height='310px'/>
                </div>
