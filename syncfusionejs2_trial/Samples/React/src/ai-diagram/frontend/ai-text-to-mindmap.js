...
var ai_mindmap_1 = require("../model/ai-mindmap");
    ...
    var dialogContent = function () {
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement("div", { style: { display: 'flex', alignItems: 'center', marginTop: '20px' } },
                ...
                React.createElement(ej2_react_buttons_1.ButtonComponent, { id: "diagram-db-send", ref: function (sendButtonObj) { return sendButton = sendButtonObj; }, onClick: function () {
                        if (textBox.value) {
                            dialog.hide();
                            (0, ai_mindmap_1.convertTextToMindMap)(textBox.value, exports.diagram);
                        }
                    }, iconCss: 'e-icons e-send', isPrimary: true, disabled: false, style: { marginLeft: '5px', height: '32px', width: '32px' } }))));
    };
    return (React.createElement(React.Fragment, null,
                ...
                React.createElement("div", { className: "db-toolbar-container" },
                    React.createElement(ej2_react_navigations_1.ToolbarComponent, { id: "toolbarEditor", ref: function (toolbar) { return exports.toolbarObj = toolbar; }, clicked: function (args) { (0, utilitymethods_1.toolbarClick)(args); }, width: '100%', height: 46 },
                        React.createElement(ej2_react_navigations_1.ItemsDirective, null,
                            React.createElement(ej2_react_navigations_1.ItemDirective, { prefixIcon: 'ai-sf-icon-undo', tooltipText: 'Undo', disabled: true }),
                            React.createElement(ej2_react_navigations_1.ItemDirective, { prefixIcon: 'ai-sf-icon-redo', tooltipText: 'Redo', disabled: true }),
                            React.createElement(ej2_react_navigations_1.ItemDirective, { prefixIcon: 'ai-sf-icon-pointer tb-icons', tooltipText: 'Select Tool', cssClass: 'tb-item-selected' }),
                            React.createElement(ej2_react_navigations_1.ItemDirective, { prefixIcon: 'ai-sf-icon-pan tb-icons', tooltipText: 'Pan Tool' }),
                            React.createElement(ej2_react_navigations_1.ItemDirective, { prefixIcon: 'ai-sf-icon-add-child', tooltipText: 'Add Child', disabled: true }),
                            React.createElement(ej2_react_navigations_1.ItemDirective, { prefixIcon: 'ai-sf-icon-add-sibling', tooltipText: 'Add Sibling', disabled: true }),
        ...
        React.createElement("div", { id: 'container' },
            React.createElement(ej2_react_popups_1.DialogComponent, { ref: function (dialogObj) { return dialog = dialogObj; }, id: 'dialog', header: '<span class="e-icons e-assistview-icon" style="color: black;width:20px; font-size: 16px;"></span> AI Assist', showCloseIcon: true, isModal: true, content: dialogContent, target: '#diagram-space', width: '540px', visible: false, height: '310px' })),
        React.createElement(ej2_react_buttons_1.FabComponent, { id: "ai-assist", isPrimary: true, content: 'AI Assist', iconCss: 'e-icons e-assistview-icon', target: "#diagram", onClick: function () { return dialog.show(); } }),
...
exports.default = AiSmartMindMap;
