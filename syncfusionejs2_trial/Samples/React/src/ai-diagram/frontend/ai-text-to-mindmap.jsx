...
import { convertTextToMindMap } from '../model/ai-mindmap';
import { data, zoomMenuItems } from '.././datasource';
import { toolbarClick, zoomChange, loadDiagram } from '.././utilitymethods';
    ...
    const dialogContent = () => {
        return (<>
                ...
                <div style={{ display: 'flex', alignItems: 'center', marginTop: '20px' }}>
                    ...
                    <ButtonComponent id="diagram-db-send" ref={sendButtonObj => sendButton = sendButtonObj} onClick={() => {
                if (textBox.value) {
                    dialog.hide();
                    convertTextToMindMap(textBox.value, diagram);
                }
            }} iconCss='e-icons e-send' isPrimary={true} disabled={false} style={{ marginLeft: '5px', height: '32px', width: '32px' }}></ButtonComponent>
                </div>
            </>);
    };
    return (<>
