...
function AiSmartFlowchart() {
    ...
    function getSymbolDefaults(symbol) {
        ...
        symbol.constraints = ej2_react_diagrams_1.NodeConstraints.Default | ej2_react_diagrams_1.NodeConstraints.Tooltip;
    }
    ...
    var palettes = [
        { id: 'flow', expanded: true, symbols: datasource_1.flowShapes, iconCss: 'ai-e-ddb-icons e-flow', title: 'Flow Shapes' },
        { id: 'connectors', expanded: true, symbols: datasource_1.connectorSymbols, iconCss: 'ai-e-ddb-icons e-connector', title: 'Connectors' }
    ];
    ...
    var dialogContent = function () {
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement(ej2_react_buttons_1.ButtonComponent, { id: "btn1", style: { flex: 1, overflow: 'visible', borderRadius: '8px', marginBottom: '10px' }, onClick: function () {
                    dialog.hide();
                    (0, ai_flowchart_1.convertTextToFlowchart)("Flowchart for online shopping", diagram);
                } }, "Flowchart for online shopping"),
            React.createElement(ej2_react_buttons_1.ButtonComponent, { onClick: function () {
                    dialog.hide();
                    (0, ai_flowchart_1.convertTextToFlowchart)("Flowchart for Mobile banking registration", diagram);
                }, id: "btn2", style: { flex: 1, overflow: 'visible', borderRadius: '8px', marginBottom: '10px' } }, "Flowchart for Mobile banking registration"),
            React.createElement(ej2_react_buttons_1.ButtonComponent, { onClick: function () {
                    dialog.hide();
                    (0, ai_flowchart_1.convertTextToFlowchart)("Flowchart for Bus ticket booking", diagram);
                ...
                React.createElement("div", { className: "db-toolbar-container" },
                    React.createElement(ej2_react_navigations_1.ToolbarComponent, { id: "toolbarEditor", ref: function (toolbarEditor) { return toolbarObj = toolbarEditor; }, clicked: toolbarClick, width: '100%', height: 49 },
                        React.createElement(ej2_react_navigations_1.ItemsDirective, null,
                            ...
                            React.createElement(ej2_react_navigations_1.ItemDirective, { type: 'Input', tooltipText: 'Export Diagram', template: function () { return React.createElement(ej2_react_splitbuttons_1.DropDownButtonComponent, { id: "exportBtn", style: { width: '100%' }, items: datasource_1.exportItems, iconCss: 'ai-e-ddb-icons e-export', select: function (args) { onselectExport(args); } }); } }),
...
exports.default = AiSmartFlowchart;
