    ...
    ProtectSheet.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section spreadsheet-control' },
                React.createElement(ej2_react_spreadsheet_1.SpreadsheetComponent, { password: 'spreadsheet', openUrl: 'https://services.syncfusion.com/react/production/api/spreadsheet/open', saveUrl: 'https://services.syncfusion.com/react/production/api/spreadsheet/save', ref: function (ssObj) { _this.spreadsheet = ssObj; }, created: this.onCreated.bind(this), beforeCellRender: this.beforeCellRender.bind(this) },
