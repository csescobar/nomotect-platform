...
function Default() {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section spreadsheet-control' },
            React.createElement(ej2_react_spreadsheet_3.SpreadsheetComponent, { openUrl: 'https://services.syncfusion.com/react/production/api/spreadsheet/open', saveUrl: 'https://services.syncfusion.com/react/production/api/spreadsheet/save', ref: function (ssObj) { spreadsheet = ssObj; }, created: onCreated.bind(this) },
