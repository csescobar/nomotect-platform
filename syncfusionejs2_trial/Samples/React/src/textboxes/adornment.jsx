        ...
        return (<div className='control-pane'>
            <div className='col-lg-12 control-section adornment-textbox'>
                <div className="content-wrapper sample-icon">
                    ...
                    <div className="row">
                        <TextBoxComponent ref={(scope) => { this.appendTextboxObj = scope; }} placeholder="Password" cssClass="e-outline" floatLabelType="Auto" appendTemplate={this.appendTemplate}/>
                    </div>
                    <div className="row">
                        <TextBoxComponent ref={(scope) => { this.iconTextboxObj = scope; }} placeholder="Enter the Mail Address" cssClass="e-outline e-icon-textbox" floatLabelType="Auto" prependTemplate={this.prependIconTemplate} appendTemplate={this.appendIconTemplate}/>
                    </div>
                </div>
            </div>
