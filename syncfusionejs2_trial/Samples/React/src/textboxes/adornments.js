...
var Adornments = /** @class */ (function (_super) {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'col-lg-12 control-section adornment-textbox' },
                React.createElement("div", { className: "content-wrapper sample-icon" },
                    ...
                    React.createElement("div", { className: "row" },
                        React.createElement(ej2_react_inputs_1.TextBoxComponent, { ref: function (scope) { _this.appendTextboxObj = scope; }, placeholder: "Password", floatLabelType: "Auto", cssClass: "e-eye-icon", appendTemplate: this.appendTemplate })),
                    React.createElement("div", { className: "row custom-margin-row" },
                        React.createElement(ej2_react_inputs_1.TextBoxComponent, { ref: function (scope) { _this.iconTextboxObj = scope; }, placeholder: "Enter the Mail Address", cssClass: "e-icon-textbox", floatLabelType: "Auto", prependTemplate: this.prependIconTemplate, appendTemplate: this.appendIconTemplate })))),
            ...
            React.createElement("div", { id: "description" },
                ...
                React.createElement("ul", null,
                    React.createElement("li", null, "The first textbox displays a prepended user icon representing the username."),
                    ...
                    React.createElement("li", null, "The third textbox combines a prepended people icon with an appended \".com\" text and a trash icon that clears the input when clicked.")),
    ...
    Adornments.prototype.prependIconTemplate = function () {
        return (React.createElement("div", null,
            React.createElement("span", { className: "e-icons e-people" }),
            React.createElement("span", { className: "e-input-separator" })));
    };
