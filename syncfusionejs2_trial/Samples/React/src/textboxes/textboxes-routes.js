...
exports.textboxesRoutes = (React.createElement(React.Fragment, null,
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/textboxes/adornments', Component: adornments_functional_1.default })));
exports.textboxesCategory = { "default": { "name": "Default Functionalities", "category": "TextBox" }, "multiline": { "name": "Multiline TextBox", "category": "TextBox" }, "adornments": { "name": "Adornments", "category": "TextBox" }, "defaultSample": "textboxes/default" };
