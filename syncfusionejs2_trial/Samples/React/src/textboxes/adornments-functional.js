    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'col-lg-12 control-section adornment-textbox' },
            React.createElement("div", { className: "content-wrapper sample-icon" },
                ...
                React.createElement("div", { className: "row" },
                    React.createElement(ej2_react_inputs_1.TextBoxComponent, { ref: appendTextboxObj, placeholder: "Password", floatLabelType: "Auto", cssClass: "e-eye-icon", appendTemplate: appendTemplate })),
                React.createElement("div", { className: "row custom-margin-row" },
                    React.createElement(ej2_react_inputs_1.TextBoxComponent, { ref: iconTextboxObj, placeholder: "Enter the Mail Address", cssClass: "e-icon-textbox", floatLabelType: "Auto", prependTemplate: prependIconTemplate, appendTemplate: appendIconTemplate })))),
