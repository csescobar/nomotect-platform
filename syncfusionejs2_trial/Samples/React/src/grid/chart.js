...
exports.GridChartIntegration = void 0;
...
var GridChartIntegration = /** @class */ (function (_super) {
    __extends(GridChartIntegration, _super);
    function GridChartIntegration() {
        ...
        _this.handleQueryCellInfo = function (args) {
        ...
        _this.handleCreated = function () {
            _this.chartInstance = new ej2_grid_chart_1.GridChart({
                enablePropertyPanel: true,
                allowExport: true,
                enableRtl: _this.gridInstance.enableRtl,
                locale: _this.gridInstance.locale,
                updateChartSettings: _this.updateChartSettings.bind(_this)
            });
        };
        _this.updateChartSettings = function (args) {
            var _a, _b;
        ...
        _this.handleContextMenuClick = function (args) {
            if (args.chartType && _this.chartInstance) {
                var chartArgs = {
                ...
                _this.chartInstance.render(chartArgs, model, categorySeries);
            }
        };
        _this.categoryTemplate = function (props) {
    ...
    GridChartIntegration.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "control-pane" },
            React.createElement("div", { className: "control-section" },
                React.createElement(ej2_react_grids_1.GridComponent, { id: "GridChart", ref: function (grid) { return _this.gridInstance = grid; }, dataSource: data_1.sales, rowHeight: 60, height: 500, allowFiltering: true, filterSettings: { type: 'Menu' }, allowSorting: true, allowMultiSorting: true, allowSelection: true, gridLines: "Both", selectionSettings: { type: 'Multiple' }, contextMenuItems: this.contextMenuItems, contextMenuClick: this.handleContextMenuClick.bind(this), queryCellInfo: this.handleQueryCellInfo.bind(this), created: this.handleCreated.bind(this) },
                    React.createElement(ej2_react_grids_1.ColumnsDirective, null,
                        ...
                        React.createElement(ej2_react_grids_1.ColumnDirective, { field: "Product", headerText: "Products", width: 200, template: this.productTemplate.bind(this), freeze: "Left" }),
                        React.createElement(ej2_react_grids_1.ColumnDirective, { field: "Category", headerText: "Categories", width: 160, template: this.categoryTemplate.bind(this) }),
    ...
    return GridChartIntegration;
}(sample_base_1.SampleBase));
exports.GridChartIntegration = GridChartIntegration;
