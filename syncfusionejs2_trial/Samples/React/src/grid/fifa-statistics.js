...
var FIFAStatistics = /** @class */ (function (_super) {
    ...
    FIFAStatistics.prototype.queryCellInfo = function (args) {
        ...
        if (((_a = args.column) === null || _a === void 0 ? void 0 : _a.field) === 'BestPlayerAward') {
            var rowIndex = parseInt((_b = args.cell) === null || _b === void 0 ? void 0 : _b.getAttribute('data-index'));
            if (rowIndex > 0) {
                if (((_c = this.fifaGridIns) === null || _c === void 0 ? void 0 : _c.currentViewData[rowIndex - 1])[args.column.field] !== args.data[args.column.field]) {
