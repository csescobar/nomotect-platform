...
function GridChartIntegration() {
    ...
    return (<div className="control-pane">
      <div className="control-section">
        <GridComponent id="GridChart" ref={grid => gridRef = grid} dataSource={sales} height={500} allowFiltering={true} filterSettings={{ type: 'Menu' }} allowSorting={true} allowMultiSorting={true} allowSelection={true} selectionSettings={{ type: 'Multiple' }} contextMenuItems={contextMenuItems} gridLines="Both" contextMenuClick={handleContextMenuClick} queryCellInfo={handleQueryCellInfo} created={handleCreated}>
          <ColumnsDirective>
