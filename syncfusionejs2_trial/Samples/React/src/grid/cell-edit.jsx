    ...
    render() {
        return (<div className='control-pane'>
                <div className='control-section'>
                        <GridComponent id="CellEdit" ref={(grid) => (this.gridInstance = grid)} dataSource={appointmentData} allowPaging={true} allowSorting={true} allowFiltering={true} toolbar={this.toolbarOptions} editSettings={this.editSettings} filterSettings={this.filterSettings} height={400} rowHeight={40} actionComplete={this.onActionComplete.bind(this)} clipMode="EllipsisWithTooltip" actionBegin={this.actionBegin.bind(this)}>
                            <ColumnsDirective>
