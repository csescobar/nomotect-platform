...
function InfiniteScrolling() {
    ...
    return (<div className='control-pane'>
            <div className='control-section'>
                ...
                <GridComponent id="InfiniteScroll" dataSource={[]} enableInfiniteScrolling={true} enableColumnVirtualization={true} height={400} pageSettings={{ pageSize: 50 }} infiniteScrollSettings={{ initialBlocks: 1, enableCache: true }} ref={g => grid = g} allowSorting={true} allowFiltering={true} filterSettings={{ type: 'CheckBox', enableInfiniteScrolling: true }} load={load.bind(this)} clipMode='EllipsisWithTooltip' rowHeight={40} footerRowHeight={40}>
                    <ColumnsDirective>
