    ...
    render() {
        return (<div className='control-pane'>
                <div className='control-section'>
                    ...
                    <GridComponent id="VirtualScroll" dataSource={[]} enableVirtualization={this.enableVirtualization} clipMode='EllipsisWithTooltip' enableColumnVirtualization={true} height={400} rowHeight={50} ref={g => this.grid = g} dataBound={this.hide.bind(this)} load={this.load.bind(this)} toolbar={this.toolbarOptions} editSettings={this.editSettings}>
                        <ColumnsDirective>
                            ...
                            <ColumnDirective field="Priority" headerText="Priority" width={120} textAlign="Center" editType="dropdownedit" template={this.priorityTemplate}/>
                ...
                <div id='description'>
                    ...
                    <p>To enable row virtualization, set the
                        <code><a aria-label="API link for documentation" target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/api/grid/#enablevirtualization">enableVirtualization</a></code>
                        property to <code>true</code>. For column virtualization, set the
                        <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/api/grid/#enablecolumnvirtualization">enableColumnVirtualization</a></code> property to <code>true</code>. When using virtualization, it is essential to define the <code><a aria-label="API link for documentation" target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/api/grid/#height">height</a></code>
                        property so that the Grid
                        can accurately calculate the number of visible rows. For seamless scrolling, set <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/loadeventargs#enableSeamlessScrolling">args.enableSeamlessScrolling</a></code> as <code>true</code> in the Grid's <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/index-default#load">load</a></code> event. This ensures smooth vertical and horizontal transitions, providing a smoother experience during fast scrolling when virtualization is enabled.
                    </p>
                    <p>
                    ...
                    <p>For more detailed information about virtual scrolling, refer to this <a aria-label="API link for documentation" target="_blank" href="https://ej2.syncfusion.com/react/documentation/grid/scrolling/virtual-scrolling">documentation.</a></p>
