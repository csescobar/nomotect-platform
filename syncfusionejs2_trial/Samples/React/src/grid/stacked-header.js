...
var StackedHeader = /** @class */ (function (_super) {
    ...
    function StackedHeader() {
        ...
        _this.columnChooserSettings = { template: _this.Template.bind(_this), headerTemplate: _this.HeaderTemplate.bind(_this), footerTemplate: _this.FooterTemplate.bind(_this) };
        return _this;
    }
    ...
    StackedHeader.prototype.Template = function (props) {
        ...
        var enableRTL = this.gridInstance && this.gridInstance.enableRtl ? true : false;
    ...
    StackedHeader.prototype.FooterTemplate = function () {
        return (React.createElement("div", { id: "columnChooserFooter" },
            React.createElement(ej2_react_buttons_1.ButtonComponent, { onClick: this.columnChooserSubmit.bind(this) }, "Apply"),
            React.createElement(ej2_react_buttons_1.ButtonComponent, { onClick: this.columnChooserClose.bind(this) }, "Close")));
    };
    ...
    StackedHeader.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_grids_1.GridComponent, { dataSource: data_1.stackedHeaderData, ref: function (grid) { _this.gridInstance = grid; }, allowPaging: true, allowResizing: true, enableHover: false, clipMode: "EllipsisWithTooltip", allowSorting: true, allowMultiSorting: true, editSettings: this.editSettings, allowFiltering: true, filterSettings: this.filterSettings, toolbar: this.toolbar, showColumnChooser: true, queryCellInfo: this.queryCellInfo.bind(this), columnChooserSettings: this.columnChooserSettings },
                    React.createElement(ej2_react_grids_1.ColumnsDirective, null,
                        React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'CustomerID', headerText: 'Customer ID', width: '160', minWidth: '115', textAlign: 'Right', validationRules: this.orderidRules, isPrimaryKey: true, showInColumnChooser: false }),
                        React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'CustomerName', headerText: 'Name', width: '150', minWidth: '120' }),
