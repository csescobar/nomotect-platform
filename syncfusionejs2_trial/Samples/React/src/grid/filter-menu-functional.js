            ...
            React.createElement("div", null,
                React.createElement("div", { style: { display: 'flex', alignItems: 'center' } },
                    ...
                    React.createElement("div", { style: { display: 'flex', gap: '6px' } },
                        ...
                        React.createElement(ej2_react_buttons_1.CheckBoxComponent, { ref: function (checkBox) { return immediateCheckBoxInstance = checkBox; }, label: 'Enable Immediate Filter ', labelPosition: 'Before', disabled: true, change: immediateCheckboxOnChange.bind(this) })))),
            React.createElement(ej2_react_grids_1.GridComponent, { dataSource: data, query: query, allowSorting: true, allowPaging: true, ref: function (grid) { return gridInstance = grid; }, pageSettings: { pageSize: 10, pageCount: 5 }, allowFiltering: true, filterSettings: filterSettings, clipMode: 'EllipsisWithTooltip' },
