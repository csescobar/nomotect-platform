...
function Virtualization() {
    ...
    return (<div className='control-pane'>
            <div className='control-section'>
                ...
                <GridComponent id="VirtualScroll" dataSource={[]} enableVirtualization={enableVirtualization} clipMode='EllipsisWithTooltip' enableColumnVirtualization={true} height={400} ref={g => grid = g} dataBound={hide.bind(this)} load={load.bind(this)} toolbar={toolbarOptions} editSettings={editSettings} rowHeight={50}>
                    <ColumnsDirective>
