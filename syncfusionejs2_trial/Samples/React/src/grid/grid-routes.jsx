...
import GridChartIntegration from './chart-functional';
...
import RowSpanningAPI from './row-spanning-api-functional';
...
import CellEdit from './cell-edit-functional';
...
import ConditionalRowSelection from './conditional-row-selection-functional';
...
import PinnedRows from './pinned-rows-functional';
import DOMVirtualGrid from './dom-virtualization-functional';
...
export const gridRoutes = (<>
         ...
         <Route path='/:theme/grid/chart' Component={GridChartIntegration}/>
         ...
         <Route path='/:theme/grid/row-spanning-api' Component={RowSpanningAPI}/>
         ...
         <Route path='/:theme/grid/cell-edit' Component={CellEdit}/>
         ...
         <Route path='/:theme/grid/conditional-row-selection' Component={ConditionalRowSelection}/>
         ...
         <Route path='/:theme/grid/pinned-rows' Component={PinnedRows}/>
         <Route path='/:theme/grid/dom-virtualization' Component={DOMVirtualGrid}/>
