...
function InfiniteScrolling() {
    ...
    function onclick() {
        if (!data.length) {
            ...
            grid.dataSource = data = data_1.salesDataSource;
            setIsLoaded(true);
        }
    }
    function load(args) {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            ...
            React.createElement("div", { className: 'div-button' },
                React.createElement(ej2_react_buttons_1.ButtonComponent, { cssClass: 'e-info', onClick: onclick.bind(this), disabled: isLoaded }, "Load 100K Data"),
                React.createElement("span", { id: "popup" },
                    React.createElement("span", { id: "gif", className: "image" }))),
            React.createElement(ej2_react_grids_1.GridComponent, { id: "InfiniteScroll", dataSource: [], enableInfiniteScrolling: true, enableColumnVirtualization: true, height: 400, pageSettings: { pageSize: 50 }, infiniteScrollSettings: { initialBlocks: 1, enableCache: true }, ref: function (g) { return grid = g; }, allowSorting: true, allowFiltering: true, filterSettings: { type: 'CheckBox', enableInfiniteScrolling: true }, load: load.bind(this), clipMode: 'EllipsisWithTooltip', rowHeight: 40, footerRowHeight: 40 },
                ...
                React.createElement(ej2_react_grids_1.Inject, { services: [ej2_react_grids_1.InfiniteScroll, ej2_react_grids_1.VirtualScroll, ej2_react_grids_1.Filter, ej2_react_grids_1.Sort, ej2_react_grids_1.Aggregate] }))),
