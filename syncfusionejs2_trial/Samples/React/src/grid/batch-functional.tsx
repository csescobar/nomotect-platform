  ...
  return (
    <div className='control-pane'>
      <div className='control-section'>
          <GridComponent id="BatchEdit" dataSource={inventoryStoreData} pageSettings={pageSettings} allowSorting={true} toolbar={toolbarOptions} allowPaging={true} editSettings={editSettings} allowFiltering={true} filterSettings={filterSettings}
            selectionSettings={selectionSettings} height={400} clipMode='EllipsisWithTooltip' ref={grid => gridRef = grid} cellEdit={cellEdit} beforeBatchSave={beforeBatchSave}>
          <ColumnsDirective>
