...
function DOMVirtualGrid() {
    ...
    return (<div className='control-pane'>
      <div className='control-section'>
        <GridComponent id="DOMVirtualGrid" dataSource={data} query={query} height={400} rowHeight={50} enableVirtualization={true} enableDomVirtualization={true} pageSettings={{ pageSize: 100 }} domVirtualizationSettings={{ rowBuffer: 10 }} clipMode='EllipsisWithTooltip' allowSorting={true} allowFiltering={true} allowSelection={true} filterSettings={{ type: 'CheckBox' }}>
          <ColumnsDirective>
