...
function CellEdit() {
    ...
    const doctorTemplate = (props) => {
        ...
        <img src={`src/grid/images/${index}.png`} alt={props.Doctor} className="doctor-img"/>
    ...
    const onActionComplete = (args) => {
        if (args.requestType === 'save' && args.columnName === 'Doctor') {
            ...
            gridRef.current?.updateCell(args.rowIndex, 'Room', doctorRoomMap[args.data.Doctor]);
        }
    };
    const validateAppointmentTime = (args) => {
        if (!args.value)
            return false;
    ...
    return (<div className='control-pane'>
      <div className='control-section'>
          <GridComponent id="CellEdit" ref={gridRef} dataSource={appointmentData} allowPaging={true} allowSorting={true} allowFiltering={true} filterSettings={filterSettings} editSettings={editSettings} toolbar={toolbarOptions} height={400} rowHeight={40} actionComplete={onActionComplete} clipMode="EllipsisWithTooltip" actionBegin={actionBegin}>
            <ColumnsDirective>
              ...
              <ColumnDirective field="AppointmentTime" headerText="Appointment Time" editType="datetimepickeredit" width="200" format={{ type: 'dateTime', format: 'M/d/y hh:mm a' }} validationRules={{ required: true,
            timeRule: [
        ...
        <div id="description">
          ...
          <p>
            More information on edit configuration can be found in the <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/grid/editing"> documentation section</a>.
          </p>
