...
function PinnedRows() {
    ...
    var contextMenuItems = ['PinRow', 'UnpinRow'];
    ...
    ;
    var requestTemplate = function (props) {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement(ej2_react_grids_1.GridComponent, { id: "PinnedRows", dataSource: data_1.supportData, ref: function (grid) { return gridInstance = grid; }, enableVirtualization: true, contextMenuItems: contextMenuItems, height: 300, isRowPinned: isRowPinned.bind(this), allowSorting: true, allowKeyboard: false, allowFiltering: true, filterSettings: filterSettings, pageSettings: { pageSize: 20 } },
                React.createElement(ej2_react_grids_1.ColumnsDirective, null,
                    ...
                    React.createElement(ej2_react_grids_1.ColumnDirective, { field: "Status", headerText: "Status", width: "140", textAlign: "Center", template: statusDetail.bind(this) }),
                    React.createElement(ej2_react_grids_1.ColumnDirective, { field: "Priority", headerText: "Priority", width: "140", textAlign: "Center", template: priorityDetail.bind(this) }),
                    ...
                    React.createElement(ej2_react_grids_1.ColumnDirective, { field: "TypeofRequest", headerText: "Type of Request", width: "210", template: requestTemplate.bind(this) }),
                    ...
                    React.createElement(ej2_react_grids_1.ColumnDirective, { field: "Rating", headerText: "Rating", width: "160", textAlign: "Center", freeze: "Right", template: ratingDetail.bind(this) })),
                React.createElement(ej2_react_grids_1.Inject, { services: [ej2_react_grids_1.VirtualScroll, ej2_react_grids_1.Sort, ej2_react_grids_1.Selection, ej2_react_grids_1.Filter, ej2_react_grids_1.Freeze, ej2_react_grids_1.ContextMenu] }))),
