...
export class BatchEdit extends SampleBase {
    gridRef = null;
    toolbarOptions = ['Add', 'Delete', 'Update', 'Cancel', 'Undo', 'Redo'];
    ...
    render() {
        ...
        <div className='control-section'>
              <GridComponent id="BatchEdit" dataSource={inventoryStoreData} pageSettings={this.pageSettings} allowSorting={true} toolbar={this.toolbarOptions} allowPaging={true} editSettings={this.editSettings} allowFiltering={true} filterSettings={this.filterSettings} selectionSettings={this.selectionSettings} height={400} clipMode='EllipsisWithTooltip' cellEdit={this.cellEdit} beforeBatchSave={this.beforeBatchSave} ref={(grid) => this.gridRef = grid}>
                <ColumnsDirective>
