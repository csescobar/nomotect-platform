...
var row_spanning_api_functional_1 = require("./row-spanning-api-functional");
...
var cell_edit_functional_1 = require("./cell-edit-functional");
...
var conditional_row_selection_functional_1 = require("./conditional-row-selection-functional");
...
var pinned_rows_functional_1 = require("./pinned-rows-functional");
var dom_virtualization_functional_1 = require("./dom-virtualization-functional");
...
exports.gridRoutes = (React.createElement(React.Fragment, null,
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/grid/chart', Component: chart_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/grid/row-spanning-api', Component: row_spanning_api_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/grid/cell-edit', Component: cell_edit_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/grid/conditional-row-selection', Component: conditional_row_selection_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/grid/pinned-rows', Component: pinned_rows_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/grid/dom-virtualization', Component: dom_virtualization_functional_1.default }),
...
exports.gridCategory = { "overview": { "name": "Overview", "category": "Data Grid" }, "live-data": { "name": "Live Data", "category": "Data Grid" }, "default": { "name": "Default Functionalities", "category": "Data Grid" }, "adaptive-layout": { "name": "Adaptive Layout", "category": "Data Grid" }, "loading-animation": { "name": "Loading Animation", "category": "Data Grid" }, "empty-record-template": { "name": "Empty Record Template", "category": "Data Grid" }, "chart": { "name": "Integrate Chart in Grid", "category": "Data Grid" }, "fifa-statistics": { "name": "FIFA Statistics", "category": "Product Use Case" }, "local-binding": { "name": "Local Data", "category": "Data Binding" }, "remote-data": { "name": "Remote Data", "category": "Data Binding" }, "custom-binding": { "name": "Custom Binding", "category": "Data Binding" }, "column-template": { "name": "Column Template", "category": "Columns" }, "header-template": { "name": "Header Template", "category": "Columns" }, "stacked-header": { "name": "Stacked Header", "category": "Columns" }, "foreign-key": { "name": "Foreign Key Column", "category": "Columns" }, "reorder": { "name": "Reorder", "category": "Columns" }, "column-resizing": { "name": "AutoFit and Resizing", "category": "Columns" }, "column-menu": { "name": "Column Menu", "category": "Columns" }, "auto-wrap": { "name": "AutoWrap Column cells", "category": "Columns" }, "column-chooser": { "name": "Column Chooser", "category": "Columns" }, "show-hide": { "name": "Show or Hide Column", "category": "Columns" }, "column-spanning": { "name": "Column Spanning", "category": "Columns" }, "row-template": { "name": "Row Template", "category": "Rows" }, "detail-template": { "name": "Detail Template", "category": "Rows" }, "row-drag-drop": { "name": "Drag and Drop", "category": "Rows" }, "drag-drop-within-grid": { "name": "Drag and Drop within Grid", "category": "Rows" }, "row-height": { "name": "Row Height", "category": "Rows" }, "row-spanning": { "name": "Row Spanning", "category": "Rows" }, "row-spanning-api": { "name": "Row Spanning API", "category": "Rows" }, "normal-edit": { "name": "Inline Editing", "category": "Editing" }, "dialog-edit": { "name": "Dialog Editing", "category": "Editing" }, "dialog-template": { "name": "Dialog Template", "category": "Editing" }, "batch": { "name": "Batch Editing", "category": "Editing" }, "cell-edit": { "name": "Cell Editing", "category": "Editing" }, "command-column": { "name": "Command Column", "category": "Editing" }, "sorting": { "name": "Sorting", "category": "Sorting" }, "filtering": { "name": "Default Filtering", "category": "Filtering" }, "filter-template": { "name": "Filter Template", "category": "Filtering" }, "filter-menu": { "name": "Filter Menu", "category": "Filtering" }, "searching": { "name": "Search", "category": "Filtering" }, "grouping": { "name": "Grouping", "category": "Grouping" }, "aggregate-default": { "name": "Default Aggregate", "category": "Aggregates" }, "aggregate-group": { "name": "Group and Caption Aggregate", "category": "Aggregates" }, "reactive-aggregate": { "name": "Reactive Aggregate", "category": "Aggregates" }, "selection": { "name": "Default Selection", "category": "Selection" }, "selection-api": { "name": "Selection API", "category": "Selection" }, "checkbox-selection": { "name": "Checkbox Selection", "category": "Selection" }, "conditional-row-selection": { "name": "Conditional Row Selection", "category": "Selection" }, "scrolling": { "name": "Default Scrolling", "category": "Scrolling" }, "sticky-header": { "name": "Sticky Header", "category": "Scrolling" }, "frozen-rows-columns": { "name": "Frozen Rows and Columns", "category": "Scrolling" }, "frozen-api": { "name": "Frozen API", "category": "Scrolling" }, "pinned-rows": { "name": "Pinned Rows", "category": "Scrolling" }, "dom-virtualization": { "name": "DOM Virtualization", "category": "Performance" }, "virtualization": { "name": "Virtual Scrolling", "category": "Performance" }, "infinite-scrolling": { "name": "Infinite Scrolling", "category": "Performance" }, "paging": { "name": "Pagination", "category": "Performance" }, "lazy-load-grouping-with-paging": { "name": "Grouping with Paging", "category": "Lazy Load Grouping" }, "lazy-load-grouping-with-infinite-scrolling": { "name": "Grouping with Infinite Scrolling", "category": "Lazy Load Grouping" }, "lazy-load-grouping-with-virtual-scrolling": { "name": "Grouping with Virtual Scrolling", "category": "Lazy Load Grouping" }, "hierarchy": { "name": "Hierarchy Grid", "category": "Relational Binding" }, "master-detail": { "name": "Master/Detail", "category": "Relational Binding" }, "default-exporting": { "name": "Default Exporting", "category": "Exporting" }, "advanced-exporting": { "name": "Advanced Exporting", "category": "Exporting" }, "master-details-export": { "name": "Hierarchy Exporting", "category": "Exporting" }, "detail-template-exporting": { "name": "Detail Template Exporting", "category": "Exporting" }, "multiple-export": { "name": "Multiple Exporting", "category": "Exporting" }, "print": { "name": "Print", "category": "Exporting" }, "grid-lines": { "name": "GridLines", "category": "Miscellaneous" }, "context-menu": { "name": "Context Menu", "category": "Miscellaneous" }, "clipboard": { "name": "Clipboard", "category": "Miscellaneous" }, "keyboard-navigation": { "name": "Keyboard Navigation", "category": "Miscellaneous" }, "enable-rtl": { "name": "RTL", "category": "Miscellaneous" }, "defaultSample": "grid/overview" };
