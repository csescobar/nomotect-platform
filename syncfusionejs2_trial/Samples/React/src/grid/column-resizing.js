                ...
                React.createElement("div", { style: { overflowX: 'auto', marginLeft: '4px' } },
                    React.createElement(ej2_react_grids_1.GridComponent, { dataSource: data_1.orderDetails, allowResizing: true, height: '400', width: '850', autoFit: true, allowSorting: true, editSettings: this.editSettings, allowFiltering: true, filterSettings: this.filterSettings, toolbar: this.toolbar },
                        React.createElement(ej2_react_grids_1.ColumnsDirective, null,
                            React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'OrderID', headerText: 'Order ID', minWidth: '115', width: '150', maxWidth: '200', textAlign: 'Right', validationRules: this.orderidRules, isPrimaryKey: true }),
                            ...
                            React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'Freight', headerText: 'Freight', minWidth: '115', width: '120', format: 'C2', textAlign: 'Right', validationRules: this.freightRules, editType: 'numericedit' }),
