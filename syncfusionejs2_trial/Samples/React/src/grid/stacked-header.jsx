...
export class StackedHeader extends SampleBase {
    ...
    locationtemplate(props) {
        return (<div className="Mapimage">
            <img src="src/grid/images/Map.png" className="e-image" alt=""/>{' '}
            <span> </span>
    ...
    columnChooserSettings = { template: this.Template.bind(this), headerTemplate: this.HeaderTemplate.bind(this), footerTemplate: this.FooterTemplate.bind(this) };
    render() {
