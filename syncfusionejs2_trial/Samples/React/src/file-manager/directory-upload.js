...
var DirectoryUpload = /** @class */ (function (_super) {
    ...
    DirectoryUpload.prototype.onCreated = function () {
        var _a, _b, _c, _d;
        if (this.fmObj && this.dropBtnObj) {
            this.dropBtnObj.content = this.fmObj.localeObj.getConstant('Upload');
            this.dropBtnObj.items = [
                { text: ((_b = (_a = this.fmObj) === null || _a === void 0 ? void 0 : _a.localeObj) === null || _b === void 0 ? void 0 : _b.getConstant('Folder')) || 'Folder' },
                { text: ((_d = (_c = this.fmObj) === null || _c === void 0 ? void 0 : _c.localeObj) === null || _d === void 0 ? void 0 : _d.getConstant('File')) || 'File' },
            ];
        }
    };
    DirectoryUpload.prototype.uploadTemplate = function () {
        var _this = this;
        return (React.createElement(ej2_react_splitbuttons_1.DropDownButtonComponent, { id: "dropButton", ref: function (scope) { _this.dropBtnObj = scope; }, iconCss: 'e-icons e-fe-upload', cssClass: "e-tbar-btn e-tbtn-txt", select: this.onSelect.bind(this), onClick: this.uploadClick.bind(this), created: this.onCreated.bind(this) }));
    };
    ...
    DirectoryUpload.prototype.onSelect = function (args) {
        var _a;
        if (args.item.text === ((_a = this.fmObj) === null || _a === void 0 ? void 0 : _a.localeObj.getConstant('Folder'))) {
