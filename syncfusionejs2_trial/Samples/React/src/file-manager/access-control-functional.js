    ...
    return (React.createElement("div", null,
        React.createElement("div", { className: "control-section" },
            React.createElement(ej2_react_filemanager_1.FileManagerComponent, { id: "api_filemanager", ajaxSettings: {
                ...
                }, toolbarSettings: { items: ['NewFolder', 'SortBy', 'Cut', 'Copy', 'Paste', 'Delete', 'Refresh', 'Download', 'Rename', 'Selection', 'View', 'Details'] }, uploadSettings: { directoryUpload: true } },
        ...
        React.createElement("div", { id: "description" },
            ...
            React.createElement("p", null,
                "In the ",
                React.createElement("code", null, "music"),
                " folder, uploading folders (directory uploads) is restricted while individual file uploads remain allowed. This ensures users can add files to the ",
                React.createElement("code", null, "music"),
                " directory without creating nested folder structures."),
            React.createElement("p", null,
