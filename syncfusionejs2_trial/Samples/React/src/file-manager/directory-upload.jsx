...
export class DirectoryUpload extends SampleBase {
    fmObj;
    dropBtnObj;
    hostUrl = "https://physical-service.syncfusion.com/";
    onCreated() {
    ...
    uploadTemplate() {
        return (<DropDownButtonComponent id="dropButton" ref={(scope) => { this.dropBtnObj = scope; }} iconCss='e-icons e-fe-upload' cssClass="e-tbar-btn e-tbtn-txt" select={this.onSelect.bind(this)} onClick={this.uploadClick.bind(this)} created={this.onCreated.bind(this)}>
