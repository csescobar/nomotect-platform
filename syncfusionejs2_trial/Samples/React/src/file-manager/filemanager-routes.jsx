...
import SequentialUpload from './sequential-upload-functional';
import VirtualizationSample from './virtualization-functional';
import TemplateSample from './template-functional';
...
export const filemanagerRoutes = (<>
         ...
         <Route path='/:theme/file-manager/sequential-upload' Component={SequentialUpload}/>
         <Route path='/:theme/file-manager/virtualization' Component={VirtualizationSample}/>
         <Route path='/:theme/file-manager/template' Component={TemplateSample}/>
