...
var sequential_upload_functional_1 = require("./sequential-upload-functional");
...
exports.filemanagerRoutes = (React.createElement(React.Fragment, null,
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/file-manager/sequential-upload', Component: sequential_upload_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/file-manager/template', Component: template_functional_1.default }),
...
exports.filemanagerCategory = { "overview": { "name": "Overview", "category": "File Manager" }, "flat-data": { "name": "Flat Data", "category": "File Manager" }, "custom-thumbnail": { "name": "Custom Thumbnails", "category": "File Manager" }, "default": { "name": "API", "category": "File Manager" }, "drag-drop": { "name": "Drag and Drop", "category": "File Manager" }, "directory-upload": { "name": "Directory upload", "category": "File Manager" }, "sequential-upload": { "name": "Sequential upload", "category": "File Manager" }, "virtualization": { "name": "Virtualization", "category": "File Manager" }, "template": { "name": "Template", "category": "File Manager" }, "file-upload": { "name": "File Upload", "category": "Use Case" }, "access-control": { "name": "Access Control", "category": "Use Case" }, "azure-service": { "name": "Azure Blob Provider", "category": "Cloud Service Providers" }, "AmazonS3Provider": { "name": "Amazon S3 File Provider", "category": "Cloud Service Providers" }, "firebase": { "name": "Firebase Realtime File Provider", "category": "Cloud Service Providers" }, "ibm-cos-node-file-provider": { "name": "IBM Cloud File Provider", "category": "Cloud Service Providers" }, "defaultSample": "file-manager/overview" };
