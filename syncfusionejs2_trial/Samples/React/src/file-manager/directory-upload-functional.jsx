...
const DirectoryUpload = () => {
    ...
    const uploadTemplate = () => {
        return (<DropDownButtonComponent ref={dropBtnRef} id="dropButton" cssClass="e-tbar-btn e-tbtn-txt" onClick={uploadClick} iconCss='e-icons e-fe-upload' select={onSelect} created={OnCreated}>
