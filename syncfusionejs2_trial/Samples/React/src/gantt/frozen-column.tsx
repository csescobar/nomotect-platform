...
import { GanttComponent, TaskFieldsModel, Inject, Selection, ColumnsDirective, ColumnDirective, Freeze, ColumnModel, Toolbar, LabelSettingsModel, ResourceFieldsModel, TimelineSettingsModel, SplitterSettingsModel } from '@syncfusion/ej2-react-gantt';
      ...
      <div className='control-pane'>
        ...
        <div id="description">
          ...
          <p>In this example, the <b>Task ID</b> and <b>Task Name</b> columns are frozen on the left, and the <b>Assignee</b> column is frozen on the right using the <code className="code">column.freeze</code> property.
            Gantt component features are segregated into individual feature-wise modules. To use column freezing, selection and toolbar, inject the <code
