...
var LoadingAnimation = /** @class */ (function (_super) {
    ...
    function LoadingAnimation() {
        ...
        _this.projectEndDate = new Date('09/21/2025');
        return _this;
    }
    ...
    LoadingAnimation.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'col-md-9' },
                React.createElement(ej2_react_gantt_1.GanttComponent, { id: 'LoadingAnimation', ref: function (gantt) { return _this.ganttInstance = gantt; }, dataSource: data_1.virtualData, treeColumnIndex: 1, labelSettings: this.labelSettings, allowSelection: true, allowFiltering: true, allowSorting: true, highlightWeekends: true, enableVirtualization: true, projectEndDate: this.projectEndDate, taskFields: this.taskFields, splitterSettings: this.splitterSettings, height: '650px', taskbarHeight: 25, rowHeight: 46, loadingIndicator: this.loadingIndicator },
