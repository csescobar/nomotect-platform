...
export class EventMarkers extends SampleBase {
    ...
    eventMarkerDay1 = new Date("04/01/2025");
    eventMarkerDay2 = new Date("04/07/2025");
    eventMarkerDay3 = new Date("04/07/2025");
    eventMarkerDay4 = new Date("04/17/2025");
    eventMarkerDay5 = new Date("04/17/2025");
    eventMarkerDay6 = new Date("05/23/2025");
    eventMarkerDay7 = new Date("05/29/2025");
    eventMarkerDay8 = new Date("06/26/2025");
    labelSettings = {
        leftLabel: 'TaskName'
    };
    timelineSettings = {
