...
var Filtering = /** @class */ (function (_super) {
    ...
    function Filtering() {
        ...
        _this.projectStartDate = new Date('07/16/2025 02:00:00 AM');
        _this.projectEndDate = new Date('07/25/2025');
    ...
    Filtering.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'col-md-9' },
                React.createElement(ej2_react_gantt_1.GanttComponent, { id: 'Filtering', ref: function (gantt) { return _this.ganttInstance = gantt; }, dataSource: data_1.filteredData, durationUnit: 'Hour', treeColumnIndex: 0, allowFiltering: true, includeWeekend: true, allowSorting: true, dateFormat: 'MM/dd/yyyy hh:mm:ss', projectStartDate: this.projectStartDate, projectEndDate: this.projectEndDate, taskFields: this.taskFields, timelineSettings: this.timelineSettings, splitterSettings: this.splitterSettings, labelSettings: this.labelSettings, filterSettings: { type: 'Menu', hierarchyMode: 'Parent' }, dayWorkingTime: this.dayWorkingTime, height: '650px', taskbarHeight: 25, rowHeight: 46, actionComplete: this.actionCompleteEvent.bind(this) },
