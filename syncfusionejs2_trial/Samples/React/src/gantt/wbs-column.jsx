...
export class EnableWbs extends SampleBase {
    ...
    eventMarkerDay1 = new Date('04/02/2025');
    timelineSettings = {
        showTooltip: true,
    ...
    handleAutoUpdateWBSChange(args) {
          ...
          <div className="col-lg-12">
            ...
            <div>
              <GanttComponent id="EnableWbs" ref={(gantt) => (this.ganttInstance = gantt)} dataSource={WBSData} taskFields={this.taskFields} enableWBS={true} enableAutoWbsUpdate={true} editSettings={this.editSettings} treeColumnIndex={2} toolbar={this.toolbar} dataBound={this.dataBound.bind(this)} selectionSettings={this.selectionSettings} splitterSettings={this.splitterSettings} filterSettings={this.filterSettings} tooltipSettings={this.tooltipSettings} labelSettings={this.labelSettings} timelineSettings={this.timelineSettings} highlightWeekends={true} allowFiltering={true} allowSorting={true} allowPdfExport={true} allowSelection={true} enableContextMenu={true} gridLines={"Both"} height='650px' taskbarHeight={25} rowHeight={46} projectStartDate={this.projectStartDate} projectEndDate={this.projectEndDate} allowUnscheduledTasks={true}>
                ...
                <Inject services={[Selection, Toolbar, Edit, Filter, Sort, ContextMenu, DayMarkers,
            ]}/>
              </GanttComponent>
            </div>
          </div>
