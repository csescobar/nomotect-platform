...
const EnableWbs = () => {
  ...
  const handleAutoUpdateWBSChange = (args: ChangeEventArgs): void => {
    if (args.checked) {
          ...
          <div style={{ display: "flex" }}>
            <div id='wbsswitch' style={{ display: "flex", alignItems: "center" }}>
              ...
              <SwitchComponent
                id="autoUpdateWBS"
                checked={true}
                change={handleAutoUpdateWBSChange}
              />
            </div>
          </div>
          <div>
