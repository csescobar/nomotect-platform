...
var Filtering = function () {
    ...
    var projectStartDate = new Date('07/16/2025 02:00:00 AM');
    var projectEndDate = new Date('07/25/2025');
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'col-md-9' },
            React.createElement(ej2_react_gantt_1.GanttComponent, { id: 'Filtering', ref: ganttInstance, dataSource: data_1.filteredData, durationUnit: 'Hour', treeColumnIndex: 0, allowFiltering: true, includeWeekend: true, allowSorting: true, dateFormat: 'MM/dd/yyyy hh:mm:ss', projectStartDate: projectStartDate, projectEndDate: projectEndDate, taskFields: taskFields, timelineSettings: timelineSettings, splitterSettings: splitterSettings, labelSettings: labelSettings, filterSettings: { type: 'Menu', hierarchyMode: 'Parent' }, dayWorkingTime: dayWorkingTime, height: '650px', taskbarHeight: 25, rowHeight: 46, actionComplete: actionCompleteEvent.bind(_this) },
                React.createElement(ej2_react_gantt_1.ColumnsDirective, null,
                    ...
                    React.createElement(ej2_react_gantt_1.ColumnDirective, { field: 'Predecessor', headerText: 'Predecessor', width: 190 })),
            ...
            React.createElement("div", { style: { float: 'right', margin: '10px' } },
                "Source:",
                React.createElement("a", { href: "https://en.wikipedia.org/wiki/Apollo_11#Launch_and_flight_to_lunar_orbit", target: '_blank' }, "https://en.wikipedia.org/wiki/Apollo_11"))),
        ...
        React.createElement("div", { id: "description" },
            ...
            React.createElement("p", null,
                "Gantt component features are segregated into individual feature-wise modules. To use the filtering and selection features, we need to inject the ",
            ...
            React.createElement("p", null,
                ...
                React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/gantt/filtering/filtering" }, "documentation section"),
                "."))));
};
