...
import { GanttComponent, TaskFieldsModel, Inject, Selection, DayMarkers, ColumnsDirective, ColumnDirective, GridLine, LabelSettingsModel, SplitterSettingsModel } from '@syncfusion/ej2-react-gantt';
