...
import { GanttComponent, EditDialogFieldsDirective, DayMarkers, EditDialogFieldDirective, Inject, Edit, Selection, Toolbar, Resize, Sort, ContextMenu, ColumnsDirective, ColumnDirective } from '@syncfusion/ej2-react-gantt';
    ...
    render() {
        ...
        <div className='control-section'>
          ...
          <div style={{ float: 'right', margin: '10px' }}>Source:
            <a href="https://en.wikipedia.org/wiki/Construction" target='_blank'>https://en.wikipedia.org/wiki/Construction</a>
          </div>
        </div>
