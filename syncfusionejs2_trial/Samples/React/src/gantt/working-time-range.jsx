    ...
    render() {
              ...
              <table id="property" className="property-panel-table" title="Properties" style={{ width: '100%', paddingLeft: '0px' }}>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div>
                        <NumericTextBoxComponent ref={NumericTextBox => this.workEndTime = NumericTextBox} id='workEnd' value={17} min={0} max={24} showSpinButton={true} change={this.change1.bind(this)} width='125px' step={0.5}/>
                      </div>
                    </td>
                  </tr>
                  <tr>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div>
                        <NumericTextBoxComponent ref={NumericTextBox => this.workEndTime1 = NumericTextBox} id='workEnd' value={17} min={0} max={24} showSpinButton={true} change={this.change2.bind(this)} width='125px' step={0.5}/>
                      </div>
                    </td>
                  </tr>
                  <tr>
        ...
        <div id="description">
          ...
          <p>
            ...
            <code>Selection</code> and <code>DayMarkers</code> into the <code>Inject Services</code> section.
          </p>
          <br />
