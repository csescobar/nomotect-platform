...
const Overview = () => {
    ...
    const projectStartDate = new Date('01/25/2025');
    const projectEndDate = new Date('01/30/2026');
    ...
    const RightLabelTemplate = (props) => {
        if (props.ganttProperties.resourceInfo) {
            ...
            for (let index = 0; index < resources.length; index++) {
                ...
                let img = (<img key={`img-${index}`} src={src} height="30px" width="30px" alt={resources[index].resourceName}/>);
    ...
    const eventMarkerDay1 = new Date('2025-03-13');
    const eventMarkerDay2 = new Date('2025-04-18');
    const eventMarkerDay3 = new Date('2025-05-30');
    const eventMarkerDay4 = new Date('2025-11-25');
    ...
    const prioritytemplate = (props) => {
        ...
        if (props.taskData.Priority) {
            return (<div className='columnTemplate1' style={{ display: 'flex' }}>
    ...
    const columnTemplate = (props) => {
        ...
        if ((props.ganttProperties.resourceNames)) {
            ...
            if (gantt.enableRtl) {
                ...
                return (<div className='columnTemplate' style={{ display: 'flex', alignItems: 'center', gap: '8px', height: '100%' }}>
    ...
    const load = () => {
        let themeCollection = ['bootstrap5', 'bootstrap', 'bootstrap4', 'fluent', 'fabric', 'fusionnew', 'material3', 'material', 'highcontrast', 'tailwind', 'fluent2', 'tailwind3', 'bootstrap5_3'];
    ...
    const Status = (status) => {
        switch (status) {
            case "In Progress":
                ...
                width = '96px';
                height = '24px';
                border = `solid 1px ${statusStyleColor}`;
                break;
            case "Open":
                display = 'flex';
    ...
    const PriorityIconStyle = (priority) => {
        switch (priority) {
            case "Low":
    ...
    const viewFields = { text: 'Text', value: 'id' };
            ...
            <div className='control-section'>
                ...
                <div>
                    ...
                    <div id='sidebar-gantt'>
                        <GanttComponent id='Overview' ref={ganttInstance} dataSource={overviewData} treeColumnIndex={0} allowSelection={true} enableWBS={true} enableAutoWbsUpdate={true} enableHover={true} highlightWeekends={true} allowExcelExport={true} allowPdfExport={true} projectStartDate={projectStartDate} projectEndDate={projectEndDate} load={load.bind(this)} pdfQueryCellInfo={pdfQueryCellInfo.bind(this)} toolbarClick={toolbarClick.bind(this)} taskFields={taskFields} timelineSettings={timelineSettings} labelSettings={labelSettings} splitterSettings={splitterSettings} height='650px' taskbarHeight={25} rowHeight={46} gridLines={gridLines} allowFiltering={true} showColumnMenu={true} allowSorting={true} allowResizing={true} toolbar={toolbarOptions} resourceFields={resourceFields} resources={editingResources} pdfQueryTaskbarInfo={pdfQueryTaskbarInfo.bind(this)}>
                            <ColumnsDirective>
