...
const Sorting = () => {
    ...
    return (<div className='control-pane'>
      <div className='control-section'>
        <GanttComponent id='Sorting' dataSource={editingData} highlightWeekends={true} allowSelection={true} taskFields={taskFields} splitterSettings={splitterSettings} treeColumnIndex={1} labelSettings={labelSettings} height='650px' taskbarHeight={25} rowHeight={46} selectedRowIndex={0} sortSettings={sortSettings} allowSorting={true} projectStartDate={projectStartDate} projectEndDate={projectEndDate}>
          <ColumnsDirective>
