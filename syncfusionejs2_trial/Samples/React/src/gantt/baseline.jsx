...
export class Baseline extends SampleBase {
    ...
    parentTaskbarTemplate = (props) => (<div className="e-gantt-parent-taskbar e-row-expand e-custom-parent" style={{ height: '10px', marginTop: '17px', background: '#F3F4F6', border: '1px solid #9CA3AF', borderRadius: '5px', textOverflow: 'ellipsis' }}>
