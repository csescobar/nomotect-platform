...
const TimelineTemplate = () => {
    ...
    return (<div className='control-pane'>
      <div className='control-section'>
        <GanttComponent id='TimelineTemplate' ref={ganttInstance} dataSource={timelineTemplateData} splitterSettings={splitterSettings} taskFields={taskFields} height='650px' taskbarHeight={25} rowHeight={46} projectStartDate={projectStartDate} projectEndDate={projectEndDate} timelineSettings={timelineSettings} timelineTemplate={timelineTemplate} labelSettings={labelSettings} treeColumnIndex={1}>
          <ColumnsDirective>
