...
import { GanttComponent, TaskFieldsModel, Inject, Selection, Toolbar, Edit, Filter, Sort, ContextMenu, DayMarkers, ColumnsDirective, ColumnDirective, EventMarkersDirective, EventMarkerDirective, EditSettingsModel, LabelSettingsModel, SplitterSettingsModel, TimelineSettingsModel, ToolbarItem, SelectionSettingsModel, FilterSettingsModel, TooltipSettingsModel } from '@syncfusion/ej2-react-gantt';
...
export class EnableWbs extends SampleBase<{}, {}> {
  ...
  public dataBound(): void {
    (this.ganttInstance.element.getElementsByClassName('e-span-label')[0] as HTMLElement).style.top = '125px';
    (this.ganttInstance.element.getElementsByClassName('e-gantt-right-arrow')[0] as HTMLElement).style.top = '131px';
  }
    ...
    return (
      <div className="control-pane">
            ...
            <div>
              <GanttComponent
                ...
                <ColumnsDirective>
                  ...
                  <ColumnDirective field="WBSCode" headerText="WBS Code" width='130px' />
        ...
        <div id="description">
          ...
          <br />
          <p>
          Gantt component features are segregated into individual feature-wise modules. To use a Filter, contextMenu, Edit, Toolbar, Sorting, Selection and markers features, we need to inject the <code>Filter</code>, <code>ContextMenu</code>, <code>Edit</code>, <code>Toolbar</code>, <code>Sort</code>, <code>Selection</code> and <code>DayMarkers</code> by into the <code>Inject Services</code> section.
          </p>
          <br/>
