...
import { GanttComponent, TaskFieldsModel, Inject, Selection, ColumnDirective, ColumnsDirective, TimelineViewMode, TimelineSettingsModel } from '@syncfusion/ej2-react-gantt';
