...
var Constraints = function () {
    ...
    var getConstraintText = function (value) {
        var map = {
    ...
    var projectEndDate = new Date("09/06/2025");
    var eventMarkers = [
    ...
    return (React.createElement("div", { className: "control-pane" },
        React.createElement("div", { className: "control-section" },
            React.createElement(ej2_react_gantt_1.GanttComponent, { id: "Constraint", dataSource: data_1.constraintData, taskFields: taskFields, editSettings: editSettings, toolbar: toolbar, allowSelection: true, gridLines: "Both", highlightWeekends: true, height: '650px', taskbarHeight: 25, rowHeight: 46, treeColumnIndex: 1, labelSettings: labelSettings, splitterSettings: splitterSettings, projectStartDate: projectStartDate, projectEndDate: projectEndDate, eventMarkers: eventMarkers },
        ...
        React.createElement("div", { id: "description" },
            ...
            React.createElement("p", null,
                ...
                " and ",
                React.createElement("code", null, "SelectionService"),
                " into the ",
