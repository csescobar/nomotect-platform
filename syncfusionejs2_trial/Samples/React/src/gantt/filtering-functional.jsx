    ...
    return (<div className='control-pane'>
      <div className='col-md-9'>
        ...
        <div style={{ float: 'right', margin: '10px' }}>Source:
          <a href="https://en.wikipedia.org/wiki/Apollo_11#Launch_and_flight_to_lunar_orbit" target='_blank'>https://en.wikipedia.org/wiki/Apollo_11</a>
        </div>
      </div>
