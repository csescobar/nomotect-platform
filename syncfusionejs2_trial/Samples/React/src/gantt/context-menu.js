...
var ContextMenuItem = /** @class */ (function (_super) {
    ...
    function ContextMenuItem() {
        ...
        _this.projectEndDate = new Date('09/08/2025');
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                ...
                React.createElement("div", { style: { float: 'right', margin: '10px' } },
                    "Source:",
                    React.createElement("a", { href: "https://en.wikipedia.org/wiki/Construction", target: '_blank' }, "https://en.wikipedia.org/wiki/Construction"))),
