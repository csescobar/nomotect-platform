...
var WorkingTimeRange = function () {
    ...
    var change1 = function (args) {
        if (workStartTime.current.value >= workEndTime.current.value) {
            if (workStartTime.current.value < 24) {
                workEndTime.current.value = workStartTime.current.value + 1.00;
            }
            else {
                workEndTime.current.value = 0.00;
            }
        }
    };
    var change2 = function (args) {
        if (workStartTime1.current.value >= workEndTime1.current.value) {
            if (workStartTime1.current.value < 24) {
                workEndTime1.current.value = workStartTime1.current.value + 1.00;
            }
            else {
                workEndTime1.current.value = 0.00;
            }
        }
    };
    var taskFields = {
    ...
    var projectStartDate = new Date('04/02/2025');
    var projectEndDate = new Date('04/15/2025');
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement("div", { className: 'col-lg-8' },
                React.createElement(ej2_react_gantt_1.GanttComponent, { id: 'WorkingTimeRange', ref: ganttInstance, dataSource: data_1.workTimeRange, highlightWeekends: true, taskFields: taskFields, labelSettings: labelSettings, height: '650px', taskbarHeight: 25, rowHeight: 46, timelineSettings: timelineSettings, durationUnit: durationUnit, splitterSettings: splitterSettings, projectStartDate: projectStartDate, projectEndDate: projectEndDate },
                ...
                React.createElement(property_pane_1.PropertyPane, { title: 'Properties' },
                    React.createElement("table", { id: "property", className: "property-panel-table", title: "Properties", style: { width: '100%', paddingLeft: '0px' } },
                        ...
                        React.createElement("tbody", null,
                            ...
                            React.createElement("tr", null,
                                ...
                                React.createElement("td", null,
                                    React.createElement("div", null,
                                        React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { ref: workStartTime, id: 'workStart', value: 8, min: 0, max: 24, showSpinButton: true, change: change1.bind(_this), width: '125px', step: 0.5 })))),
                            React.createElement("tr", null,
                                React.createElement("td", { style: { paddingBottom: '10px' } },
                                    React.createElement("div", { id: 'workEndTime', style: { marginLeft: '10px', marginTop: "10px" } }, "Work End Time")),
                                React.createElement("td", null,
                                    React.createElement("div", null,
                                        React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { ref: workEndTime, id: 'workEnd', value: 17, min: 0, max: 24, showSpinButton: true, change: change1.bind(_this), width: '125px', step: 0.5 })))),
                            React.createElement("tr", null,
                                React.createElement("td", { colSpan: 2 },
                                    React.createElement("div", null,
                            ...
                            React.createElement("tr", null,
                                React.createElement("td", { style: { paddingBottom: '10px' } },
                                    React.createElement("div", { id: 'workStart1', style: { marginLeft: '10px', marginTop: "10px" } }, "Work Start Time")),
                                React.createElement("td", null,
                                    React.createElement("div", null,
                                        React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { ref: workStartTime1, id: 'workStart1', value: 8, min: 0, max: 24, showSpinButton: true, change: change2.bind(_this), width: '125px', step: 0.5 })))),
                            React.createElement("tr", null,
                                React.createElement("td", { style: { paddingBottom: '10px' } },
                                    React.createElement("div", { id: 'workEnd1', style: { marginLeft: '10px', marginTop: "10px" } }, "Work End Time")),
                                React.createElement("td", null,
                                    React.createElement("div", null,
                                        React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { ref: workEndTime1, id: 'workEnd1', value: 17, min: 0, max: 24, showSpinButton: true, change: change2.bind(_this), width: '125px', step: 0.5 })))),
                            React.createElement("tr", null,
                                React.createElement("td", { colSpan: 2 },
                                    React.createElement("div", null,
        ...
        React.createElement("div", { id: "description" },
            ...
            React.createElement("p", null,
                ...
                React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/gantt/scheduling-tasks#configure-working-time-range" }, "documentation section"),
                "."))));
};
