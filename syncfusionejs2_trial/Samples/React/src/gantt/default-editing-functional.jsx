...
import { GanttComponent, EditDialogFieldsDirective, DayMarkers, EditDialogFieldDirective, Inject, Edit, Selection, Toolbar, ColumnsDirective, ColumnDirective } from '@syncfusion/ej2-react-gantt';
    ...
    return (<div className='control-pane'>
      ...
      <div id="action-description">
        ...
        <ul>
          ...
          <li><code>Edit </code> - To edit a task, double-click a row or taskbar, or click the toolbar Edit button after selecting a row</li>
