...
export class SortingAPI extends SampleBase {
    ...
    render() {
                ...
                <tbody>
                  ...
                  <tr>
                    <td style={{ width: '100%', paddingRight: '10px' }}>
                      <div>
                        <DropDownListComponent ref={DropDownList => this.dropdownColumns = DropDownList} id='columns' width="150px" tabIndex={1} dataSource={this.dropdownColumnsData} fields={{ text: 'type', value: 'id' }} value='TaskName'></DropDownListComponent>
                      </div>
                    </td>
                  </tr>
                  <tr>
        ...
        <div id="action-description">
          <p>The sorting feature enables you to order data in a particular direction. It can be enabled by setting the <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/gantt#allowsorting">allowSorting</a> to true.</p>
        </div>
