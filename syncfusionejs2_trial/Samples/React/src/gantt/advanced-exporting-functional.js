...
var AdvancedExporting = function () {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            ...
            React.createElement(ej2_react_gantt_1.GanttComponent, { id: 'AdvancedExporting', ref: ganttInstance, dataSource: data_1.pdfExport, dateFormat: 'MMM dd, y', enableCriticalPath: true, treeColumnIndex: 1, allowExcelExport: true, allowPdfExport: true, allowSelection: true, showColumnMenu: false, highlightWeekends: true, allowUnscheduledTasks: true, projectStartDate: projectStartDate, splitterSettings: splitterSettings, taskFields: taskFields, timelineSettings: timelineSettings, labelSettings: labelSettings, toolbarClick: toolbarClick.bind(_this), height: '650px', taskbarHeight: 25, rowHeight: 46, gridLines: gridLines, toolbar: toolbar, resourceFields: resourceFields, holidays: holidays, eventMarkers: eventMarkers, resources: data_1.editingResources, pdfQueryTaskbarInfo: pdfQueryTaskbarInfo, queryTaskbarInfo: queryTaskbarInfo },
