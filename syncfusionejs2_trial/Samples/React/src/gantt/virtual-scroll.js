...
var Virtualscroll = /** @class */ (function (_super) {
    ...
    function Virtualscroll() {
        ...
        _this.projectStartDate = new Date('04/01/2025');
    ...
    Virtualscroll.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_gantt_1.GanttComponent, { id: 'VirtualScroll', dataSource: data_1.virtualData, treeColumnIndex: 1, labelSettings: this.labelSettings, allowSelection: true, highlightWeekends: true, enableVirtualization: true, enableTimelineVirtualization: true, taskFields: this.taskFields, splitterSettings: this.splitterSettings, height: '650px', taskbarHeight: 25, rowHeight: 46, projectEndDate: this.projectEndDate, projectStartDate: this.projectStartDate },
                    React.createElement(ej2_react_gantt_1.ColumnsDirective, null,
                        React.createElement(ej2_react_gantt_1.ColumnDirective, { field: 'TaskID' }),
                        React.createElement(ej2_react_gantt_1.ColumnDirective, { field: 'TaskName', headerText: 'Task Name', width: 300 }),
            ...
            React.createElement("div", { id: "description" },
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/gantt/virtual-scroll" }, "documentation section"),
                    "."))));
    };
