...
export class Virtualscroll extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
          <GanttComponent id='VirtualScroll' dataSource={virtualData} treeColumnIndex={1} labelSettings={this.labelSettings} allowSelection={true} highlightWeekends={true} enableVirtualization={true} enableTimelineVirtualization={true} taskFields={this.taskFields} splitterSettings={this.splitterSettings} height='650px' taskbarHeight={25} rowHeight={46} projectEndDate={this.projectEndDate} projectStartDate={this.projectStartDate}>
            <ColumnsDirective>
