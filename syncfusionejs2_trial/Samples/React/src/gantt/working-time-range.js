...
var WorkingTimeRange = /** @class */ (function (_super) {
    ...
    function WorkingTimeRange() {
        ...
        _this.projectStartDate = new Date('04/02/2025');
        _this.projectEndDate = new Date('04/15/2025');
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement("div", { className: 'col-lg-8' },
                    React.createElement(ej2_react_gantt_1.GanttComponent, { id: 'WorkingTimeRange', ref: function (gantt) { return _this.ganttInstance = gantt; }, dataSource: data_1.workTimeRange, highlightWeekends: true, taskFields: this.taskFields, labelSettings: this.labelSettings, height: '650px', taskbarHeight: 25, rowHeight: 46, timelineSettings: this.timelineSettings, durationUnit: this.durationUnit, splitterSettings: this.splitterSettings, projectStartDate: this.projectStartDate, projectEndDate: this.projectEndDate },
                        ...
                        React.createElement("table", { id: "property", className: "property-panel-table", title: "Properties", style: { width: '100%', paddingLeft: '0px' } },
                            ...
                            React.createElement("tbody", null,
                                ...
                                React.createElement("tr", null,
                                    ...
                                    React.createElement("td", null,
                                        React.createElement("div", null,
                                            React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { ref: function (NumericTextBox) { return _this.workEndTime = NumericTextBox; }, id: 'workEnd', value: 17, min: 0, max: 24, showSpinButton: true, change: this.change1.bind(this), width: '125px', step: 0.5 })))),
                                React.createElement("tr", null,
                                    React.createElement("td", { colSpan: 2 },
                                        React.createElement("div", null,
                            ...
                            React.createElement("tbody", null,
                                ...
                                React.createElement("tr", null,
                                    ...
                                    React.createElement("td", null,
                                        React.createElement("div", null,
                                            React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { ref: function (NumericTextBox) { return _this.workEndTime1 = NumericTextBox; }, id: 'workEnd', value: 17, min: 0, max: 24, showSpinButton: true, change: this.change2.bind(this), width: '125px', step: 0.5 })))),
                                React.createElement("tr", null,
                                    React.createElement("td", { colSpan: 2 },
                                        React.createElement("div", null,
