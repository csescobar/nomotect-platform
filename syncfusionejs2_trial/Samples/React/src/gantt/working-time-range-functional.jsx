...
const WorkingTimeRange = () => {
    ...
    const projectStartDate = new Date('04/02/2025');
    const projectEndDate = new Date('04/15/2025');
    const perform = () => {
    ...
    return (<div className='control-pane'>
      <div className='control-section'>
        <div className='col-lg-8'>
          <GanttComponent id='WorkingTimeRange' ref={ganttInstance} dataSource={workTimeRange} highlightWeekends={true} taskFields={taskFields} labelSettings={labelSettings} height='650px' taskbarHeight={25} rowHeight={46} timelineSettings={timelineSettings} durationUnit={durationUnit} splitterSettings={splitterSettings} projectStartDate={projectStartDate} projectEndDate={projectEndDate}>
            <ColumnsDirective>
            ...
            <table id="property" className="property-panel-table" title="Properties" style={{ width: '100%', paddingLeft: '0px' }}>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div>
                      <NumericTextBoxComponent ref={workStartTime} id='workStart' value={8} min={0} max={24} showSpinButton={true} change={change1.bind(this)} width='125px' step={0.5}></NumericTextBoxComponent>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <div>
                      <NumericTextBoxComponent ref={workEndTime} id='workEnd' value={17} min={0} max={24} showSpinButton={true} change={change1.bind(this)} width='125px' step={0.5}></NumericTextBoxComponent>
                    </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td style={{ paddingBottom: '10px' }}>
                    <div id='workStart1' style={{ marginLeft: '10px', marginTop: "10px" }}>Work Start Time</div>
                  </td>
                  <td>
                    <div>
                      <NumericTextBoxComponent ref={workStartTime1} id='workStart1' value={8} min={0} max={24} showSpinButton={true} change={change2.bind(this)} width='125px' step={0.5}></NumericTextBoxComponent>
                    </div>
                  </td>
                </tr>
                <tr>
                  <td style={{ paddingBottom: '10px' }}>
                    <div id='workEnd1' style={{ marginLeft: '10px', marginTop: "10px" }}>Work End Time</div>
                  </td>
                  <td>
                    <div>
                      <NumericTextBoxComponent ref={workEndTime1} id='workEnd1' value={17} min={0} max={24} showSpinButton={true} change={change2.bind(this)} width='125px' step={0.5}></NumericTextBoxComponent>
                    </div>
                  </td>
                </tr>
                <tr>
      ...
      <div id="description">
        ...
        <br />
        <p>More information on the Essential<sup>®</sup> React Gantt Chart can be found in this <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/gantt/scheduling-tasks#configure-working-time-range">documentation section</a>.</p>
      </div>
    </div>);
};
