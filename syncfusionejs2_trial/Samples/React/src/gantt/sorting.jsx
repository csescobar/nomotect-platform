...
export class Sorting extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
          <GanttComponent id='Sorting' dataSource={editingData} highlightWeekends={true} allowSelection={true} taskFields={this.taskFields} splitterSettings={this.splitterSettings} treeColumnIndex={1} labelSettings={this.labelSettings} height='650px' taskbarHeight={25} rowHeight={46} selectedRowIndex={0} sortSettings={this.sortSettings} allowSorting={true} projectStartDate={this.projectStartDate} projectEndDate={this.projectEndDate}>
            <ColumnsDirective>
