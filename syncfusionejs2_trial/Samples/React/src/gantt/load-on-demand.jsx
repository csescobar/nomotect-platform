...
export class LoadOnDemand extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
          <GanttComponent id='LoadOnDemand' dataSource={this.dataSource} treeColumnIndex={1} taskFields={this.taskFields} enableVirtualization={true} loadChildOnDemand={true} height='650px' taskbarHeight={25} rowHeight={46} projectStartDate={this.projectStartDate} projectEndDate={this.projectEndDate}>
            <ColumnsDirective>
