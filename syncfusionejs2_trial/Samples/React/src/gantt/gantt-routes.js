...
var default_editing_functional_1 = require("./default-editing-functional");
...
var infinite_timeline_scrolling_functional_1 = require("./infinite-timeline-scrolling-functional");
...
var wbs_column_functional_1 = require("./wbs-column-functional");
var frozen_column_functional_1 = require("./frozen-column-functional");
...
var baseline_template_functional_1 = require("./baseline-template-functional");
...
exports.ganttRoutes = (React.createElement(React.Fragment, null,
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/gantt/default-editing', Component: default_editing_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/gantt/dialog-editing', Component: dialog_editing_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/gantt/constraints', Component: constraints_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/gantt/infinite-timeline-scrolling', Component: infinite_timeline_scrolling_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/gantt/wbs-column', Component: wbs_column_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/gantt/frozen-column', Component: frozen_column_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/gantt/baseline-template', Component: baseline_template_functional_1.default }),
