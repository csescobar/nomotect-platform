...
const Baseline = () => {
    ...
    const ParentTemplate = (props) => {
        return (<div className="e-gantt-parent-taskbar e-row-expand e-custom-parent" style={{ height: '10px', marginTop: '17px', background: '#F3F4F6', border: '1px solid #9CA3AF', borderRadius: '5px', textOverflow: 'ellipsis' }}>
    ...
    return (<div className='control-pane'>
      <div className='control-section'>
        ...
        <div style={{ float: 'right', margin: '10px' }}>Source:
          <a href="https://en.wikipedia.org/wiki/Service_(motor_vehicle)" target='_blank'>https://en.wikipedia.org/wiki/Service_(motor_vehicle)</a>
        </div>
      </div>
