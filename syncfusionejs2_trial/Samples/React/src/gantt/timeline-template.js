...
var TimelineTemplate = /** @class */ (function (_super) {
    ...
    function TimelineTemplate() {
        ...
        _this.timelineTemplate = function (props) {
                ...
                return (React.createElement("div", { className: "e-header-cell-label e-gantt-top-cell-text", style: {
                    ...
                    React.createElement("div", { style: {
                        ...
                        React.createElement("div", { style: {
                                lineHeight: 'initial',
                                fontWeight: 'normal'
                            } }, _this.weekDate(props.date)),
                        React.createElement("div", { style: {
                                lineHeight: 'normal',
                                paddingTop: '5px',
                                paddingBottom: '2px',
                                fontWeight: 'normal'
                            } }, _this.formatDate(props.date)),
                        React.createElement("div", { style: {
                                width: '20px',
                                height: '20px',
                                lineHeight: 'normal'
                            ...
                            React.createElement("img", { style: {
                                    width: '100%',
                                    height: '100%'
                                }, src: _this.imageString(props.date) })))));
            }
        };
        _this.projectStartDate = new Date('03/29/2025 01:00:00 PM');
        _this.projectEndDate = new Date('04/23/2025');
        return _this;
    }
    ...
    TimelineTemplate.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_gantt_1.GanttComponent, { id: 'TimelineTemplate', ref: function (gantt) { return _this.ganttInstance = gantt; }, dataSource: data_1.timelineTemplateData, highlightWeekends: true, splitterSettings: this.splitterSettings, taskFields: this.taskFields, height: '650px', taskbarHeight: 25, rowHeight: 46, labelSettings: this.labelSettings, projectStartDate: this.projectStartDate, projectEndDate: this.projectEndDate, timelineSettings: this.timelineSettings, timelineTemplate: this.timelineTemplate, treeColumnIndex: 1 },
            ...
            React.createElement("div", { id: "description" },
                ...
                React.createElement("p", null,
                    "Gantt component features are segregated into individual feature-wise modules. To use selection and marker features, we need to inject the ",
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/gantt/time-line/time-line#timeline-template" }, "documentation section"),
                    "."))));
    };
