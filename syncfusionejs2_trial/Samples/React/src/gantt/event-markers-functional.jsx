...
const EventMarkers = () => {
    ...
    const eventMarkerDay1 = new Date("04/01/2025");
    const eventMarkerDay2 = new Date("04/07/2025");
    const eventMarkerDay3 = new Date("04/07/2025");
    const eventMarkerDay4 = new Date("04/17/2025");
    const eventMarkerDay5 = new Date("04/17/2025");
    const eventMarkerDay6 = new Date("05/23/2025");
    const eventMarkerDay7 = new Date("05/29/2025");
    const eventMarkerDay8 = new Date("06/26/2025");
    const labelSettings = {
        leftLabel: 'TaskName'
    };
