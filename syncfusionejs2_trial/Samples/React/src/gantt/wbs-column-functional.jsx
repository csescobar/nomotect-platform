...
const EnableWbs = () => {
    ...
    const eventMarkerDay1 = new Date('04/02/2025');
    const handleAutoUpdateWBSChange = (args) => {
        if (args.checked) {
    ...
    const projectEndDate = new Date("05/30/2025");
        ...
        <div className="col-lg-12">
          <div style={{ display: "flex" }}>
            <div id='wbsswitch' style={{ display: "flex", alignItems: "center" }}>
              ...
              <SwitchComponent id="autoUpdateWBS" checked={true} change={handleAutoUpdateWBSChange}/>
            </div>
          </div>
          <div>
