...
export class Taskbar extends SampleBase {
    ...
    eventMarkerDay1 = new Date('03/05/2025 07:09:00 PM');
    eventMarkerDay2 = new Date('03/05/2025 07:46:00 PM');
    eventMarkerDay3 = new Date('03/05/2025 07:59:00 PM');
    eventMarkerDay4 = new Date('03/05/2025 08:08:00 PM');
    eventMarkerDay5 = new Date('03/05/2025 08:24:00 PM');
    eventMarkerDay6 = new Date('03/05/2025 08:31:00 PM');
    eventMarkerDay7 = new Date('03/05/2025 08:47:00 PM');
    labelSettings = {
        leftLabel: 'TaskName',
    };
    ...
    render() {
        ...
        <div className='control-section'>
          <GanttComponent id='TaskbarTemplate' dataSource={customizedData} dateFormat={'hh:mm a'} taskFields={this.taskFields} height='650px' splitterSettings={this.splitterSettings} treeColumnIndex={1} rowHeight={75} taskbarHeight={65} dayWorkingTime={this.dayWorkingTime} durationUnit={'Minute'} timelineSettings={this.timelineSettings} labelSettings={this.labelSettings} tooltipSettings={this.tooltipSettings} milestoneTemplate={this.milestone} taskbarTemplate={this.childTaskbarTemplate} projectStartDate={this.projectStartDate} projectEndDate={this.projectEndDate} allowSelection={true}>
            <ColumnsDirective>
