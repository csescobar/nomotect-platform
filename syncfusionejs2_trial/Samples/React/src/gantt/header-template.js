...
var HeaderTemplate = /** @class */ (function (_super) {
    ...
    function HeaderTemplate() {
        ...
        _this.projectEndDate = new Date('07/06/2025');
        return _this;
    }
    HeaderTemplate.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_gantt_1.GanttComponent, { id: 'HeaderTemplate', resourceFields: this.resourceFields, resources: data_1.editingResources, dataSource: data_1.templateData, highlightWeekends: true, splitterSettings: this.splitterSettings, taskFields: this.taskFields, labelSettings: this.labelSettings, height: '650px', taskbarHeight: 25, rowHeight: 46, projectStartDate: this.projectStartDate, projectEndDate: this.projectEndDate },
            ...
            React.createElement("div", { id: "description" },
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/gantt/columns/column-headers#customize-header-using-template" }, "documentation section"),
                    "."))));
    };
