...
var GanttDialogEditing = function () {
    (0, react_1.useEffect)(function () {
        (0, sample_base_1.updateSampleSection)();
    }, []);
    var ganttInstance = React.useRef(null);
    var taskFields = {
        id: 'TaskID',
        name: 'TaskName',
        startDate: 'StartDate',
    ...
    var toolbar = ['Add', 'Edit', 'Delete', 'ExpandAll', 'CollapseAll'];
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement(ej2_react_gantt_1.GanttComponent, { id: "Dialog", ref: ganttInstance, dataSource: data_1.dialogData, taskFields: taskFields, resourceFields: resourceFields, resources: data_1.dataResources, editSettings: editSettings, toolbar: toolbar, renderBaseline: true, treeColumnIndex: 1, taskMode: "Custom", allowSelection: true, showColumnMenu: true, splitterSettings: splitterSettings, gridLines: "Both", highlightWeekends: true, timelineSettings: timelineSettings, labelSettings: labelSettings, allowResizing: true, taskbarHeight: 25, rowHeight: 46, height: "650px", projectStartDate: new Date('03/30/2025'), projectEndDate: new Date('07/19/2025'), actionComplete: actionComplete },
...
exports.default = GanttDialogEditing;
