...
export class ShowHideColumn extends SampleBase {
    ...
    render() {
        ...
        <div className='col-md-9 control-section'>
          ...
          <GanttComponent id='ColumnMenu' treeColumnIndex={1} allowFiltering={true} allowSorting={true} ref={gantt => this.ganttObj = gantt} allowResizing={true} dataSource={projectNewData} highlightWeekends={true} splitterSettings={this.splitterSettings} taskFields={this.taskFields} labelSettings={this.labelSettings} height='650px' taskbarHeight={25} rowHeight={46} projectStartDate={this.projectStartDate} projectEndDate={this.projectEndDate}>
              <ColumnsDirective>
