...
const SortingAPI = () => {
    ...
    const projectEndDate = new Date('09/01/2025');
              ...
              <tbody>
                ...
                <tr>
                  <td style={{ width: '100%', paddingRight: '10px' }}>
                    <div>
                      <DropDownListComponent ref={dropdownColumns} id='columns' width="150px" tabIndex={1} dataSource={dropdownColumnsData} fields={{ text: 'type', value: 'id' }} value='TaskName'></DropDownListComponent>
                    </div>
                  </td>
                </tr>
                <tr>
