...
var ResourceAllocation = /** @class */ (function (_super) {
    ...
    function ResourceAllocation() {
        ...
        _this.projectEndDate = new Date('07/28/2025');
        _this.labelSettings = {
    ...
    ResourceAllocation.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_gantt_1.GanttComponent, { id: 'resource', dataSource: data_1.resourceAllocationData, ref: function (gantt) { return _this.ganttInstance = gantt; }, treeColumnIndex: 1, allowSelection: true, highlightWeekends: true, toolbar: this.toolbar, editSettings: this.editSettings, projectStartDate: this.projectStartDate, projectEndDate: this.projectEndDate, resourceFields: this.resourceFields, taskFields: this.taskFields, taskType: this.taskType, labelSettings: this.labelSettings, splitterSettings: this.splitterSettings, height: '650px', taskbarHeight: 25, rowHeight: 46, resources: data_1.resourceAllocationResources, workUnit: this.workUnit, queryTaskbarInfo: this.queryTaskbarInfo, editDialogFields: this.editDialogFields, addDialogFields: this.addDialogFields, actionBegin: this.actionBegin, actionComplete: this.actionComplete, cellEdit: this.cellEdit },
                    React.createElement(ej2_react_gantt_1.ColumnsDirective, null,
                        ...
                        React.createElement(ej2_react_gantt_1.ColumnDirective, { field: 'work', headerText: 'Work', width: '110' }),
                        React.createElement(ej2_react_gantt_1.ColumnDirective, { field: 'Duration', headerText: 'Duration', width: '150' }),
                        React.createElement(ej2_react_gantt_1.ColumnDirective, { field: 'taskType', headerText: 'Task Type', width: '150' })),
            ...
            React.createElement("div", { id: "description" },
                ...
                React.createElement("p", null,
                    "Gantt component features are segregated into individual feature-wise modules. To use a selection, markers, edit and toolbar features, we need to inject the ",
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/gantt/resources" }, "documentation section"),
                    "."))));
    };
