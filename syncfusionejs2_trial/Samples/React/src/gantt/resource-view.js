...
var ResourceView = /** @class */ (function (_super) {
    ...
    function ResourceView() {
        ...
        _this.projectEndDate = new Date('05/18/2025');
        _this.labelSettings = {
    ...
    ResourceView.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { id: "action-description" },
                ...
                React.createElement("p", null, "When a resource is assigned with two or more tasks which are scheduled on the same date, it is termed as over allocation for a resource. The number of over allocation dates ranges are highlighted as with square bracket. The following sample demonstrates the over allocation for a resource. In this sample, over allocation can be hidden by using the CSS \u2018visibility\u2019 property on custom toolbar item action.")),
            React.createElement("div", { id: "description" },
                ...
                React.createElement("p", null,
                    "The Gantt control features are segregated into individual feature-wise modules. To use a selection, markers, toolbar, edit, and resize features, we need to inject the ",
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/gantt/resource-view" }, "documentation section"),
                    "."))));
    };
    return ResourceView;
