...
import { GanttComponent, TaskFieldsModel, Inject, Selection, DayMarkers, DurationUnit, ColumnsDirective, ColumnDirective, TimelineSettingsModel, LabelSettingsModel } from '@syncfusion/ej2-react-gantt';
...
export class WorkingTimeRange extends SampleBase<{}, {}> {
  ...
  public projectEndDate: Date = new Date('04/15/2025');
