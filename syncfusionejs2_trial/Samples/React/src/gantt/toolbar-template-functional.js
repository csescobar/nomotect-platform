    ...
    return (React.createElement("div", { className: 'control-pane' },
        ...
        React.createElement("div", { id: "description" },
            React.createElement("p", null,
                ...
                " event."),
            React.createElement("p", null,
                "In this sample, the custom toolbar elements ",
                React.createElement("code", null, "Quick Filter"),
                " and ",
                React.createElement("code", null, "Clear Filter"),
                " are rendered along with predefined toolbar items ExpandAll and CollapseAll. While clicking the ",
                React.createElement("code", null, "Quick Filter"),
                " toolbar item, filtering occurs for the ",
                React.createElement("code", null, "Task Name"),
                " column. The filtered column can be cleared using the ",
                React.createElement("code", null, "Clear Filter"),
                " toolbar item."),
            React.createElement("p", null,
