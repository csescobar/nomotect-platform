...
export class GanttDialogEditing extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
          <GanttComponent id="Dialog" ref={gantt => this.ganttInstance = gantt} dataSource={dialogData} taskFields={this.taskFields} resourceFields={this.resourceFields} resources={dataResources} editSettings={this.editSettings} toolbar={this.toolbar} renderBaseline={true} treeColumnIndex={1} taskMode="Custom" allowSelection={true} showColumnMenu={true} splitterSettings={this.splitterSettings} gridLines="Both" highlightWeekends={true} timelineSettings={this.timelineSettings} labelSettings={this.labelSettings} allowResizing={true} taskbarHeight={25} rowHeight={46} height="650px" projectStartDate={new Date('03/30/2025')} projectEndDate={new Date('07/19/2025')} actionComplete={this.actionComplete}>
            <ColumnsDirective>
