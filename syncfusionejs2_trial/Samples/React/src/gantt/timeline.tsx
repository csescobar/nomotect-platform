...
import { GanttComponent, TimelineViewMode, Inject, Selection, Sort, DayMarkers, ColumnsDirective, ColumnDirective, TaskFieldsModel, TimelineSettingsModel, SplitterSettingsModel, LabelSettingsModel } from '@syncfusion/ej2-react-gantt';
...
export class Timeline extends SampleBase<{}, {}> {
  ...
  public changeDateRange = (args: any): void => {
    this.ganttInstance.timelineSettings.viewStartDate = isNullOrUndefined(args.startDate) ? this.startDateValue : args.startDate;
    this.ganttInstance.timelineSettings.viewEndDate = isNullOrUndefined(args.endDate) ? this.endDateValue : args.endDate;
  }
    ...
    return (
      <div className='control-pane'>
        ...
        <div id="description">
          ...
          <p>Gantt component features are segregated into individual feature-wise modules. To use selection, sorting and marker features, we need to inject the <code>Selection</code>, <code>Sort</code> and <code>DayMarkers</code> into the <code>Inject Services</code> section.</p>
          <br/>
