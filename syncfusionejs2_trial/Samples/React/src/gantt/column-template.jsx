...
export class ColumnTemplate extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
          <GanttComponent id='ColumnTemplate' rowHeight={60} resourceFields={this.resourceFields} resources={editingResources} dataSource={templateData} highlightWeekends={true} treeColumnIndex={1} splitterSettings={this.splitterSettings} taskFields={this.taskFields} labelSettings={this.labelSettings} height='650px' taskbarHeight={25} projectStartDate={this.projectStartDate} projectEndDate={this.projectEndDate}>
            <ColumnsDirective>
