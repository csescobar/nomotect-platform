...
var Timezone = function () {
    ...
    var dayWorkingTime = [{ from: 0, to: 23 }];
    var getTimeZonesWithOffsets = function () {
        var now = new Date();
        var zones;
    ...
    var timeZoneList = function (args) {
    ...
    var timelineUnit = function (args) {
        var unit = args.value;
    ...
    var getPreviousTimeSpan = function () {
        if (ganttInstance.current) {
            ganttInstance.current.previousTimeSpan();
        }
    };
    var getNextTimeSpan = function () {
        if (ganttInstance.current) {
    ...
    var toolbar = [
        ...
        {
            align: 'Left',
            template: function () { return (React.createElement(ej2_react_dropdowns_1.ComboBoxComponent, { id: "timezonelist", value: "UTC (UTC+00:00)", placeholder: "Select Time Zone", change: timeZoneList, allowFiltering: true, filterType: "Contains", dataSource: getTimeZonesWithOffsets(), width: "300px", popupWidth: "350px", popupHeight: "350px", fields: { value: 'id', text: 'text' } })); },
        },
        {
            align: 'Right',
            template: function () { return (React.createElement(ej2_react_buttons_1.ButtonComponent, { id: "previous-timespan", cssClass: "previous-timespan", onClick: getPreviousTimeSpan, iconCss: 'e-icons e-chevron-left-fill' })); }
        },
        {
            type: 'Separator',
            align: 'Right'
        ...
        {
            align: 'Right',
            template: function () { return (React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { id: "timeline", value: timelineSettings.topTier.unit, placeholder: "Select timeline", change: timelineUnit, dataSource: timelineData, width: '100px' })); }
        },
        {
            type: 'Separator',
            align: 'Right'
        ...
        {
            align: 'Right',
            template: function () { return (React.createElement(ej2_react_buttons_1.ButtonComponent, { id: "next-timespan", cssClass: "next-timespan", onClick: getNextTimeSpan, iconCss: 'e-icons e-chevron-right-fill' })); }
        }
    ];
    return (React.createElement("div", { className: "control-pane" },
        React.createElement("div", { className: "control-section" },
            React.createElement(ej2_react_gantt_1.GanttComponent, { id: "Timezone", ref: ganttInstance, dataSource: timezoneData, taskFields: taskFields, timelineSettings: timelineSettings, toolbar: toolbar, height: "650px", taskbarHeight: 25, rowHeight: 46, timezone: getTimeZonesWithOffsets()[0].id, durationUnit: "Hour", includeWeekend: true, treeColumnIndex: 1, dayWorkingTime: dayWorkingTime },
                ...
                React.createElement(ej2_react_gantt_1.Inject, { services: [ej2_react_gantt_1.Selection, ej2_react_gantt_1.Toolbar] }))),
        ...
        React.createElement("div", { id: "description" },
            ...
            React.createElement("p", null,
                "When a user sets any timezone, dates are converted based on the value set to the ",
