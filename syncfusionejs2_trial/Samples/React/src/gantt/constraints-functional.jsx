...
const Constraints = () => {
    ...
    const projectEndDate = new Date("09/06/2025");
    const eventMarkers = [
    ...
    return (<div className="control-pane">
      <div className="control-section">
        <GanttComponent id="Constraint" dataSource={constraintData} taskFields={taskFields} editSettings={editSettings} toolbar={toolbar} allowSelection={true} gridLines="Both" highlightWeekends={true} height='650px' taskbarHeight={25} rowHeight={46} treeColumnIndex={1} labelSettings={labelSettings} splitterSettings={splitterSettings} projectStartDate={projectStartDate} projectEndDate={projectEndDate} eventMarkers={eventMarkers}>
          <ColumnsDirective>
            <ColumnDirective field="TaskID" visible={false}/>
            <ColumnDirective field="TaskName" headerText="Job Name" width="230" clipMode="EllipsisWithTooltip"/>
