...
const LoadingAnimation = () => {
    ...
    const projectEndDate = new Date('09/21/2025');
    return (<div className='control-pane'>
      <div className='col-md-9'>
        <GanttComponent id='LoadingAnimation' ref={ganttInstance} dataSource={virtualData} treeColumnIndex={1} labelSettings={labelSettings} allowSelection={true} allowFiltering={true} allowSorting={true} highlightWeekends={true} enableVirtualization={true} projectEndDate={projectEndDate} taskFields={taskFields} splitterSettings={splitterSettings} height='650px' taskbarHeight={25} rowHeight={46} loadingIndicator={loadingIndicator}>
          <ColumnsDirective>
          ...
          <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
            <tbody>
              <tr>
                ...
                <td style={{ width: '70%' }}>
                  <div>
                    <DropDownListComponent width="113px" id="seltype" change={onChange} dataSource={filterType} value="Shimmer"/>
                  </div>
                </td>
              </tr>
            </tbody>
