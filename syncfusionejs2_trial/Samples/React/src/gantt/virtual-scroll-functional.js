...
var Virtualscroll = function () {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement(ej2_react_gantt_1.GanttComponent, { id: 'VirtualScroll', dataSource: data_1.virtualData, treeColumnIndex: 1, labelSettings: labelSettings, allowSelection: true, highlightWeekends: true, enableVirtualization: true, enableTimelineVirtualization: true, taskFields: taskFields, splitterSettings: splitterSettings, height: '650px', taskbarHeight: 25, rowHeight: 46, projectStartDate: projectStartDate, projectEndDate: projectEndDate },
