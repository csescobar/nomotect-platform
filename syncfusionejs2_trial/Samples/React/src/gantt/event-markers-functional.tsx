...
import { GanttComponent, TaskFieldsModel, Inject, EventMarkersDirective, EventMarkerDirective, Selection, DayMarkers, ColumnDirective, ColumnsDirective, LabelSettingsModel, SplitterSettingsModel, TimelineSettingsModel } from '@syncfusion/ej2-react-gantt';
