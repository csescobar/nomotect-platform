...
var LoadingAnimation = function () {
    ...
    var projectEndDate = new Date('09/21/2025');
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'col-md-9' },
            React.createElement(ej2_react_gantt_1.GanttComponent, { id: 'LoadingAnimation', ref: ganttInstance, dataSource: data_1.virtualData, treeColumnIndex: 1, labelSettings: labelSettings, allowSelection: true, allowFiltering: true, allowSorting: true, highlightWeekends: true, enableVirtualization: true, projectEndDate: projectEndDate, taskFields: taskFields, splitterSettings: splitterSettings, height: '650px', taskbarHeight: 25, rowHeight: 46, loadingIndicator: loadingIndicator },
                React.createElement(ej2_react_gantt_1.ColumnsDirective, null,
                    React.createElement(ej2_react_gantt_1.ColumnDirective, { field: 'TaskID', width: 100 }),
                    React.createElement(ej2_react_gantt_1.ColumnDirective, { field: 'TaskName', headerText: 'Task Name', width: "300px" }),
                    React.createElement(ej2_react_gantt_1.ColumnDirective, { field: 'StartDate', width: 170 }),
                        ...
                        React.createElement("tr", null,
                            ...
                            React.createElement("td", { style: { width: '70%' } },
                                React.createElement("div", null,
                                    React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { width: "113px", id: "seltype", change: onChange, dataSource: filterType, value: "Shimmer" })))))))),
        ...
        React.createElement("div", { id: "description" },
            ...
            React.createElement("p", null,
                "Gantt component features are segregated into individual feature-wise modules. To use virtualscroll, Filter, sorting and selection features, we need to inject ",
            ...
            React.createElement("p", null,
                ...
                React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/gantt/loading-animation" }, "documentation section"),
                "."))));
};
