...
export class LoadingAnimation extends SampleBase {
    ...
    render() {
        ...
        <div className='col-md-9'>
          <GanttComponent id='LoadingAnimation' ref={gantt => this.ganttInstance = gantt} dataSource={virtualData} treeColumnIndex={1} labelSettings={this.labelSettings} allowSelection={true} allowFiltering={true} allowSorting={true} highlightWeekends={true} enableVirtualization={true} projectEndDate={this.projectEndDate} taskFields={this.taskFields} splitterSettings={this.splitterSettings} height='650px' taskbarHeight={25} rowHeight={46} loadingIndicator={this.loadingIndicator}>
            <ColumnsDirective>
