...
var TimelineTemplate = function () {
    ...
    var weekDate = function (dateString) {
        var _a;
        var date = ((_a = ganttInstance.current) === null || _a === void 0 ? void 0 : _a.locale) === 'ar' ? parseArabicDate(dateString) : parseDateString(dateString);
    ...
    var imageString = function (date) {
        var _a;
        var imageDate = ((_a = ganttInstance.current) === null || _a === void 0 ? void 0 : _a.locale) === 'ar' ? parseArabicDate(date) : parseDateString(date);
    ...
    var projectStartDate = new Date('03/29/2025 01:00:00 PM');
    var projectEndDate = new Date('04/23/2025');
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement(ej2_react_gantt_1.GanttComponent, { id: 'TimelineTemplate', ref: ganttInstance, dataSource: data_1.timelineTemplateData, splitterSettings: splitterSettings, taskFields: taskFields, height: '650px', taskbarHeight: 25, rowHeight: 46, projectStartDate: projectStartDate, projectEndDate: projectEndDate, timelineSettings: timelineSettings, timelineTemplate: timelineTemplate, labelSettings: labelSettings, treeColumnIndex: 1 },
