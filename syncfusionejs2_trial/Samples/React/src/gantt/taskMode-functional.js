...
var TaskMode = function () {
    ...
    var projectStartDate = new Date('02/18/2025');
    var projectEndDate = new Date('03/30/2025');
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement(ej2_react_gantt_1.GanttComponent, { id: 'TaskMode', dataSource: data_1.taskModeData, treeColumnIndex: 1, allowSelection: true, highlightWeekends: true, toolbar: toolbar, editSettings: editSettings, splitterSettings: splitterSettings, height: '650px', taskbarHeight: 25, rowHeight: 46, taskMode: 'Custom', taskFields: taskFields, labelSettings: labelSettings, projectStartDate: projectStartDate, projectEndDate: projectEndDate, validateManualTasksOnLinking: true },
                React.createElement(ej2_react_gantt_1.ColumnsDirective, null,
                    React.createElement(ej2_react_gantt_1.ColumnDirective, { field: 'TaskID', visible: false }),
                    React.createElement(ej2_react_gantt_1.ColumnDirective, { field: 'TaskName', headerText: 'Task Name', width: '130' }),
                    React.createElement(ej2_react_gantt_1.ColumnDirective, { field: 'isManual', headerText: 'Task Mode', width: '120' })),
        ...
        React.createElement("div", { id: "description" },
            ...
            React.createElement("p", null,
                "Gantt component features are segregated into individual feature-wise modules. To use editing, selection, markers and toolbar features, we need to inject the ",
            ...
            React.createElement("p", null,
                ...
                React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/gantt/scheduling-tasks" }, "documentation section"),
                "."))));
};
