...
import { GanttComponent, TaskFieldsModel, Inject, Selection, DayMarkers, DurationUnit, ColumnsDirective, ColumnDirective, TimelineSettingsModel, LabelSettingsModel, SplitterSettingsModel } from '@syncfusion/ej2-react-gantt';
...
const WorkingTimeRange = () => {
  ...
  const projectEndDate: Date = new Date('04/15/2025');
  const perform = (): void => {
