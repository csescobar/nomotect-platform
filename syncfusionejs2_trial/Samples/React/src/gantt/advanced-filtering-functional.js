...
var AdvancedFiltering = function () {
    ...
    var projectEndDate = new Date('06/21/2025');
    var splitterSettings = { columnIndex: 2 };
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section', style: { paddingTop: '0px', paddingBottom: '60px' } },
            React.createElement("div", { id: 'ganttsidebar-parent' },
                ...
                React.createElement(ej2_react_gantt_1.GanttComponent, { id: 'AdvancedFiltering', ref: ganttRef, dataSource: data_1.projectNewData, treeColumnIndex: 0, allowFiltering: true, includeWeekend: true, projectStartDate: projectStartDate, projectEndDate: projectEndDate, taskFields: taskFields, splitterSettings: splitterSettings, labelSettings: labelSettings, height: '650px', taskbarHeight: 25, rowHeight: 46, rowSelected: rowSelected },
                    React.createElement(ej2_react_gantt_1.ColumnsDirective, null,
                        React.createElement(ej2_react_gantt_1.ColumnDirective, { field: 'TaskID', headerText: 'Task ID', width: '120' }),
        ...
        React.createElement("div", { id: "description" },
            ...
            React.createElement("p", null,
                "Gantt component features are segregated into individual feature-wise modules. To use filtering and selection features, we need to inject ",
