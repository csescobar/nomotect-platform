...
var SplitTasks = /** @class */ (function (_super) {
    ...
    function SplitTasks() {
        ...
        _this.projectStartDate = new Date('01/29/2025');
        _this.projectEndDate = new Date('04/20/2025');
        return _this;
    }
    SplitTasks.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { id: "description" },
                ...
                React.createElement("p", null,
                    "Gantt component features are segregated into individual feature-wise modules. To use selection, edit, toolbar, and context menu features, we need to inject the ",
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/gantt/managing-tasks/splitting-and-merging-tasks" }, "documentation section"),
                    "."))));
    };
    return SplitTasks;
