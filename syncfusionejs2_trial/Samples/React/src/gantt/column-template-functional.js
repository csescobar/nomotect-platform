...
var ColumnTemplate = function () {
    ...
    var projectStartDate = new Date('03/24/2025');
    var projectEndDate = new Date('06/01/2025');
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement(ej2_react_gantt_1.GanttComponent, { id: 'ColumnTemplate', rowHeight: 60, resourceFields: resourceFields, resources: data_1.editingResources, dataSource: data_1.templateData, highlightWeekends: true, treeColumnIndex: 1, splitterSettings: splitterSettings, taskFields: taskFields, labelSettings: labelSettings, height: '650px', taskbarHeight: 25, projectStartDate: projectStartDate, projectEndDate: projectEndDate },
