...
export class Constraints extends SampleBase {
    ...
    RightLabelTemplate(props) {
        const value = props.ganttProperties.constraintType;
        const map = {
    ...
    render() {
        ...
        <div className="control-section">
          <GanttComponent id="Constraint" dataSource={constraintData} taskFields={this.taskFields} editSettings={this.editSettings} toolbar={this.toolbar} allowSelection={true} gridLines="Both" highlightWeekends={true} height='650px' taskbarHeight={25} rowHeight={46} treeColumnIndex={1} labelSettings={this.labelSettings} splitterSettings={this.splitterSettings} projectStartDate={this.projectStartDate} projectEndDate={this.projectEndDate} eventMarkers={this.eventMarkers}>
            <ColumnsDirective>
