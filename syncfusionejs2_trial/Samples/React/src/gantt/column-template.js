...
var ColumnTemplate = /** @class */ (function (_super) {
    ...
    function ColumnTemplate() {
        ...
        _this.projectStartDate = new Date('03/24/2025');
        _this.projectEndDate = new Date('06/01/2025');
        return _this;
    }
    ColumnTemplate.prototype.columnTemplate = function (props) {
        ...
        if ((props.ganttProperties.resourceNames)) {
            ...
            if (gantt.enableRtl) {
                ...
                return (React.createElement("div", { className: 'columnTemplate' },
                    React.createElement("img", { src: src, height: '40px', width: '40px', alt: props.ganttProperties.resourceNames }),
                    React.createElement("div", { style: { display: "inline-block", width: '100%', position: "relative", left: "10px" } }, props.ganttProperties.resourceNames)));
            }
        }
        else {
    ...
    ColumnTemplate.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_gantt_1.GanttComponent, { id: 'ColumnTemplate', rowHeight: 60, resourceFields: this.resourceFields, resources: data_1.editingResources, dataSource: data_1.templateData, highlightWeekends: true, treeColumnIndex: 1, splitterSettings: this.splitterSettings, taskFields: this.taskFields, labelSettings: this.labelSettings, height: '650px', taskbarHeight: 25, projectStartDate: this.projectStartDate, projectEndDate: this.projectEndDate },
                    React.createElement(ej2_react_gantt_1.ColumnsDirective, null,
                        React.createElement(ej2_react_gantt_1.ColumnDirective, { field: 'TaskID', headerText: 'Task ID', width: '100', textAlign: "Left" }),
                        React.createElement(ej2_react_gantt_1.ColumnDirective, { field: 'TaskName', headerText: 'Name', width: '280' }),
            ...
            React.createElement("div", { id: "description" },
                ...
                React.createElement("p", null,
                    "In this demo, using column template, the resource column is presented with employee photos. The ",
                    React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/angular/documentation/api/gantt/columnModel/#template" }, "columns -> template"),
                    " property is used to customize the column display."),
                React.createElement("p", null,
                    "Gantt component features are segregated into individual feature-wise modules. To use selection, we need to inject the ",
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/gantt/columns/column-template" }, "documentation section"),
                    "."))));
    };
