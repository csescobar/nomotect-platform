...
var UnscheduledTask = /** @class */ (function (_super) {
    ...
    function UnscheduledTask() {
        ...
        _this.projectStartDate = new Date('12/29/2024');
        _this.projectEndDate = new Date('02/14/2025');
        return _this;
    }
    ...
    UnscheduledTask.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_gantt_1.GanttComponent, { id: 'Unscheduled', ref: function (gantt) { return _this.ganttInstance = gantt; }, dataSource: data_1.unscheduledData, taskFields: this.taskFields, height: '650px', taskbarHeight: 25, rowHeight: 46, editSettings: this.editSettings, allowSelection: true, toolbar: this.toolbar, labelSettings: this.labelSettings, highlightWeekends: true, allowUnscheduledTasks: true, toolbarClick: this.toolbarClickEvent.bind(this), splitterSettings: this.splitterSettings, columns: this.columns, projectStartDate: this.projectStartDate, projectEndDate: this.projectEndDate },
                    React.createElement(ej2_react_gantt_1.Inject, { services: [ej2_react_gantt_1.Toolbar, ej2_react_gantt_1.Edit, ej2_react_gantt_1.Selection, ej2_react_gantt_1.DayMarkers] }))),
            ...
            React.createElement("div", { id: "description" },
                React.createElement("p", null,
                    ...
                    React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/api/gantt#allowunscheduledtasks" }, "allowUnscheduledTasks"),
                ...
                React.createElement("p", null,
                    "Gantt component features are segregated into individual feature-wise modules. To use a toolbar, selection and add features, we need to inject the ",
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/gantt/scheduling-tasks#enable-unscheduled-tasks" }, "documentation section"),
                    "."))));
    };
