...
export class TimelineTemplate extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
          <GanttComponent id='TimelineTemplate' ref={gantt => this.ganttInstance = gantt} dataSource={timelineTemplateData} highlightWeekends={true} splitterSettings={this.splitterSettings} taskFields={this.taskFields} height='650px' taskbarHeight={25} rowHeight={46} labelSettings={this.labelSettings} projectStartDate={this.projectStartDate} projectEndDate={this.projectEndDate} timelineSettings={this.timelineSettings} timelineTemplate={this.timelineTemplate} treeColumnIndex={1}>
            <ColumnsDirective>
