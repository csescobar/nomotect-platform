...
export class LocalData extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
          <GanttComponent id='LocalData' dataSource={localData} highlightWeekends={true} allowSelection={true} treeColumnIndex={1} taskFields={this.taskFields} labelSettings={this.labelSettings} height='650px' taskbarHeight={25} rowHeight={46} splitterSettings={this.splitterSettings} projectStartDate={this.projectStartDate} projectEndDate={this.projectEndDate}>
            <ColumnsDirective>
