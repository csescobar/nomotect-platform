...
var Taskbar = function () {
    ...
    var eventMarkerDay1 = new Date('03/05/2025 07:09:00 PM');
    var eventMarkerDay2 = new Date('03/05/2025 07:46:00 PM');
    var eventMarkerDay3 = new Date('03/05/2025 07:59:00 PM');
    var eventMarkerDay4 = new Date('03/05/2025 08:08:00 PM');
    var eventMarkerDay5 = new Date('03/05/2025 08:24:00 PM');
    var eventMarkerDay6 = new Date('03/05/2025 08:31:00 PM');
    var eventMarkerDay7 = new Date('03/05/2025 08:47:00 PM');
    var labelSettings = {
        leftLabel: 'TaskName',
    };
    ...
    var milestoneTemplate = function (props) {
    ...
    var milestone = milestoneTemplate.bind(_this);
    var projectStartDate = new Date('03/05/2025 06:00 PM');
    var projectEndDate = new Date('03/05/2025 09:50 PM');
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement(ej2_react_gantt_1.GanttComponent, { id: 'TaskbarTemplate', dataSource: data_1.customizedData, dateFormat: 'hh:mm a', taskFields: taskFields, height: '650px', splitterSettings: splitterSettings, treeColumnIndex: 1, rowHeight: 75, taskbarHeight: 65, dayWorkingTime: dayWorkingTime, durationUnit: 'Minute', timelineSettings: timelineSettings, labelSettings: labelSettings, tooltipSettings: tooltipSettings, milestoneTemplate: milestone, taskbarTemplate: childTaskbarTemplate, projectStartDate: projectStartDate, projectEndDate: projectEndDate, allowSelection: true },
