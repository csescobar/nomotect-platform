...
var ReorderColumn = function () {
    ...
    var projectStartDate = new Date('03/31/2025');
    var projectEndDate = new Date('07/20/2025');
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement("div", { className: 'col-md-9' },
                React.createElement(ej2_react_gantt_1.GanttComponent, { id: 'ReorderColumn', treeColumnIndex: 1, allowReordering: true, ref: ganttObj, splitterSettings: splitterSettings, actionComplete: actionComplete.bind(_this), dataSource: data_1.projectNewData, highlightWeekends: true, taskFields: taskFields, labelSettings: labelSettings, height: '650px', taskbarHeight: 25, rowHeight: 46, projectStartDate: projectStartDate, projectEndDate: projectEndDate },
        ...
        React.createElement("div", { id: "description" },
            ...
            React.createElement("p", null,
                "Gantt component features are segregated into individual feature-wise modules. To use reordering and selection features, we need to inject ",
            ...
            React.createElement("p", null,
                ...
                React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/gantt/columns/column-reordering" }, "documentation section"),
                "."))));
};
