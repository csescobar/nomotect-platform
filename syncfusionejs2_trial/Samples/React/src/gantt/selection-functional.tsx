...
import { GanttComponent, TaskFieldsModel, Inject, Selection, LabelSettingsModel, SplitterSettingsModel, SelectionSettingsModel } from '@syncfusion/ej2-react-gantt';
