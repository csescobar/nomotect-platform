...
import { GanttComponent, TaskFieldsModel, Inject, Selection, Toolbar, ExcelExport, PdfExport, ColumnsDirective, ColumnDirective, PdfExportProperties, DayMarkers, CriticalPath, ResourceFieldsModel, SplitterSettingsModel, GridLine, ToolbarItem, TimelineSettingsModel, LabelSettingsModel, EventMarkerModel, HolidayModel } from '@syncfusion/ej2-react-gantt';
...
const AdvancedExporting = () => {
  ...
  let isFitToWidth: boolean = false;
      ...
      <div id="description">
        ...
        <ul>
          ...
          <li>
            ...
            using
            <a target="_blank"
              href="https://ej2.syncfusion.com/documentation/api/gantt/pdfexportproperties#ganttstyle"> ganttstyle </a>
            in <a target="_blank"
              href="https://ej2.syncfusion.com/react/documentation/api/gantt/pdfExportProperties"> pdfExportProperties </a>.
          </li>
          <li>
