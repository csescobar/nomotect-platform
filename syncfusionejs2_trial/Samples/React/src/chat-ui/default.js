        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { id: "description" },
                React.createElement("p", null,
                    "In this example, two Chat UI web component are used to represent users ",
                    ...
                    React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/api/chat-ui/#messagesend" }, "messageSend"),
                    " event, while typing indicators are shown in the other chat interface via the ",
                    React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/api/chat-ui/#usertyping" }, "userTyping"),
                    " event, adding a more interactive feel. The toolbar for each chat includes a dropdown menu with options like muting and deleting messages, demonstrating the component\u2019s ability to customize and control the chat experience."))));
    };
    return Default;
