                        ...
                        React.createElement("div", { className: 'chat-usecase-leftPane' },
                            ...
                            React.createElement("div", { id: "toggle-chat-list", className: "toggle-chat-listview e-card" },
                                React.createElement("div", { id: "listview_template", tabIndex: 1, style: { border: 'none' } },
                                    React.createElement(ej2_react_lists_1.ListViewComponent, { dataSource: data["integrationListTemplateData"], template: this.template, headerTitle: "Chats", cssClass: "e-list-template", showHeader: true, select: function (args) { return _this.handleSelect(args); }, ref: function (listview) { return (_this.listviewInst = listview); } })))),
                        React.createElement("div", { className: 'chat-usecase-rightPane' },
                            React.createElement(ej2_react_interactive_chat_1.ChatUIComponent, { id: "integration-chat", style: { border: 'none', height: 'inherit' }, headerText: "Albert", headerIconCss: "chat_user1_avatar", messages: this.chatMessages.user1, user: { id: 'user1', user: 'Albert', avatarUrl: './src/chat-ui/images/andrew.png' }, headerToolbar: userToolbarSettings, messageSend: function (args) { return _this.handleMessageSend(args); }, ref: function (chatUI) { return (_this.chatUiInst = chatUI); } }))))),
