    ...
    render() {
        ...
        <div className="control-section chat-ui">
          <div className="attachment-chatui">
            <ChatUIComponent ref={this.chatRef} headerText="Paul Wilson (You)" headerIconCss="chat_user_avatar" user={this.state.user} messages={this.state.messages} headerToolbar={this.headerToolbar} emptyChatTemplate={`
