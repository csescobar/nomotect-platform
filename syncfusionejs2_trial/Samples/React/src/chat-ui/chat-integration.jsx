                            ...
                            <div className='chat-usecase-leftPane'>
                                ...
                                <div id="toggle-chat-list" className="toggle-chat-listview e-card">
                                    <div id="listview_template" tabIndex={1} style={{ border: 'none' }}>
                                        <ListViewComponent dataSource={data["integrationListTemplateData"]} template={this.template} headerTitle="Chats" cssClass="e-list-template" showHeader={true} select={(args) => this.handleSelect(args)} ref={listview => (this.listviewInst = listview)}/>
                                    </div>
                                </div>
                            </div>
                            <div className='chat-usecase-rightPane'>
                                <ChatUIComponent id="integration-chat" style={{ border: 'none', height: 'inherit' }} headerText="Albert" headerIconCss="chat_user1_avatar" messages={this.chatMessages.user1} user={{ id: 'user1', user: 'Albert', avatarUrl: './src/chat-ui/images/andrew.png' }} headerToolbar={userToolbarSettings} messageSend={(args) => this.handleMessageSend(args)} ref={chatUI => (this.chatUiInst = chatUI)}/>
                            </div>
                        </SplitterComponent>
                    </div>
                </div>
