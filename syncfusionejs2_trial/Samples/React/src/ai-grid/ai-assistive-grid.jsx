...
import { GridComponent, ColumnsDirective, ColumnDirective, Inject, Toolbar, Sort, Filter, Group, Page, Search } from '@syncfusion/ej2-react-grids';
...
function AIAssistiveGrid() {
    ...
    return (<div>
            <div id='assistive-grid'>
                <DialogComponent ref={(dialogIns) => dialog = dialogIns} target='#ai-grid' id='ai-assist-dialog' width='500px' visible={false} height='500px' footerTemplate={dialogFooterTemplate} created={created}>
                ...
                <GridComponent ref={(gridIns) => grid = gridIns} id="ai-grid" height={650} dataSource={purchaseDetails} allowFiltering={true} allowSorting={true} allowGrouping={true} filterSettings={filterSettings} allowPaging={true} toolbar={toolbarOptions} toolbarClick={toolbarClick}>
                    <ColumnsDirective>
