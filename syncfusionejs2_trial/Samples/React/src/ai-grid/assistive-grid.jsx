    ...
    render() {
        return (<div className='control-pane'>
                ...
                <div id="action-description">
                    ...
                    <p>To explore this and more Syncfusion React Smart AI integrations locally, check out our <a target='_blank' href='https://github.com/syncfusion/smart-ai-samples/tree/master/react/src/ai-components/grid/assistive-grid' aria-label="Navigate to explore the syncfusion React AI Demos repository">GitHub repository</a>.</p>
                </div>
                <div id='description'>
