...
function AIAssistiveGrid() {
    ...
    var onPromptRequest = function (args) {
        assistView.stopResponding.classList.remove('e-btn-active');
        ...
        (0, AIModel_1.fetchAI)(args.prompt, grid, dialog, assistView, columns);
    };
        ...
        return (React.createElement("div", { className: "e-suggestions" },
            ...
            React.createElement("div", { className: "e-suggestion-list" },
                React.createElement("ul", { ref: suggestionListRef },
                    React.createElement("li", null, "Find iPhone 15 Pro"),
                    React.createElement("li", null, "Sort Amount from lowest to highest"),
                    React.createElement("li", null, "Payment status not completed"),
                    React.createElement("li", null, "Group status column"),
                    React.createElement("li", null, "Clear Filtering"),
                    React.createElement("li", null, "Clear Sorting"),
                    React.createElement("li", null, "Remove Grouping")))));
    };
    var filterSettings = { type: 'Excel' };
    return (React.createElement("div", null,
        React.createElement("div", { id: 'assistive-grid' },
            React.createElement(ej2_react_popups_1.DialogComponent, { ref: function (dialogIns) { return dialog = dialogIns; }, target: '#ai-grid', id: 'ai-assist-dialog', width: '500px', visible: false, height: '500px', footerTemplate: dialogFooterTemplate, created: created },
            ...
            React.createElement(ej2_react_grids_1.GridComponent, { ref: function (gridIns) { return grid = gridIns; }, id: "ai-grid", height: 650, dataSource: datasource_1.purchaseDetails, allowFiltering: true, allowSorting: true, allowGrouping: true, filterSettings: filterSettings, allowPaging: true, toolbar: toolbarOptions, toolbarClick: toolbarClick },
                ...
                React.createElement(ej2_react_grids_1.Inject, { services: [ej2_react_grids_1.Toolbar, ej2_react_grids_1.Sort, ej2_react_grids_1.Filter, ej2_react_grids_1.Group, ej2_react_grids_1.Page, ej2_react_grids_1.Search] })))));
}
