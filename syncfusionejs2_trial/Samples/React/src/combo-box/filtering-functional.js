    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement("div", { className: 'col-lg-8' },
                React.createElement("div", { id: 'filtering', style: { paddingTop: '50px' } },
                    React.createElement(ej2_react_dropdowns_1.ComboBoxComponent, { id: "country", dataSource: searchData, filtering: onFiltering.bind(_this), allowFiltering: true, fields: fields, placeholder: "Select a country", popupHeight: "270px", debounceDelay: debounceDelay }))),
        ...
        React.createElement("div", { id: "description" },
            React.createElement("p", null,
                ...
                " method to display its list items. The debounce delay, in milliseconds, for filtering items in the ComboBox component can be set using the ",
                React.createElement("a", { href: "https://ej2.syncfusion.com/react/documentation/api/combo-box/#debouncedelay", target: "_blank" }, "debounceDelay"),
                " property."),
            React.createElement("p", null,
