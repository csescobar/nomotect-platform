...
export class PasteSettings extends SampleBase {
    blockEditorRef = React.createRef();
    formatOptionRef = React.createRef();
    deniedTagsRef = React.createRef();
    pasteSettings = {
    ...
    deniedTagChange = () => {
        if (!this.deniedTagsRef.current?.value)
            return;
        this.onPasteCleanupSettingsChange(this.deniedTagsRef.current.value);
    };
    onPasteCleanupSettingsChange = (value) => {
        if (!this.blockEditorRef.current) {
            return;
        }
        if (value) {
        ...
        return (<div className='control-pane'>
                <div className="col-lg-8 control-section">
                    <div className="blockeditor-paste">
                        <BlockEditorComponent ref={this.blockEditorRef} id='block-editor' height="600px" blocks={data["blockDataPaste"]} pasteCleanupSettings={this.pasteSettings}/>
                    </div>
                </div>
                            ...
                            <table id="property" title="Properties">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <DropDownListComponent id='formatOption' ref={this.formatOptionRef} dataSource={this.formatData} change={this.formatChange} value={this.value} fields={this.fields} popupHeight={this.height}/>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <TextBoxComponent ref={this.deniedTagsRef} cssClass="e-input" placeholder="'img[!href]', 'h1'" blur={this.deniedTagChange}/>
                                            </div>
                                        </td>
                                    </tr>
