...
const PasteSettings = () => {
    ...
    const deniedTagChange = () => {
        if (!deniedTagsRef.current?.value)
            return;
    ...
    return (<div className='control-pane'>
            <div className="col-lg-8 control-section">
                <div className="blockeditor-paste">
                    ...
                    <BlockEditorComponent ref={blockEditorRef} id='block-editor' height="600px" blocks={data["blockDataPaste"]} pasteCleanupSettings={pasteSettings}/>
                </div>
            </div>
                        ...
                        <table id="property" title="Properties">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <DropDownListComponent id='formatOption' ref={formatOptionRef} dataSource={formatData} change={formatChange} value={value} fields={fields} popupHeight={height}/>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <TextBoxComponent ref={deniedTagsRef} cssClass="e-input" placeholder="'img[!href]', 'h1'" blur={deniedTagChange}/>
                                        </div>
                                    </td>
                                </tr>
