...
var Exporting = /** @class */ (function (_super) {
    ...
    function Exporting() {
        ...
        _this.today = new Date().toLocaleDateString('en-US', {
            month: 'short',
            day: '2-digit',
            year: 'numeric'
        });
            ...
            var excelExportProperties = {
                ...
                footer: {
                    ...
                    rows: [
                        ...
                        { cells: [{ colSpan: 10, value: "Report generated on: ".concat(this.today), style: { fontColor: '#1B4965', fontSize: 15, hAlign: 'Center', bold: true } }] }
                    ]
                }
            };
            ...
            var pdfExportProperties = {
                ...
                footer: {
                    ...
                    contents: [
                        ...
                        {
                            type: 'Text',
                            value: "Report generated on: ".concat(this.today),
                            position: { x: 385, y: 25 },
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement("div", { className: 'col-lg-8 adaptive' },
                    React.createElement(ej2_react_pivotview_1.PivotViewComponent, { id: 'PivotView', ref: function (pivotview) { _this.pivotObj = pivotview; }, dataSourceSettings: dataSourceSettings, allowExcelExport: true, allowPdfExport: true, showFieldList: true, width: '100%', height: '350', gridSettings: { columnWidth: 140 }, allowConditionalFormatting: true },
                                ...
                                React.createElement("tr", { style: { height: '50px' } },
                                    ...
                                    React.createElement("td", null,
                                        React.createElement("div", { style: { paddingLeft: 0 } },
                                            React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { id: "etype", value: "pdf", ref: function (d) { return _this.mode = d; }, dataSource: this.exportType, fields: { text: 'text', value: 'value' }, placeholder: "PDF" })))),
                                React.createElement("tr", { style: { height: '50px' } },
                                    React.createElement("td", null),
                                    React.createElement("td", null,
