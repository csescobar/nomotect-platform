...
function SparkLine() {
    ...
    return (<div className='control-pane'>
            <div className='control-section' id='pivot-table-section'>
                <PivotViewComponent id='PivotView_sparkline' ref={(pivotview) => { pivotObj = pivotview; }} dataSourceSettings={dataSourceSettings} width={'100%'} height={'450'} gridSettings={gridSettings} showTooltip={false} dataBound={onDataBound}>
                </PivotViewComponent>
            </div>
