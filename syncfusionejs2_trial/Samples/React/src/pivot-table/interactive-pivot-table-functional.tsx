...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <soap:Body>
    ...
    const resolveEndpoint = (endpoint: string) => {
        ...
        if (!proxyBaseUrl) return trimmed; // direct
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                            ...
                            <div className="olap-row">
                                ...
                                <DropDownListComponent
                                    ...
                                    disabled={!olapConnected || loadingSources}
                                    change={async (e) => {
                                        const v = e.value;
                            ...
                            <div className="olap-row">
                                ...
                                <DropDownListComponent
                                    ...
                                    disabled={!selectedDataSource || loadingCatalogs}
                                    change={async (e) => {
                                        const v = e.value;
                            ...
                            <div className="olap-row">
                                ...
                                <DropDownListComponent
                                    ...
                                    disabled={!selectedCatalog || loadingCubes}
                                    change={async (e) => {
                                        const v = e.value;
                                        setSelectedCube(v);
