...
var TabularLayout = /** @class */ (function (_super) {
    __extends(TabularLayout, _super);
    function TabularLayout() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TabularLayout.prototype.onChange = function (args) {
        this.pivotObj.gridSettings.layout = this.pivotObj.gridSettings.layout === 'Compact' ? 'Tabular' : 'Compact';
    };
    TabularLayout.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section', style: { overflow: 'initial' } },
                ...
                React.createElement("div", null,
                    React.createElement(ej2_react_pivotview_1.PivotViewComponent, { id: 'PivotView', ref: function (scope) { _this.pivotObj = scope; }, dataSourceSettings: dataSourceSettings, showGroupingBar: true, showFieldList: true, width: '100%', height: '450', gridSettings: { columnWidth: ej2_base_1.Browser.isDevice ? 100 : 140, layout: 'Tabular' } },
...
exports.TabularLayout = TabularLayout;
