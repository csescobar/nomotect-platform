...
let chartData = ['Line', 'Column', 'Area', 'WinLoss'];
let obj = {};
let sparkline;
...
export class SparkLine extends SampleBase {
    ...
    onDataBound() {
        if (isDropDownExist) {
            ...
            let chartTypeDropDown = new DropDownList({
                floatLabelType: 'Auto',
    ...
    render() {
        return (<div className='control-pane'>
                <div className='control-section' id='pivot-table-section'>
                    <PivotViewComponent id='PivotView_sparkline' ref={(pivotview) => { this.pivotObj = pivotview; }} dataSourceSettings={dataSourceSettings} width={'100%'} height={'450'} gridSettings={this.gridSettings} showTooltip={false} dataBound={this.onDataBound}>
                    </PivotViewComponent>
                </div>
                ...
                <div id="description">
                    <p>This sample demonstrates how to embed <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/sparkline/getting-started/">Sparkline</a> charts within the
                        Pivot Table's grand total cells to visually summarize yearly sales performance across different regions.</p>
                    <p>The charts are rendered by capturing relevant cell values during the <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/pivotview/row-and-column#querycellinfo">queryCellInfo</a>
                        event and inserting the sparklines after the Pivot Table is fully rendered via the <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/pivotview/#databound">dataBound</a> event.
                    </p>
                    <p>
