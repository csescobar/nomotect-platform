...
import ExternalDataBasedFiltering from './external-data-based-filtering-functional';
...
import PivotTableExporting from './pivot-table-exporting-functional';
export const pivottableRoutes = (<>
         ...
         <Route path='/:theme/pivot-table/dynamic-binding' Component={DynamicBinding}/>
         ...
         <Route path='/:theme/pivot-table/pivot-chart-fieldlist' Component={PivotChartFieldList}/>
         ...
         <Route path='/:theme/pivot-table/sparkline' Component={SparkLine}/>
         ...
         <Route path='/:theme/pivot-table/external-data-based-filtering' Component={ExternalDataBasedFiltering}/>
         ...
         <Route path='/:theme/pivot-table/pivot-table-exporting' Component={PivotTableExporting}/>
