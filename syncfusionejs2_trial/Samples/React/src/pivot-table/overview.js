...
var PivotOverview = /** @class */ (function (_super) {
    ...
    PivotOverview.prototype.excelQueryCellInfo = function (args) {
        if ((args === null || args === void 0 ? void 0 : args.cell).axis === 'value' && args.value === undefined) {
            args.style.numberFormat = undefined;
        }
    };
    PivotOverview.prototype.load = function (args) {
            ...
            React.createElement("div", { className: 'control-section', id: 'pivot-table-section', style: { overflow: 'initial' } },
                React.createElement("div", null,
                    React.createElement(ej2_react_pivotview_1.PivotViewComponent, { id: 'PivotView', ref: function (scope) { _this.pivotObj = scope; }, dataSourceSettings: dataSourceSettings, width: '100%', height: '600', showFieldList: true, exportAllPages: false, maxNodeLimitInMemberEditor: 50, cellTemplate: this.cellTemplate.bind(this), showGroupingBar: true, allowGrouping: true, enableVirtualization: true, enableValueSorting: true, allowDeferLayoutUpdate: true, allowDrillThrough: true, gridSettings: {
                        ...
                        }, allowExcelExport: true, allowNumberFormatting: true, allowConditionalFormatting: true, allowPdfExport: true, showToolbar: true, allowCalculatedField: true, displayOption: { view: 'Both' }, toolbar: this.toolbarOptions, newReport: this.newReport.bind(this), renameReport: this.renameReport.bind(this), removeReport: this.removeReport.bind(this), loadReport: this.loadReport.bind(this), fetchReport: this.fetchReport.bind(this), saveReport: this.saveReport.bind(this), toolbarRender: this.beforeToolbarRender.bind(this), load: this.load.bind(this), chartSettings: { title: 'Top Universities Analysis', load: this.chartOnLoad.bind(this) }, chartSeriesCreated: this.chartSeriesCreated.bind(this), enableFieldSearching: true },
