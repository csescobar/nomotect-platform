  ...
  <soap:Body>
    ...
    return (<div className='control-pane'>
            ...
            handleOpenRemote();
                ...
                <PivotViewComponent id='PivotView' ref={(scope) => { pivotObj = scope; }} dataSourceSettings={dataSourceSettings} width={'100%'} height={500} showFieldList showToolbar allowCalculatedField={true} allowPdfExport={true} allowExcelExport={true} allowNumberFormatting={true} allowConditionalFormatting={true} toolbar={toolbarOptions} toolbarRender={toolbarRender} dataBound={onDataBound} enginePopulated={onEnginePopulated} displayOption={{ view: 'Both' }} gridSettings={{ columnWidth: Browser.isDevice ? 100 : 120 }}>
