...
function TabularLayout() {
    ...
    return (<div className='control-pane'>
            <div className='control-section' style={{ overflow: 'initial' }}>
                ...
                <div>
                    <PivotViewComponent id='PivotView' ref={(scope) => { pivotObj = scope; }} dataSourceSettings={dataSourceSettings} showGroupingBar={true} showFieldList={true} width={'100%'} height={'450'} gridSettings={{ columnWidth: Browser.isDevice ? 100 : 140, layout: 'Tabular' }}>
            ...
            <div id="description">
                ...
                <p>
                    More information on the Essential JS2 Pivot Table can be found in this <a target="_blank" href="https://ej2.syncfusion.com/documentation/pivotview/getting-started#adding-pivot-table-component">
