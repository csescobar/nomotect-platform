...
var dynamic_binding_functional_1 = require("./dynamic-binding-functional");
var performance_functional_1 = require("./performance-functional");
var pivot_chart_functional_1 = require("./pivot-chart-functional");
var pivot_chart_fieldlist_functional_1 = require("./pivot-chart-fieldlist-functional");
...
var sparkline_functional_1 = require("./sparkline-functional");
...
var external_data_based_filtering_functional_1 = require("./external-data-based-filtering-functional");
...
var pivot_table_exporting_functional_1 = require("./pivot-table-exporting-functional");
exports.pivottableRoutes = (React.createElement(React.Fragment, null,
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/pivot-table/dynamic-binding', Component: dynamic_binding_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/pivot-table/pivot-chart-fieldlist', Component: pivot_chart_fieldlist_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/pivot-table/sparkline', Component: sparkline_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/pivot-table/external-data-based-filtering', Component: external_data_based_filtering_functional_1.default }),
