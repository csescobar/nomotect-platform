...
export class PivotTableExporting extends SampleBase {
    pivotObj;
    toolbarOptions = ['Chart', 'FieldList'];
    toolbarRender(args) {
    ...
    onDataBound() {
        ...
        if (document.querySelector('#grid_menu .e-menu-item') == null) {
            ...
            new Menu({ items: menuItems, select: this.gridToolbarClicked }, '#grid_menu');
        }
    }
    toolbarClicked() {
    ...
    render() {
        return (<div className='control-pane'>
                <div className='control-section'>
                    <PivotViewComponent id='PivotView' ref={d => this.pivotObj = d} dataSourceSettings={dataSourceSettings} width={'100%'} height={'450'} showToolbar={true} allowPdfExport={true} gridSettings={{ columnWidth: Browser.isDevice ? 100 : 120 }} showFieldList={true} showGroupingBar={true} allowDataCompression={true} allowExcelExport={true} displayOption={{ view: 'Both' }} toolbar={this.toolbarOptions} chartSettings={{
                ...
                <div id="description">
                    ...
                    <p>The Pivot Table uses a server-side pivot engine powered by the <a target="_blank" href="https://www.nuget.org/packages/Syncfusion.Pivot.Engine/"> Syncfusion.Pivot.Engine</a> package. This
                        engine runs on a separate hosted server, performing all pivot operations—including <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/pivotview/aggregation/#aggregation">
                        ...
                        using the <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/pivotview/dataSourceSettings/#url">
