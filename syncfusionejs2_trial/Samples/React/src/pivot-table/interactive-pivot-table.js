...
function InteractivePivotTableView() {
    ...
    var _g = (0, react_1.useState)(data_source_1.Pivot_Data), currentData = _g[0], setCurrentData = _g[1];
    var _h = (0, react_1.useState)('https://bi.syncfusion.com/olap/msmdpump.dll'), olapProxyUrl = _h[0], setOlapProxyUrl = _h[1];
    var proxyBaseUrl = (0, react_1.useState)('')[0]; // reserved for proxy usage if needed
    ...
    var applyReportSettings = function (pivot, reportSettings, isOlapReport) { return __awaiter(_this, void 0, void 0, function () {
        var maybeDataUrl, maybeCsvUrl, res, jsonData, arr, res, csvString, csvArray, _e_1;
        var _a;
                ...
                switch (_j.label) {
                    ...
                    case 1:
                        ...
                        looksLikeReport = !Array.isArray(unwrappedData)
                            && ((unwrappedData === null || unwrappedData === void 0 ? void 0 : unwrappedData.dataSourceSettings) || (unwrappedData === null || unwrappedData === void 0 ? void 0 : unwrappedData.rows) || (unwrappedData === null || unwrappedData === void 0 ? void 0 : unwrappedData.columns) || (unwrappedData === null || unwrappedData === void 0 ? void 0 : unwrappedData.values) || (unwrappedData === null || unwrappedData === void 0 ? void 0 : unwrappedData.url) || (unwrappedData === null || unwrappedData === void 0 ? void 0 : unwrappedData.providerType));
                        if (!looksLikeReport) return [3 /*break*/, 4];
                        reportSettings = (_f = unwrappedData.dataSourceSettings) !== null && _f !== void 0 ? _f : unwrappedData;
                        isOlapReport = ((_g = reportSettings) === null || _g === void 0 ? void 0 : _g.providerType) === 'SSAS';
                        if (pivot)
                            resetPivot();
                    ...
                    case 4:
                        dataArray = Array.isArray(unwrappedData) ? unwrappedData : ((_h = unwrappedData === null || unwrappedData === void 0 ? void 0 : unwrappedData.data) !== null && _h !== void 0 ? _h : unwrappedData);
    ...
    var applyOlapBinding = function (opts) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            ...
            olapDataSourceSettings = {
                ...
                providerType: 'SSAS',
                cube: cube,
                localeIdentifier: 1033, dataSource: [], rows: [], columns: [], values: []
            };
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 3:
                                                ...
                                                setOlapUiMessage("Connect failed: ".concat(e_1.message, ".").concat(corsHint));
                                                setOlapConnected(false);
                                                setOlapDataSources([]);
                                                return [3 /*break*/, 5];
                                            case 4:
...
var InteractivePivotTable = /** @class */ (function (_super) {
    __extends(InteractivePivotTable, _super);
    function InteractivePivotTable() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    InteractivePivotTable.prototype.render = function () {
        return React.createElement(InteractivePivotTableView, null);
    };
    return InteractivePivotTable;
