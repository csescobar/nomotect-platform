...
var SparkLine = /** @class */ (function (_super) {
    ...
    function SparkLine() {
        ...
        _this.gridSettings = {
            columnWidth: 110,
            rowHeight: 70,
            queryCellInfo: _this.queryCellInfo.bind(_this),
            columnRender: _this.columnRender.bind(_this),
            headerCellInfo: _this.headerCellInfo.bind(_this)
        };
        return _this;
    }
    SparkLine.prototype.queryCellInfo = function (args) {
    ...
    SparkLine.prototype.headerCellInfo = function (args) {
        var _a, _b, _c;
    ...
    SparkLine.prototype.columnRender = function (args) {
    ...
    SparkLine.prototype.onDataBound = function () {
        var _this = this;
        if (isDropDownExist) {
    ...
    SparkLine.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section', id: 'pivot-table-section' },
                React.createElement(ej2_react_pivotview_1.PivotViewComponent, { id: 'PivotView_sparkline', ref: function (pivotview) { _this.pivotObj = pivotview; }, dataSourceSettings: dataSourceSettings, width: '100%', height: '450', gridSettings: this.gridSettings, showTooltip: false, dataBound: this.onDataBound })),
