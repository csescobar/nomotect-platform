...
import { PivotViewComponent, IDataOptions, IDataSet, Inject, Toolbar, PDFExport, ExcelExport, FieldList } from '@syncfusion/ej2-react-pivotview';
...
function ClassicLayout() {
    ...
    let pivotObj: any;
    let repeatLabelSwitch: any;
    let toolbarOptions: any = ['Export', 'FieldList'];
    function onChange() {
