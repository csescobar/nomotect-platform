...
function PivotChartFieldList() {
    ...
    return (<div className="control-pane">
            ...
            <div className="control-section" style={{ overflow: 'auto' }}>
                <div style={{ width: '100%' }}>
                    <ToolbarComponent ref={d => toolbarObj = d} id="defaultToolbar" height="50px" clicked={ToolbarCliked} items={toolbarItems} beforeCreate={() => beforeCreate()}></ToolbarComponent>
                </div>
                <div id='pivot_sidebar' className='maincontent' style={{ width: '100%', height: '720px' }}>
                    <div id='pivot_container' style={{ width: '64%' }}>
                        <PivotViewComponent id='PivotView' ref={d => pivotObj = d} enginePopulated={afterPivotPopulate.bind(this)} actionBegin={actionBegin.bind(this)} dataBound={onPivotDataBound.bind(this)} width={'100%'} height={'350'} gridSettings={{ columnWidth: 140 }} chartSettings={{ title: 'Sales Analysis', chartSeries: { type: 'Column' }, load: chartOnLoad.bind(this) }} displayOption={{ view: 'Both', primary: 'Chart' }} toolbar={toolbarOptions} showToolbar={true}>
                            <Inject services={[PivotChart, Toolbar, FieldList]}/>
                        </PivotViewComponent>
                    </div>
                </div>
                <aside>
                    <SidebarComponent ref={d => sideObj = d} height={'100%'} id='defaultSidebar' className='default-sidebar' target=".maincontent" type="Auto" isOpen={true} position="Right" enableGestures={false} change={() => onChange()}>
