...
import { PivotViewComponent, PivotFieldListComponent, Inject, CalculatedField, PivotChart, Toolbar, FieldList } from '@syncfusion/ej2-react-pivotview';
...
let displayOptionDropDown;
let primaryViewDropDown;
                ...
                displayOptionDropDown = new DropDownList({
                    ...
                    change: (args) => {
                        ...
                        if (args.value !== 'Both') {
                            ...
                            this.pivotObj.displayOption = { view: args.value };
                        }
                ...
                primaryViewDropDown = new DropDownList({
                    ...
                    change: (args) => {
                        ...
                        if (this.pivotObj.displayOption.view == 'Both') {
                            this.pivotObj.displayOption = { view: 'Both', primary: args.value };
                            this.pivotObj.refresh();
                        }
                    }
                });
    ...
    render() {
        return (<div className="control-pane">
                ...
                <div className="control-section" style={{ overflow: 'auto' }}>
                    <div style={{ width: '100%' }}>
                        <ToolbarComponent id="defaultToolbar" ref={d => this.toolbarObj = d} height="50px" clicked={this.ToolbarCliked.bind(this)} items={this.toolbarItems} beforeCreate={() => this.beforeCreate()}></ToolbarComponent>
                    </div>
                    <div id='pivot_sidebar' className='maincontent' style={{ width: '100%', height: '720px' }}>
                         <div id='pivot_container' style={{ width: '64%' }}>
                            <PivotViewComponent id='PivotView' ref={d => this.pivotObj = d} enginePopulated={this.afterPivotPopulate.bind(this)} actionBegin={this.actionBegin.bind(this)} dataBound={this.onPivotDataBound.bind(this)} width={'100%'} height={'350'} gridSettings={{ columnWidth: 140 }} chartSettings={{ title: 'Sales Analysis', chartSeries: { type: 'Column' }, load: this.chartOnLoad.bind(this) }} displayOption={{ view: 'Both', primary: 'Chart' }} toolbar={this.toolbarOptions} showToolbar={true}>
                            <Inject services={[PivotChart, Toolbar, FieldList]}/>
                            </PivotViewComponent>
                         </div>
                    </div>
                    <aside>
                        <SidebarComponent ref={d => this.sideObj = d} height={'100%'} id='defaultSidebar' className='default-sidebar' target=".maincontent" type="Auto" isOpen={true} position="Right" enableGestures={false} change={() => this.onChange()}>
                ...
                <div id="description">
                    ...
                    <p>
                        ...
                        configurable using the <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/pivotview/displayOptionModel/#view">displayOption.view</a> property:
                    </p>
                    <table>
                        <tbody>
                            <tr>
