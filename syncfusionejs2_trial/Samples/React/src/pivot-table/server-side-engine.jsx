...
import { PivotViewComponent, Inject, FieldList, GroupingBar, Toolbar, PDFExport, ExcelExport } from '@syncfusion/ej2-react-pivotview';
...
export class ServerSideEngine extends SampleBase {
    pivotObj;
    toolbarOptions = ['Export', 'FieldList'];
    dataSourceSettings = {
    ...
    onDataBound() {
        ...
        if (document.querySelector('#grid_menu .e-menu-item') == null) {
            ...
            new Menu({ items: menuItems, select: this.gridToolbarClicked.bind(this) }, '#grid_menu');
        }
    }
    gridToolbarClicked(args) {
    ...
    getExcelExportProperties(excelExportProperties) {
    ...
    getPdfExportProperties(pdfExportProperties) {
    ...
    render() {
        return (<div className='control-pane'>
                <div className='control-section'>
                    <PivotViewComponent id='PivotView' ref={d => this.pivotObj = d} dataSourceSettings={this.dataSourceSettings} showFieldList={true} showGroupingBar={true} width={'100%'} height={'450'} dataBound={this.onDataBound.bind(this)} allowDataCompression={true} showToolbar={true} allowPdfExport={true} allowExcelExport={true} gridSettings={{ columnWidth: Browser.isDevice ? 100 : 120, layout: 'Tabular' }} toolbarRender={this.beforeToolbarRender.bind(this)} toolbar={this.toolbarOptions} beforeExport={this.beforeExport.bind(this)}>
                ...
                <div id="description">
                    ...
                    <p>
                        For further performance improvements when working with large data volumes, we recommend enabling <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/pivotview/#enablevirtualization">
