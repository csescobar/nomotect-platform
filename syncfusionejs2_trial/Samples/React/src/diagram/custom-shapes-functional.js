...
function HtmlNode() {
    ...
    return (React.createElement("div", { className: "control-pane" },
        React.createElement("div", { id: "custom-diagram", className: "control-section" },
            React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "diagram", ref: function (diagram) { return (diagramInstance = diagram); }, width: "100%", backgroundColor: '#f5f5f5', height: "1100px", nodes: nodes, created: function (args) { rendereComplete(); }, nodeTemplate: template.bind(this), load: function () { load(); } })),
