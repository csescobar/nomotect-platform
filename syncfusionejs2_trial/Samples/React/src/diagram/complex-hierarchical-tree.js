...
var ComplexHierarchicalModel = /** @class */ (function (_super) {
    ...
    ComplexHierarchicalModel.prototype.render = function () {
        return (React.createElement("div", { className: "control-pane diagram-control-pane diagram-complex" },
            ...
            React.createElement("div", { className: "col-lg-4 property-section" },
                ...
                React.createElement("div", { className: "row property-panel-content", id: "appearance", ref: function (appearance) { return (propertyPanelInstance = appearance); }, style: { paddingTop: "10px" } },
                    ...
                    React.createElement("div", { className: "row", style: { paddingTop: "8px" } }, ["toptobottom", "bottomtotop", "lefttoright"].map(function (id, index) { return (React.createElement("div", { className: "image-pattern-style".concat(index === 0 ? "e-selected-style" : ""), id: id, key: id, style: {
                ...
                React.createElement("div", { className: "row property-panel-content", style: { paddingTop: "10px" } },
                    ...
                    [
                        ...
                        return (React.createElement("div", { key: id, className: "row", style: { paddingTop: "8px" } },
