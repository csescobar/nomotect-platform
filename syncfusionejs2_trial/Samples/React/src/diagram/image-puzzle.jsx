...
function onCreated() {
    ...
    setTimeout(() => {
        // show diagram
        const container = document.querySelector('.diagram-puzzle-container');
        if (container) {
...
export class ImagePuzzle extends SampleBase {
    ...
    render() {
        return (<div className="control-pane diagram-puzzle-container" style={{ opacity: 0 }}>
            <style>{SAMPLE_CSS}</style>
            <div className="control-section">
                <div className="content-wrapper" style={{ width: '100%' }}>
                    <DiagramComponent id="diagram" ref={(diagramref) => (diagram = diagramref)} height="800px" nodes={nodes} constraints={DiagramConstraints.Default & ~DiagramConstraints.UndoRedo} snapSettings={{
