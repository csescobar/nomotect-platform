...
import { DiagramComponent, Diagram, BpmnDiagrams, UndoRedo, NodeConstraints, DiagramTools, SymbolPalette, SymbolPaletteComponent, } from "@syncfusion/ej2-react-diagrams";
          ...
          <div id="toolbarContainer">
            ...
            <div id='toggleSwitchContainer'>
              <div id="switch-container" ref={(switchContainer) => (switchContainerRef = switchContainer)}>
                ...
                <TooltipComponent id="switch_tooltip_digram" ref={(switchTooltip) => (switchTooltipRef = switchTooltip)} content="Enable Editing" position="TopCenter">
