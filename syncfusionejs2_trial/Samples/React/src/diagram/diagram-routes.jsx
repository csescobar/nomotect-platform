...
import ContainerSample from './container-functional';
...
import VisioImportExport from './visio-import-export-functional';
...
import EntityRelationshipDiagram from './entity-relationship-diagram-functional';
...
import ShortestPathVisualizerDiagram from './shortest-path-visualizer-functional';
import TournamentBracket from './tournament-bracket-functional';
import TicketBookingDiagram from './ticket-booking-functional';
import SpiralDiagram from './spiral-diagram-functional';
import ImagePuzzle from './image-puzzle-functional';
import PeriodicTable from './periodic-table-functional';
import HistoryTimelineDiagramComponent from './history-timeline-functional';
import FunnelDiagram from './funnel-diagram-functional';
import FamilyTreeDiagram from './family-tree-functional';
import SerpentineDiagram from './serpentine-diagram-functional';
import AngleDiagram from './angle-diagram-functional';
import PipelineInstrumentationDiagram from './pipeline-instrumentation-diagram-functional';
import NeuralNetworkDiagram from './neural-network-functional';
...
export const diagramRoutes = (<>
         ...
         <Route path='/:theme/diagram/container' Component={ContainerSample}/>
         ...
         <Route path='/:theme/diagram/visio-import-export' Component={VisioImportExport}/>
         ...
         <Route path='/:theme/diagram/entity-relationship-diagram' Component={EntityRelationshipDiagram}/>
         ...
         <Route path='/:theme/diagram/shortest-path-visualizer' Component={ShortestPathVisualizerDiagram}/>
         <Route path='/:theme/diagram/tournament-bracket' Component={TournamentBracket}/>
         <Route path='/:theme/diagram/ticket-booking' Component={TicketBookingDiagram}/>
         <Route path='/:theme/diagram/spiral-diagram' Component={SpiralDiagram}/>
         <Route path='/:theme/diagram/image-puzzle' Component={ImagePuzzle}/>
         <Route path='/:theme/diagram/periodic-table' Component={PeriodicTable}/>
         <Route path='/:theme/diagram/history-timeline' Component={HistoryTimelineDiagramComponent}/>
         <Route path='/:theme/diagram/funnel-diagram' Component={FunnelDiagram}/>
         <Route path='/:theme/diagram/family-tree' Component={FamilyTreeDiagram}/>
         <Route path='/:theme/diagram/serpentine-diagram' Component={SerpentineDiagram}/>
         <Route path='/:theme/diagram/angle-diagram' Component={AngleDiagram}/>
         <Route path='/:theme/diagram/pipeline-instrumentation-diagram' Component={PipelineInstrumentationDiagram}/>
         <Route path='/:theme/diagram/neural-network' Component={NeuralNetworkDiagram}/>
