...
exports.NeuralNetworkDiagram = void 0;
...
var NeuralNetworkDiagram = /** @class */ (function (_super) {
    __extends(NeuralNetworkDiagram, _super);
    function NeuralNetworkDiagram() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    NeuralNetworkDiagram.prototype.rendereComplete = function () {
        if (diagramInstance) {
            diagramInstance.fitToPage();
        }
    };
    NeuralNetworkDiagram.prototype.render = function () {
        return (React.createElement("div", { className: "control-pane" },
            React.createElement("div", { className: "control-section neural-network-container", style: { opacity: 0 } },
                React.createElement("div", { style: { width: "100%" } },
                    React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "diagram", ref: function (diagram) { return (diagramInstance = diagram); }, width: "100%", height: "600px", nodes: nodes, connectors: connectors, snapSettings: { constraints: ej2_react_diagrams_1.SnapConstraints.None }, tool: ej2_react_diagrams_1.DiagramTools.ZoomPan, created: function () {
                            diagramInstance.fitToPage();
                            setTimeout(function () {
                                // show diagram
                                var container = document.querySelector('.neural-network-container');
                                if (container) {
