...
function ERDiagram() {
    const [diagramCreated, setDiagramCreated] = React.useState<boolean>(false);
    ...
    const onUserHandleMouseDown = (args: UserHandleEventsArgs) => {
        if (args.element) {
    ...
    const contextMenuOpen = (args: DiagramBeforeMenuOpenEventArgs) => {
        let hiddenId: string[] = [];
