...
import { DiagramComponent, Inject, UndoRedo, SnapConstraints, ConnectorBridging, NodeConstraints, DiagramTools, PortVisibility, FlipDirection } from '@syncfusion/ej2-react-diagrams';
...
function PipelineInstrumentationDiagram() {
    ...
    return (<div className="control-pane">
            <div className="control-section diagram-pipeline" style={{ width: "100%", opacity: showDiagram ? 1 : 0 }}>
                ...
                <DiagramComponent id="diagram" ref={(diagram) => (diagramInstance = diagram)} width={'100%'} height={'700px'} nodes={pipelineModel.nodes} connectors={pipelineModel.connectors} tool={DiagramTools.ZoomPan} snapSettings={{ constraints: SnapConstraints.None }} getNodeDefaults={getNodeDefaults} getConnectorDefaults={getConnectorDefaults} created={() => {
            appendHTMLElements();
