...
function AngleDiagram() {
    ...
    var _b = initializeDiagram(), nodes = _b.nodes, connectors = _b.connectors;
    React.useEffect(function () {
        (0, sample_base_1.updateSampleSection)();
    }, []);
    return (React.createElement("div", { className: "control-pane diagram-control-pane", style: { opacity: diagramCreated ? 1 : 0 } },
        React.createElement("style", null, sampleCss),
        React.createElement("div", { className: "control-section angle-diagram-container", style: { width: '100%' } },
            React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "diagram", ref: function (diagramref) { return (diagram = diagramref); }, width: '100%', height: '750px', snapSettings: { constraints: ej2_react_diagrams_1.SnapConstraints.None }, selectedItems: { constraints: ej2_react_diagrams_1.SelectorConstraints.Rotate }, nodes: nodes, connectors: connectors, scrollChange: function () {
                    var _a;
