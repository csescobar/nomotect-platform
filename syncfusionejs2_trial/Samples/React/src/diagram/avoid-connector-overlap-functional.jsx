...
function AvoidConnectorOverlapDiagram() {
    ...
    return (<div className="control-pane">
            <div className="control-section">
                <div style={{ width: "100%" }}>
                    <DiagramComponent id="diagram" ref={diagramRef} width={"100%"} height={"580"} snapSettings={{ constraints: SnapConstraints.None }} constraints={DiagramConstraints.Default | DiagramConstraints.LineRouting | DiagramConstraints.AvoidLineOverlapping} nodes={nodes} connectors={connectors} tool={DiagramTools.ZoomPan} created={() => diagramRef.current.fitToPage()}>
