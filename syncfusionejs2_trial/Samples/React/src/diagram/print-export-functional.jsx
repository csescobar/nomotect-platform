...
const exportItems = [{ text: "JPG" }, { text: "PNG" }, { text: "SVG" }];
...
function PrintExport() {
    ...
    // Handlers
    const onItemClick = React.useCallback((args) => {
    ...
    const onSelectExportFormat = React.useCallback((args) => {
    ...
    const checkboxTemplate = React.useCallback(() => {
        return (<CheckBoxComponent id="checkBox" checked={false} label="Multiple Page" ref={(checkBox) => (checkBoxRef.current = checkBox)}/>);
    }, []);
    return (<div className="control-pane">
            ...
            <div className="control-section">
                <div style={{ width: "100%" }}>
                    ...
                    {/* Diagram */}
                    <DiagramComponent id="diagram_print_export" ref={(diagram) => (diagramRef.current = diagram)} width={"100%"} height={"580px"} nodes={nodes} connectors={connectors} snapSettings={{ constraints: SnapConstraints.None }} pageSettings={{ width: 550, height: 500, multiplePage: true }} getConnectorDefaults={(connector, _diagram) => {
