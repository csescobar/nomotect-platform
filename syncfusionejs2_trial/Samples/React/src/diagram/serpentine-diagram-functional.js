...
function SerpentineDiagram() {
    var diagramInstance = React.useRef(null);
    var _a = React.useState(0.65), currentZoom = _a[0], setCurrentZoom = _a[1];
    React.useEffect(function () {
        (0, sample_base_1.updateSampleSection)();
        var handleResize = function () { return renderSerpentineLayout(); };
        window.addEventListener('resize', handleResize);
        requestAnimationFrame(function () {
            var diagram = diagramInstance.current;
            if (!diagram)
                return;
    ...
    var createDecorator = function (color, pivotX) { return ({
        shape: 'Custom',
        width: 20,
        height: 30,
        pivot: { x: pivotX },
    ...
    var renderSerpentineLayout = function () {
        var diagram = diagramInstance.current;
    ...
    var handleZoom = function (level) {
        var diagram = diagramInstance.current;
        if (!diagram)
            return;
        var currentZoomValue = diagram.scrollSettings.currentZoom || 1;
        var zoomFactor = level / currentZoomValue;
        var focusPoint = {
            x: diagram.scrollSettings.viewPortWidth / 2,
            y: diagram.scrollSettings.viewPortHeight / 2
        };
        ...
        React.createElement("div", { className: "control-section" },
            React.createElement("div", { className: "content-wrapper", style: { width: "100%" } },
                ...
                React.createElement("div", { className: "zoom-controls-container", style: { padding: '0 0 15px 0', textAlign: 'center' } }, Object.keys(ZOOM_FACTORS).map(function (id) {
                    ...
                    return (React.createElement(ej2_react_buttons_1.ButtonComponent, { key: id, id: id, isPrimary: currentZoom === level, onClick: function () { return handleZoom(level); } },
                        level,
                        "x"));
                })),
                React.createElement("div", null,
                    React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "serpentineDiagram", ref: diagramInstance, width: "100%", height: "600px", className: "diagram-container", snapSettings: { constraints: ej2_react_diagrams_1.SnapConstraints.None }, scrollSettings: { scrollableArea: SCROLL_AREA, padding: SCROLL_PADDING }, tool: ej2_react_diagrams_1.DiagramTools.ZoomPan, nodes: [], connectors: [] })))),
...
exports.default = SerpentineDiagram;
