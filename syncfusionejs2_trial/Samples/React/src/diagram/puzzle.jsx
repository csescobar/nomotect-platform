...
import { DiagramComponent, Node, NodeConstraints, SnapConstraints, SelectorConstraints } from '@syncfusion/ej2-react-diagrams';
import { SampleBase } from "../common/sample-base";
let diagram;
let gameBoard = new Array(16);
let emptyIndex = 0;
let moveCount = 0;
let gameTimer = null;
...
function moveTileToEmptySpace(tileNumber) {
    ...
    moveCount++;
    const node = diagram.getObject(`tile${tileNumber}`);
    if (node) {
...
export class InteractiveImagePuzzle extends SampleBase {
    componentDidMount() {
        diagram.fitToPage();
        setTimeout(() => {
    ...
    render() {
        return (<div className="control-pane diagram-puzzle-container">
            <style>{SAMPLE_CSS}</style>
            <div className="control-section">
                <div className="content-wrapper" style={{ width: '100%' }}>
                    <DiagramComponent id="diagram" ref={(diagramref) => (diagram = diagramref)} height="800px" nodes={nodes} snapSettings={{
                ...
                cursor: 'pointer',
                color: '#ccc'
            }} title="Close" onClick={closeWinDialog}>✕</div>
                ...
                <div id="action-description">
                    <p>
                        This sample showcases an interactive sliding image puzzle game built using the Syncfusion<sup>®</sup> EJ2 Diagram component, transforming images into a 4x4 grid of draggable tiles, with features like move and time tracking.                    </p>
                </div>
                <div id="description">
                    <p>
