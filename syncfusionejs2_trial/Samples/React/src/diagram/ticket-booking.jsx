        ...
        <div className="control-section">
          ...
          <div className="show-timing-section" style={{ margin: "20px 0" }}>
            <ul className="timing-list" style={{ display: "flex", gap: 16, listStyle: "none", justifyContent: "center" }}>
              ...
              {showTimings.map((timing) => (<li key={timing.id} onClick={() => this.onTimingClick(timing)} data-timing={timing.id} className={`timing-item ${timing.status} ${selectedTimingId === timing.id ? "selected" : ""}`} style={{ pointerEvents: timing.status === "sold-out" ? "none" : "auto", cursor: "pointer" }}>
