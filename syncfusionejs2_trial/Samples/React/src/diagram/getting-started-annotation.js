...
var GettingStartedAnnotation = /** @class */ (function (_super) {
    ...
    GettingStartedAnnotation.prototype.render = function () {
        return (React.createElement("div", { className: "control-pane diagram-control-pane diagram-annotation" },
                            ...
                            if (arg.state === "Changed") {
                                ...
                                if (arg.newValue[0]) {
                                    ...
                                    if (annotations && annotations.length > 0) {
                                        ...
                                        var hasInteraction = (node_1.annotations[0].constraints & ej2_react_diagrams_1.AnnotationConstraints.Interaction) === ej2_react_diagrams_1.AnnotationConstraints.Interaction;
                                        labelConstraintsInstance.disabled = false;
                                        labelConstraintsInstance.checked = hasInteraction;
                                    }
                                    else {
                                        labelConstraintsInstance.disabled = true;
                                        labelConstraintsInstance.checked = false;
                                    }
                                }
                                else {
                            ...
                            React.createElement("div", { className: "row property-panel-content", id: "appearance", ref: function (appearance) { return (appearanceInstance = appearance); } },
                                ...
                                React.createElement("div", { className: "row" },
                                    React.createElement("div", { className: "row", style: { paddingTop: "8px" } },
                                        React.createElement("div", { className: "image-pattern-style", id: "left", style: {
                                                backgroundImage: "url('(https://ej2.syncfusion.com/react/demos/diagram/Images/annotation/Annotation_1.png')",
                                                marginRight: "4px"
                                            } }),
                                        React.createElement("div", { className: "image-pattern-style", id: "right", style: {
                                                backgroundImage: "url('(https://ej2.syncfusion.com/react/demos/diagram/Images/annotation/Annotation_2.png')",
                                                margin: "0px 4px"
                                            } }),
                                        React.createElement("div", { className: "image-pattern-style", id: "bottomLeft", style: {
                                                backgroundImage: "url('(https://ej2.syncfusion.com/react/demos/diagram/Images/annotation/Annotation_3.png')"
                                            } })),
                                    React.createElement("div", { className: "row", style: { paddingTop: "8px" } },
                                        React.createElement("div", { className: "image-pattern-style", id: "bottomRight", style: {
                                                backgroundImage: "url('(https://ej2.syncfusion.com/react/demos/diagram/Images/annotation/Annotation_4.png')",
                                                margin: "0px 4px"
                                            } }),
                                        React.createElement("div", { className: "image-pattern-style", id: "center", style: {
                                                backgroundImage: "url('(https://ej2.syncfusion.com/react/demos/diagram/Images/annotation/Annotation_5.png')",
                                                marginRight: "4px"
                                            } }),
                                        React.createElement("div", { className: "image-pattern-style", id: "bottomCenter", style: {
                                                backgroundImage: "url('(https://ej2.syncfusion.com/react/demos/diagram/Images/annotation/Annotation_6.png')"
                                            } }))),
                                React.createElement("div", { className: "row property-panel-content", style: { paddingTop: "10px", overflow: "hidden" } },
                                    ...
                                    React.createElement("div", { className: "row", style: { paddingTop: "8px" } },
                                        ...
                                        React.createElement("div", { className: "col-xs-4 column-style" },
                                            React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { id: "fontSize", value: 12, min: 1, max: 50, step: 1, format: "##.##", change: function () {
                                                    changed("fontsize");
                                    ...
                                    React.createElement("div", { className: "row", style: { paddingTop: "10px" } },
                                        ...
                                        React.createElement("div", { className: "row col-xs-8", style: { paddingLeft: "0px", paddingTop: "8px" } },
                                            React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { id: "diagramAnnotationTemplate", fields: this.fields, popupWidth: 200, width: "100%", placeholder: "Select a template", dataSource: templateList, change: function () {
                                                    changed("template");
                                                }, ref: function (template) { return (templateData = template); } }))),
                                    React.createElement("div", { className: "row", style: { paddingTop: "10px" } },
                                        React.createElement("div", { className: "row row-header" }, "Behaviour"),
                                        React.createElement("div", { className: "row", style: { paddingTop: "8px" } },
                                            React.createElement(ej2_react_buttons_1.CheckBoxComponent, { id: "labelConstraints", label: "Label constraints", checked: false, change: function () { changed("interaction"); }, ref: function (labelConstraints) { return (labelConstraintsInstance = labelConstraints); } }))))))))),
