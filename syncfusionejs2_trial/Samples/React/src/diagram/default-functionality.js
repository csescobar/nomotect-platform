                    ...
                    React.createElement("div", { className: "db-toolbar-container" },
                        React.createElement(ej2_react_navigations_1.ToolbarComponent, { ref: function (toolbar) { return (toolbarEditor = toolbar); }, id: "toolbar_diagram", clicked: toolbarClick, overflowMode: 'Scrollable', width: '100%' },
                            React.createElement(ej2_react_navigations_1.ItemsDirective, null,
                                ...
                                React.createElement(ej2_react_navigations_1.ItemDirective, { prefixIcon: "e-icons e-export", type: "Input", tooltipText: 'Export Diagram', align: "Left", id: "Export", template: this.dropDown }),
                                ...
                                React.createElement(ej2_react_navigations_1.ItemDirective, { type: "Input", tooltipText: 'Change Connector Type', align: "Left", id: "Draw_con", template: this.connector }),
                                ...
                                React.createElement(ej2_react_navigations_1.ItemDirective, { disabled: true, type: "Input", tooltipText: 'Align Objects', cssClass: 'tb-item-middle tb-item-lock-category', align: "Left", id: "Align_objects", template: this.alignments }),
                                React.createElement(ej2_react_navigations_1.ItemDirective, { disabled: true, type: "Input", tooltipText: 'Distribute Objects', cssClass: 'tb-item-middle tb-item-lock-category', align: "Left", id: "Distribute_objects", template: this.distribute }),
                                React.createElement(ej2_react_navigations_1.ItemDirective, { type: 'Separator' }),
                                React.createElement(ej2_react_navigations_1.ItemDirective, { disabled: true, type: "Input", tooltipText: 'Order Commands', cssClass: 'tb-item-middle tb-item-lock-category', align: "Left", id: "Order", template: this.order }),
                                React.createElement(ej2_react_navigations_1.ItemDirective, { type: 'Separator' }),
                                React.createElement(ej2_react_navigations_1.ItemDirective, { disabled: true, type: "Input", tooltipText: 'Group/Ungroup', cssClass: 'tb-item-middle tb-item-lock-category', align: "Left", id: "Group", template: this.group }),
                                React.createElement(ej2_react_navigations_1.ItemDirective, { type: 'Separator' }),
                                React.createElement(ej2_react_navigations_1.ItemDirective, { disabled: true, type: "Input", tooltipText: 'Rotate', cssClass: 'tb-item-middle tb-item-lock-category', align: "Left", id: "Rotate", template: this.rotate }),
                                React.createElement(ej2_react_navigations_1.ItemDirective, { type: 'Separator' }),
                                React.createElement(ej2_react_navigations_1.ItemDirective, { disabled: true, type: "Input", tooltipText: 'Flip', cssClass: 'tb-item-middle tb-item-lock-category', align: "Left", id: "Flip", template: this.flip }),
                                React.createElement(ej2_react_navigations_1.ItemDirective, { type: 'Separator' }),
                                React.createElement(ej2_react_navigations_1.ItemDirective, { type: "Input", cssClass: 'tb-item-end tb-zoom-dropdown-btn', align: "Left", id: "Zoom", template: this.zoom })))),
