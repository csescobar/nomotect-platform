...
function ImagePuzzle() {
    ...
    return (React.createElement("div", { className: "control-pane diagram-puzzle-container", style: { opacity: showDiagram ? 1 : 0 } },
