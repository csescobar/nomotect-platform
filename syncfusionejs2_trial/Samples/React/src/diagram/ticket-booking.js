...
exports.TicketBookingDiagram = void 0;
...
var TicketBookingDiagram = /** @class */ (function (_super) {
    __extends(TicketBookingDiagram, _super);
    function TicketBookingDiagram() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TicketBookingDiagram.prototype.rendereComplete = function () {
        if (diagramInstance) {
    ...
    TicketBookingDiagram.prototype.onTimingClick = function (timing) {
    ...
    TicketBookingDiagram.prototype.render = function () {
        var _this = this;
        var _a;
            ...
            React.createElement("div", { className: "control-section" },
                ...
                React.createElement("div", { className: "show-timing-section", style: { margin: "20px 0" } },
                    React.createElement("ul", { className: "timing-list", style: { display: "flex", gap: 16, listStyle: "none", justifyContent: "center" } },
                        ...
                        showTimings.map(function (timing) { return (React.createElement("li", { key: timing.id, onClick: function () { return _this.onTimingClick(timing); }, "data-timing": timing.id, className: "timing-item ".concat(timing.status, " ").concat(selectedTimingId === timing.id ? "selected" : ""), style: { pointerEvents: timing.status === "sold-out" ? "none" : "auto", cursor: "pointer" } },
    ...
    return TicketBookingDiagram;
}(sample_base_1.SampleBase));
exports.TicketBookingDiagram = TicketBookingDiagram;
