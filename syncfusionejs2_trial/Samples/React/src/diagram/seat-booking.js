...
exports.SeatBookingDiagram = void 0;
...
var ticketCount = selectedSeatsArray.length;
...
function bindTimingClicks() {
    ...
    timingItems.forEach(function (item) {
        var timingId = parseInt(item.getAttribute("data-timing") || '0');
...
function handleProceed() {
    ...
    var totalAmount = (seatSelection.Amount !== null ? seatSelection.Amount + 50 : 50).toFixed(2);
...
var SeatBookingDiagram = /** @class */ (function (_super) {
    __extends(SeatBookingDiagram, _super);
    function SeatBookingDiagram() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    SeatBookingDiagram.prototype.renderComplete = function () {
        if (diagramInstance) {
    ...
    SeatBookingDiagram.prototype.render = function () {
        var _a;
            ...
            React.createElement("div", { className: "control-section" },
                    ...
                    React.createElement("h2", null,
                        React.createElement("div", null,
                            React.createElement("span", { className: "movie-name" },
                                React.createElement("a", { className: "movie-name-lnk", href: "" }, movieTitle))),
                        React.createElement("div", null,
                ...
                React.createElement("div", { className: "show-timing-section", style: { margin: "20px 0" } },
                    React.createElement("ul", { className: "timing-list", style: { display: "flex", gap: 16, listStyle: "none", justifyContent: "center" } },
                        ...
                        showTimings.map(function (timing) { return (React.createElement("li", { key: timing.id, onClick: function () { return bindTimingClicks(); }, className: "timing-item ".concat(timing.status, " ").concat(selectedTimingId === timing.id ? "selected" : ""), style: { pointerEvents: timing.status === "sold-out" ? "none" : "auto", cursor: "pointer" } },
                ...
                React.createElement("div", { className: "booking-summary-container" },
                    ...
                    React.createElement("div", { className: "booking-section" },
                        ...
                        React.createElement("button", { className: "btn-proceed", disabled: seatSelection.TicketCount === 0, onClick: handleProceed, id: "proceedButton" }, "Proceed"))),
                React.createElement(ej2_react_popups_1.DialogComponent, { id: "seatBookingDialog", ref: function (d) { return (seatDialogRef = d); }, visible: false, width: "400px", animationSettings: { effect: "Zoom" }, isModal: true, target: '.control-section', buttons: [
                        { click: function () { return seatDialogRef === null || seatDialogRef === void 0 ? void 0 : seatDialogRef.hide(); }, buttonModel: { content: "Close", cssClass: 'btn2 btn2-proceed', isPrimary: true } }
                    ] })),
            React.createElement("div", { id: "action-description", style: { marginTop: 20 } },
                React.createElement("p", null,
                    "This sample implements a functional movie ticket booking interface using the Syncfusion",
                    React.createElement("sup", null, "\u00AE"),
                    " EJ2 Diagram component, providing an intuitive visual representation of a cinema hall's seating arrangement with real-time price updates and a complete booking workflow.")),
    ...
    return SeatBookingDiagram;
}(sample_base_1.SampleBase));
exports.SeatBookingDiagram = SeatBookingDiagram;
