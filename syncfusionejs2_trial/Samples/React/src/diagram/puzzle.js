...
exports.InteractiveImagePuzzle = void 0;
...
var InteractiveImagePuzzle = /** @class */ (function (_super) {
    __extends(InteractiveImagePuzzle, _super);
    function InteractiveImagePuzzle() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    InteractiveImagePuzzle.prototype.componentDidMount = function () {
        diagram.fitToPage();
        setTimeout(function () {
            document.getElementById('winClose').addEventListener('click', function () { return closeWinDialog(); });
        }, 1000);
    };
    InteractiveImagePuzzle.prototype.componentWillUnmount = function () {
        clearTimer();
    };
    InteractiveImagePuzzle.prototype.render = function () {
    ...
    return InteractiveImagePuzzle;
}(sample_base_1.SampleBase));
exports.InteractiveImagePuzzle = InteractiveImagePuzzle;
