...
function PeriodicTable() {
    ...
    var _b = React.useState(false), showDiagram = _b[0], setShowDiagram = _b[1];
    var periodicTableModel = React.useMemo(function () { return initPeriodicTable(); }, []);
    React.useEffect(function () {
        (0, sample_base_1.updateSampleSection)();
    }, []);
    // Handle mouse enter event
    var handleMouseEnter = function (args) {
        var _a;
    ...
    var handleMouseLeave = function (args) {
        var _a;
    ...
    var handleSelectionChange = function (args) {
        var _a;
        if (args.state === 'Changed') {
            ...
            if ((_a = selectednode === null || selectednode === void 0 ? void 0 : selectednode.addInfo) === null || _a === void 0 ? void 0 : _a.label) {
                ...
                diagramRef.current.nodes.forEach(function (node) {
                ...
                diagramRef.current.nodes.forEach(function (node) { return node.style.opacity = 1; });
            }
        }
    };
    var getConnectorDefaults = function (connector) {
    ...
    return (React.createElement("div", { className: "control-pane" },
        React.createElement("div", { className: "control-section periodic-table", style: { width: "100%", opacity: showDiagram ? 1 : 0 } },
            React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "diagram", ref: diagramRef, width: '100%', height: '700px', nodes: periodicTableModel.nodes, connectors: periodicTableModel.connectors, constraints: ej2_react_diagrams_1.DiagramConstraints.Default & ~ej2_react_diagrams_1.DiagramConstraints.UndoRedo, snapSettings: { constraints: ej2_react_diagrams_1.SnapConstraints.None }, tool: ej2_react_diagrams_1.DiagramTools.SingleSelect, getConnectorDefaults: getConnectorDefaults, selectedItems: { constraints: ej2_react_diagrams_1.SelectorConstraints.None }, mouseEnter: handleMouseEnter, mouseLeave: handleMouseLeave, selectionChange: handleSelectionChange, created: function () {
