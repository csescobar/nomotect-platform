...
import { DiagramComponent, SymbolPaletteComponent, Node, Connector, DiagramTools, NodeConstraints, ConnectorConstraints, FlipDirection } from "@syncfusion/ej2-react-diagrams";
...
export class Default extends SampleBase {
    ...
    dropDown = () => {
        return (<div><DropDownButtonComponent items={data} cssClass="custom-export-dropdown" iconCss="e-icons e-export" select={onselectExport}></DropDownButtonComponent></div>);
    };
    connector = () => {
        return (<div><DropDownButtonComponent items={connectorData} cssClass="tb-item-middle" iconCss="e-diagram-icons1 e-diagram-connector e-icons" select={onConnectorSelect}></DropDownButtonComponent></div>);
    };
    shapes = () => {
        return (<div><DropDownButtonComponent items={shapeData} cssClass="tb-item-middle" iconCss="e-shapes e-icons" select={onShapesSelect}></DropDownButtonComponent></div>);
    };
    alignments = () => {
        return (<div><DropDownButtonComponent items={alignData} iconCss="e-icons e-restart-at-1" select={onSelectAlignObjects}></DropDownButtonComponent></div>);
    };
    distribute = () => {
        return (<div><DropDownButtonComponent items={distributeData} iconCss="e-icons e-stroke-width" select={onSelectDistributeObjects}></DropDownButtonComponent></div>);
    };
    order = () => {
        return (<div><DropDownButtonComponent items={orderData} iconCss="e-icons e-order" select={onSelectOrder}></DropDownButtonComponent></div>);
    };
    group = () => {
        return (<div><DropDownButtonComponent items={groupData} iconCss="e-icons e-group-1" select={onSelectGroup}></DropDownButtonComponent></div>);
    };
    rotate = () => {
        return (<div><DropDownButtonComponent items={rotateData} iconCss="e-icons e-repeat" select={onSelectRotate}></DropDownButtonComponent></div>);
    };
    flip = () => {
        return (<div><DropDownButtonComponent items={flipData} iconCss="e-icons e-flip-horizontal" select={onSelectFlip}></DropDownButtonComponent></div>);
    };
    zoom = () => {
        return (<div><DropDownButtonComponent id="btnZoomIncrement" items={zoomData} content={Math.round(diagramInstance.scrollSettings.currentZoom * 100) + ' %'} select={zoomChange}></DropDownButtonComponent></div>);
    };
    render() {
        ...
        <div className="control-section">
          <div style={{ width: "100%" }}>
            <div style={{ display: 'none' }}>
              <UploaderComponent id="UploadFiles" name="UploadFiles" type="file" showFileList={false} asyncSettings={asyncSettings} success={onUploadSuccess}></UploaderComponent>
            </div>
            <div className="db-toolbar-container">
              <ToolbarComponent ref={(toolbar) => (toolbarEditor = toolbar)} id="toolbar_diagram" clicked={toolbarClick} overflowMode={'Scrollable'} width={'100%'}>
                <ItemsDirective>
                  ...
                  <ItemDirective disabled={true} prefixIcon='e-cut e-icons' tooltipText='Cut' cssClass='tb-item-middle tb-item-lock-category' align="Left" id="Cut"/>
                  <ItemDirective disabled={true} prefixIcon='e-copy e-icons' tooltipText='Copy' cssClass='tb-item-middle tb-item-lock-category' align="Left" id="Copy"/>
                  <ItemDirective disabled={true} prefixIcon='e-icons e-paste' tooltipText='Paste' cssClass='tb-item-middle tb-item-lock-category' align="Left" id="Paste"/>
                  <ItemDirective type='Separator'/>
                  <ItemDirective prefixIcon='e-icons e-undo' tooltipText='Undo' align="Left" id="Undo"/>
                  <ItemDirective prefixIcon='e-icons e-redo' tooltipText='Redo' align="Left" id="Redo"/>
                  <ItemDirective type='Separator'/>
                  <ItemDirective prefixIcon='e-pan e-icons' tooltipText='Pan Tool' cssClass='tb-item-start pan-item' align="Left" id="Pan_tool"/>
                  <ItemDirective prefixIcon='e-mouse-pointer e-icons' tooltipText='Select Tool' cssClass='tb-item-middle' align="Left" id="Select_tool"/>
                  ...
                  <ItemDirective type='Separator'/>
                  <ItemDirective disabled={true} prefixIcon='e-icons e-lock' tooltipText='Lock' cssClass='tb-item-middle tb-item-lock-category' align="Left" id="Lock"/>
                  <ItemDirective disabled={true} prefixIcon='e-trash e-icons' tooltipText='Delete' cssClass='tb-item-middle tb-item-lock-category' align="Left" id="Delete"/>
                  <ItemDirective type='Separator' align='Center'/>

                  <ItemDirective disabled={true} type="Input" tooltipText='Align Objects' cssClass='tb-item-middle tb-item-lock-category' align="Left" id="Align_objects" template={this.alignments}/>
                  <ItemDirective disabled={true} type="Input" tooltipText='Distribute Objects' cssClass='tb-item-middle tb-item-lock-category' align="Left" id="Distribute_objects" template={this.distribute}/>
                  <ItemDirective type='Separator'/>
                  <ItemDirective disabled={true} type="Input" tooltipText='Order Commands' cssClass='tb-item-middle tb-item-lock-category' align="Left" id="Order" template={this.order}/>
                  <ItemDirective type='Separator'/>
                  <ItemDirective disabled={true} type="Input" tooltipText='Group/Ungroup' cssClass='tb-item-middle tb-item-lock-category' align="Left" id="Group" template={this.group}/>
                  <ItemDirective type='Separator'/>
                  <ItemDirective disabled={true} type="Input" tooltipText='Rotate' cssClass='tb-item-middle tb-item-lock-category' align="Left" id="Rotate" template={this.rotate}/>
                  <ItemDirective type='Separator'/>
                  <ItemDirective disabled={true} type="Input" tooltipText='Flip' cssClass='tb-item-middle tb-item-lock-category' align="Left" id="Flip" template={this.flip}/>
                  <ItemDirective type='Separator'/>
                  <ItemDirective type="Input" cssClass='tb-item-end tb-zoom-dropdown-btn' align="Left" id="Zoom" template={this.zoom}/>
                </ItemsDirective>
              </ToolbarComponent>
            </div>
