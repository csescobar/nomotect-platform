            ...
            changed("fontfamily");
                ...
                <div className="row" style={{ paddingTop: "10px" }}>
                  ...
                  <div className="row col-xs-8" style={{ paddingLeft: "0px", paddingTop: "8px" }}>
                    <DropDownListComponent id="diagramAnnotationTemplate" fields={fields} popupWidth={200} width={"100%"} placeholder={"Select a template"} dataSource={templateList} change={() => {
            changed("template");
