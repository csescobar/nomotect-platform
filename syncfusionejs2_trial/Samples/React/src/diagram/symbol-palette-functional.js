...
function SymbolPalette() {
    ...
    function symbolDefaults(symbol) {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement("div", { className: "control-section" },
            React.createElement("div", { className: "diagram-symbolpalette", style: { width: '100%' } },
                React.createElement("div", { className: "palette-column" },
                    ...
                    React.createElement("div", { id: "palette-space", ref: function (paletteSpace) { return (paletteSpaceInstance = paletteSpace); }, className: "sb-mobile-palette" },
                        React.createElement(ej2_react_diagrams_1.SymbolPaletteComponent, { id: "symbolpalette", ref: function (symbolpal) { return (palette = symbolpal); }, expandMode: 'Multiple', palettes: [
                            ...
                            ], enableAnimation: true, enableSearch: true, width: '100%', height: '900px', getNodeDefaults: symbolDefaults.bind(this), getSymbolInfo: symbolInfo.bind(this), symbolMargin: { left: 15, right: 15, top: 15, bottom: 15 } }))),
                React.createElement("div", { className: "diagram-column" },
                    React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "diagram", ref: function (diagram) { return (diagramInstance = diagram); }, width: '100%', height: '900px', rulerSettings: { showRulers: true }, pageSettings: { width: 1500, height: 1500 }, getNodeDefaults: nodeDefaults.bind(this), scrollSettings: {
