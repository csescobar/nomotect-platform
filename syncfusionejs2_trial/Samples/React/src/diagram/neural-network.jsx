...
import { DiagramComponent, DiagramTools, SnapConstraints, NodeConstraints, ConnectorConstraints } from "@syncfusion/ej2-react-diagrams";
...
export class NeuralNetworkDiagram extends SampleBase {
    ...
    render() {
        ...
        <div className="control-section neural-network-container" style={{ opacity: 0 }}>
          <div style={{ width: "100%" }}>
            <DiagramComponent id="diagram" ref={(diagram) => (diagramInstance = diagram)} width={"100%"} height={"600px"} nodes={nodes} connectors={connectors} snapSettings={{ constraints: SnapConstraints.None }} tool={DiagramTools.ZoomPan} created={() => {
                diagramInstance.fitToPage();
                setTimeout(() => {
                    // show diagram
        ...
        <div id="action-description">
          <p>
            This sample provides an interactive visualization of a neural network architecture using the <a href="https://www.syncfusion.com/react-components/react-diagram" target="_blank">React Diagram</a>. It displays multi-layered networks with configurable neurons, connections, and data flow patterns.
          </p>
        </div>
        <div id="description">
          <p>
