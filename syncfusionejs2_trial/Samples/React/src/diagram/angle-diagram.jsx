...
export class AngleDiagram extends SampleBase {
    ...
    render() {
        ...
        <div className="control-section angle-diagram-container" style={{ width: '100%', opacity: 0 }}>
          <DiagramComponent id="diagram" ref={(diagramref) => (diagram = diagramref)} width={'100%'} height={'750px'} snapSettings={{ constraints: SnapConstraints.None }} selectedItems={{ constraints: SelectorConstraints.Rotate }} scrollChange={() => {
                ...
                diagram.fitToPage();
                setTimeout(() => {
                    const container = document.querySelector('.angle-diagram-container');
                    if (container)
