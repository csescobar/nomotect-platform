...
import { DiagramComponent, SymbolPaletteComponent, Node, Connector, DiagramTools, NodeConstraints, ConnectorConstraints, PrintAndExport, UndoRedo, FlipDirection, Inject } from "@syncfusion/ej2-react-diagrams";
          ...
          <div className="db-toolbar-container">
            <ToolbarComponent ref={(toolbar) => (toolbarEditor = toolbar)} id="toolbar_diagram" clicked={toolbarClick} overflowMode={'Scrollable'} width={'100%'}>
              <ItemsDirective>
                ...
                <ItemDirective disabled={true} type="Input" tooltipText='Align Objects' cssClass='tb-item-middle tb-item-lock-category' align="Left" id="Align_objects" template={alignments}/>
                <ItemDirective disabled={true} type="Input" tooltipText='Distribute Objects' cssClass='tb-item-middle tb-item-lock-category' align="Left" id="Distribute_objects" template={distribute}/>
                <ItemDirective type='Separator'/>
                <ItemDirective disabled={true} type="Input" tooltipText='Order Commands' cssClass='tb-item-middle tb-item-lock-category' align="Left" id="Order" template={order}/>
                <ItemDirective type='Separator'/>
                <ItemDirective disabled={true} type="Input" tooltipText='Group/Ungroup' cssClass='tb-item-middle tb-item-lock-category' align="Left" id="Group" template={group}/>
                <ItemDirective type='Separator'/>
                <ItemDirective disabled={true} type="Input" tooltipText='Rotate' cssClass='tb-item-middle tb-item-lock-category' align="Left" id="Rotate" template={rotate}/>
                <ItemDirective type='Separator'/>
                <ItemDirective disabled={true} type="Input" tooltipText='Flip' cssClass='tb-item-middle tb-item-lock-category' align="Left" id="Flip" template={flip}/>
                <ItemDirective type='Separator'/>
                <ItemDirective type="Input" cssClass='tb-item-end tb-zoom-dropdown-btn' align="Left" id="Zoom" template={zoom}/>
              </ItemsDirective>
            </ToolbarComponent>
          </div>
