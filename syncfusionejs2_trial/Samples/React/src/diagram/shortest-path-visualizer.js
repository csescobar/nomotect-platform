...
exports.ShortestPathVisualizerDiagram = void 0;
...
var handleCreated = function () {
    ...
    if (diagram) {
        ...
        setTimeout(function () {
            // show diagram
            var container = document.querySelector('.shortest-path-container');
            if (container) {
...
var ShortestPathVisualizerDiagram = /** @class */ (function (_super) {
    __extends(ShortestPathVisualizerDiagram, _super);
    function ShortestPathVisualizerDiagram() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ShortestPathVisualizerDiagram.prototype.componentDidMount = function () {
        buildGraph();
    };
    ShortestPathVisualizerDiagram.prototype.componentWillUnmount = function () {
        this.cleanupIntervals();
    };
    ShortestPathVisualizerDiagram.prototype.cleanupIntervals = function () {
        dashIntervals.forEach(function (interval) { return clearInterval(interval); });
        dashIntervals.clear();
    };
    ShortestPathVisualizerDiagram.prototype.render = function () {
        return (React.createElement("div", { className: "shortest-path-container", style: { opacity: 0 } },
    ...
    return ShortestPathVisualizerDiagram;
}(sample_base_1.SampleBase));
exports.ShortestPathVisualizerDiagram = ShortestPathVisualizerDiagram;
