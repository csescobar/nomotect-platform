...
function FlowchartLayoutDiagram() {
    ...
    return (React.createElement("div", { className: "diagram-flowchartLayout" },
        React.createElement("style", null, SAMPLE_CSS),
        React.createElement("div", { className: " col-lg-9 control-section diagram-flowchartLayout" },
            React.createElement("div", { className: "control-wrapper" },
                React.createElement("div", { style: { width: '100%', background: 'white', border: '1px solid #D5D5D5' } },
                    React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "diagram", ref: function (diagram) { return (diagramInstance = diagram); }, width: '100%', height: '700px', scrollSettings: { scrollLimit: 'Infinity', padding: { bottom: 50, right: 50 } }, rulerSettings: { showRulers: true }, getNodeDefaults: getNodeDefaults, getConnectorDefaults: getConnectorDefaults, tool: ej2_react_diagrams_1.DiagramTools.ZoomPan, layout: {
                            type: 'Flowchart',
        ...
        React.createElement("div", { className: "flow-property-section" },
            React.createElement("div", { className: " col-lg-3 property-panel-header", style: { marginLeft: '10px' } }, "Properties"),
