...
function PeriodicTable() {
    ...
    const handleSelectionChange = (args) => {
        if (args.state === 'Changed') {
            ...
            if (selectednode?.addInfo?.label) {
                ...
                diagramRef.current.nodes.forEach((node) => {
    ...
    return (<div className="control-pane">
            <div className="control-section periodic-table" style={{ width: "100%", opacity: showDiagram ? 1 : 0 }}>
                ...
                <DiagramComponent id="diagram" ref={diagramRef} width={'100%'} height={'700px'} nodes={periodicTableModel.nodes} connectors={periodicTableModel.connectors} constraints={DiagramConstraints.Default & ~DiagramConstraints.UndoRedo} snapSettings={{ constraints: SnapConstraints.None }} tool={DiagramTools.SingleSelect} getConnectorDefaults={getConnectorDefaults} selectedItems={{ constraints: SelectorConstraints.None }} mouseEnter={handleMouseEnter} mouseLeave={handleMouseLeave} selectionChange={handleSelectionChange} created={() => {
