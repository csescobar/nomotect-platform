    ...
    function rendereComplete() {
        ...
        appearanceInstance.onclick = function (args) {
            ...
            if (target && target.id == "freehand") {
                ...
                diagramInstance.snapSettings.constraints = (ej2_react_diagrams_1.SnapConstraints.SnapToObject | ej2_react_diagrams_1.SnapConstraints.SnapToLines) | ej2_react_diagrams_1.SnapConstraints.ShowLines;
            }
        };
    }
