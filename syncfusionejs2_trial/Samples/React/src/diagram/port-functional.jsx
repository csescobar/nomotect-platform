...
function Port() {
    ...
    return (<div className="control-pane diagram-port">
                            ...
                            <div className="row sb-child-row">
                                <div className="col-lg-6">
                                    ...
                                    <div style={{ paddingBottom: "8px" }}>
                                        ...
                                        <NumericTextBoxComponent ref={widthRef => (portWidthNum = widthRef)} id="width" enabled={true} format={"###.##"} value={1} step={0.5} max={15} min={1} change={(args) => {
