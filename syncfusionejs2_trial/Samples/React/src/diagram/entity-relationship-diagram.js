...
var ERDiagram = /** @class */ (function (_super) {
    __extends(ERDiagram, _super);
    function ERDiagram() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.diagramCreated = false;
        _this.isMobile = false;
        _this.openPalette = function () {
            var paletteSpace = document.getElementById('palette-space');
            _this.isMobile = window.matchMedia('(max-width:550px)').matches;
            if (!paletteSpace) {
                return;
            }
            if (_this.isMobile) {
        ...
        _this.onUserHandleMouseDown = function (args) {
            if (args.element) {
                ...
                if (handleName === 'AddField') {
                    ...
                    var fieldToRemove = _this.getSelectedFieldToRemove(node);
                    if (!fieldToRemove) {
                        return;
                    }
    ...
    ERDiagram.prototype.componentDidMount = function () {
        this.addEvents();
    };
    ERDiagram.prototype.addEvents = function () {
        var _this = this;
        ...
        if (this.isMobile) {
            ...
            window.addEventListener('resize', function () {
                _this.isMobile = window.matchMedia('(max-width:550px)').matches;
                var paletteSpace = document.getElementById('palette-space');
                if (!_this.isMobile && paletteSpace && paletteSpace.classList.contains('sb-mobile-palette-open')) {
                    paletteSpace.classList.remove('sb-mobile-palette-open');
                }
            });
        }
    };
    ERDiagram.prototype.getSelectedFieldToRemove = function (entityNode) {
    ...
    ERDiagram.prototype.contextMenuClick = function (args) {
    ...
    ERDiagram.prototype.contextMenuOpen = function (args) {
        var hiddenId = [];
    ...
    ERDiagram.prototype.render = function () {
        var _this = this;
                ...
                React.createElement("div", { style: { width: "100%" } },
                    ...
                    React.createElement("div", { id: "diagram-space", className: "sb-mobile-diagram" },
                        React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "diagram", ref: function (diagram) { return (diagramInstance = diagram); }, width: '100%', height: '560px', nodes: nodes, connectors: connectors, constraints: ej2_react_diagrams_1.DiagramConstraints.Default | ej2_react_diagrams_1.DiagramConstraints.LineRouting | ej2_react_diagrams_1.DiagramConstraints.AvoidLineOverlapping, tool: ej2_react_diagrams_1.DiagramTools.SingleSelect, snapSettings: { constraints: ej2_react_diagrams_1.SnapConstraints.None }, selectedItems: { userHandles: [] }, getConnectorDefaults: function (connector) {
                                ...
                                return connector;
                            }, onUserHandleMouseDown: this.onUserHandleMouseDown, selectionChange: this.onSelectionChange, created: function () {
