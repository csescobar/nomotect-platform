...
function AvoidConnectorOverlapDiagram() {
    var nodes = React.useMemo(function () { return createNodes(); }, []);
    var connectors = React.useMemo(function () { return createConnectors(); }, []);
    ...
    return (React.createElement("div", { className: "control-pane" },
        React.createElement("div", { className: "control-section" },
            React.createElement("div", { style: { width: "100%" } },
                React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "diagram", ref: diagramRef, width: "100%", height: "580", snapSettings: { constraints: ej2_react_diagrams_1.SnapConstraints.None }, constraints: ej2_react_diagrams_1.DiagramConstraints.Default | ej2_react_diagrams_1.DiagramConstraints.LineRouting | ej2_react_diagrams_1.DiagramConstraints.AvoidLineOverlapping, nodes: nodes, connectors: connectors, tool: ej2_react_diagrams_1.DiagramTools.ZoomPan, created: function () { return diagramRef.current.fitToPage(); } },
