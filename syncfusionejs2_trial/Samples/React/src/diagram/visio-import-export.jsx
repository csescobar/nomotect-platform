...
export class VisioImportExport extends SampleBase {
    ...
    render() {
        ...
        <div className="control-section visio-import-container" style={{ opacity: 0 }}>
          <div style={{ width: "100%" }}>
            <div>
              <input id="vsdxInput" type="file" accept=".vsdx" style={{ display: 'none', position: 'absolute', left: '-9999px', width: 0, height: 0, opacity: 0 }}/>
            </div>
...
function toolbarClick(args) {
    ...
    switch (item) {
        ...
        case 'Import Visio (.vsdx)':
            let vsdxInput = document.getElementById('vsdxInput');
            if (vsdxInput) {
                vsdxInput.click();
