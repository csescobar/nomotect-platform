...
function FunnelDiagram() {
    ...
    var nodes = React.useMemo(function () { return getNodes(); }, []);
    var connectors = React.useMemo(function () { return getConnectors(); }, []);
    React.useEffect(function () {
        (0, sample_base_1.updateSampleSection)();
    }, []);
    return (React.createElement("div", { className: "control-pane" },
        React.createElement("style", null, funnelCss),
        React.createElement("div", { className: "control-section funnel-diagram-container", style: { width: "100%", opacity: diagramCreated ? 1 : 0 } },
            React.createElement(ej2_react_diagrams_1.DiagramComponent, { ref: diagramRef, id: "diagram", width: "100%", height: "675px", nodes: nodes, connectors: connectors, snapSettings: {
                    constraints: ej2_react_diagrams_1.SnapConstraints.None
                }, created: function () {
                    diagramRef.current.fitToPage();
                    setTimeout(function () { return setCreated(true); }, 10);
                }, load: function () {
                    if (diagramCreated) {
                        diagramRef.current.fitToPage();
                    }
