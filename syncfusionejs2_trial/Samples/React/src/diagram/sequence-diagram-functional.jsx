...
import { DiagramComponent, Inject, UndoRedo, SnapConstraints, DiagramTools, Diagram, UmlSequenceMessageType, UmlSequenceFragmentType, UmlSequenceActivationBox, UmlSequenceParticipantStereotype } from '@syncfusion/ej2-react-diagrams';
    ...
    return (<div className="control-pane diagram-control-pane">
            <div>
                <div>
                    ...
                    <DiagramComponent id="diagram" ref={(diagram) => (diagramInstance = diagram)} width={'100%'} height={'700px'} model={sequenceModel} tool={DiagramTools.ZoomPan} created={() => {
