...
exports.ShortestPathDiagram = void 0;
...
var ShortestPathDiagram = /** @class */ (function (_super) {
    __extends(ShortestPathDiagram, _super);
    function ShortestPathDiagram() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ShortestPathDiagram.prototype.componentDidMount = function () {
        buildGraph();
    };
    ShortestPathDiagram.prototype.componentWillUnmount = function () {
        this.cleanupIntervals();
    };
    ShortestPathDiagram.prototype.cleanupIntervals = function () {
        dashIntervals.forEach(function (interval) { return clearInterval(interval); });
        dashIntervals.clear();
    };
    ShortestPathDiagram.prototype.render = function () {
        return (React.createElement("div", { className: "shortest-path-container" },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null,
                    "This sample demonstrates an interactive shortest path algorithm visualization using the Syncfusion",
                    React.createElement("sup", null, "\u00AE"),
                    " EJ2 Diagram component, featuring a dynamic graph where users select source and destination nodes to view animated optimal paths.")),
            React.createElement("div", { id: "description" },
                React.createElement("p", null,
                    "Users interactively find the shortest path by selecting a ",
                    React.createElement("b", null, "source"),
                    " node and hovering over a ",
                    React.createElement("b", null, "destination."),
                    " The optimal path dynamically highlights with animated, dashed connectors and numerical labels. Tooltip instantly display the path sequence, or provide ",
                    React.createElement("b", null, "\"No path found\""),
                    " warnings. A toggle seamlessly switches between directed and undirected graph modes."))));
    };
    return ShortestPathDiagram;
}(sample_base_1.SampleBase));
exports.ShortestPathDiagram = ShortestPathDiagram;
