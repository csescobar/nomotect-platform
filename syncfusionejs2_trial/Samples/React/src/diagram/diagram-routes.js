...
var visio_import_export_functional_1 = require("./visio-import-export-functional");
...
var entity_relationship_diagram_functional_1 = require("./entity-relationship-diagram-functional");
...
var shortest_path_visualizer_functional_1 = require("./shortest-path-visualizer-functional");
var tournament_bracket_functional_1 = require("./tournament-bracket-functional");
var ticket_booking_functional_1 = require("./ticket-booking-functional");
var spiral_diagram_functional_1 = require("./spiral-diagram-functional");
var image_puzzle_functional_1 = require("./image-puzzle-functional");
var periodic_table_functional_1 = require("./periodic-table-functional");
var history_timeline_functional_1 = require("./history-timeline-functional");
var funnel_diagram_functional_1 = require("./funnel-diagram-functional");
var family_tree_functional_1 = require("./family-tree-functional");
var serpentine_diagram_functional_1 = require("./serpentine-diagram-functional");
var angle_diagram_functional_1 = require("./angle-diagram-functional");
var pipeline_instrumentation_diagram_functional_1 = require("./pipeline-instrumentation-diagram-functional");
var neural_network_functional_1 = require("./neural-network-functional");
...
exports.diagramRoutes = (React.createElement(React.Fragment, null,
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/diagram/container', Component: container_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/diagram/visio-import-export', Component: visio_import_export_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/diagram/entity-relationship-diagram', Component: entity_relationship_diagram_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/diagram/shortest-path-visualizer', Component: shortest_path_visualizer_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/diagram/tournament-bracket', Component: tournament_bracket_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/diagram/ticket-booking', Component: ticket_booking_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/diagram/spiral-diagram', Component: spiral_diagram_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/diagram/image-puzzle', Component: image_puzzle_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/diagram/periodic-table', Component: periodic_table_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/diagram/history-timeline', Component: history_timeline_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/diagram/funnel-diagram', Component: funnel_diagram_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/diagram/family-tree', Component: family_tree_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/diagram/serpentine-diagram', Component: serpentine_diagram_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/diagram/angle-diagram', Component: angle_diagram_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/diagram/pipeline-instrumentation-diagram', Component: pipeline_instrumentation_diagram_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/diagram/neural-network', Component: neural_network_functional_1.default }),
...
exports.diagramCategory = { "default-functionality": { "name": "Flow Chart", "category": "Getting Started" }, "shape-gallery": { "name": "Shapes", "category": "Getting Started" }, "getting-started-node": { "name": "Nodes", "category": "Getting Started" }, "custom-shapes": { "name": "HTML Shapes", "category": "Getting Started" }, "connectors": { "name": "Connectors", "category": "Getting Started" }, "line-routing": { "name": "LineRouting", "category": "Getting Started" }, "avoid-connector-overlap": { "name": "Avoid Connector Overlap", "category": "Getting Started" }, "getting-started-annotation": { "name": "Annotations", "category": "Getting Started" }, "port": { "name": "Ports", "category": "Getting Started" }, "swim-lane": { "name": "SwimLane", "category": "Getting Started" }, "container": { "name": "Container", "category": "Getting Started" }, "grouping-and-ordering": { "name": "Grouping and Ordering", "category": "Getting Started" }, "diagram-events": { "name": "Events", "category": "Getting Started" }, "history-manager": { "name": "HistoryManager", "category": "Getting Started" }, "commands": { "name": "Commands", "category": "Getting Started" }, "constraints": { "name": "Constraints", "category": "Getting Started" }, "tool-tip": { "name": "Tooltip", "category": "Getting Started" }, "symbol-palette": { "name": "Symbol Palette", "category": "Getting Started" }, "zoom-and-pan": { "name": "Zooming and Panning", "category": "Interactive Features" }, "snapping": { "name": "Snapping", "category": "Interactive Features" }, "scrolling": { "name": "Scrolling", "category": "Interactive Features" }, "drawing-tool": { "name": "Drawing Tools", "category": "Interactive Features" }, "key-board-functions": { "name": "Keyboard Interaction", "category": "Interactive Features" }, "quick-commands": { "name": "User Handle", "category": "Interactive Features" }, "overview": { "name": "Overview Panel", "category": "Interactive Features" }, "hierarchical-model": { "name": "Hierarchical Tree", "category": "Automatic Layouts" }, "organization-model": { "name": "Organization Chart", "category": "Automatic Layouts" }, "flowchart-layout": { "name": "Flowchart Layout", "category": "Automatic Layouts" }, "radial-tree": { "name": "Radial Tree", "category": "Automatic Layouts" }, "mind-map": { "name": "Mind Map", "category": "Automatic Layouts" }, "symmetric-layout": { "name": "Symmetric Layout", "category": "Automatic Layouts" }, "complex-hierarchical-tree": { "name": "Complex Hierarchical Tree", "category": "Automatic Layouts" }, "right-to-left-tree": { "name": "RTL Tree", "category": "Automatic Layouts" }, "pert-chart": { "name": "PERT Chart", "category": "Automatic Layouts" }, "hierarchical-layout-with-multiple-roots": { "name": "Hierarchical Layout With Multiple Roots", "category": "Automatic Layouts" }, "local-data": { "name": "Local Data", "category": "Data Binding" }, "remote-data": { "name": "Remote Data", "category": "Data Binding" }, "visio-import-export": { "name": "Visio", "category": "File Format" }, "virtualize": { "name": "Virtualization", "category": "Performance" }, "serialization": { "name": "Serialization", "category": "Save and Restore" }, "print-export": { "name": "Print and Export", "category": "Print and Export" }, "bpmn-editor": { "name": "BPMN Editor", "category": "Use Case Diagram" }, "logic-circuit": { "name": "Logic circuit Diagram", "category": "Use Case Diagram" }, "entity-relationship-diagram": { "name": "Entity Relationship Diagram", "category": "Use Case Diagram" }, "activity": { "name": "UML Activity Diagram", "category": "Use Case Diagram" }, "sequence-diagram": { "name": "UML Sequence Diagram", "category": "Use Case Diagram" }, "activity-class": { "name": "UML Class Diagram", "category": "Use Case Diagram" }, "shortest-path-visualizer": { "name": "Shortest Path Visualizer", "category": "Use Case Diagram" }, "tournament-bracket": { "name": "Tournament Bracket", "category": "Use Case Diagram" }, "ticket-booking": { "name": "Ticket Booking", "category": "Use Case Diagram" }, "spiral-diagram": { "name": "Spiral Diagram", "category": "Use Case Diagram" }, "image-puzzle": { "name": "Image Puzzle", "category": "Use Case Diagram" }, "periodic-table": { "name": "Periodic Table", "category": "Use Case Diagram" }, "history-timeline": { "name": "History Timeline", "category": "Use Case Diagram" }, "funnel-diagram": { "name": "Funnel Diagram", "category": "Use Case Diagram" }, "family-tree": { "name": "Family Tree Diagram", "category": "Use Case Diagram" }, "serpentine-diagram": { "name": "Serpentine Diagram", "category": "Use Case Diagram" }, "angle-diagram": { "name": "Solar Panel Angle", "category": "Real-Time Diagrams" }, "pipeline-instrumentation-diagram": { "name": "P&ID Diagram", "category": "Real-Time Diagrams" }, "neural-network": { "name": "Neural Network", "category": "Real-Time Diagrams" }, "venn-diagram": { "name": "Venn Diagram", "category": "Real-Time Diagrams" }, "fishbone-diagram": { "name": "Fishbone Diagram", "category": "Real-Time Diagrams" }, "workflow-editor": { "name": "Workflow Diagram", "category": "Real-Time Diagrams" }, "network-diagram": { "name": "Network Diagram", "category": "Real-Time Diagrams" }, "tree-view": { "name": "Diagram Binding With TreeView", "category": "Real-Time Diagrams" }, "flow-execution": { "name": "Flow Execution", "category": "Real-Time Diagrams" }, "defaultSample": "diagram/default-functionality" };
