...
import { DiagramComponent, SnapConstraints, NodeConstraints, ConnectorConstraints } from '@syncfusion/ej2-react-diagrams';
...
// Stage node factory
function createNode(id, width, height, fill, offsetX, offsetY, pathData, valueText, iconClass, description, cumulativeRate, conversionRate, portX = 0.9) {
    return {
        id,
        offsetX,
        offsetY,
...
// Connector factory
function createConnector(sourceID, targetID, strokeColor, p1x, p1y, p2x, p2y, sourcePortID = 'port') {
    return {
        sourceID,
        sourcePortID,
        targetID,
    ...
    render() {
        return (<div className="control-pane diagram-control-pane">
                ...
                <div className="control-section funnel-diagram-container" style={{ opacity: 0 }}>
                    ...
                    <DiagramComponent ref={this.diagramRef} id="diagram" width="100%" height="675px" nodes={this.nodes} connectors={this.connectors} snapSettings={{
                ...
                setTimeout(() => {
                    // show diagram
                    const container = document.querySelector('.funnel-diagram-container');
                    if (container) {
