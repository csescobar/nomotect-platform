...
<div class="${containerCls}">
  <div class="person-card">
    ...
    /* ===================== Events ===================== */
    onMouseEnter = (args) => {
        const node = args?.actualObject || null;
