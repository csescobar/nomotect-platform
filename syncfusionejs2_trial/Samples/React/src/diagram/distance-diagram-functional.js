...
var createWallConnector = function (connectors, id, startX, startY, endX, endY, color, thickness) {
    ...
    if (id.includes('WallOuter')) {
        wallConnector.ports = [
            { id: "".concat(id, "StartPort"), offset: 0, visibility: ej2_react_diagrams_1.PortVisibility.Hidden, shape: 'Circle', width: 8, height: 8 },
            { id: "".concat(id, "MiddlePort"), offset: middlePortPosition, visibility: ej2_react_diagrams_1.PortVisibility.Hidden, shape: 'Square', width: 6, height: 6 },
            { id: "".concat(id, "EndPort"), offset: 1, visibility: ej2_react_diagrams_1.PortVisibility.Hidden, shape: 'Circle', width: 8, height: 8 },
        ];
        if (id === 'WallOuterRight') {
            wallConnector.ports.push({ id: "".concat(id, "MiddlePort2"), offset: 0.61, visibility: ej2_react_diagrams_1.PortVisibility.Hidden, shape: 'Circle', width: 8, height: 8, style: { fill: '#4ECDC4', strokeColor: '#333333', strokeWidth: 1 } });
        }
        if (id === 'WallOuterBottom') {
            wallConnector.ports.push({ id: "".concat(id, "MiddlePort2"), offset: 0.8, visibility: ej2_react_diagrams_1.PortVisibility.Hidden, shape: 'Circle', width: 8, height: 8, style: { fill: '#4ECDC4', strokeColor: '#333333', strokeWidth: 1 } });
        }
    }
    connectors.push(wallConnector);
};
var createItem = function (nodes, id, x, y, width, height, pathData, options) {
    var item = {
        id: id,
        width: width,
        height: height,
...
var createBedroomItem = function (nodes, id, x, y, width, height, pathData) {
...
var createKitchenItem = function (nodes, id, x, y, width, height, pathData, color) {
...
var createLivingRoomItem = function (nodes, id, x, y, width, height, pathData) {
...
var createBathroomDoor = function (nodes, id, x, y, width, height, pathData) {
    var options = { fill: '#E6E6FA', strokeColor: '#9370DB', rotateAngle: 270, flip: ej2_react_diagrams_1.FlipDirection.Vertical };
    createItem(nodes, id, x, y, width, height, pathData, options);
};
var createPortConnections = function (connectors) {
    var wallOuterTop = connectors.find(function (c) { return c.id === 'WallOuterTop'; });
    var wallOuterLeft = connectors.find(function (c) { return c.id === 'WallOuterLeft'; });
    var wallOuterBottom = connectors.find(function (c) { return c.id === 'WallOuterBottom'; });
    var wallOuterRight = connectors.find(function (c) { return c.id === 'WallOuterRight'; });
    var separator1 = connectors.find(function (c) { return c.id === 'Separator1'; });
    var separator2 = connectors.find(function (c) { return c.id === 'Separator2'; });
    var separator3 = connectors.find(function (c) { return c.id === 'Separator3'; });
    var separator4 = connectors.find(function (c) { return c.id === 'Separator4'; });
...
var createRestroomSeparator = function (connectors) {
    createWallConnector(connectors, 'RestroomSeparator', 780, 610, 780, 480, '#333333', 5);
    var restroomSeparator = connectors.find(function (c) { return c.id === 'RestroomSeparator'; });
    var wallOuterBottom = connectors.find(function (c) { return c.id === 'WallOuterBottom'; });
...
var createHallSeparator = function (connectors) {
    createWallConnector(connectors, 'HallSeparator', 540, 610, 540, 410, '#333333', 5);
    var hallSeparator = connectors.find(function (c) { return c.id === 'HallSeparator'; });
    var wallOuterBottom = connectors.find(function (c) { return c.id === 'WallOuterBottom'; });
...
var formatMeasurement = function (value, unit) { return "".concat(value.toFixed(1), " ").concat(unit); };
var convertPixelsToSelectedUnit = function (pixelValue, unit) {
    switch (unit) {
...
var createExtensionLine = function (connectors, id, startX, startY, endX, endY) {
    var extensionLine = { id: id, sourcePoint: { x: startX, y: startY }, targetPoint: { x: endX, y: endY }, type: 'Straight', constraints: ej2_react_diagrams_1.ConnectorConstraints.None, sourceDecorator: { shape: 'None' }, targetDecorator: { shape: 'None' }, style: { strokeColor: '#0066CC', strokeWidth: 1 }, };
    connectors.push(extensionLine);
};
var createDimensionConnector = function (connectors, id, startX, startY, endX, endY, dimensionText, isHorizontal) {
    var dimensionLine = {
        id: id, sourcePoint: { x: startX, y: startY }, targetPoint: { x: endX, y: endY }, type: 'Straight', constraints: ej2_react_diagrams_1.ConnectorConstraints.None, style: { strokeColor: '#0066CC', strokeWidth: 2 },
    ...
    if (isHorizontal) {
        createExtensionLine(connectors, "".concat(id, "_ExtStart"), startX, startY - 10, startX, startY + 10);
        createExtensionLine(connectors, "".concat(id, "_ExtEnd"), endX, endY - 10, endX, endY + 10);
    }
    else {
        createExtensionLine(connectors, "".concat(id, "_ExtStart"), startX - 10, startY, startX + 10, startY);
        createExtensionLine(connectors, "".concat(id, "_ExtEnd"), endX - 10, endY, endX + 10, endY);
    }
};
var getInitialLayout = function () {
    var nodes = [];
    var connectors = [];
    var selectedUnitForInit = 'in';
    var formatAndConvert = function (val) { return formatMeasurement(convertPixelsToSelectedUnit(val, selectedUnitForInit), selectedUnitForInit); };
    ...
    var allSeparators = connectors.filter(function (c) { return c.id.startsWith('Separator') || c.id === 'RestroomSeparator' || c.id === 'HallSeparator'; });
    allSeparators.forEach(function (separator) {
        var wallOuterTop = connectors.find(function (c) { return c.id === 'WallOuterTop'; });
        var wallOuterBottom = connectors.find(function (c) { return c.id === 'WallOuterBottom'; });
        var wallOuterRight = connectors.find(function (c) { return c.id === 'WallOuterRight'; });
        var yOffset = 0, xOffset = 0, distance = 0;
        switch (separator.id) {
            case 'Separator1':
                distance = Math.abs(separator.targetPoint.x - separator.sourcePoint.x);
                yOffset = wallOuterBottom.sourcePoint.y + 40;
                createDimensionConnector(connectors, separator.id + 'Measurement', separator.sourcePoint.x, yOffset, separator.targetPoint.x, yOffset, formatAndConvert(distance), true);
                break;
            case 'Separator3':
                distance = Math.abs(separator.targetPoint.x - separator.sourcePoint.x);
            ...
            case 'HallSeparator':
                ...
                xOffset = 270;
                createDimensionConnector(connectors, separator.id + 'Measurement', xOffset, separator.sourcePoint.y, xOffset, separator.targetPoint.y, formatAndConvert(distance), false);
                break;
            case 'Separator4':
                distance = Math.abs(separator.targetPoint.x - separator.sourcePoint.x);
...
function DistanceDiagram() {
    ...
    var diagramData = React.useState(function () { return getInitialLayout(); })[0];
    var _a = React.useState('in'), selectedUnit = _a[0], setSelectedUnit = _a[1];
    var _b = React.useState(false), diagramCreated = _b[0], setDiagramCreated = _b[1];
    React.useEffect(function () {
        (0, sample_base_1.updateSampleSection)();
    }, []);
    var convertBetweenUnits = function (value, fromUnit, toUnit) {
        if (fromUnit === toUnit)
            return value;
        var inchValue;
        switch (fromUnit) {
    ...
    var updateConnectorAnnotations = React.useCallback(function (newUnit) {
        var diagram = diagramRef.current;
        if (!(diagram === null || diagram === void 0 ? void 0 : diagram.connectors))
            return;
        diagram.connectors.forEach(function (connector) {
            var _a, _b;
            if (((_a = connector.id) === null || _a === void 0 ? void 0 : _a.includes('Measurement')) && ((_b = connector.annotations) === null || _b === void 0 ? void 0 : _b[0])) {
                var content = connector.annotations[0].content;
                var parts = content.split(' ');
                if (parts.length > 1) {
                    var value = parseFloat(parts[0]);
                    var currentUnit = parts[1];
                    var convertedValue = convertBetweenUnits(value, currentUnit, newUnit);
    ...
    var onUnitChanged = React.useCallback(function (args) {
        var newUnit = args.value;
        setSelectedUnit(newUnit);
        updateConnectorAnnotations(newUnit);
    }, [updateConnectorAnnotations]);
    var updateDimensionConnectors = function (movedConnector, diagram) {
        ...
        if (id.startsWith('Separator') || id === 'RestroomSeparator' || id === 'HallSeparator') {
            ...
            var startX = 0, startY = 0, endX = 0, endY = 0, distance = 0;
    ...
    var onPointChanged = React.useCallback(function (args) {
        if (diagramRef.current && args.connector) {
            updateDimensionConnectors(args.connector, diagramRef.current);
        }
    }, [selectedUnit]);
    var unitOptions = [
    ...
    return (React.createElement("div", { className: "control-pane" },
        ...
        React.createElement("div", { className: "control-section diagram-distance-measurement", style: { opacity: diagramCreated ? 1 : 0 } },
            React.createElement("div", { className: "content-wrapper", style: { width: '100%' } },
                React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "distanceDiagram", ref: diagramRef, width: '100%', height: '750px', nodes: diagramData.nodes, connectors: diagramData.connectors, snapSettings: { constraints: ej2_react_diagrams_1.SnapConstraints.ShowLines, gridType: 'Dots', horizontalGridlines: { dotIntervals: [1, 30, 1, 30, 1, 30] }, verticalGridlines: { dotIntervals: [1, 30, 1, 30, 1, 30] } }, rulerSettings: { showRulers: true }, tool: ej2_react_diagrams_1.DiagramTools.SingleSelect, getNodeDefaults: function (node) {
                    ...
                    }, sourcePointChange: onPointChanged, targetPointChange: onPointChanged }),
                React.createElement("div", { className: "distance-units" },
                    ...
                    React.createElement("div", { id: "unit-dropdown" },
                        React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { dataSource: unitOptions, fields: { text: 'text', value: 'value' }, value: selectedUnit, change: onUnitChanged, width: '155px' }))))),
...
exports.default = DistanceDiagram;
