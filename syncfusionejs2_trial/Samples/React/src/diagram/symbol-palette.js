...
function HTMLTemplate() {
    var htmlNodes = [
        ...
        { id: 'BugFix', shape: { type: 'HTML', content: getTemplateContent('BugFix') }, width: 70, height: 70, tooltip: { content: 'Bug Fix' }, constraints: ej2_react_diagrams_1.NodeConstraints.Tooltip },
    ];
    return htmlNodes;
}
...
var SymbolPalette = /** @class */ (function (_super) {
    ...
    SymbolPalette.prototype.renderComplete = function () {
        addEvents();
    };
    SymbolPalette.prototype.render = function () {
        return (React.createElement("div", null,
            ...
            React.createElement("div", { className: "control-section" },
                React.createElement("div", { className: "diagram-symbolpalette", style: { width: '100%' } },
                    React.createElement("div", { className: "palette-column", style: { minWidth: '20%' } },
                        React.createElement("div", { className: "sb-mobile-palette-bar" },
                            React.createElement("div", { id: "palette-icon", ref: function (paletteIcon) { return (paletteIconInstance = paletteIcon); }, role: "button", className: "e-ddb-icons1 e-toggle-palette" })),
                        React.createElement("div", { id: "palette-space", ref: function (paletteSpace) { return (paletteSpaceInstance = paletteSpace); }, className: "sb-mobile-palette" },
                            React.createElement(ej2_react_diagrams_1.SymbolPaletteComponent, { id: "symbolpalette", ref: function (symbolpal) { return (palette = symbolpal); }, expandMode: 'Multiple', palettes: [
                                    {
                                        id: 'flow',
                                        expanded: true,
                                        symbols: flowShapes,
                                ...
                                ], enableAnimation: true, enableSearch: true, width: '100%', height: '900px', getNodeDefaults: this.symbolDefaults.bind(this), getSymbolInfo: this.symbolInfo.bind(this), symbolMargin: { left: 15, right: 15, top: 15, bottom: 15 } }))),
                    React.createElement("div", { className: "diagram-column" },
                        React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "diagram", ref: function (diagram) { return (diagramInstance = diagram); }, width: '100%', height: '900px', rulerSettings: { showRulers: true }, pageSettings: { width: 1500, height: 1500 }, getNodeDefaults: this.nodeDefaults.bind(this), scrollSettings: {
                                scrollLimit: 'Infinity',
                                canAutoScroll: true,
                                autoScrollBorder: { left: 10, right: 10, top: 10, bottom: 10 },
                                scrollableArea: scrollableArea,
                            } })),
                    React.createElement("div", { className: "symbolpalette-property-section" },
                        React.createElement("div", { className: "property-panel-section", style: { paddingLeft: '5px' } },
                            React.createElement("div", { className: "property-panel-header", style: { paddingLeft: '0px' } }, "Properties"),
                                ...
                                React.createElement("table", { id: "property", title: "Properties", style: { width: '100%', height: '100%' } },
                                    React.createElement("tbody", null,
                                        React.createElement("tr", { style: { height: "50px" } },
                                            ...
                                            React.createElement("td", null,
                                                React.createElement("div", { style: { paddingLeft: '20px', paddingTop: '10px' } },
                                                    React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { id: "expand", index: 1, width: 120, ref: function (expandRef) { return (expand = expandRef); }, dataSource: expandMode, change: function () {
                                        ...
                                        React.createElement("tr", null,
                                            ...
                                            React.createElement("td", null,
                                                React.createElement("div", { style: { paddingTop: '10px', paddingLeft: '20px' } },
                                                    React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { id: "size", value: 50, min: 40, max: 90, width: 120, step: 5, format: "##.##", change: function (args) {
                                        ...
                                        React.createElement("tr", null,
                                            React.createElement("td", { style: { height: "50px" } },
                                                React.createElement("div", { style: { paddingTop: '14px' } }, "Animation ")),
                                            React.createElement("td", null,
                                                React.createElement("div", { style: { paddingTop: '10px', paddingLeft: '20px' } },
                                                    React.createElement(ej2_react_buttons_1.CheckBoxComponent, { id: "animation", checked: true, change: onAnimationChange })))),
                                        React.createElement("tr", null,
                                            React.createElement("td", { style: { height: "50px" } },
                                                React.createElement("div", { style: { paddingTop: '14px' } }, "Item Text ")),
                                            React.createElement("td", null,
                                                React.createElement("div", { style: { paddingTop: '10px', paddingLeft: '20px' } },
                                                    React.createElement(ej2_react_buttons_1.CheckBoxComponent, { id: "itemtext", change: onItemTextChange })))),
                                        React.createElement("tr", null,
                                            React.createElement("td", { style: { height: "50px" } },
                                                React.createElement("div", { style: { paddingTop: '14px' } }, "Header Icon ")),
                                            React.createElement("td", null,
                                                React.createElement("div", { style: { paddingTop: '10px', paddingLeft: '20px' } },
                                                    React.createElement(ej2_react_buttons_1.CheckBoxComponent, { id: "headericon", checked: true, change: onHeaderIconChange })))),
                                        React.createElement("tr", null,
                                            React.createElement("td", { style: { height: "50px" } },
                                                React.createElement("div", { style: { paddingTop: '14px' } }, "Show Search TextBox ")),
                                            React.createElement("td", null,
                                                React.createElement("div", { style: { paddingTop: '10px', paddingLeft: '20px' } },
                                                    React.createElement(ej2_react_buttons_1.CheckBoxComponent, { id: "showsearch", checked: true, change: handleshowSearch }))))))))))),
            ...
            React.createElement("div", { id: "description" },
                React.createElement("p", null,
                    ...
                    " component. Symbol sizes can be adjusted using the ",
                    React.createElement("code", null, "width"),
                    " and ",
                    React.createElement("code", null, "height"),
                    " properties via the ",
                    React.createElement("code", null, "getSymbolInfo"),
                    " method."),
                React.createElement("p", null, "Additional features include:"),
                React.createElement("ul", null,
                    React.createElement("li", null,
                        "Enabling or disabling animation using the ",
                        React.createElement("code", null, "enableAnimation"),
                        " property."),
                    React.createElement("li", null,
                        "Activating search functionality with the ",
                        React.createElement("code", null, "enableSearch"),
                        " property, allowing users to find symbols by ID or search tags")),
                React.createElement("p", null,
                    "Note: The size of ",
                    React.createElement("b", null, "\"HTML Shapes\""),
                    " in the symbol palette is restricted at runtime when modifying symbol size property, to maintain a consistent layout and visual appearance."),
                React.createElement("br", null))));
    };
    //set Node default value
    SymbolPalette.prototype.symbolDefaults = function (symbol) {
    ...
    SymbolPalette.prototype.nodeDefaults = function (node) {
...
function handleshowSearch(args) {
    if (args.checked) {
