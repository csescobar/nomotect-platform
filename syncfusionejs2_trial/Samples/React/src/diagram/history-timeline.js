...
exports.HistoryTimelineDiagramComponent = void 0;
...
var HistoryTimelineDiagramComponent = /** @class */ (function (_super) {
    __extends(HistoryTimelineDiagramComponent, _super);
    function HistoryTimelineDiagramComponent() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    HistoryTimelineDiagramComponent.prototype.rendereComplete = function () {
    ...
    HistoryTimelineDiagramComponent.prototype.render = function () {
            ...
            React.createElement("div", { id: "timeline-container" },
                ...
                React.createElement("div", { className: "control-section" },
                    React.createElement("div", { className: "content-wrapper", style: { width: "100%" } },
                        React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "timeline-diagram", ref: function (diagramref) { return (diagram = diagramref); }, width: "100%", height: "600", nodes: nodes, connectors: connectors, tool: ej2_react_diagrams_1.DiagramTools.ZoomPan | ej2_react_diagrams_1.DiagramTools.SingleSelect, constraints: ej2_react_diagrams_1.DiagramConstraints.Default & ~ej2_react_diagrams_1.DiagramConstraints.PanY, snapSettings: { constraints: ej2_react_diagrams_1.SnapConstraints.None }, selectedItems: selectedItems, selectionChange: selectionChange, onUserHandleMouseDown: onUserHandleMouseDown, click: click, created: created, load: load, commandManager: {
                                commands: [
                                    {
                                        name: 'copy',
    ...
    return HistoryTimelineDiagramComponent;
}(sample_base_1.SampleBase));
exports.HistoryTimelineDiagramComponent = HistoryTimelineDiagramComponent;
