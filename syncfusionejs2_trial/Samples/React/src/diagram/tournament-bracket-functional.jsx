    ...
    return (<div className="control-pane">
            <div className="control-section tournament-result-container">
                ...
                <div className="sample-section">
                    ...
                    {showDiagram && (<DiagramComponent id="footballResultDiagram" ref={diagramRef} width={"100%"} height={"100%"} nodes={nodes} connectors={connectors} getConnectorDefaults={(connector) => {
