    ...
    return (<div className="control-pane diagram-puzzle-container">
            ...
            color: '#ccc'
                ...
                <div id="action-description">
                    <p>
                        This sample showcases an interactive sliding image puzzle game built using the Syncfusion<sup>®</sup> EJ2 Diagram component, transforming images into a 4x4 grid of draggable tiles, with features like move and time tracking.
                    </p>
                </div>
                <div id="description">
                    <p>
...
export default InteractiveImagePuzzle;
const SAMPLE_CSS = `
