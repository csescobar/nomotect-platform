...
function TournamentBracket() {
    ...
    React.useEffect(function () {
        ...
        return function () { return clearTimeout(loadingTimer); };
    }, []);
    return (React.createElement("div", { className: "control-pane" },
        React.createElement("div", { className: "control-section tournament-result-container" },
            ...
            React.createElement("div", { className: "sample-section" },
                isLoading && (React.createElement("div", { className: "loading" },
                    React.createElement("span", null, "Loading Tournament Results..."))),
                showDiagram && (React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "footballResultDiagram", ref: diagramRef, width: "100%", height: "100%", nodes: nodes, connectors: connectors, getConnectorDefaults: function (connector) {
...
exports.default = TournamentBracket;
