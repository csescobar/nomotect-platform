...
function NeuralNetworkDiagram() {
    ...
    return (<div className="control-pane">
      <div className="control-section" style={{ opacity: showDiagram ? 1 : 0 }}>
        <div style={{ width: "100%" }}>
          <DiagramComponent id="diagram" ref={diagramRef} width={"100%"} height={"600px"} nodes={nodes} connectors={connectors} snapSettings={{ constraints: SnapConstraints.None }} tool={DiagramTools.ZoomPan} created={() => {
            if (diagramRef.current)
                diagramRef.current.fitToPage();
            setTimeout(() => {
                setShowDiagram(true);
