...
function FlowchartLayoutDiagram() {
    ...
    return (<div className="diagram-flowchartLayout">
            <style>{SAMPLE_CSS}</style>
            <div className=" col-lg-9 control-section diagram-flowchartLayout">
                <div className="control-wrapper">
                    <div style={{ width: '100%', background: 'white', border: '1px solid #D5D5D5' }}>
                        <DiagramComponent id="diagram" ref={(diagram) => (diagramInstance = diagram)} width={'100%'} height={'700px'} scrollSettings={{ scrollLimit: 'Infinity', padding: { bottom: 50, right: 50 } }} rulerSettings={{ showRulers: true }} getNodeDefaults={getNodeDefaults} getConnectorDefaults={getConnectorDefaults} tool={DiagramTools.ZoomPan} layout={{
            type: 'Flowchart',
