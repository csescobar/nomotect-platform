...
exports.DistanceDiagram = void 0;
var React = require("react");
var ej2_react_diagrams_1 = require("@syncfusion/ej2-react-diagrams");
var sample_base_1 = require("../common/sample-base");
var ej2_react_dropdowns_1 = require("@syncfusion/ej2-react-dropdowns");
var DistanceDiagram = /** @class */ (function (_super) {
    __extends(DistanceDiagram, _super);
    function DistanceDiagram(props) {
        var _this = _super.call(this, props) || this;
        _this.diagramInstance = React.createRef();
        _this.nodes = [];
        _this.connectors = [];
        _this.selectedUnit = 'in';
        _this.createWallConnector = function (id, startX, startY, endX, endY, color, thickness) {
            var middlePortPosition = 0.5;
            var constraints = id.includes('WallOuter') ?
                ej2_react_diagrams_1.ConnectorConstraints.None :
                (ej2_react_diagrams_1.ConnectorConstraints.Default | ej2_react_diagrams_1.ConnectorConstraints.ReadOnly) &
                    ~(ej2_react_diagrams_1.ConnectorConstraints.Drag | ej2_react_diagrams_1.ConnectorConstraints.DragSourceEnd);
            switch (id) {
                case 'WallOuterLeft':
            ...
            if (id.includes('WallOuter')) {
                wallConnector.ports = [
                    { id: id + 'StartPort', offset: 0, visibility: ej2_react_diagrams_1.PortVisibility.Hidden, shape: 'Circle', width: 8, height: 8 },
                    { id: id + 'MiddlePort', offset: middlePortPosition, visibility: ej2_react_diagrams_1.PortVisibility.Hidden, shape: 'Square', width: 6, height: 6 },
                    { id: id + 'EndPort', offset: 1, visibility: ej2_react_diagrams_1.PortVisibility.Hidden, shape: 'Circle', width: 8, height: 8 },
                ];
                if (id === 'WallOuterRight') {
                    wallConnector.ports.push({ id: id + 'MiddlePort2', offset: 0.61, visibility: ej2_react_diagrams_1.PortVisibility.Hidden, shape: 'Circle', width: 8, height: 8, style: { fill: '#4ECDC4', strokeColor: '#333333', strokeWidth: 1 } });
                }
                if (id === 'WallOuterBottom') {
                    wallConnector.ports.push({ id: id + 'MiddlePort2', offset: 0.8, visibility: ej2_react_diagrams_1.PortVisibility.Hidden, shape: 'Circle', width: 8, height: 8, style: { fill: '#4ECDC4', strokeColor: '#333333', strokeWidth: 1 } });
                }
            }
            _this.connectors.push(wallConnector);
        };
        _this.createItem = function (id, x, y, width, height, pathData, options) {
            var item = {
                id: id,
                width: width,
                height: height,
                ...
                flip: options.flip || ej2_react_diagrams_1.FlipDirection.None,
            };
            _this.nodes.push(item);
        };
        _this.createBedroomItem = function (id, x, y, width, height, pathData) {
            var options = { fill: '#E8F4FD', strokeColor: '#2E86AB' };
            if (id === 'BedItem2') {
            ...
            if (id === 'bedroomDoor2') {
                options.flip = ej2_react_diagrams_1.FlipDirection.Horizontal;
                options.fill = '#F0F8E8';
                options.strokeColor = '#228B22';
            }
            _this.createItem(id, x, y, width, height, pathData, options);
        };
        _this.createKitchenItem = function (id, x, y, width, height, pathData, color) {
            var options = { fill: color, strokeColor: '#333' };
            if (id === 'KitchenSink') {
                options.fill = '#FFF2E8';
        ...
        _this.createLivingRoomItem = function (id, x, y, width, height, pathData) {
            var options = { fill: '#FFF8DC', strokeColor: '#B8860B' };
            if (id === 'Bathroom') {
                options.rotateAngle = 90;
                options.fill = '#E6E6FA';
        ...
        _this.createBathroomDoor = function (id, x, y, width, height, pathData) {
            var options = { fill: '#E6E6FA', strokeColor: '#9370DB', rotateAngle: 270, flip: ej2_react_diagrams_1.FlipDirection.Vertical };
            _this.createItem(id, x, y, width, height, pathData, options);
        };
        _this.createPortConnections = function () {
            var wallOuterTop = _this.connectors.find(function (c) { return c.id === 'WallOuterTop'; });
            var wallOuterLeft = _this.connectors.find(function (c) { return c.id === 'WallOuterLeft'; });
            var wallOuterBottom = _this.connectors.find(function (c) { return c.id === 'WallOuterBottom'; });
            var wallOuterRight = _this.connectors.find(function (c) { return c.id === 'WallOuterRight'; });
            var separator1 = _this.connectors.find(function (c) { return c.id === 'Separator1'; });
            var separator2 = _this.connectors.find(function (c) { return c.id === 'Separator2'; });
            var separator3 = _this.connectors.find(function (c) { return c.id === 'Separator3'; });
            var separator4 = _this.connectors.find(function (c) { return c.id === 'Separator4'; });
        ...
        _this.createRestroomSeparator = function () {
            _this.createWallConnector('RestroomSeparator', 780, 610, 780, 480, '#333333', 5);
            var restroomSeparator = _this.connectors.find(function (c) { return c.id === 'RestroomSeparator'; });
            var wallOuterBottom = _this.connectors.find(function (c) { return c.id === 'WallOuterBottom'; });
        ...
        _this.createHallSeparator = function () {
            _this.createWallConnector('HallSeparator', 540, 610, 540, 410, '#333333', 5);
            var hallSeparator = _this.connectors.find(function (c) { return c.id === 'HallSeparator'; });
            var wallOuterBottom = _this.connectors.find(function (c) { return c.id === 'WallOuterBottom'; });
        ...
        _this.createDimensionConnector = function (id, startX, startY, endX, endY, dimensionText, isHorizontal) {
            var dimensionLine = {
                id: id,
                sourcePoint: { x: startX, y: startY },
                targetPoint: { x: endX, y: endY },
            ...
            _this.connectors.push(dimensionLine);
            if (isHorizontal) {
                _this.createExtensionLine(id + '_ExtStart', startX, startY - 10, startX, startY + 10);
                _this.createExtensionLine(id + '_ExtEnd', endX, endY - 10, endX, endY + 10);
            }
            else {
                _this.createExtensionLine(id + '_ExtStart', startX - 10, startY, startX + 10, startY);
                _this.createExtensionLine(id + '_ExtEnd', endX - 10, endY, endX + 10, endY);
            }
        };
        _this.addSpecificSeparatorMeasurement = function (separator) {
            var wallOuterTop = _this.connectors.find(function (c) { return c.id === 'WallOuterTop'; });
            var wallOuterBottom = _this.connectors.find(function (c) { return c.id === 'WallOuterBottom'; });
            var wallOuterRight = _this.connectors.find(function (c) { return c.id === 'WallOuterRight'; });
            var yOffset, xOffset, distance;
            switch (separator.id) {
                case 'Separator1':
                    distance = Math.abs(separator.targetPoint.x - separator.sourcePoint.x);
                    yOffset = wallOuterBottom.sourcePoint.y + 40;
                    _this.createDimensionConnector(separator.id + 'Measurement', separator.sourcePoint.x, yOffset, separator.targetPoint.x, yOffset, _this.formatMeasurement(_this.convertPixelsToSelectedUnit(distance)), true);
                    break;
                case 'Separator3':
                    distance = Math.abs(separator.targetPoint.x - separator.sourcePoint.x);
                ...
                case 'HallSeparator':
                    ...
                    xOffset = 270;
                    _this.createDimensionConnector(separator.id + 'Measurement', xOffset, separator.sourcePoint.y, xOffset, separator.targetPoint.y, _this.formatMeasurement(_this.convertPixelsToSelectedUnit(distance)), false);
                    break;
                case 'Separator4':
                    distance = Math.abs(separator.targetPoint.x - separator.sourcePoint.x);
            ...
            _this.diagramInstance.current.connectors.forEach(function (connector) {
                if (connector.id.includes('Measurement') && connector.annotations && connector.annotations.length > 0) {
                    ...
                    if (parts.length > 1) {
                        ...
                        var convertedValue = _this.convertBetweenUnits(value, currentUnit, _this.selectedUnit);
                        connector.annotations[0].content = _this.formatMeasurement(convertedValue);
                    }
                }
            });
            _this.diagramInstance.current.dataBind();
        };
        _this.formatMeasurement = function (value) { return value.toFixed(1) + ' ' + _this.selectedUnit; };
        _this.convertPixelsToSelectedUnit = function (pixelValue) {
            switch (_this.selectedUnit) {
        ...
        _this.convertBetweenUnits = function (value, fromUnit, toUnit) {
            if (fromUnit === toUnit)
                return value;
            var inchValue;
            switch (fromUnit) {
        ...
        _this.onPointChanged = function (args) {
            _this.updateDimensionConnectors(args.connector);
        };
        _this.updateDimensionConnectors = function (movedConnector) {
            var id = movedConnector.id;
            if (id.startsWith('Separator') || id === 'RestroomSeparator' || id === 'HallSeparator') {
                var measurementId = id + 'Measurement';
                var dimConnector = _this.diagramInstance.current.getObject(measurementId);
                var extStartConnector = _this.diagramInstance.current.getObject(measurementId + '_ExtStart');
                var extEndConnector = _this.diagramInstance.current.getObject(measurementId + '_ExtEnd');
                if (!dimConnector || !extStartConnector || !extEndConnector)
                    return;
                var wallOuterTop = _this.diagramInstance.current.getObject('WallOuterTop');
                var wallOuterBottom = _this.diagramInstance.current.getObject('WallOuterBottom');
                var wallOuterRight = _this.diagramInstance.current.getObject('WallOuterRight');
                var startX = void 0, startY = void 0, endX = void 0, endY = void 0, distance = void 0, isHorizontal = void 0;
                switch (id) {
                    case 'Separator1':
                ...
                dimConnector.annotations[0].content = _this.formatMeasurement(_this.convertPixelsToSelectedUnit(distance));
                if (isHorizontal) {
        ...
        _this.createInitialLayout();
        return _this;
    }
    DistanceDiagram.prototype.createExtensionLine = function (id, startX, startY, endX, endY) {
        var extensionLine = {
            id: id,
            sourcePoint: { x: startX, y: startY },
            targetPoint: { x: endX, y: endY },
    ...
    DistanceDiagram.prototype.render = function () {
        var _this = this;
        var unitOptions = [{ text: 'Feet (ft)', value: 'ft' }, { text: 'Inches (in)', value: 'in' }, { text: 'Centimeters (cm)', value: 'cm' }];
        return (React.createElement("div", { className: "control-pane" },
            React.createElement("style", null, sampleCss),
            React.createElement("div", { className: "control-section diagram-distance-measurement", style: { width: '100%', opacity: 0 } },
                React.createElement("div", { className: "content-wrapper" },
                    React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "distanceDiagram", ref: this.diagramInstance, width: '100%', height: '750px', nodes: this.nodes, connectors: this.connectors, snapSettings: { constraints: ej2_react_diagrams_1.SnapConstraints.ShowLines, gridType: 'Dots', horizontalGridlines: { dotIntervals: [1, 30, 1, 30, 1, 30] }, verticalGridlines: { dotIntervals: [1, 30, 1, 30, 1, 30] } }, rulerSettings: { showRulers: true }, tool: ej2_react_diagrams_1.DiagramTools.SingleSelect, getNodeDefaults: function (node) { node.constraints = ej2_react_diagrams_1.NodeConstraints.None; return node; }, created: function () {
                            _this.diagramCreated = true;
                            _this.diagramInstance.current.fitToPage();
                            setTimeout(function () {
                                var container = document.querySelector('.diagram-distance-measurement');
                                if (container)
                        ...
                        }, sourcePointChange: this.onPointChanged, targetPointChange: this.onPointChanged }),
                    React.createElement("div", { className: "distance-units" },
                        React.createElement("label", { className: "distance-unit-label" }, "Unit: "),
                        React.createElement("div", { id: "unit-dropdown" },
                            React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { dataSource: unitOptions, fields: { text: 'text', value: 'value' }, value: this.selectedUnit, change: this.onUnitChanged, width: '155px' }))))),
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null,
                    "This sample uses the Syncfusion",
                    React.createElement("sup", null, "\u00AE"),
                    " EJ2 React Diagram component to demonstrate measuring and visualizing distances between elements with interactive connectors.")),
...
exports.DistanceDiagram = DistanceDiagram;
