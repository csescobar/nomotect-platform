...
function Port() {
    ...
    function rendereComplete() {
        setTimeout(function () { return diagramInstance.fitToPage(); }, 100);
        diagramInstance.select([diagramInstance.nodes[0]]);
    }
    // Renders the diagram and property panel UI components.
    return (React.createElement("div", { className: "control-pane diagram-port" },
                    ...
                    React.createElement("div", { className: "property-section-content" },
                        ...
                        React.createElement("div", { className: "row sb-child-row" },
                            React.createElement("div", { className: "col-lg-6" },
                                ...
                                React.createElement("div", { style: { paddingBottom: "8px" } },
                                    React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { ref: function (widthRef) { return (portWidthNum = widthRef); }, id: "width", enabled: true, format: "###.##", value: 1, step: 0.5, max: 15, min: 1, change: function (args) {
