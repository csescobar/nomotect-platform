...
function initializeImageCollections() {
    ...
    for (var i = 1; i <= 16; i++) {
        ...
        var col = ((i - 1) % 4) + 1;
        bridgeTheme[i] = "https://ej2.syncfusion.com/react/demos/src/diagram/Images/puzzle/bridge".concat(col, "x").concat(row, ".png");
        natureTheme[i] = "https://ej2.syncfusion.com/react/demos/src/diagram/Images/puzzle/image".concat(col, "x").concat(row, ".png");
        manTheme[i] = "https://ej2.syncfusion.com/react/demos/src/diagram/Images/puzzle/man".concat(col, "x").concat(row, ".png");
    }
...
function onCreated() {
    ...
    setTimeout(function () {
        // show diagram
        var container = document.querySelector('.diagram-puzzle-container');
        if (container) {
...
var ImagePuzzle = /** @class */ (function (_super) {
    __extends(ImagePuzzle, _super);
    function ImagePuzzle() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ImagePuzzle.prototype.componentDidMount = function () {
        diagram.fitToPage();
        setTimeout(function () {
            document.getElementById('winClose').addEventListener('click', function () { return closeWinDialog(); });
        }, 1000);
    };
    ImagePuzzle.prototype.componentWillUnmount = function () {
        clearTimer();
    };
    ImagePuzzle.prototype.render = function () {
        return (React.createElement("div", { className: "control-pane diagram-puzzle-container", style: { opacity: 0 } },
            React.createElement("style", null, SAMPLE_CSS),
            React.createElement("div", { className: "control-section" },
                React.createElement("div", { className: "content-wrapper", style: { width: '100%' } },
                    React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "diagram", ref: function (diagramref) { return (diagram = diagramref); }, height: "800px", nodes: nodes, constraints: ej2_react_diagrams_1.DiagramConstraints.Default & ~ej2_react_diagrams_1.DiagramConstraints.UndoRedo, snapSettings: {
                    ...
                    React.createElement("div", { id: "winDialog", style: {
                        ...
                        React.createElement("div", { style: {
                            ...
                            React.createElement("p", { style: { color: '#ccc', fontSize: '18px', marginBottom: '30px' } },
                                ...
                                " steps in ",
                                React.createElement("span", { id: "finalTime" }, timeDisplay)))))),
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null,
                    "This sample showcases an interactive sliding image puzzle game built using the ",
                    React.createElement("a", { href: "https://www.syncfusion.com/react-components/react-diagram", target: "_blank" }, "React Diagram"),
                    ", transforming images into a 4x4 grid of draggable tiles, with features like move and time tracking.")),
...
exports.ImagePuzzle = ImagePuzzle;
