...
export class ComplexHierarchicalModel extends SampleBase {
    ...
    render() {
        return (<div className="control-pane diagram-control-pane diagram-complex">
         ...
         dataSourceSettings={{
                ...
                <div className="col-lg-4 property-section">
                    ...
                    <div className="row property-panel-content" id="appearance" ref={appearance => (propertyPanelInstance = appearance)} style={{ paddingTop: "10px" }}>
                        ...
                        <div className="row" style={{ paddingTop: "8px" }}>
                            {["toptobottom", "bottomtotop", "lefttoright"].map((id, index) => (<div className={`image-pattern-style${index === 0 ? "e-selected-style" : ""}`} id={id} key={id} style={{
            ...
            ].map(({ id, label, value, min, max }) => (<div key={id} className="row" style={{ paddingTop: "8px" }}>
