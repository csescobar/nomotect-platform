...
function PipelineInstrumentationDiagram() {
    ...
    var pipelineModel = initPipelineDiagram();
    return (React.createElement("div", { className: "control-pane" },
        React.createElement("div", { className: "control-section diagram-pipeline", style: { width: "100%", opacity: showDiagram ? 1 : 0 } },
            ...
            React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "diagram", ref: function (diagram) { return (diagramInstance = diagram); }, width: '100%', height: '700px', nodes: pipelineModel.nodes, connectors: pipelineModel.connectors, tool: ej2_react_diagrams_1.DiagramTools.ZoomPan, snapSettings: { constraints: ej2_react_diagrams_1.SnapConstraints.None }, getNodeDefaults: getNodeDefaults, getConnectorDefaults: getConnectorDefaults, created: function () {
                    appendHTMLElements();
...
exports.default = PipelineInstrumentationDiagram;
