...
export class GettingStartedAnnotation extends SampleBase {
    ...
    render() {
        return (<div className="control-pane diagram-control-pane diagram-annotation">
            ...
            <div className="property-section-content">
              <div className="row property-panel-content" id="appearance" ref={appearance => (appearanceInstance = appearance)}>
                ...
                for (let i = 0; i < diagramInstance.selectedItems.nodes.length; i++) {
                    ...
                    <div className="col-xs-4 column-style">
                      <NumericTextBoxComponent id="fontSize" value={12} min={1} max={50} step={1} format="##.##" change={() => {
                changed("fontsize");
                ...
                changed("fontfamily");
                  ...
                  <DropDownListComponent id="diagramAnnotationTemplate" fields={this.fields} popupWidth={200} width={"100%"} placeholder={"Select a template"} dataSource={templateList} change={() => {
                changed("template");
              ...
              <div className="row" style={{ paddingTop: "8px" }}>
                <CheckBoxComponent id="labelConstraints" label={"Label constraints"} checked={false} change={() => { changed("interaction"); }} ref={labelConstraints => (labelConstraintsInstance = labelConstraints)}/>
              </div>
           </div>
          </div>
        </div>
