...
export class HtmlNode extends SampleBase {
    ...
    render() {
        ...
        <div id="custom-diagram" className="control-section">
          <DiagramComponent id="diagram" ref={diagram => (diagramInstance = diagram)} width={"100%"} backgroundColor='#f5f5f5' height={"1100px"} nodes={nodes} nodeTemplate={template.bind(this)} load={() => {
