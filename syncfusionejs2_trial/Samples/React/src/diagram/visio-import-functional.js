...
function VisioImportExport() {
    ...
    return (React.createElement("div", { className: "control-pane" },
        React.createElement("div", { className: "control-section visio-import-container", style: { width: "100%", opacity: diagramCreated ? 1 : 0 } },
            React.createElement("div", { style: { display: 'none' } },
                React.createElement(ej2_react_inputs_1.UploaderComponent, { id: "fileUpload", type: "file", showFileList: false, asyncSettings: asyncSettings, success: onUploadSuccess, multiple: false, allowedExtensions: ".vsdx", ref: function (uploaderRef) { return (uploaderInstance = uploaderRef); } })),
            React.createElement("div", { className: "db-toolbar-container" },
                React.createElement(ej2_react_navigations_1.ToolbarComponent, { ref: function (toolbar) { return (toolbarEditor = toolbar); }, id: "toolbar_diagram", clicked: toolbarClick, overflowMode: 'Scrollable', width: '100%' },
                    React.createElement(ej2_react_navigations_1.ItemsDirective, null,
                        ...
                        React.createElement(ej2_react_navigations_1.ItemDirective, { type: "Input", tooltipText: 'Draw Connectors', align: "Left", id: "Draw_con", template: connector }),
        ...
        React.createElement("div", { id: "action-description" },
            React.createElement("p", null,
                "This sample demonstrates how to import and export Visio diagrams using the Syncfusion",
                React.createElement("sup", null, "\u00AE"),
                " EJ2 React Diagram. Any Visio file (.vsdx) can be imported to visualize and edit workflows, and the customized diagram can then be exported back to Visio format (.vsdx) for seamless collaboration and interoperability.")),
...
exports.default = VisioImportExport;
