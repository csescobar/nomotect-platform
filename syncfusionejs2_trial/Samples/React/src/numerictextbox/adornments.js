        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: "col-lg-12 control-section" },
                React.createElement("div", { className: "content-wrapper sample-numeric-icon" },
                    ...
                    React.createElement("div", { className: "row custom-margin" },
                        React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { ref: function (scope) { _this.appendNumericObj = scope; }, floatLabelType: 'Auto', step: 1, value: 5, placeholder: 'Enter the kg', appendTemplate: this.appendTemplate, change: this.kgChange })),
                    React.createElement("div", { className: "row custom-margin-row" },
                        React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { ref: function (scope) { _this.iconNumericObj = scope; }, floatLabelType: 'Auto', placeholder: 'Enter the Number', value: 10, showSpinButton: false, prependTemplate: this.prependIconTemplate, appendTemplate: this.appendIconTemplate })))),
