...
var Adornments = function () {
    ...
    var prependIconTemplate = function () {
        var handleResetClick = function () {
            iconNumericObj.current.value = 0;
        };
        return (React.createElement(React.Fragment, null,
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: "col-lg-12 control-section" },
            React.createElement("div", { className: "content-wrapper sample-numeric-icon" },
                ...
                React.createElement("div", { className: "row custom-margin" },
                    React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { ref: appendNumericObj, floatLabelType: 'Auto', cssClass: 'e-outline', step: 1, value: 5, placeholder: 'Enter the kg', appendTemplate: appendTemplate, change: onKgChange })),
                React.createElement("div", { className: "row custom-margin-row" },
                    React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { ref: iconNumericObj, floatLabelType: 'Auto', cssClass: 'e-filled', placeholder: 'Enter the Number', value: 10, showSpinButton: false, prependTemplate: prependIconTemplate, appendTemplate: appendIconTemplate })))),
