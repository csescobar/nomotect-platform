...
exports.numerictextboxRoutes = (React.createElement(React.Fragment, null,
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/numerictextbox/adornments', Component: adornments_functional_1.default })));
exports.numerictextboxCategory = { "default": { "name": "Default Functionalities", "category": "Numeric Textbox" }, "range-validation": { "name": "Range Validation", "category": "Numeric Textbox" }, "custom-format": { "name": "Custom Format", "category": "Numeric Textbox" }, "restrict-decimals": { "name": "Restrict Decimals", "category": "Numeric Textbox" }, "adornments": { "name": "Adornments", "category": "Numeric Textbox" }, "defaultSample": "numerictextbox/default" };
