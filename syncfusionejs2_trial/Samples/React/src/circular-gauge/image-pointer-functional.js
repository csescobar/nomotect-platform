        ...
        React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section row' },
                React.createElement("div", { className: 'col-lg-12' },
                    React.createElement(ej2_react_circulargauge_1.CircularGaugeComponent, { load: load.bind(_this), title: 'Shot Put Distance', background: 'transparent', loaded: onChartLoad.bind(_this), id: 'image-container', titleStyle: { fontFamily: 'inherit' }, centerY: "57%'" },
