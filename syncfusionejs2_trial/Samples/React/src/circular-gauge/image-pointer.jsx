        ...
        return (<main><div className='control-pane'>
                ...
                <div className='control-section row'>
                    <div className='col-lg-12'>
                        <CircularGaugeComponent load={this.load.bind(this)} title='Shot Put Distance' background='transparent' loaded={this.onChartLoad.bind(this)} id='image-container' titleStyle={{ fontFamily: 'inherit' }} centerY="57%'">
