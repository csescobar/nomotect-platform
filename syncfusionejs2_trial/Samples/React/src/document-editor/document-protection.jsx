        ...
        return (<div className='control-pane'>
            <div className="col-lg-9 control-section">
                ...
                <div id="documenteditor_container_body">
                    <DocumentEditorContainerComponent id="container" ref={(scope) => { this.container = scope; }} style={{ 'display': 'block' }} height={'590px'} toolbarMode={'Ribbon'} serviceUrl={this.hostUrl} enableToolbar={true} locale='en-US' documentEditorSettings={this.settings}/>
                </div>
            </div>
