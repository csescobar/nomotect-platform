...
var DocumentProtection = /** @class */ (function (_super) {
    ...
    function DocumentProtection() {
        ...
        _this.hostUrl = 'https://services.syncfusion.com/react/production/api/documenteditor/';
        ...
        _this.change = function (args) {
            if (args.checked) {
                _this.container.toolbarMode = 'Ribbon';
            }
            else {
                _this.container.toolbarMode = 'Toolbar';
            }
            _this.titleBar.showButtons(_this.container.toolbarMode != 'Ribbon');
        };
        return _this;
    }
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: "col-lg-9 control-section" },
                ...
                React.createElement("div", { id: "documenteditor_container_body" },
                    React.createElement(ej2_react_documenteditor_1.DocumentEditorContainerComponent, { id: "container", ref: function (scope) { _this.container = scope; }, style: { 'display': 'block' }, height: '590px', toolbarMode: 'Ribbon', serviceUrl: this.hostUrl, enableToolbar: true, locale: 'en-US', documentEditorSettings: this.settings }))),
