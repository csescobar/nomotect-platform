    ...
    return (<div className="control-pane">
            <div className="control-section">
                ...
                <div id="documenteditor_container_body">
                    <DocumentEditorContainerComponent id="container" ref={container} style={{ display: "block" }} height={"590px"} toolbarMode={"Ribbon"} serviceUrl={hostUrl} enableToolbar={true} locale="en-US" showPropertiesPane={false} enableTrackChanges={true} userColor={"#b70f34"} currentUser={"Nancy Davolio"}/>
                </div>
            </div>
