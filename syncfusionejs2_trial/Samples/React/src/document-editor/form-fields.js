        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                ...
                React.createElement("div", { id: "documenteditor_container_body" },
                    React.createElement(ej2_react_documenteditor_1.DocumentEditorContainerComponent, { id: "container", ref: function (scope) { _this.container = scope; }, style: { 'display': 'block' }, height: '590px', toolbarMode: 'Ribbon', serviceUrl: this.hostUrl, enableToolbar: true, showPropertiesPane: false, locale: 'en-US', documentEditorSettings: this.settings }))),
