...
var Toolbar = function () {
    ...
    var _b = (0, react_1.useState)(false), isSignDisabled = _b[0], setIsSignDisabled = _b[1];
    ...
    var bgColorRef = (0, react_1.useRef)('');
    var strokeColorRef = (0, react_1.useRef)('rgb(0, 0, 0)');
        ...
        React.createElement("div", { className: "col-lg-12 control-section" },
            React.createElement("div", { id: "signature-toolbar-control" },
                ...
                React.createElement("div", { id: "signature-control" },
                    React.createElement(ej2_react_inputs_2.SignatureComponent, { maxStrokeWidth: strokeWidth, backgroundColor: bgColorRef.current, strokeColor: strokeColorRef.current, id: "signature", change: onChange, ref: singnatureObj, disabled: isSignDisabled })))),
