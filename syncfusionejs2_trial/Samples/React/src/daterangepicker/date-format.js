...
var Format = /** @class */ (function (_super) {
    ...
    function Format() {
        ...
        _this.index = 3;
        _this.onChangeInputFormat = function (args) {
            // Update the class property
            _this.inputFormats = args.value || [];
            // Directly update the DateRangePicker instance
            if (_this.daterangepickerInstance) {
                _this.daterangepickerInstance.inputFormats = _this.inputFormats;
            }
        };
        return _this;
    }
            ...
            React.createElement("div", { className: 'control-section row' },
                React.createElement("div", { className: 'col-lg-7' },
                    React.createElement("div", { className: 'daterangepicker-control-section format' },
                        React.createElement(ej2_react_calendars_1.DateRangePickerComponent, { format: 'dd/MMM/yy hh:mm a', ref: function (calendar) { return _this.daterangepickerInstance = calendar; }, startDate: startValue, endDate: endValue, inputFormats: this.inputFormats }))),
                ...
                React.createElement("div", { id: "format", className: 'col-lg-4 property-section' },
                    React.createElement("div", null,
                        ...
                        React.createElement(ej2_react_dropdowns_1.MultiSelectComponent, { id: "inputFormatsDatePicker", ref: function (multiselect) { return _this.inputFormatInstance = multiselect; }, dataSource: this.inputFormatData, fields: this.checkFields, allowFiltering: false, placeholder: "e.g. MM/dd/yyyy", value: this.inputFormats, mode: "CheckBox", showSelectAll: true, showDropDownIcon: true, enableSelectionOrder: false, change: this.onChangeInputFormat },
