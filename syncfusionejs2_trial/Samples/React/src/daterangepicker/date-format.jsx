        ...
        <div className='control-section row'>
          <div className='col-lg-7'>
            <div className='daterangepicker-control-section format'>
              <DateRangePickerComponent format='dd/MMM/yy hh:mm a' ref={calendar => this.daterangepickerInstance = calendar} startDate={startValue} endDate={endValue} inputFormats={this.inputFormats}/>
            </div>
          </div>
          ...
          <div id="format" className='col-lg-4 property-section'>
            <div>
              ...
              <MultiSelectComponent id="inputFormatsDatePicker" ref={multiselect => this.inputFormatInstance = multiselect} dataSource={this.inputFormatData} fields={this.checkFields} allowFiltering={false} placeholder="e.g. MM/dd/yyyy" value={this.inputFormats} mode="CheckBox" showSelectAll={true} showDropDownIcon={true} enableSelectionOrder={false} change={this.onChangeInputFormat}>
