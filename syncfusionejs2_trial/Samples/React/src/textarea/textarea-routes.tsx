...
export const textareaRoutes = (
    <>
         ...
         <Route  path='/:theme/textarea/adornments' Component={ Adornments }/>
         <Route  path='/:theme/textarea/api' Component={ Api }/>

    </>
)

export const textareaCategory = {"default":{"name":"Default Functionalities","category":"TextArea"},"floating-label":{"name":"Floating Label","category":"TextArea"},"resize":{"name":"Resize","category":"TextArea"},"adornments":{"name":"Adornments","category":"TextArea"},"api":{"name":"API","category":"TextArea"},"defaultSample":"textarea/default"}