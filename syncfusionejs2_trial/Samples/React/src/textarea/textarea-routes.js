...
var adornments_functional_1 = require("./adornments-functional");
...
exports.textareaRoutes = (React.createElement(React.Fragment, null,
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/textarea/adornments', Component: adornments_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/textarea/api', Component: api_functional_1.default })));
exports.textareaCategory = { "default": { "name": "Default Functionalities", "category": "TextArea" }, "floating-label": { "name": "Floating Label", "category": "TextArea" }, "resize": { "name": "Resize", "category": "TextArea" }, "adornments": { "name": "Adornments", "category": "TextArea" }, "api": { "name": "API", "category": "TextArea" }, "defaultSample": "textarea/default" };
