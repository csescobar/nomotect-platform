...
var VirtualScrolling = function () {
    ...
    return (React.createElement("div", { className: "control-pane" },
        React.createElement("div", { className: "control-section" },
            React.createElement(ej2_react_treegrid_1.TreeGridComponent, { ref: function (g) { return treegrid.current = g; }, dataSource: data_1.virtualScrollData, enableVirtualization: true, idMapping: "TaskID", parentIdMapping: "ParentID", treeColumnIndex: 2, editSettings: editSettings, toolbar: toolbarOptions, height: "400", rowHeight: 50, clipMode: "EllipsisWithTooltip", actionBegin: actionBegin, load: load },
                React.createElement(ej2_react_treegrid_1.ColumnsDirective, null,
                    ...
                    React.createElement(ej2_react_treegrid_1.ColumnDirective, { field: "Status", headerText: "Status", width: "210", textAlign: "Center", template: statusTemplate, editType: "dropdownedit", validationRules: { required: true } }),
                    React.createElement(ej2_react_treegrid_1.ColumnDirective, { field: "Region", headerText: "Region", width: "180", editType: "dropdownedit", template: regionTemplate, validationRules: { required: true } }),
                    ...
                    React.createElement(ej2_react_treegrid_1.ColumnDirective, { field: "Priority", headerText: "Priority", width: "130", textAlign: "Center", template: priorityTemplate, editType: "dropdownedit", validationRules: { required: true } }),
                    React.createElement(ej2_react_treegrid_1.ColumnDirective, { field: "ComplianceScore", headerText: "Compliance Score", width: "180", textAlign: "Left", template: complianceTemplate, validationRules: { required: true }, editType: "numericedit", edit: { params: { format: "n" } } })),
