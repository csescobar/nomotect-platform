...
var EmployeeTreeGrid = function () {
    (0, react_1.useEffect)(function () {
        (0, sample_base_1.updateSampleSection)();
    }, []);
    var treeGridRef = (0, react_1.useRef)(null);
    var _a = (0, react_1.useState)('hr'), viewer = _a[0], setViewer = _a[1];
    var getBarHTML = function (value) {
    ...
    var getColumns = function (viewer) {
        var baseColumns = [
            {
                field: 'ID',
                headerText: 'ID',
            ...
            case 'helpdesk':
                return __spreadArray(__spreadArray([], baseColumns, true), [
                    ...
                    },
                    {
                        ...
                        clipMode: 'EllipsisWithTooltip',
                        template: function (props) { return (React.createElement("div", { className: "leave-bar-container" }, ['casual', 'earned', 'sick'].map(function (type) {
                            var _a;
                            return (React.createElement(React.Fragment, { key: type },
                                React.createElement("div", { className: "leave-bar" },
                                    ...
                                    React.createElement("div", { className: "bar ".concat(type), dangerouslySetInnerHTML: {
                                            __html: getBarHTML(((_a = props.LeaveAvailability) === null || _a === void 0 ? void 0 : _a[type]) || 0),
                                        } })),
    ...
    var handleViewerChange = function (e) {
        setViewer(e.value);
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement("div", { className: "viewer-container", style: { margin: '10px' } },
                ...
                React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { id: "viewer", dataSource: viewerRoles, fields: { text: 'role', value: 'id' }, value: viewer, change: handleViewerChange, placeholder: "Select Viewer Role" })),
            React.createElement(ej2_react_treegrid_1.TreeGridComponent, { key: viewer, id: "sample", ref: treeGridRef, dataSource: data_1.employeeData, childMapping: "Children", treeColumnIndex: 0, height: 400, allowSorting: true, allowFiltering: true, filterSettings: {
                    type: 'Menu',
                    hierarchyMode: 'None',
                    mode: 'Immediate',
                }, pageSettings: { pageSize: 10 }, enableHover: true, gridLines: "Both" },
                React.createElement(ej2_react_treegrid_1.ColumnsDirective, null, getColumns(viewer).map(function (col, idx) { return (React.createElement(ej2_react_treegrid_1.ColumnDirective, __assign({ key: idx }, col))); })),
...
exports.default = EmployeeTreeGrid;
