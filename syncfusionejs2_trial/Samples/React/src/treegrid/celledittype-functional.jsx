...
const EditType = () => {
    ...
    return (<div className="control-pane">
      <div className="control-section">
        <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping="subtasks" height="400" editSettings={editSettings} clipMode='EllipsisWithTooltip' pageSettings={pageSettings} toolbar={toolbarOptions}>
          <ColumnsDirective>
