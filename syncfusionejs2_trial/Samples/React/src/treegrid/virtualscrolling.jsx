    ...
    render() {
        ...
        return (<div className='control-pane'>
                <div className='control-section'>
                    <TreeGridComponent ref={(g) => this.treegrid = g} dataSource={virtualScrollData} idMapping="TaskID" parentIdMapping="ParentID" enableVirtualization={this.enableVirtualization} treeColumnIndex={2} editSettings={this.editSettings} toolbar={this.toolbarOptions} height='400' rowHeight={50} clipMode='EllipsisWithTooltip' actionBegin={this.actionBegin} load={this.load.bind(this)}>
                        <ColumnsDirective>
                            ...
                            <ColumnDirective field="Status" headerText="Status" width="210" textAlign="Center" template={this.statusTemplate} editType="dropdownedit" validationRules={{ required: true }}/>
                            <ColumnDirective field="Region" headerText="Region" width="180" editType="dropdownedit" template={this.regionTemplate} validationRules={{ required: true }}/>
                            ...
                            <ColumnDirective field="Priority" headerText="Priority" width="130" textAlign="Center" template={this.priorityTemplate} editType="dropdownedit" validationRules={{ required: true }}/>
                            <ColumnDirective field="ComplianceScore" headerText="Compliance Score" width="180" textAlign="Left" template={this.complianceTemplate} validationRules={{ required: true }} editType="numericedit" edit={{ params: { format: "n" } }}/>
                        </ColumnsDirective>
