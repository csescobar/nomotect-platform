...
var employee_functional_1 = require("./employee-functional");
var restaurant_menu_functional_1 = require("./restaurant-menu-functional");
...
var stickyheader_functional_1 = require("./stickyheader-functional");
...
var remotevirtual_functional_1 = require("./remotevirtual-functional");
...
exports.treegridRoutes = (React.createElement(React.Fragment, null,
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/treegrid/empty-record-template', Component: empty_record_template_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/treegrid/employee', Component: employee_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/treegrid/restaurant-menu', Component: restaurant_menu_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/treegrid/custom-binding', Component: custom_binding_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/treegrid/row-spanning', Component: row_spanning_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/treegrid/stickyheader', Component: stickyheader_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/treegrid/remotevirtual', Component: remotevirtual_functional_1.default }),
