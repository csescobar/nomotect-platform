      ...
      <div className="control-section">
        <TreeGridComponent dataSource={countries} childMapping="states" height="400" allowReordering={true} allowFiltering={true} allowSorting={true} filterSettings={{ type: "Menu", hierarchyMode: "Parent" }}>
          <ColumnsDirective>
            ...
            <ColumnDirective field="population" headerText="Population (Million)" valueAccessor={populationValue} textAlign="Right" width="250"></ColumnDirective>
            <ColumnDirective field="gdp" headerText="GDP Rate %" allowFiltering={false} width="155" template={gdptemplate}/>
