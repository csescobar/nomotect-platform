...
var Overview = /** @class */ (function (_super) {
    ...
    Overview.prototype.gridTemplate = function (props) {
        ...
        return (React.createElement("div", { style: { display: 'inline' } },
            ...
            React.createElement("div", { style: { display: 'inline-block', padding: '0px 6px', verticalAlign: 'middle' } }, props.name)));
    };
            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_treegrid_1.TreeGridComponent, { dataSource: data_1.countries, childMapping: 'states', height: '400', allowReordering: true, allowFiltering: true, allowSorting: true, filterSettings: { type: 'Menu', hierarchyMode: 'Parent' } },
                    React.createElement(ej2_react_treegrid_1.ColumnsDirective, null,
                        ...
                        React.createElement(ej2_react_treegrid_1.ColumnDirective, { field: 'population', headerText: 'Population (Million)', valueAccessor: this.populationValue, textAlign: 'Right', width: '250' }),
                        React.createElement(ej2_react_treegrid_1.ColumnDirective, { field: 'gdp', headerText: 'GDP Rate %', allowFiltering: false, width: '155', template: this.gdptemplate }),
                        ...
                        React.createElement(ej2_react_treegrid_1.ColumnDirective, { field: 'timezone', headerText: 'Time Zone', width: '180', template: this.timezonetemplate })),
