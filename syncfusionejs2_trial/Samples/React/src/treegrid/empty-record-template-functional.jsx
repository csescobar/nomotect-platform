...
const EmptyRecordTemplate = () => {
    ...
    const onDataBound = () => {
        ...
        const filterMenudivs = treegridRef.current?.element.querySelectorAll('.e-filtermenudiv');
    ...
    return (<div className="control-pane">
            <div className="control-section">
                ...
                <TreeGridComponent id="TreeGrid" ref={treegridRef} dataSource={[]} treeColumnIndex={1} childMapping="subtasks" emptyRecordTemplate={template.bind(this)} toolbar={['Add', 'Delete', 'Update', 'Cancel', 'Search']} editSettings={{ allowEditing: true, allowAdding: true, allowDeleting: true }} allowPaging={true} allowSorting={true} allowFiltering={true} filterSettings={{ type: 'Menu' }} dataBound={onDataBound.bind(this)} actionComplete={onActionComplete.bind(this)}>
                    <ColumnsDirective>
