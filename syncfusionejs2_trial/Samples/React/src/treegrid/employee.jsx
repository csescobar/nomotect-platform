...
export class EmployeeTreeGrid extends SampleBase {
    treeGridRef = createRef();
    constructor(props) {
        super(props);
        this.state = { viewer: 'hr' };
    }
    handleViewerChange = (args) => {
        this.setState({ viewer: args.value });
        this.treeGridRef.clearFiltering();
        this.treeGridRef.clearSorting();
    };
    getBarHTML(value) {
    ...
    getColumns(viewer) {
        const baseColumns = [
            ...
            },
            {
                ...
                width: 280,
                clipMode: 'EllipsisWithTooltip',
                template: (props) => (<div className="employee-content">
                        <img src={`src/treegrid/images/${props.FullName}.png`} alt={props.FullName} className="employee-img"/>
            ...
            case 'hr':
                return [
                    ...baseColumns,
                    {
                        ...
                        width: 200,
                        clipMode: 'EllipsisWithTooltip',
                        template: (props) => (<div className="flag-container">
                                <img src={`src/treegrid/images/${props.Location}.png`} className="flag-img" alt={props.Location}/>
                    ...
                    },
                    {
                        ...
                        width: 200,
                        clipMode: 'EllipsisWithTooltip',
                        template: (props) => (<a href={`mailto:${props.Email}`} className="email-link">
                                {props.Email}
                            </a>),
                    },
                ];
            ...
            case 'helpdesk':
                return [
                    ...
                    },
                    {
                        ...
                        clipMode: 'EllipsisWithTooltip',
                        template: (props) => (<div className="leave-bar-container">
                                {['casual', 'earned', 'sick'].map((type) => (<React.Fragment key={type}>
                                        <div className="leave-bar">
                                            <span className="leave-label">
                                                {type.charAt(0).toUpperCase() + type.slice(1)}
                                            </span>
                                            <div className={`bar ${type}`} dangerouslySetInnerHTML={{
        ...
        return (<div className='control-pane'>
                <div className='control-section'>
                    <div className="viewer-container" style={{ margin: '10px' }}>
                        ...
                        <DropDownListComponent id="viewer" dataSource={viewerRoles} fields={{ text: 'role', value: 'id' }} value={viewer} change={this.handleViewerChange} placeholder="Select Viewer Role"/>
                    </div>

                    <TreeGridComponent key={viewer} id="sample" ref={this.treeGridRef} dataSource={employeeData} childMapping="Children" treeColumnIndex={0} height={400} allowSorting={true} allowFiltering={true} filterSettings={{
                type: 'Menu',
                hierarchyMode: 'None',
                mode: 'Immediate',
                ...
                <div id='description'>
                    <p>
                        This section highlights dynamic column generation and custom templates to present data that is specific and relevant to each viewer role. Features such as <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/treegrid/sorting">
                            Sorting</a>, <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/treegrid/filtering/filtering#filter-hierarchy-modes">
                            Filtering with hierarchical support</a> and <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/treegrid/columns/columns#format">
                            Column formatting</a> are seamlessly integrated. The Tree Grid <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/treegrid/columns/column-template">
