...
export class CustomAggregate extends SampleBase {
    ...
    pdfAggregateQueryCellInfo = (args) => {
        if (args.cell.column.headerText === "Category") {
            args.value = "Count of " + this.item + " : " + args.row.data.category.Custom;
        }
    };
    render() {
        ...
        <div className='control-section'>
          <TreeGridComponent dataSource={summaryData} treeColumnIndex={1} gridLines="Both" childMapping='subtasks' height='400' allowExcelExport={true} allowPdfExport={true} excelAggregateQueryCellInfo={this.excelAggregateQueryCellInfo.bind(this)} pdfAggregateQueryCellInfo={this.pdfAggregateQueryCellInfo.bind(this)} ref={treegrid => this.treegridObj = treegrid} toolbarClick={this.toolbarClick.bind(this)} toolbar={this.toolbarOptions} dataBound={this.dataBound.bind(this)}>
                  <ColumnsDirective>
