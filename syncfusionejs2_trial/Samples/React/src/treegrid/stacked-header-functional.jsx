...
const Stacked = () => {
    ...
    return (<div className="control-pane">
      <div className="control-section">
        <TreeGridComponent dataSource={stackedData} id="TreeGrid" ref={(treegrid) => { treegridInstance = treegrid; }} treeColumnIndex={1} childMapping="subtasks" height="350" allowPaging={true} pageSettings={{ pageCount: 5 }} showColumnChooser={true} columnChooserSettings={columnChooserSettings} toolbar={toolbar} clipMode='EllipsisWithTooltip'>
          <ColumnsDirective>
