...
const RemoteVirtual = () => {
    ...
    return (<div className="control-pane">
      <div className="control-section">
        <TreeGridComponent dataSource={data} idMapping="TaskID" parentIdMapping="ParentValue" hasChildMapping="isParent" expandStateMapping="IsExpanded" height="450" enableVirtualization={true} loadChildOnDemand={true} pageSettings={{ pageSize: 20 }} treeColumnIndex={1}>
          <ColumnsDirective>
