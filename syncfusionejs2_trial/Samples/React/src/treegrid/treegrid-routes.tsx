...
import EmployeeTreeGrid from './employee-functional';
import RestaurantMenu from './restaurant-menu-functional';
...
import RowSpanningAPI from './row-spanning-functional';
...
import StickyHeader from './stickyheader-functional';
...
import RemoteVirtual from './remotevirtual-functional';
...
export const treegridRoutes = (
    <>
         ...
         <Route  path='/:theme/treegrid/empty-record-template' Component={ EmptyRecordTemplate }/>
         <Route  path='/:theme/treegrid/employee' Component={ EmployeeTreeGrid }/>
         <Route  path='/:theme/treegrid/restaurant-menu' Component={ RestaurantMenu }/>
         ...
         <Route  path='/:theme/treegrid/custom-binding' Component={ CustomBinding }/>
         ...
         <Route  path='/:theme/treegrid/row-spanning' Component={ RowSpanningAPI }/>
         ...
         <Route  path='/:theme/treegrid/stickyheader' Component={ StickyHeader }/>
         ...
         <Route  path='/:theme/treegrid/remotevirtual' Component={ RemoteVirtual }/>
