    ...
    DefaultScrolling.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_treegrid_1.TreeGridComponent, { dataSource: data_1.sampleData, childMapping: 'subtasks', treeColumnIndex: 1, height: '400' },
                    React.createElement(ej2_react_treegrid_1.ColumnsDirective, null,
                        ...
                        React.createElement(ej2_react_treegrid_1.ColumnDirective, { field: 'approved', headerText: 'Approved', textAlign: 'Center', width: '120' })))),
            ...
            React.createElement("div", { id: "description" },
                React.createElement("p", null, "The Tree Grid will show scrollbars when the content exceeds the element's width or height. The vertical and horizontal scrollbars will be displayed based on the following criteria."),
                React.createElement("ul", null,
                    React.createElement("li", null, "The vertical scrollbar appears when the total height of rows in the Tree Grid exceeds its element's height."),
                    React.createElement("li", null, "The horizontal scrollbar appears when the sum of the column`s width exceeds the Tree Grid element's width.")),
                React.createElement("p", null,
                    ...
                    " properties are used to set the Tree Grid height and width, respectively. The value of these properties can be a numeric, pixel(",
                ...
                React.createElement("p", null,
                    ...
                    ", respectively. Now, the Tree Grid will render with a vertical scrollbar when the total height of rows exceeds its element height and horizontal scrollbar will appear when the total column width exceeds the element's width."),
                React.createElement("p", null,
