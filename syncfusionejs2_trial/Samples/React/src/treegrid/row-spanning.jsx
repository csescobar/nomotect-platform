    ...
    render() {
        return (<div className="control-pane">
                <div className="control-section">
                    <TreeGridComponent dataSource={rowSpanData} enableHover={false} allowSelection={false} allowPaging={true} pageSettings={{ pageSizeMode: 'All', pageSize: 18 }} rowHeight={50} gridLines='Both' enableColumnSpan={true} enableRowSpan={true} height={400} childMapping='children' treeColumnIndex={0} clipMode='EllipsisWithTooltip'>

                        <ColumnsDirective>
                            <ColumnDirective field="activityName" headerText="Phase Name" width="250" freeze="Left"/>
                            <ColumnDirective headerText="Schedule" textAlign="Center" columns={[
                ...
                { field: 'endDate', headerText: 'End Date', type: 'date', format: 'MM/dd/yyyy', width: 140, textAlign: 'Center' }
                            ...
                            <ColumnDirective headerText="Work Status" textAlign="Center" columns={[
                { field: 'status', headerText: 'Status', width: 180, textAlign: 'Center' }
            ]}/>
                            <ColumnDirective headerText="Compliance" textAlign="Center" columns={[
                ...
                { field: 'punchListStatus', headerText: 'Punch List Status', width: 180, textAlign: 'Center' }
                            ...
                            <ColumnDirective headerText="Personnel" textAlign="Center" columns={[
                { field: 'supervisor', headerText: 'Supervisor', width: 180 },
                { field: 'team', headerText: 'Crew', width: 200 }
            ]}/>
                            <ColumnDirective headerText="Materials" textAlign="Center" columns={[
                ...
                { field: 'materialCost', headerText: 'Material Cost', width: 140, format: 'C2', textAlign: 'Right', enableRowSpan: false }
                            ...
                            <ColumnDirective headerText="Cost Summary" textAlign="Center" columns={[
