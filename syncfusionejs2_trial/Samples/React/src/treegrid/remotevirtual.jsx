...
import { TreeGridComponent, ColumnsDirective, ColumnDirective, Page, Inject, VirtualScroll, } from '@syncfusion/ej2-react-treegrid';
...
export class RemoteVirtual extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
          <TreeGridComponent dataSource={this.data} ref={treegrid => this.treegridInstance = treegrid} idMapping="TaskID" parentIdMapping="ParentValue" hasChildMapping="isParent" expandStateMapping="IsExpanded" height="450" enableVirtualization={true} loadChildOnDemand={true} pageSettings={{ pageSize: 20 }} treeColumnIndex={1}>
            <ColumnsDirective>
              <ColumnDirective field="TaskID" headerText="Task ID" isPrimaryKey={true} width="80" textAlign="Right"></ColumnDirective>
