...
var Template = function () {
    ...
    var focusInputElement = function (item, args) {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section tbar-control-section' },
            React.createElement("div", { className: 'control toolbar-sample tbar-sample', style: { margin: '150px 0', width: '100%', maxWidth: '100%' } },
                React.createElement(ej2_react_navigations_1.ToolbarComponent, { overflowMode: 'Popup', cssClass: 'template', keyDown: handleKeyDown },
                    React.createElement(ej2_react_navigations_1.ItemsDirective, null,
                        ...
                        React.createElement(ej2_react_navigations_1.ItemDirective, { type: 'Separator' }),
                        React.createElement(ej2_react_navigations_1.ItemDirective, { prefixIcon: 'e-icons e-zoom-out', tooltipText: 'Zoom-Out', text: 'Zoom-Out', showTextOn: 'Overflow', align: "Left", tabIndex: 0 }),
                        ...
                        React.createElement(ej2_react_navigations_1.ItemDirective, { type: 'Separator' }),
                        React.createElement(ej2_react_navigations_1.ItemDirective, { prefixIcon: 'e-icons e-mouse-pointer', tooltipText: 'Text selection tool', text: 'Selection', showTextOn: 'Overflow', align: "Left", tabIndex: 0 }),
                        ...
                        React.createElement(ej2_react_navigations_1.ItemDirective, { type: 'Separator' }),
                        React.createElement(ej2_react_navigations_1.ItemDirective, { prefixIcon: 'e-pv-comment-icon', tooltipText: 'Add Comments', text: 'Add Comments', showTextOn: 'Overflow', align: "Left", tabIndex: 0 }),
                        React.createElement(ej2_react_navigations_1.ItemDirective, { type: 'Separator' }),
                        React.createElement(ej2_react_navigations_1.ItemDirective, { text: 'Submit Form', align: "Left", tabIndex: 0 }),
