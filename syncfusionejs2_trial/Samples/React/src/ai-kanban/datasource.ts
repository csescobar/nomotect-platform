...
export let pizzaData: PizzaDataModel[] = [
    {
        ...
        ImageURL: "https://blazor.syncfusion.com/demos/_content/blazor_server_common_net10/images/kanban/menu-01.png",
        Price: "$4.79",
    ...
    },
    {
        ...
        CardTags: ["Onions", "Pepper", "Cheese"],
        ImageURL: "https://blazor.syncfusion.com/demos/_content/blazor_server_common_net10/images/kanban/menu-02.png",
        Price: "$14.99",
        Date: new Date(new Date().getFullYear(), new Date().getMonth(), 10),
        Feedback: "",
        SentimentScore: 0,
    ...
    },
    {
        ...
        CardTags: ["BBQ", "Prawn"],
        ImageURL: "https://blazor.syncfusion.com/demos/_content/blazor_server_common_net10/images/kanban/menu-07.png",
        Price: "$14.99",
        Date: new Date(new Date().getFullYear(), new Date().getMonth(), 10),
        Feedback: "",
        SentimentScore: 0,
    ...
    },
    {
        ...
        ImageURL: "https://blazor.syncfusion.com/demos/_content/blazor_server_common_net10/images/kanban/menu-13.png",
        Price: "$4.79",
        Date: new Date(new Date().getFullYear(), new Date().getMonth(), 10),
        SentimentScore: 0,
        Emoji: ""
    },
    {
        ...
        ImageURL: "https://blazor.syncfusion.com/demos/_content/blazor_server_common_net10/images/kanban/menu-10.png",
        Price: "$11.99",
        Date: new Date(new Date().getFullYear(), new Date().getMonth(), 10),
        SentimentScore: 0,
        Emoji: ""
    },
    {
        ...
        ImageURL: "https://blazor.syncfusion.com/demos/_content/blazor_server_common_net10/images/kanban/menu-15.png",
        Price: "$4.79",
        Date: new Date(new Date().getFullYear(), new Date().getMonth(), 10),
        Feedback: "",
        SentimentScore: 0,
    ...
    },
    {
        ...
        ImageURL: "https://blazor.syncfusion.com/demos/_content/blazor_server_common_net10/images/kanban/menu-18.png",
        Price: "$4.99",
        Date: new Date(new Date().getFullYear(), new Date().getMonth(), 10),
        Feedback: "",
        SentimentScore: 0,
    ...
    },
    {
        ...
        ImageURL: "https://blazor.syncfusion.com/demos/_content/blazor_server_common_net10/images/kanban/menu-20.png",
        Price: "$11.99",
        Date: new Date(new Date().getFullYear(), new Date().getMonth(), 10),
        Feedback: "",
        SentimentScore: 0,
