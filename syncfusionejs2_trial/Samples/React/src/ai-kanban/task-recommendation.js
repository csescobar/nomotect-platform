...
var ai_task_recommendation_1 = require("./ai-task-recommendation");
/* custom code start*/
...
var TaskRecommendation = /** @class */ (function (_super) {
    ...
    TaskRecommendation.prototype.componentDidMount = function () {
        (0, sample_base_2.updateAISampleSection)();
    };
    TaskRecommendation.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement(ai_task_recommendation_1.default, null)),
