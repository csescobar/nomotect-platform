...
function AiSmartRecommendation() {
        ...
        try {
            if (taskCount && projectDetails) {
                ...
                result.then(function (result) {
                    try {
                        var data = result.replace(/```json/gi, '').replace(/```/g, '').trim();
    ...
    function getResponseFromOpenAI(promptQuery) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, ai_service_1.OpenAiModelKanban)(promptQuery)];
                    case 1:
                        content = _a.sent();
        ...
        return (React.createElement("div", { className: "card-template" },
            ...
            React.createElement("div", { className: "e-card-content" },
                React.createElement("div", { className: "e-text e-tooltip-text" },
                    "$",
                    data.Description)),
            React.createElement("div", { className: "e-card-footer", style: { padding: '7px 14px' } },
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { id: "container" },
            ...
            React.createElement("div", { className: "rows row-large", id: "homecontainer" },
            ...
            React.createElement("div", { className: "rows", id: "toast-kanban-observable", style: { height: '100%', display: 'none', boxShadow: 'none', border: 'none', marginTop: '5px', paddingTop: '5px' } },
...
exports.default = AiSmartRecommendation;
