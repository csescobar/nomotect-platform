...
export const aikanbanCategory = {"task-recommendation":{"name":"AI Task Recommendation","category":"Kanban"},"sentiment-analysis":{"name":"Sentiment Analysis","category":"Kanban"},"defaultSample":"ai-kanban/task-recommendation"}