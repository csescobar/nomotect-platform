...
var Wizard = function () {
    ...
    var _d = (0, react_1.useState)(false), dialogReady = _d[0], setDialogReady = _d[1];
    ...
    return (React.createElement("div", null,
        React.createElement("div", { className: "col-lg-12 control-section e-tab-section" },
            React.createElement("div", { className: "e-sample-resize-container" },
                ...
                dialogReady && (React.createElement(ej2_react_popups_1.DialogComponent, { ref: alertDlg, header: "Success", width: 250, isModal: true, visible: false, showCloseIcon: true, content: "Your payment was successfully processed", target: "#tab-wizard", buttons: dlgButtons, created: dlgCreated })))),
