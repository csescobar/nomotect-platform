    ...
    render() {
        ...
        <div className="col-lg-12 control-section e-tab-section">
          <div className="e-sample-resize-container">
            ...
            {state.dialogReady && (<DialogComponent ref={dialog => (this.alertDlg = dialog)} header="Success" width={250} isModal={true} visible={false} showCloseIcon={true} content="Your payment was successfully processed" target={this.dlgTarget} buttons={this.dlgButtons} created={this.dlgCreated.bind(this)}/>)}
          </div>
        </div>
