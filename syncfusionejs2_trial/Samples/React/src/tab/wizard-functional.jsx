    ...
    return (<div>
            <div className="col-lg-12 control-section e-tab-section">
                <div className="e-sample-resize-container">
                    ...
                    {dialogReady && (<DialogComponent ref={alertDlg} header="Success" width={250} isModal={true} visible={false} showCloseIcon={true} content="Your payment was successfully processed" target="#tab-wizard" buttons={dlgButtons} created={dlgCreated}/>)}
                </div>
            </div>
