    ...
    return (React.createElement("div", { className: "control-section" },
        React.createElement("div", { className: "row skeleton-row" },
            React.createElement("div", { className: "col-sm-6 container" },
                ...
                React.createElement(ej2_react_notifications_1.SkeletonComponent, { className: 'skeleton', id: 'skeletonCircleSmall', shape: 'Circle', width: '1.875rem' }),
            ...
            React.createElement("div", { className: "col-sm-6 container" },
                ...
                React.createElement(ej2_react_notifications_1.SkeletonComponent, { className: 'skeleton', id: 'skeletonSquareSmall', shape: 'Square', width: '1.875rem' }),
