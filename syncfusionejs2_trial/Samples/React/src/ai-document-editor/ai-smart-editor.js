...
function SmartEditor() {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { id: 'container', style: { height: "100%", width: "100%" } },
            ...
            React.createElement(ej2_react_documenteditor_1.DocumentEditorContainerComponent, { ref: container, id: 'DocumentEditor', style: { height: "99%", width: "100%" }, enableToolbar: true, height: '99%', width: '100%', serviceUrl: 'https://services.syncfusion.com/react/production/api/documenteditor/' },
