...
function WritingAssist() {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { id: 'container', style: { height: "100%" } },
            ...
            React.createElement(ej2_react_documenteditor_1.DocumentEditorContainerComponent, { id: 'DocumentEditor', ref: container, enableToolbar: true, height: '99%', serviceUrl: 'https://services.syncfusion.com/react/production/api/documenteditor/', toolbarItems: [
