...
function SmartEditor() {
    ...
    return (<>
            <div id='container' style={{ height: "100%", width: "100%" }}>
                ...
                <DocumentEditorContainerComponent ref={container} id='DocumentEditor' style={{ height: "99%", width: "100%" }} enableToolbar={true} height='99%' width='100%' serviceUrl='https://services.syncfusion.com/react/production/api/documenteditor/'>
