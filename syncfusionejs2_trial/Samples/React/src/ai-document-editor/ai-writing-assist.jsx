...
function WritingAssist() {
    ...
    return (<>
            <div id='container' style={{ height: "100%" }}>
                ...
                <DocumentEditorContainerComponent id='DocumentEditor' ref={container} enableToolbar={true} height='99%' serviceUrl='https://services.syncfusion.com/react/production/api/documenteditor/' toolbarItems={[
