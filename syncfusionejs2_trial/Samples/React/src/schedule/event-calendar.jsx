...
import { ScheduleComponent, Day, Week, WorkWeek, Month, Agenda, Inject, Resize, DragAndDrop, ResourcesDirective, ResourceDirective, TimelineMonth, Year, resetTime, ViewsDirective, ViewDirective, addDays } from '@syncfusion/ej2-react-schedule';
    ...
    render() {
        return (<div id="event-calendar-sample" className="control-section event-calendar-control-section">
                <div className="control-wrapper">
                    ...
                    <SidebarComponent id="sidebar-left" className="sidebar-treeview" ref={(sidebar) => this.calendarSidebarObj = sidebar} width={'320px'} height={'550px'} enableGestures={false} target={'.main-content'} mediaQuery={'(min-width: 600px)'} isOpen={true}>
                    ...
                    <div className="main-content" id="main-text">
                        <div className="sidebar-content">
                            ...
                            <div className="unplanned-container">
                                ...
                                <SidebarComponent ref={(rightSidebarObj) => this.unPlannedSidebarObj = rightSidebarObj} id="sidebar-right" position={'Right'} width={'300px'} enableGestures={false} target={'.main-content'} type="Push" isOpen={false} created={this.unplannedSideBarCreated} close={this.unplannedSidebarClosed}>
