...
var Views = function () {
    ...
    var onViewChange = function (args) {
        var _a;
        scheduleObj.current.currentView = args.value;
    ...
    return (React.createElement("div", { className: 'schedule-control-section' },
        React.createElement("div", { className: 'col-lg-9 control-section' },
            React.createElement("div", { className: 'control-wrapper' },
                React.createElement(ej2_react_schedule_1.ScheduleComponent, { width: '100%', height: '650px', ref: scheduleObj, selectedDate: new Date(2021, 1, 15), eventSettings: { dataSource: data }, eventRendered: onEventRendered },
                        ...
                        React.createElement("tr", { style: { height: '50px' } },
                            React.createElement("td", { style: { width: '100%' } },
                                React.createElement("div", null,
                                    React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { style: { padding: '6px' }, value: 'Week', fields: fields, dataSource: viewOptions, change: onViewChange, placeholder: 'Current View', floatLabelType: 'Always' })))))))),
