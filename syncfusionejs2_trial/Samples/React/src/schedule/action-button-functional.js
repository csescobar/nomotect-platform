...
var ActionButton = function () {
    ...
    var schedulePopupClose = function (args) {
    ...
    var isAllDayEvent = function (props) {
    ...
    var cloneEvent = function (event) { return JSON.parse(JSON.stringify(event)); };
    var isShortEvent = function (props, isAllDay) {
        var start = new Date(props.StartTime);
        var end = new Date(props.EndTime);
        var diffMinutes = (end.getTime() - start.getTime()) / (1000 * 60);
        return diffMinutes <= 45 || isAllDay;
    };
    var isSpannedEvent = function (props) {
        if (!scheduleObj.current)
            return false;
        var viewDates = scheduleObj.current.getCurrentViewDates();
    ...
    var getActionButtonStyle = function (isAllDay) {
        if (isAllDay === void 0) { isAllDay = false; }
        return (__assign(__assign({ position: 'absolute', top: isAllDay ? '0px' : '6px' }, (scheduleObj.current.enableRtl
            ? { left: '6px' }
            : { right: '6px' })), { display: 'flex', gap: '4px' }));
    };
    var dayEventTemplate = function (props) {
        var start = new Date(props.StartTime);
        var end = new Date(props.EndTime);
        ...
        var isAllDay = isAllDayEvent(props);
        var isSpanned = isSpannedEvent(props);
        ...
        return (React.createElement("div", null,
            React.createElement("div", null,
                ...
                !showOnlyText && (React.createElement("div", null,
                    ...
                    " - ",
                    endTimeStr))),
            showIcons && (React.createElement("div", { style: getActionButtonStyle(isAllDay) },
    ...
    var weekEventTemplate = function (props) {
        var start = new Date(props.StartTime);
        var startTimeStr = start.toLocaleTimeString([], {
            hour: '2-digit',
            minute: '2-digit',
        ...
        var isAllDay = isAllDayEvent(props);
        var shortEvent = isShortEvent(props, isAllDay);
        var isSpanned = isSpannedEvent(props);
        var showOnlyText = isAllDay || isSpanned;
        var showIcons = !isSpanned;
        return (React.createElement("div", null,
            ...
            shortEvent ? ((showIcons && React.createElement("div", { style: getActionButtonStyle(isAllDay) },
                React.createElement("div", { className: "e-icons e-edit", onClick: handleEdit, style: {
                        width: '24px',
                        height: '24px',
                        display: 'flex',
    ...
    return (React.createElement("div", { id: "event-calendar-sample", className: "control-section event-calendar-control-section" },
        React.createElement("div", { className: "control-wrapper" },
            ...
            React.createElement(ej2_react_navigations_1.SidebarComponent, { id: "sidebar-left", className: "sidebar-treeview", ref: calendarSidebarObj, width: '255px', height: '550px', target: '.main-content', mediaQuery: '(min-width: 600px)', isOpen: true },
            ...
            React.createElement("div", { className: "main-content", id: "main-text" },
                React.createElement("div", { className: "sidebar-content" },
                    React.createElement("div", { className: "schedule-container" },
                        React.createElement(ej2_react_schedule_1.ScheduleComponent, { id: "Schedule", ref: scheduleObj, height: '550px', selectedDate: currentDate, currentView: base_1.Browser.isDevice ? 'Day' : 'Week', showHeaderBar: false, eventSettings: eventSettings, eventRendered: eventRendered, popupOpen: schedulePopupOpen, popupClose: schedulePopupClose, created: updateDateRange, allowDragAndDrop: false, actionComplete: onScheduleActionComplete },
                            React.createElement(ej2_react_schedule_1.ResourcesDirective, null,
                                React.createElement(ej2_react_schedule_1.ResourceDirective, { field: 'ResourceId', title: 'Resources', name: 'Resources', dataSource: resourceData, textField: 'name', idField: 'id', colorField: 'color' })),
                            React.createElement(ej2_react_schedule_1.ViewsDirective, null,
                                React.createElement(ej2_react_schedule_1.ViewDirective, { option: 'Day', eventTemplate: dayEventTemplate, allowOverlap: false }),
                                !base_1.Browser.isDevice && (React.createElement(ej2_react_schedule_1.ViewDirective, { option: 'Week', eventTemplate: weekEventTemplate, allowOverlap: false }))),
