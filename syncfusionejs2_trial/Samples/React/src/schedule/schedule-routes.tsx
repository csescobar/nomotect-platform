...
import EmployeeShiftManagement from './employee-shift-management-functional';
import EventManagement from './event-management-functional';
import TableReservation from './table-reservation-functional';
import SchedulerWithChart from './integration-with-chart-functional';
import ActionEventButtons from './action-event-buttons-functional';
import CascadingEventEditor from './cascading-event-editor-functional';
...
import LimitConcurrentEvents from './limit-concurrent-events-functional';
...
export const scheduleRoutes = (
    <>
         ...
         <Route  path='/:theme/schedule/employee-shift-management' Component={ EmployeeShiftManagement }/>
         <Route  path='/:theme/schedule/event-management' Component={ EventManagement }/>
         <Route  path='/:theme/schedule/table-reservation' Component={ TableReservation }/>
         <Route  path='/:theme/schedule/integration-with-chart' Component={ SchedulerWithChart }/>
         <Route  path='/:theme/schedule/action-event-buttons' Component={ ActionEventButtons }/>
         <Route  path='/:theme/schedule/cascading-event-editor' Component={ CascadingEventEditor }/>
         ...
         <Route  path='/:theme/schedule/limit-concurrent-events' Component={ LimitConcurrentEvents }/>
