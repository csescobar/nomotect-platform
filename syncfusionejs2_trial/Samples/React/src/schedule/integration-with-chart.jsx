    ...
    render() {
        return (<div className='schedule-control-section'>
          <div className="col-lg-12 schedule-with-chart control-section">
            <div className="schedule-content-wrapper">
              <div className="modern-layout" style={{ display: 'flex', gap: '10px' }}>
                ...
                <div id="scheduler" className="scheduler-wrapper">
                  <ScheduleComponent ref={(s) => (this.schedule = s)} height="650px" width="100%" selectedDate={new Date(2026, 0, 12)} views={['TimelineMonth']} allowOverlap={false} resourceHeaderTemplate={this.resourceTemplate} headerIndentTemplate={this.headerIndentTemplate} group={{
                resources: ['TruckDetails'],
                headerTooltipTemplate: { this: this.tooltipTemplate }
            }} eventSettings={{ dataSource: this.events }} actionComplete={(args) => {
                if (args.requestType === 'eventCreated' ||
                    ...
                    <ResourcesDirective>
                      <ResourceDirective name="TruckDetails" field="DriverID" dataSource={this.drivers} textField="driver" idField="id" colorField="color"/>
                    </ResourcesDirective>
                ...
                <div id="chart-container" className="chart-section">
                  <div className="chart-header">
                    ...
                    <div id="chart-ddl" className="dropdown-wrapper">
                      <DropDownListComponent width="100%" value={this.currentMode} placeholder="Select Metric" fields={{ text: 'text', value: 'value' }} dataSource={[
            ...
            }} legendSettings={{ visible: false }} load={this.load.bind(this)} tooltip={{ enable: true, enableHighlight: true }} pointRender={(args) => {
                let driver;
                if (this.currentMode === 'capacity') {
                    driver = this.drivers.find((d) => d.truck === args.point?.x);
                }
                else {
                    driver = this.drivers.find((d) => d.driver === args.point?.x);
                }
                if (driver) {
