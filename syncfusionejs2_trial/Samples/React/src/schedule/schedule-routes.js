...
var employee_shift_management_functional_1 = require("./employee-shift-management-functional");
var event_management_functional_1 = require("./event-management-functional");
var table_reservation_functional_1 = require("./table-reservation-functional");
var integration_with_chart_functional_1 = require("./integration-with-chart-functional");
var action_event_buttons_functional_1 = require("./action-event-buttons-functional");
var cascading_event_editor_functional_1 = require("./cascading-event-editor-functional");
...
var limit_concurrent_events_functional_1 = require("./limit-concurrent-events-functional");
...
exports.scheduleRoutes = (React.createElement(React.Fragment, null,
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/schedule/employee-shift-management', Component: employee_shift_management_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/schedule/event-management', Component: event_management_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/schedule/table-reservation', Component: table_reservation_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/schedule/integration-with-chart', Component: integration_with_chart_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/schedule/action-event-buttons', Component: action_event_buttons_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/schedule/cascading-event-editor', Component: cascading_event_editor_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/schedule/limit-concurrent-events', Component: limit_concurrent_events_functional_1.default }),
