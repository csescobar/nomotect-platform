    ...
    return (React.createElement("div", { className: 'schedule-control-section' },
        React.createElement("div", { className: 'col-lg-9 control-section' },
            React.createElement("div", { className: 'control-wrapper' },
                React.createElement(ej2_react_schedule_1.ScheduleComponent, { height: '650px', ref: scheduleObj, selectedDate: new Date(2021, 0, 10), workDays: workDays, eventSettings: { dataSource: data } },
                        ...
                        React.createElement("tr", { style: { height: '50px' } },
                            React.createElement("td", { style: { width: '100%' } },
                                React.createElement("div", { className: 'datepicker-control-section' },
                                    React.createElement(ej2_react_calendars_1.DatePickerComponent, { value: new Date(2021, 0, 10), showClearButton: false, change: change, placeholder: 'Current Date', floatLabelType: 'Always' })))))))),
