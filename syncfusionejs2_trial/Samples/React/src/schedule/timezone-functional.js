    ...
    return (React.createElement("div", { className: 'schedule-control-section' },
        React.createElement("div", { className: 'col-lg-12 control-section' },
            React.createElement("div", { className: 'control-wrapper' },
                ...
                React.createElement(ej2_react_schedule_1.ScheduleComponent, { width: '100%', height: '650px', ref: scheduleObj, selectedDate: new Date(2021, 5, 20), timezone: 'UTC', workHours: { start: '11:00' }, eventSettings: { dataSource: fifaEvents }, eventRendered: onEventRendered },
