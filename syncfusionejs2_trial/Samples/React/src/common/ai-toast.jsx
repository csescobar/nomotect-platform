...
export default function AIToast() {
    ...
    function contentTemplate() {
        return (<div className='ai-toast-content-child' style={{
                display: 'flex',
                ...
                <button onClick={() => toastInstance.hide()} style={{
                background: 'none',
                border: 'none',
                cursor: 'pointer',
                fontSize: '16px',
    ...
    return (<ToastComponent className='ai-toast' width={420} ref={toast => toastInstance = toast} content={contentTemplate} created={toastCreated.bind(this)} position={{ X: "Right", Y: "Top" }} timeOut={0} newestOnTop={true}/>);
}
;
