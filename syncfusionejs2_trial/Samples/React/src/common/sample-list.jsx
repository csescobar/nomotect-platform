...
export let samplesList = [
    ...
    },
    {
        ...
        'samples': AIGridSampleOrder.concat(AIDiagramSampleOrder, ComboBoxAISampleOrder, AITreeGridSampleOrder, AIQuerybuilderSampleOrder, AIImageEditorSampleOrder, AIPivotTableSampleOrder, AIKanbanSampleOrder, AISchedulerSampleOrder, AIMapsSampleOrder, AIGanttSampleOrder)
    },
    {
