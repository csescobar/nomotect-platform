...
var aiControlRegex = /^(?:block-editor\/ai-[a-z-]+|ai-(?!assistview\b)[a-z-]+(?:\/[A-Za-z0-9-]+)?|ai-assistview\/ai-[a-z-]+|inline-ai-assist\/ai-[a-z-]+|dashboards(?:\/[A-Za-z0-9-]+)?)$/;
var hash;
var catRegex = /(-| )/g;
var propRegex = /-3/;
var controlName;
...
function renderSampleHeader() {
    ...
    if (hash[2].startsWith('ai-') && ['ai-assistview', 'ai-smart-paste', 'ai-smart-textarea'].indexOf(hash[2]) === -1) {
        controlElem = (0, ej2_base_1.select)('[control-name="ai-grid"]');
    }
