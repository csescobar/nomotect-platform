...
var Workflow = /** @class */ (function (_super) {
    ...
    Workflow.prototype.cardTemplate = function (props) {
        ...
        return (React.createElement("div", { className: "card-template" },
            ...
            React.createElement("div", { className: 'e-card-custom-footer' }, props.Tags.split(",").map(function (tag, index) { return React.createElement("div", { key: "tag-".concat(index), className: "e-card-tag-field" }, tag); }))));
    };
