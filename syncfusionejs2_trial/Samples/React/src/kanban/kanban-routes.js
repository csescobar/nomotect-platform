...
var column_rearrangement_functional_1 = require("./column-rearrangement-functional");
...
exports.kanbanRoutes = (React.createElement(React.Fragment, null,
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/kanban/column-rearrangement', Component: column_rearrangement_functional_1.default }),
...
exports.kanbanCategory = { "overview": { "name": "Overview", "category": "Kanban" }, "default": { "name": "Default Functionalities", "category": "Kanban" }, "swimlane": { "name": "Swimlane", "category": "Kanban" }, "workflow": { "name": "Workflow", "category": "Kanban" }, "stacked-header": { "name": "Stacked Header", "category": "Kanban" }, "dialog-editing": { "name": "Dialog Editing", "category": "Kanban" }, "search-filter": { "name": "Search and Filter Cards", "category": "Kanban" }, "sorting": { "name": "Sorting Cards", "category": "Kanban" }, "virtual-scrolling": { "name": "Virtual Scrolling", "category": "Kanban" }, "local-data": { "name": "Local Data", "category": "Data Binding" }, "remote-data": { "name": "Remote Data", "category": "Data Binding" }, "header-template": { "name": "Header Template", "category": "Templates" }, "swimlane-template": { "name": "Swimlane Template", "category": "Templates" }, "card-template": { "name": "Card Template", "category": "Templates" }, "tooltip-template": { "name": "Tooltip Template", "category": "Templates" }, "toggle-columns": { "name": "Toggle Columns", "category": "Columns" }, "show-hide": { "name": "Show/Hide Columns", "category": "Columns" }, "column-rearrangement": { "name": "Column Rearrangement", "category": "Columns" }, "wip-validation": { "name": "WIP Validation", "category": "Validation" }, "api": { "name": "API", "category": "Miscellaneous" }, "events": { "name": "Events", "category": "Miscellaneous" }, "defaultSample": "kanban/overview" };
