                        ...
                        <form id="formTemp" method="post">
                            ...
                            <div className="form-group">
                                ...
                                <div id="uploadError"></div>
                                    <UploaderComponent id='UploadFiles' type='file' ref={(scope) => { this.uploadObj = scope; }} selected={this.onFileSelected.bind(this)} failure={this.onFailure.bind(this)} autoUpload={this.autoUpload} allowedExtensions={this.allowedExtensions} multiple={this.multiple}></UploaderComponent>
                            </div>
                            <div className="form-group">
                                <div className="e-float-input">
