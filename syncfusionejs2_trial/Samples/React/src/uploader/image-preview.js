                    ...
                    React.createElement("div", { className: 'imagepreview' },
                        React.createElement("div", { id: 'dropArea', ref: this.dropAreaRef, className: 'dropTarget' },
                            React.createElement("span", { id: 'dropimage', ref: this.dropImageRef, className: 'file-name-drop' },
                                ...
                                " "),
                            React.createElement(ej2_react_inputs_1.UploaderComponent, { id: 'UploadFiles', type: 'file', ref: function (upload) { return _this.uploadObj = upload; }, asyncSettings: this.asyncSettings, success: this.onUploadSuccess.bind(this), selected: this.onSelect.bind(this), removing: this.onRemoveFile.bind(this), progress: this.onFileUpload.bind(this), failure: this.onUploadFailed.bind(this), allowedExtensions: this.allowedExtensions })))),
