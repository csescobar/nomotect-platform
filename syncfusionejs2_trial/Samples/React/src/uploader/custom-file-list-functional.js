                ...
                React.createElement("div", { className: 'template_wrapper' },
                    React.createElement("div", { id: 'dropArea', className: 'dropArea', ref: dropRef },
                        React.createElement("span", { id: 'drop', className: 'file-name-span drop' },
                            ...
                            " "),
                        React.createElement(ej2_react_inputs_1.UploaderComponent, { id: 'UploadFiles', type: 'file', ref: uploadObj, asyncSettings: asyncSettings, success: onSuccess.bind(_this), removing: onRemoveFile.bind(_this), selected: onFileSelect.bind(_this), progress: onFileUpload.bind(_this), failure: onUploadFailed.bind(_this), dropArea: dropElement })))),
