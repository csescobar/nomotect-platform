                ...
                React.createElement("div", { className: 'imagepreview' },
                    React.createElement("div", { id: 'dropArea', ref: dropAreaRef, className: 'dropTarget' },
                        React.createElement("span", { id: 'dropimage', ref: dropImageRef, className: 'file-name-drop' },
                            ...
                            " "),
                        React.createElement(ej2_react_inputs_1.UploaderComponent, { id: 'UploadFiles', type: 'file', ref: uploadObj, asyncSettings: asyncSettings, success: onUploadSuccess.bind(_this), selected: onSelect.bind(_this), removing: onRemoveFile.bind(_this), progress: onFileUpload.bind(_this), failure: onUploadFailed.bind(_this), allowedExtensions: allowedExtensions })))),
