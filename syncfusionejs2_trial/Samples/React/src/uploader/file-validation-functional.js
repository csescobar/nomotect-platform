    ...
    return (React.createElement("div", { className: 'control-pane', ref: dropContainerRef },
        React.createElement("div", { className: 'control-section col-lg-12 uploadpreview' },
            React.createElement("div", { className: 'upload_wrapper' },
                React.createElement(ej2_react_inputs_1.UploaderComponent, { id: 'UploadFiles', type: 'file', ref: uploadObj, asyncSettings: asyncSettings, failure: onFailure.bind(_this), selected: onFileSelected.bind(_this), minFileSize: 10000, autoUpload: false, removing: onRemoveFile.bind(_this), allowedExtensions: allowedExtensions }))),
