                    ...
                    React.createElement("div", { className: 'template_wrapper' },
                        React.createElement("div", { id: 'dropArea', className: 'dropArea', ref: this.dropRef },
                            React.createElement("span", { id: 'drop', className: 'file-name-span drop' },
                                ...
                                " "),
                            React.createElement(ej2_react_inputs_1.UploaderComponent, { id: 'UploadFiles', type: 'file', ref: function (scope) { _this.uploadObj = scope; }, asyncSettings: this.asyncSettings, success: this.onSuccess.bind(this), removing: this.onRemoveFile.bind(this), selected: this.onFileSelect.bind(this), progress: this.onFileUpload.bind(this), failure: this.onUploadFailed.bind(this), dropArea: this.dropElement })))),
