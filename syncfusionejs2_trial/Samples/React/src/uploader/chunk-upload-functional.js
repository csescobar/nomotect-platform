        ...
        React.createElement("div", { className: 'control-section row uploadpreview' },
            React.createElement("div", { className: 'col-lg-8' },
                React.createElement("div", { className: 'upload_wrapper' },
                    React.createElement(ej2_react_inputs_1.UploaderComponent, { id: 'UploadFiles', type: 'file', ref: uploadObj, asyncSettings: asyncSettings, autoUpload: autoUpload, failure: onFailure.bind(_this), removing: onRemoveFile.bind(_this), pausing: onPausing.bind(_this), resuming: onResuming.bind(_this), chunkFailure: onBeforeFailure.bind(_this) }))),
