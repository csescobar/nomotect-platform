                ...
                <div className='col-lg-9'>
                    <div className='template_wrapper'>
                        ...
                        <div id='dropArea' className='dropArea' ref={this.dropRef}>
                            ...
                            <UploaderComponent id='UploadFiles' type='file' ref={(scope) => { this.uploadObj = scope; }} asyncSettings={this.asyncSettings} success={this.onSuccess.bind(this)} removing={this.onRemoveFile.bind(this)} selected={this.onFileSelect.bind(this)} progress={this.onFileUpload.bind(this)} // Triggres when upload is in progress
