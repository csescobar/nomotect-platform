...
var ChunkUpload = /** @class */ (function (_super) {
    ...
    ChunkUpload.prototype.onChange = function (args) {
        this.uploadObj.asyncSettings.chunkSize = args.value;
    };
    ...
    ChunkUpload.prototype.onFailure = function (args) {
            ...
            React.createElement("div", { className: 'control-section row uploadpreview' },
                React.createElement("div", { className: 'col-lg-8' },
                    React.createElement("div", { className: 'upload_wrapper' },
                        React.createElement(ej2_react_inputs_1.UploaderComponent, { id: 'UploadFiles', type: 'file', ref: function (scope) { _this.uploadObj = scope; }, asyncSettings: this.asyncSettings, autoUpload: this.autoUpload, removing: this.onRemoveFile.bind(this), failure: this.onFailure.bind(this), pausing: this.onPausing.bind(this), resuming: this.onResuming.bind(this), chunkFailure: this.onBeforeFailure.bind(this) }))),
