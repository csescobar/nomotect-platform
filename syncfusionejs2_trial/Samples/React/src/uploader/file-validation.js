...
var Validation = /** @class */ (function (_super) {
    ...
    Validation.prototype.onFailure = function (args) {
        ...
        return (React.createElement("div", { className: 'control-pane', ref: this.dropContainerRef },
            React.createElement("div", { className: 'control-section col-lg-12 uploadpreview' },
                React.createElement("div", { className: 'upload_wrapper' },
                    React.createElement(ej2_react_inputs_1.UploaderComponent, { id: 'UploadFiles', type: 'file', ref: function (scope) { _this.uploadObj = scope; }, asyncSettings: this.asyncSettings, selected: this.onFileSelected.bind(this), minFileSize: this.minFileSize, autoUpload: this.autoUpload, removing: this.onRemoveFile.bind(this), failure: this.onFailure.bind(this), allowedExtensions: this.allowedExtensions }))),
