        ...
        React.createElement("div", { className: 'control-section row uploadpreview' },
            React.createElement("div", { className: 'col-lg-9' },
                React.createElement("div", { className: 'upload_wrapper' },
                    React.createElement(ej2_react_inputs_1.UploaderComponent, { id: 'UploadFiles', type: 'file', ref: uploadObj, asyncSettings: asyncSettings, failure: onFailure.bind(_this), removing: onRemoveFile.bind(_this), autoUpload: isAutoUpload, sequentialUpload: isSequentialUpload }))),
