...
var Formsupport = /** @class */ (function (_super) {
    ...
    Formsupport.prototype.onFailure = function (args) {
                ...
                React.createElement("div", { className: "control_wrapper uploader-form", id: "control_wrapper" },
                    React.createElement("form", { id: "formTemp", method: "post" },
                        ...
                        React.createElement("div", { className: "form-group" },
                            ...
                            React.createElement(ej2_react_inputs_1.UploaderComponent, { id: 'UploadFiles', type: 'file', ref: function (scope) { _this.uploadObj = scope; }, selected: this.onFileSelected.bind(this), failure: this.onFailure.bind(this), autoUpload: this.autoUpload, allowedExtensions: this.allowedExtensions, multiple: this.multiple })),
                        React.createElement("div", { className: "form-group" },
                            React.createElement("div", { className: "e-float-input" },
