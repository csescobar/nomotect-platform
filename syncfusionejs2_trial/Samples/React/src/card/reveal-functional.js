                                                ...
                                                React.createElement("tr", null,
                                                    React.createElement("td", null,
                                                        React.createElement("div", { className: "e-card-actions" },
                                                            React.createElement("button", { id: "showcarddata", className: "e-btn e-outline e-primary", onClick: reveal }, "Know More"))),
                                                    React.createElement("td", { style: { textAlign: 'right' } },
                                                        React.createElement("div", { className: "e-card-actions" },
                                                            React.createElement("button", { className: "e-card-btn", id: "showcarddata_icon", title: "Click to see more...", onClick: reveal },
                                                                React.createElement("span", { className: "e-icons e-more-vertical-1", style: { margin: '0px' } }))))))))),
