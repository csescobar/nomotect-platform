...
var Overview = function () {
    ...
    var inlineAssistRef = React.useRef(null);
    ...
    var attachHoverEvent = React.useCallback(function (element) {
        var handleMouseEnter = function () {
            var _a;
            if (!isPopupOpen && ((_a = element.parentElement) === null || _a === void 0 ? void 0 : _a.classList.contains('email-body'))) {
    ...
    var updateSparkleButtonPosition = React.useCallback(function (element) {
        var _a, _b;
    ...
    var handleResponseItemSelect = React.useCallback(function (args) {
        ...
        if (args.command.label === 'Accept') {
            if (isGlobalRequest && emailContentRef.current) {
                var lastPrompt = (_a = inlineAssistRef.current) === null || _a === void 0 ? void 0 : _a.prompts[(((_c = (_b = inlineAssistRef.current) === null || _b === void 0 ? void 0 : _b.prompts) === null || _c === void 0 ? void 0 : _c.length) || 1) - 1];
                if (lastPrompt) {
                ...
                var lastPrompt = (_d = inlineAssistRef.current) === null || _d === void 0 ? void 0 : _d.prompts[(((_f = (_e = inlineAssistRef.current) === null || _e === void 0 ? void 0 : _e.prompts) === null || _f === void 0 ? void 0 : _f.length) || 1) - 1];
                if (lastPrompt) {
                    ...
                    React.createElement("div", { className: "email-composer e-card" },
                        ...
                        React.createElement("div", { className: "email-field-vertical e-card-content" },
                            React.createElement("div", { className: "message-header" },
                                React.createElement(ej2_react_buttons_1.ButtonComponent, { ref: aiAssistantBtnRef, id: "aiAssistantBtn", title: "AI Assistant", iconCss: "e-icons e-ai-chat", isPrimary: true, onClick: handleAIAssistantClick }, "AI Assistant")),
                            ...
                            React.createElement(ej2_react_buttons_1.ButtonComponent, { ref: sparkleButtonRef, id: "sparkleBtn", title: "AI Assistant", iconCss: "e-icons e-ai-chat", isPrimary: true, style: { display: 'none' }, onClick: handleSparkleClick })),
                        React.createElement("div", { className: "email-actions e-card-content" },
                            React.createElement(ej2_react_buttons_1.ButtonComponent, { id: "sendEmailBtn", title: "Send", cssClass: "e-primary", onClick: handleSendEmail }, "Send Email")))),
                React.createElement(ej2_react_interactive_chat_1.InlineAIAssistComponent, { ref: inlineAssistRef, id: "inlineAssist", commandSettings: commandSettings, relateTo: "#emailContent", promptRequest: handlePromptRequest, responseSettings: responseSettings, open: function () { return setIsPopupOpen(true); }, close: function () {
