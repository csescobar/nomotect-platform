                    ...
                    fetch(AI_SERVICE_URL + '/api/stream', {
                        ...
                        const processStream = () => {
                            return reader.read().then((result) => {
                                ...
                                if (promptRef.current && promptRef.current.popupObj) {
                                    promptRef.current.popupObj.refreshPosition();
                                }
    ...
    return (<div className="control-pane">
      <div className="control-section">
        <div className="rte-integration-container">
          ...
          <InlineAIAssistComponent ref={promptRef} id="inline-ai-assist" commandSettings={commandSettings} inlineToolbarSettings={inlineToolbarSettings} responseMode="Inline" promptRequest={handlePromptRequest} close={handlePromptClose} responseSettings={responseSettings}/>
        </div>
      </div>
