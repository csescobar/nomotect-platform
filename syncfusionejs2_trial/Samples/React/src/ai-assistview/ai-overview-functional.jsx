...
const Overview = () => {
    const overviewPromptResponseData = data["overviewPromptResponseData"];
    const overviewSuggestions = data["overviewSuggestions"];
    ...
    const getRandomResponse = (regeneratedResponses) => {
    ...
    const promptRequest = async (args) => {
        ...
        const foundPrompt = (overviewPromptResponseData || []).find((p) => p.prompt === args.prompt);
        ...
        assistInstance.current.promptSuggestions = foundPrompt?.suggestions || overviewSuggestions || [];
    };
