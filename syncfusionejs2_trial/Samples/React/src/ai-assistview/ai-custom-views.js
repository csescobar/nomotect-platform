    ...
    function CustomViews() {
        ...
        _this.updateResponseView = function (prompt) {
            ...
            setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                var foundPrompt, args, response, _a, copyBtn;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            this.abortController = new AbortController();
                            foundPrompt = this.prompts.find(function (promptObj) { return promptObj.prompt === prompt; });
                            args = { prompt: prompt };
                        ...
                        case 3:
                            ...
                            copyBtn = responseView.children[0].querySelector('#copyBtn');
        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { id: "description" },
                React.createElement("p", null,
                    ...
                    React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/api/ai-assistview#views" }, "views"),
                    " property."),
