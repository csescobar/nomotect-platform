...
var AIAssistant = /** @class */ (function (_super) {
    ...
    function AIAssistant() {
        ...
        _this.onListViewSelect = function (args) {
            if (args.isInteracted) {
                _this.selectedConvId = args.data.id;
                _this.updateAIAssistViewData(args.data.id);
                _this.updateBannerStyle();
            }
        };
        // Reset button click handler
        _this.handleReset = function () {
            _this.listViewRef.dataSource = [];
            _this.listViewRef.dataBind();
            // Clear localStorage
            localStorage.setItem('aiassist-view', JSON.stringify({}));
            // Reset the current conversation
            _this.selectedConvId = "";
            _this.aiAssistViewRef.prompts = [];
            _this.aiAssistViewRef.promptSuggestions = _this.suggestion;
            _this.updateBannerStyle();
        };
        // Get current date
        ...
        // Format date
        _this.getDateFormat = function (date) {
        ...
        _this.getCategory = function (key) {
            var today = _this.getDateFormat(Date.now());
            var date = _this.getDateFormat(key);
        ...
        _this.updateBannerStyle = function () {
            ...
            if ((_a = _this.aiAssistViewRef.prompts) === null || _a === void 0 ? void 0 : _a.length) {
        ...
        _this.checkAndUpdateLocalStorage = function (prompt) {
            ...
            var prompts = [];
            var aiAssistViewInst = _this.aiAssistViewRef;
            ...
            if (_this.selectedConvId) {
                var convData = appData[_this.selectedConvId];
                if (convData && convData.name === convData.name) {
                    // Update list item text if needed
                    var dataSource = _this.listViewRef.dataSource;
                    if (dataSource) {
                        for (var k = 0; k < dataSource.length; k++) {
                            var item = dataSource[k];
                            if (item && item.id === _this.selectedConvId) {
                ...
                _this.selectedConvId = newConvId;
                var convData = {
                    name: prompt,
                    prompts: prompts,
                ...
                localStorage.setItem('aiassist-view', JSON.stringify(appData));
                _this.refreshConversationList();
                _this.listViewRef.selectItem({ index: 0 });
            }
        };
        // Update conversation name
        _this.updateConversationName = function (prompt) {
            if (_this.isFirstPrompt && _this.selectedConvId) {
                var aiAssistView = JSON.parse(localStorage.getItem('aiassist-view') || '{}');
                var convData = aiAssistView[_this.selectedConvId];
            ...
            for (var i = 0; i < keys.length; i++) {
                ...
                if (convData && convData.name) {
                    ...
                    items.push({
                        ...
                        category: _this.getCategory(numericKey),
                        time: _this.getDateFormat(numericKey)
                    });
                }
            }
        ...
        _this.refreshConversationList = function () {
            var listData = _this.getLeftPaneData();
            _this.listDatas = listData;
            _this.listViewRef.dataSource = listData;
            _this.listViewRef.dataBind();
        };
        ...
        _this.updateAIAssistViewData = function (id) {
            if (id) {
                ...
                _this.aiAssistViewRef.prompts = convData.prompts;
                _this.aiAssistViewRef.promptSuggestions = convData.promptSuggestions;
            }
            else {
                _this.aiAssistViewRef.prompts = [];
                _this.aiAssistViewRef.promptSuggestions = _this.suggestion;
        ...
        _this.loadNewAIAssist = function () {
            ...
            if (_this.listDatas.length !== 0) {
                _this.aiAssistViewRef.prompts = [];
                _this.aiAssistViewRef.promptSuggestions = _this.suggestion;
            }
            var curConvDate = _this.getDate().toString();
            var aiAssistView = localStorage.getItem('aiassist-view');
            var appData = JSON.parse(aiAssistView || '{}');
            var convData = {
                name: "New Conversation",
                prompts: [],
                promptSuggestions: _this.suggestion
            };
            appData[curConvDate] = convData;
            localStorage.setItem('aiassist-view', JSON.stringify(appData));
            _this.refreshConversationList();
            _this.selectedConvId = curConvDate;
            _this.listViewRef.selectItem({ id: curConvDate });
            _this.updateBannerStyle();
        };
        // Get AI response
        _this.getResult = function (prompt) { return __awaiter(_this, void 0, void 0, function () {
            var responseObj;
            return __generator(this, function (_a) {
                responseObj = this.assistantResponses.find(function (resp) { return resp.prompt === prompt; });
                return [2 /*return*/, responseObj ? responseObj.response : ""];
            });
        }); };
        // Execute prompt
            ...
            return __generator(this, function (_a) {
                try {
                    timeoutId_1 = setTimeout(function () {
                        _this.aiAssistViewRef.addPromptResponse("I apologize, but I'm experiencing some difficulty processing your request at this moment, which might be due to the complexity of your query or a technical limitation on my end, so I would greatly appreciate it if you could rephrase your question or provide additional context that might help me better understand what you're looking for.");
                        _this.updateConversationName(prompt);
                    }, 2000);
                    ...
                    setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            suggestionsObj = this.assistantResponses.find(function (resp) { return resp.prompt === prompt; });
                    ...
                    setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.getResult(prompt)];
                                case 1:
                                    result = _a.sent();
                                    this.aiAssistViewRef.addPromptResponse(result);
                                    this.aiAssistViewRef.promptSuggestions = finalResult_1;
                    ...
                    this.aiAssistViewRef.addPromptResponse("I apologize, but I'm experiencing some difficulty processing your request at this moment, which might be due to the complexity of your query or a technical limitation on my end, so I would greatly appreciate it if you could rephrase your question or provide additional context that might help me better understand what you're looking for.");
                    this.aiAssistViewRef.promptSuggestions = [];
                    this.updateConversationName(prompt);
                }
            ...
            React.createElement("div", { className: "control-section" },
                React.createElement("div", null,
                    React.createElement("div", { className: "ai-assistant" },
                        React.createElement(ej2_react_interactive_chat_1.AIAssistViewComponent, { id: "aiAssistView", ref: function (aiassistview) { return (_this.aiAssistViewRef = aiassistview); }, promptSuggestions: this.suggestion, toolbarSettings: this.toolbarSettings, enableAttachments: true, attachmentSettings: this.attachmentSettings, promptRequest: function (args) { return _this.execute(args.prompt); }, bannerTemplate: this.bannerTemplate, created: this.created })))),
            React.createElement(ej2_react_navigations_1.SidebarComponent, { id: "assistantSidebar", ref: function (sidebar) { return (_this.sidebarRef = sidebar); }, width: "260px", target: ".ai-assistant", position: "Left", enableDock: true, dockSize: "75px", enableGestures: false },
                React.createElement("div", { className: "assistant-sidebar-header" },
                    React.createElement(ej2_react_navigations_1.ToolbarComponent, { id: "assistantToolbar" },
                        React.createElement(ej2_react_navigations_1.ItemsDirective, null,
                            ...
                            React.createElement(ej2_react_navigations_1.ItemDirective, { prefixIcon: "e-icons e-menu", tooltipText: "Toggle sidebar", align: "Right", click: function () { return _this.sidebarRef.toggle(); } }),
                            React.createElement(ej2_react_navigations_1.ItemDirective, { prefixIcon: "e-icons e-rename", tooltipText: "Start new chat", align: "Right", cssClass: "new-chat-button", click: this.loadNewAIAssist })))),
                React.createElement("div", { className: "assistant-sidebar-content" },
                    React.createElement("div", { className: "assistant-listview-option", tabIndex: 1 },
                        ...
                        React.createElement("span", { className: "e-icons e-refresh", title: "Reset", id: "resetButton", onClick: this.handleReset })),
                    React.createElement(ej2_react_lists_1.ListViewComponent, { id: "assistant-listview-grp", ref: function (listView) { return (_this.listViewRef = listView); }, dataSource: this.listDatas, fields: this.listViewFields, template: this.listTemplate, select: this.onListViewSelect }))),
