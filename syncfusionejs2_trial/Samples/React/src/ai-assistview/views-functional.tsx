...
const Views = () => {
    ...
    const footerTemplate:string = `<div class="custom-footer">
        <textarea id="textarea"></textarea>
        <button id="btn" style="margin-top: 10px">Generate Prompt</button>
    </div>`;

    const viewTemplate: string = '<div id="custom-view"></div>';

    const button: Button = new Button({ cssClass: `generate-btn e-primary`, content:'Generate Prompt'});
    ...
    const buttonClicked = () => {
        ...
        if(promptValue) {
            promptsData.unshift(promptValue as PromptModel);
    ...
    const copyClick = (copyButtonEle: Element) => {
