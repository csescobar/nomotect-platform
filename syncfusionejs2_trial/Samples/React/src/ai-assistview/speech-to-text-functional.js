...
var SpeechToText = function () {
    ...
    var azureApiKey = ''; // Your_Azure_OpenAI_API_Key
    var azureEndpoint = ''; // Your_Azure_OpenAI_Endpoint
    var azureDeployment = ''; // Your_Deployment_Name
    var azureApiVersion = ''; // Your_Azure_OpenAI_API_Version
    ...
    var streamResponse = function (response) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    if (i % responseUpdateRate === 0 || i === responseLength) {
                        ...
                        (_a = aiAssistViewObj.current) === null || _a === void 0 ? void 0 : _a.addPromptResponse(htmlResponse, i === responseLength);
                        (_b = aiAssistViewObj.current) === null || _b === void 0 ? void 0 : _b.scrollToBottom();
                    }
                    return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(resolve, 15); })];
                case 2:
                    _c.sent(); // Delay for streaming effect
                    return [3 /*break*/, 1];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, streamResponse(responseText)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    error_1 = _a.sent();
                    aiAssistViewObj.current.addPromptResponse('⚠️ Something went wrong while connecting to the OpenAI service. Please check your API key or try again later.');
                    stopStreaming = true;
                    return [3 /*break*/, 5];
