        ...
        return (<div className='control-pane'>
                <div className="control-section">
                    <div className="thinking-aiassistview">
                        <AIAssistViewComponent id="aiAssistView" bannerTemplate={this.bannerTemplate} promptSuggestions={this.promptSuggestions} promptRequest={this.promptRequest} enableStreaming={true} ref={aiassistView => (this.assistInstance = aiassistView)}>
