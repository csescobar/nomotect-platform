    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: "control-section" },
            React.createElement("div", { className: "default-aiassistview" },
                React.createElement(ej2_react_interactive_chat_1.AIAssistViewComponent, { id: "aiAssistView", promptSuggestions: suggestion, toolbarSettings: assistViewToolbarSettings, enableStreaming: true, promptRequest: promptRequest, ref: assistInstance, bannerTemplate: bannerTemplate }))),
