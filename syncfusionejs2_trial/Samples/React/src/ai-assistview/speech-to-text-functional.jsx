...
const SpeechToText = () => {
    ...
    let azureApiKey = ''; // Your_Azure_OpenAI_API_Key
    let azureEndpoint = ''; // Your_Azure_OpenAI_Endpoint
    let azureDeployment = ''; // Your_Deployment_Name
    let azureApiVersion = ''; // Your_Azure_OpenAI_API_Version
