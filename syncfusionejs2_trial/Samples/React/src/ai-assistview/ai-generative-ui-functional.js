...
var GenerativeUI = function () {
    ...
    var toolSystemPrompt = data["toolSystemPrompt"];
    var promptsData = data["promptsData"];
    var currentChartConfig = (0, react_1.useRef)({});
    var currentGridConfig = (0, react_1.useRef)({});
    ...
    var processChartConfig = function (args) {
        var chartConfig = {
    ...
    var processGridConfig = function (args) {
        var data = args.data || [];
        var gridConfig = {
            data: data,
            columns: args.columns || (data.length
    ...
    var ChartTemplate = function (args) { return (React.createElement(ej2_react_charts_1.ChartComponent, { id: "generativeChart", primaryXAxis: {
        ...
        React.createElement(ej2_react_charts_1.SeriesCollectionDirective, null,
            React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: currentChartConfig.current.dataSource, xName: currentChartConfig.current.xField, yName: currentChartConfig.current.yField, type: currentChartConfig.current.chartType, marker: { visible: true } })))); };
    var GridTemplate = function (args) {
        var _a;
        return (React.createElement(ej2_react_grids_1.GridComponent, { dataSource: currentGridConfig.current.data, allowPaging: false, pageSettings: { pageSize: 8 }, width: "fit-content" },
            React.createElement(ej2_react_grids_1.ColumnsDirective, null, (_a = currentGridConfig.current.columns) === null || _a === void 0 ? void 0 : _a.map(function (column, index) { return (React.createElement(ej2_react_grids_1.ColumnDirective, { key: index, field: column.field, headerText: column.headerText, width: column.width, textAlign: column.textAlign })); })),
