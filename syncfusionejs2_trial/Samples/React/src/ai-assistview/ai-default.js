        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: "control-section" },
                React.createElement("div", { className: "default-aiassistview" },
                    React.createElement(ej2_react_interactive_chat_1.AIAssistViewComponent, { id: "aiAssistView", toolbarSettings: this.assistViewToolbarSettings, bannerTemplate: this.bannerTemplate, promptSuggestions: this.suggestion, enableStreaming: true, promptRequest: this.promptRequest, ref: function (aiassistView) { return (_this.assistInstance = aiassistView); } }))),
