    ...
    return (<div className='control-pane'>
            <div className="control-section">
                <div className="thinking-aiassistview">
                    <AIAssistViewComponent id="aiAssistView" bannerTemplate={bannerTemplate} promptSuggestions={promptSuggestions} promptRequest={promptRequest} ref={assistInstance}>
