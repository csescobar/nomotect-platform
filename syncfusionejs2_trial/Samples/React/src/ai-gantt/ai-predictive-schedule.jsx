...
import { GanttComponent, Toolbar, Edit, Selection, CriticalPath, ContextMenu, Filter, Sort, Reorder, DayMarkers, ColumnsDirective, ColumnDirective, Inject } from '@syncfusion/ej2-react-gantt';
import { HistoricalTaskData, HistoricalDataCollection2021, HistoricalDataCollection2022, HistoricalDataCollection2023, HistoricalDataCollection2024, HistoricalDataCollection2025 } from './datasource';
...
function TaskSchedule() {
        ...
        if (args.item.text === 'Predictive scheduling') {
          ...
          Return the updated TaskCollection in JSON format, with no additional text or explanations.`;
            ...
            aioutput.then((result) => {
                ...
                let currentData = ganttInstance.currentViewData;
    ...
    return (<div className='control-pane'>
            <div className='control-section'>
                <div id='container'>
                    <GanttComponent id="GanttContainer" ref={gantt => ganttInstance = gantt} dataSource={HistoricalTaskData} renderBaseline={true} toolbar={toolbarOptions} taskFields={taskFields} editSettings={{
            allowAdding: true,
            allowEditing: true,
            allowDeleting: true,
