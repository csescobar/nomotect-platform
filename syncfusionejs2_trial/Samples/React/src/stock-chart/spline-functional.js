    ...
    return (React.createElement("div", { className: 'control-pane' },
        ...
        React.createElement("div", { id: "description" },
            React.createElement("p", null,
                "This example shows how to render and configure a stock chart to visualize stock data with a last value label using the ",
                React.createElement("code", null, "lastValueLabel"),
                " option. A spline series is used by setting the series ",
