...
exports.Sankey = exports.links = exports.nodes = void 0;
        ...
        return (React.createElement("div", { className: "control-pane" },
            ...
            React.createElement("div", { className: "control-section" },
                React.createElement(ej2_react_charts_1.SankeyComponent, { id: "sankey-container", width: "90%", height: base_1.Browser.isDevice ? "600" : "450", title: 'California Energy Consumption in 2023', subTitle: 'Source: Lawrence Livermore National Laboratory', linkStyle: { opacity: 0.6, curvature: 0.55, colorType: 'Source' }, labelSettings: { visible: base_1.Browser.isDevice ? false : true }, tooltip: { enable: true, nodeTemplate: '${name}: ${value} TBtu', linkTemplate: base_1.Browser.isDevice ? '${start.name}: ${start.out} TBtu → <br/> ${target.name}: ${target.in} TBtu' : '${start.name}: ${start.out} TBtu → <br/> ${target.name}: ${target.in} TBtu' }, legendSettings: { visible: true, position: 'Bottom', itemPadding: 8 }, load: this.load, loaded: this.onLoaded },
                    ...
                    React.createElement(ej2_react_charts_1.SankeyNodesCollectionDirective, null, exports.nodes.map(function (node) { return (React.createElement(ej2_react_charts_1.SankeyNodeDirective, { key: node.id, id: node.id, color: node.color, offset: node.offset })); })),
                    React.createElement(ej2_react_charts_1.SankeyLinksCollectionDirective, null, exports.links.map(function (link, i) { return (React.createElement(ej2_react_charts_1.SankeyLinkDirective, { key: "".concat(link.sourceId, "-").concat(link.targetId, "-").concat(i), sourceId: link.sourceId, targetId: link.targetId, value: link.value })); })))),
