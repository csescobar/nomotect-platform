...
function RightToLeft() {
    ...
    return (<div className="control-pane">
      ...
      <div id="action-description">
        <p>
          Explore supply chain flows with a right‑to‑left Sankey diagram using illustrative values in thousand shipments (k).
          The chart maps product categories to transport modes, world regions, and delivery status for quick logistics insight.
        </p>
      </div>
