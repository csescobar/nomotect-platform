...
function RightToLeft() {
    ...
    return (React.createElement("div", { className: "control-pane" },
        ...
        React.createElement("div", { id: "action-description" },
            React.createElement("p", null, "Explore supply chain flows with a right\u2011to\u2011left Sankey diagram using illustrative values in thousand shipments (k). The chart maps product categories to transport modes, world regions, and delivery status for quick logistics insight.")),
