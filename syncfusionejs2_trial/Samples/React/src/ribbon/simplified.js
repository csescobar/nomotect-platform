...
var Simplified = /** @class */ (function (_super) {
    ...
    function Simplified() {
        ...
        _this.filtering = function (e) {
            var query = new ej2_data_1.Query();
            query = (e.text !== "") ? query.where("Text", "contains", e.text, true) : query;
            e.updateData(_this.fontStyle, query);
        };
            ...
            React.createElement("div", { className: 'col-lg-12 control-section simplified-ribbon-section' },
                React.createElement("div", { className: 'control ribbon-sample' },
                    React.createElement("div", { id: "simplified-ribbonContainer", className: 'simplified-ribbon-container' },
                                    ...
                                    React.createElement(ej2_react_ribbon_1.RibbonGroupsDirective, null,
                                        ...
                                        React.createElement(ej2_react_ribbon_1.RibbonGroupDirective, { header: "Illustration", overflowHeader: "Illustrations", id: 'illustration', groupIconCss: "e-icons e-image", enableGroupOverflow: true, orientation: "Row" },
                                            React.createElement(ej2_react_ribbon_1.RibbonCollectionsDirective, null,
                                                React.createElement(ej2_react_ribbon_1.RibbonCollectionDirective, null,
                                                    React.createElement(ej2_react_ribbon_2.RibbonItemsDirective, null,
                                                        React.createElement(ej2_react_ribbon_2.RibbonItemDirective, { id: 'pictureddl', type: "DropDown", dropDownSettings: { iconCss: "e-icons e-image", content: "Pictures", target: '#simplified-pictureList' } }),
                        ...
                        React.createElement(ej2_react_lists_1.ListViewComponent, { id: 'simplified-pictureList', dataSource: ['This Device', 'Stock Images', 'Online Images'], showHeader: true, headerTitle: "Insert Picture From", select: function (args) { this.updateContent("Picture -> " + args.text); } })))),
