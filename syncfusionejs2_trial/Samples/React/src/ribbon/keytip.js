...
var KeyTip = /** @class */ (function (_super) {
    ...
    function KeyTip() {
        ...
        _this.updateContent = function (args) {
            _this.toastInstance.show({ content: "Last clicked item is " + args });
        };
        _this.launchClick = function (args) {
            if (args.groupId == "clipboard") {
                _this.updateContent("Clipboard Launcher Icon");
            }
            else if (args.groupId == "illustration") {
                _this.updateContent("Illustration Launcher Icon");
            }
            else if (args.groupId == "header_footer") {
                _this.updateContent("Header & Footer Launcher Icon");
            }
        };
        _this.isBackstageOpened = false;
        _this.handleClickInsideBackstageContent = function (e) {
            e.stopPropagation();
            var cName = e.target.className;
            if (cName !== "section-title" && cName !== "home-wrapper" && cName !== "new-wrapper" && cName !== "block-wrapper" && cName !== "e-ribbon-backstage-content") {
                _this.ribbonObj.ribbonBackstageModule.hideBackstage();
                _this.toastInstance.show({ content: 'Backstage content is interacted and closed.' });
                _this.ribbonObj.element.querySelector('.e-ribbon-backstage-content').removeEventListener('click', _this.handleClickInsideBackstageContent.bind(_this));
            }
        };
        _this.backstageClickHandler = function () {
            _this.ribbonObj.ribbonBackstageModule.hideBackstage();
            _this.toastInstance.show({ content: 'Print action is selected' });
        };
        _this.getBackstageContent = function (item) {
        ...
        _this.ribbonCreated = function () {
            if (!_this.isBackstageOpened) {
                _this.ribbonObj.element.querySelector('.e-ribbon-backstage').addEventListener('click', _this.backstageClick.bind(_this));
            }
            _this.ribbonObj.ribbonKeyTipModule.showKeyTips();
        };
        _this.backstageClick = function () {
            _this.isBackstageOpened = true;
            _this.ribbonObj.element.querySelector('.e-ribbon-backstage-content').addEventListener('click', _this.handleClickInsideBackstageContent.bind(_this));
        };
        return _this;
    }
                                    ...
                                    React.createElement(ej2_react_ribbon_1.RibbonGroupsDirective, null,
                                        ...
                                        React.createElement(ej2_react_ribbon_1.RibbonGroupDirective, { header: "Editor", groupIconCss: "sf-icon-editor", isCollapsible: false },
                                            React.createElement(ej2_react_ribbon_1.RibbonCollectionsDirective, null,
                                                React.createElement(ej2_react_ribbon_1.RibbonCollectionDirective, null,
                                                    React.createElement(ej2_react_ribbon_2.RibbonItemsDirective, null,
                                                        React.createElement(ej2_react_ribbon_2.RibbonItemDirective, { type: "Button", keyTip: 'SU', allowedSizes: ej2_react_ribbon_2.RibbonItemSize.Large, buttonSettings: { iconCss: "sf-icon-editor", content: "Editor", clicked: function () { this.updateContent("Editor"); } } }))))),
