    ...
    return (<>
            ...
            lineHeight: "35px"
                        ...
                        <div className="ai-form-footer">
                            ...
                            <SmartPasteButtonComponent type="button" id="smart-paste" className="form-button e-btn e-primary" content={'Smart Paste'} iconCss={"e-icons e-paste"} aiAssistHandler={serverAIRequest}/>
                        </div>
                    </form>
