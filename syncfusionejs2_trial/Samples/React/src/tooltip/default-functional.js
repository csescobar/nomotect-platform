                            ...
                            React.createElement("tr", null,
                                ...
                                React.createElement("td", { style: { width: '70%', paddingRight: '10px' } },
                                    React.createElement("div", null,
                                        React.createElement("select", { id: 'ddl', name: 'ddl', value: position, onChange: change.bind(_this), className: 'form-control', style: { padding: '6px' }, "aria-label": "positions" },
                                            React.createElement("option", { value: "TopLeft" }, "Top Left"),
                                            React.createElement("option", { value: "TopCenter" }, "Top Center"),
