...
import InvisibleDigitalSignature from './invisible-digital-signature-functional';
import VisibleDigitalSignature from './visible-digital-signature-functional';
...
export const pdfviewerRoutes = (
    <>
         ...
         <Route  path='/:theme/pdfviewer/invisible-digital-signature' Component={ InvisibleDigitalSignature }/>
         <Route  path='/:theme/pdfviewer/visible-digital-signature' Component={ VisibleDigitalSignature }/>
