...
export class InvisibleDigitalSignature extends SampleBase<{}, StateType> {
            ...
            <div className='control-section'>
                <div>
                    ...
                    <div>
                        ...
                        <MessageComponent id="msg_warning" content={this.msgWarning} visible={this.state.warningVisible} severity="Warning"></MessageComponent>
                        <MessageComponent id="msg_error" content={this.msgError} visible={this.state.errorVisible} severity="Error"></MessageComponent>
                    </div>
