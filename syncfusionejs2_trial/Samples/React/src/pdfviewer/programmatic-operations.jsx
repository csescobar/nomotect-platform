...
export class ProgrammaticOperations extends SampleBase {
    constructor(props) {
        super(props);
      ...
      <div className="col-lg-3 e-pv-property-section-pdfviewer e-pv-main-panel">
        ...
        <div className="e-pv-property-panel-content">
          ...
          <div className="e-pv-annot-inner-container" hidden={!this.state.showStampType}>
            ...
            <div className="e-pv-input-item">
              <DropDownListComponent dataSource={this.state.currentCommentsList} fields={this.stampCommentsTypeDatafields} value={this.state.stampComment} change={(e) => this.onpropertiesvaluechanges('stampComment', e)}/>
            </div>
          </div>
    ...
    updatePropertiesInUI = () => {
        ...
        this.setState({
            ...
            isDeleteVertexDisabled: isNullOrUndefined(this.selectedAnnotation.vertexPoints) ? true : ((this.selectedAnnotation.vertexPoints.length > 1) ? false : true),
            showFileUploader: this.selectedAnnotation.showFileUploader
        });
    };
