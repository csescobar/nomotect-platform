...
var Default = /** @class */ (function (_super) {
    ...
    function Default() {
        ...
        _this.pageOrganizerSettings = { showImageZoomingSlider: true };
    ...
    Default.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { className: 'control-section' },
                ...
                React.createElement(ej2_react_pdfviewer_1.PdfViewerComponent, { ref: function (scope) { _this.viewer = scope; }, id: "container", documentPath: "https://cdn.syncfusion.com/content/pdf/pdf-succinctly.pdf", resourceUrl: "https://cdn.syncfusion.com/ej2/23.2.6/dist/ej2-pdfviewer-lib", documentLoad: this.documentLoaded, style: { 'height': '640px' }, pageOrganizerSettings: this.pageOrganizerSettings },
            ...
            React.createElement("div", { id: "description" },
                ...
                React.createElement("ul", null,
                    ...
                    React.createElement("li", null,
                        ...
                        " feature to preserve edits, e///nabling users to download the modified version of the PDF document for future reference."),
                    React.createElement("li", null, "Zoom in or out of page images using the slider opened through the page zoom icon available in the toolbar or using keyboard accessibility.")),
                React.createElement("p", null,
