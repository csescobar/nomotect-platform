            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement("div", { className: 'col-lg-8' },
                    React.createElement("div", { id: 'multifilter', className: "control-styles", style: { paddingTop: '50px' } },
                        ...
                        React.createElement(ej2_react_dropdowns_1.MultiSelectComponent, { id: "comboelement", ref: function (multiselect) { _this.listObj = multiselect; }, dataSource: this.data, filtering: this.onFiltering.bind(this), allowFiltering: true, fields: this.fields, placeholder: "Select countries", debounceDelay: 300 }))),
                React.createElement("div", { className: 'col-lg-4 property-section dropdown-filtering' },
                    React.createElement(property_pane_1.PropertyPane, { title: 'Properties:' },
                        React.createElement("div", { className: "property-panel-content" },
                            ...
                            React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { format: 'n0', value: 300, min: 1, change: this.onChange.bind(this) }))))),
