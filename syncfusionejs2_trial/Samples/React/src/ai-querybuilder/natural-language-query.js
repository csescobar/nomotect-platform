...
var ai_natural_language_query_1 = require("./ai-natural-language-query");
/* custom code start*/
...
var NaturalLanguageQuery = /** @class */ (function (_super) {
    ...
    NaturalLanguageQuery.prototype.componentDidMount = function () {
        (0, sample_base_2.updateAISampleSection)();
    };
    NaturalLanguageQuery.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement(ai_natural_language_query_1.default, null)),
