...
function AiNLQuerying() {
    ...
    function clicked() {
        ...
        aiOutput.then(function (result) {
            if (result) {
                if ((result === null || result === void 0 ? void 0 : result.indexOf("```sql")) !== -1) {
                    result = result.split("```sql")[1];
                }
                var val = result.split("WHERE ")[1].split(";\n")[0];
                val = val.replace("\n", "");
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement("div", { id: "ai-wrapper" },
                React.createElement(ej2_react_navigations_1.TabComponent, { id: "ai-tab" },
                ...
                React.createElement("div", { id: "prompt-ui" },
                    React.createElement("div", { id: "customTbarDialog" },
                        React.createElement("span", { className: "ai-e-text" }, "Query"),
                ...
                React.createElement("div", { className: "e-custom-elem" },
                    React.createElement(ej2_react_buttons_1.ButtonComponent, { id: "submit", iconCss: 'e-icons e-play', onClick: clicked, isPrimary: true }, "Run Query")),
                React.createElement("div", { className: "e-custom-elem" },
                    React.createElement("span", { className: "ai-e-text" }, "Results from your AI generated Query"),
