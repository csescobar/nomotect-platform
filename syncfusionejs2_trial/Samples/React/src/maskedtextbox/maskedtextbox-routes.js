...
exports.maskedtextboxRoutes = (React.createElement(React.Fragment, null,
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/maskedtextbox/adornments', Component: adornments_functional_1.default })));
exports.maskedtextboxCategory = { "default": { "name": "Default Functionalities", "category": "Input Mask" }, "custom-mask": { "name": "Custom Mask", "category": "Input Mask" }, "formats": { "name": "Formats", "category": "Input Mask" }, "adornments": { "name": "Adornments", "category": "Input Mask" }, "defaultSample": "maskedtextbox/default" };
