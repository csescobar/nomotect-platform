...
export const maskedtextboxRoutes = (<>
         ...
         <Route path='/:theme/maskedtextbox/adornments' Component={Adornments}/>

    </>);
export const maskedtextboxCategory = { "default": { "name": "Default Functionalities", "category": "Input Mask" }, "custom-mask": { "name": "Custom Mask", "category": "Input Mask" }, "formats": { "name": "Formats", "category": "Input Mask" }, "adornments": { "name": "Adornments", "category": "Input Mask" }, "defaultSample": "maskedtextbox/default" };
