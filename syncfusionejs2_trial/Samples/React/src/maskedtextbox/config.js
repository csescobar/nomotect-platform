...
exports.MaskedTextBoxOrder = [
    ...
    { 'path': 'maskedtextbox/adornments', 'component': 'Adornments', 'name': 'Adornments', 'order': '01', 'category': 'Input Mask', 'description': 'The example exposes a React Masked TextBox with adornments support. It helps to render custom elements before or after the input element.', 'api': '{"MaskedTextBoxComponent":["prependTemplate","appendTemplate"] }' }
];
