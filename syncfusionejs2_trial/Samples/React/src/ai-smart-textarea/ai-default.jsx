        ...
        <div className='control-section'>
            <div className="ai-content-wrapper">
                ...
                <DropDownListComponent type="text" id='user-role' dataSource={rolesData} width='75%' placeholder="Select a role" value="Maintainer of an open-source project replying to GitHub issues" popupHeight="200px" change={onChange}/>
                 <div style={{ width: "75%" }}>
                <SmartTextAreaComponent cols={150} id='smart-textarea' ref={(textarea) => { textareaObj = textarea; }} placeholder={'Enter your queries here'} floatLabelType={'Auto'} rows={5} userRole={'Employee communicating with internal team'} UserPhrases={phrasesData} aiSuggestionHandler={serverAIRequest}></SmartTextAreaComponent>
                </div>
            </div>
        </div>
    </div>);
