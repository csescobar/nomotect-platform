...
exports.AIAssistantClassComponent = void 0;
var React = require("react");
var sample_base_1 = require("../common/sample-base");
var ej2_react_richtexteditor_1 = require("@syncfusion/ej2-react-richtexteditor");
var ai_service_1 = require("../common/ai-service");
var ai_toast_1 = require("../common/ai-toast");
var AIAssistantClassComponent = /** @class */ (function (_super) {
    __extends(AIAssistantClassComponent, _super);
    function AIAssistantClassComponent() {
        ...
        _this.aiAssistantSettings = {
            popupWidth: '550px'
        };
        return _this;
    }
    AIAssistantClassComponent.prototype.componentDidMount = function () {
        (0, sample_base_1.updateSampleSection)();
    };
    AIAssistantClassComponent.prototype.onAIAssistantPromptRequest = function (args) {
        var e_1, _a;
        var _b;
        return __awaiter(this, void 0, void 0, function () {
            var _c, response, errorData, stream, fullText, _d, _e, chunk, e_1_1, error_1, banner, header;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, fetch(ai_service_1.AI_SERVICE_URL + '/api/stream', {
                                ...
                                headers: {
                                    ...
                                    'Authorization': (_b = this.userID) !== null && _b !== void 0 ? _b : ''
                                },
                    ...
                    case 6:
                        ...
                        _d = __asyncValues(stream);
                        _f.label = 7;
                    case 7: return [4 /*yield*/, _d.next()];
                    case 8:
                        if (!(_e = _f.sent(), !_e.done)) return [3 /*break*/, 10];
                        chunk = _e.value;
                        fullText += chunk;
                    ...
                    case 18:
                        ...
                        else if (typeof error_1.message === 'string' && error_1.message.includes('token limit')) {
                            this.editorRef.addAIPromptResponse(error_1.message, false);
                            this.editorRef.addAIPromptResponse(error_1.message, true);
                            banner = document.querySelector('.banner-message');
                            header = document.querySelector('.sb-header1');
                            if (banner)
                                banner.innerHTML = error_1.message;
                            if (header)
                                header.classList.remove('sb-hide');
                        }
                        else {
    ...
    return AIAssistantClassComponent;
}(sample_base_1.SampleBase));
exports.AIAssistantClassComponent = AIAssistantClassComponent;
