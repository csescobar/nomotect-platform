...
/**
 * React component for Rich Text Editor with Inline AI Prompt integration
    ...
    render() {
        ...
        <div className="control-section">
          <div className="rte-integration-container">
            ...
            <InlineAIPromptComponent ref={this.promptRef} id="inline-ai-prompt" commandSettings={this.commandSettings} inlineToolbarSettings={this.inlineToolbarSettings} responseMode="Inline" promptRequest={this.handlePromptRequest} close={this.handlePromptClose} responseSettings={this.responseSettings}/>
          </div>
        </div>
