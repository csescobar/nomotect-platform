...
var Overview = /** @class */ (function (_super) {
    ...
    function Overview(props) {
        ...
        _this.inlinePromptRef = React.createRef();
        ...
        _this.attachHoverEventsToChildren = function (container) {
            ...
            paragraphs.forEach(function (para) {
                ...
                var handleMouseEnter = function () {
                    var _a;
                    if (!_this.state.isPopupOpen && ((_a = paragraph.parentElement) === null || _a === void 0 ? void 0 : _a.classList.contains('email-body'))) {
                        _this.currentHoveredParagraph = paragraph;
                        _this.currentHoveredParagraphSyncRef = paragraph;
                        _this.updateSparkleButtonPosition(paragraph);
                    }
                };
        ...
        _this.attachHoverEvent = function (paragraph) {
            // Remove old listener first to avoid duplicates
            var existingListener = paragraph.__hoverListener;
            if (existingListener) {
                paragraph.removeEventListener('mouseenter', existingListener);
        ...
        _this.updateSparkleButtonPosition = function (paragraph) {
            var _a;
        ...
        _this.handleSparkleClick = function () {
            if (_this.currentHoveredParagraph && _this.inlinePromptRef.current) {
                _this.setState({ isGlobalRequest: false });
                _this.inlinePromptRef.current.relateTo = _this.currentHoveredParagraph;
                _this.inlinePromptRef.current.dataBind();
                _this.inlinePromptRef.current.showPopup();
            }
        };
        _this.handleAIAssistantClick = function () {
            if (_this.inlinePromptRef.current && _this.aiAssistantBtnRef.current) {
                _this.setState({ isGlobalRequest: true });
                _this.inlinePromptRef.current.relateTo = _this.aiAssistantBtnRef.current.element;
                _this.inlinePromptRef.current.dataBind();
                _this.inlinePromptRef.current.showPopup();
            }
        };
                ...
                try {
                    ...
                    fetch(ai_service_1.AI_SERVICE_URL + '/api/chat', {
                        ...
                        if (result && result.response) {
                            ...
                            if (_this.inlinePromptRef.current) {
                                _this.inlinePromptRef.current.addResponse(aiResponse);
                            }
                        }
                    })
                        ...
                        setTimeout(function () {
                            ...
                            if (_this.inlinePromptRef.current) {
                                _this.inlinePromptRef.current.addResponse(fallbackResponse);
        ...
        _this.handleResponseItemSelect = function (args) {
            ...
            if (args.command.label === 'Accept') {
                if (_this.state.isGlobalRequest && _this.emailContentRef.current) {
                    var lastPrompt = (_a = _this.inlinePromptRef.current) === null || _a === void 0 ? void 0 : _a.prompts[(((_c = (_b = _this.inlinePromptRef.current) === null || _b === void 0 ? void 0 : _b.prompts) === null || _c === void 0 ? void 0 : _c.length) || 1) - 1];
                    if (lastPrompt) {
                    ...
                    var lastPrompt = (_d = _this.inlinePromptRef.current) === null || _d === void 0 ? void 0 : _d.prompts[(((_f = (_e = _this.inlinePromptRef.current) === null || _e === void 0 ? void 0 : _e.prompts) === null || _f === void 0 ? void 0 : _f.length) || 1) - 1];
                    if (lastPrompt) {
                        _this.currentHoveredParagraphSyncRef.innerHTML = lastPrompt.response;
                    }
                }
                if (_this.inlinePromptRef.current) {
                    _this.inlinePromptRef.current.hidePopup();
                }
            }
                        ...
                        React.createElement("div", { className: "email-composer e-card" },
                            ...
                            React.createElement("div", { className: "email-field-vertical e-card-content" },
                                React.createElement("div", { className: "message-header" },
                                    React.createElement(ej2_react_buttons_1.ButtonComponent, { ref: this.aiAssistantBtnRef, id: "aiAssistantBtn", iconCss: "e-icons e-ai-chat", isPrimary: true }, "AI Assistant")),
                                ...
                                React.createElement(ej2_react_buttons_1.ButtonComponent, { ref: this.sparkleButtonRef, id: "sparkleBtn", iconCss: "e-icons e-ai-chat", isPrimary: true, style: { display: 'none' } })),
                            React.createElement("div", { className: "email-actions e-card-content" },
                                React.createElement(ej2_react_buttons_1.ButtonComponent, { id: "sendEmailBtn", cssClass: "e-primary", onClick: this.handleSendEmail }, "Send Email")))),
                    React.createElement(ej2_react_interactive_chat_1.InlineAIPromptComponent, { ref: this.inlinePromptRef, id: "inlinePrompt", commandSettings: this.commandSettings, relateTo: "#emailContent", promptRequest: this.handlePromptRequest, responseSettings: responseSettings, open: this.handlePopupOpen, close: this.handlePopupClose }))),
