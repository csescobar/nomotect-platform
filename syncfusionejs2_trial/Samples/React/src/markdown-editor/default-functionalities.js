...
var MarkDown = /** @class */ (function (_super) {
    ...
    MarkDown.prototype.markdownConversion = function () {
        if (this.mdsource.classList.contains('e-active')) {
            ...
            htmlPreview.innerHTML = ej2_markdown_converter_1.MarkdownConverter.toHtml(this.rteObj.contentModule.getEditPanel().value, { lineBreak: true });
        }
    };
        ...
        return (React.createElement("div", { id: "markdownSample", className: 'control-pane' },
            React.createElement("div", { className: 'control-section', id: "rteMarkdown" },
                React.createElement("div", { className: "content-wrapper" },
                    React.createElement(ej2_react_richtexteditor_1.RichTextEditorComponent, { id: "markdownRTE", ref: function (richtexteditor) { _this.rteObj = richtexteditor; }, editorMode: 'Markdown', height: '520px', valueTemplate: this.template, formatter: this.formatter, toolbarSettings: this.toolbarSettings },
