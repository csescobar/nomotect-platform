...
This project is licensed under the **MIT License** – see the LICENSE file for details.`;
    ...
    function markdownConversion() {
        if (mdsource.classList.contains('e-active')) {
            ...
            htmlPreview.innerHTML = MarkdownConverter.toHtml(rteObj.contentModule.getEditPanel().value, { lineBreak: true });
        }
    }
    ...
    return (<div id="markdownSample" className='control-pane'>
            <div className='control-section' id="rteMarkdown">
                <div className="content-wrapper">
                    <RichTextEditorComponent id="markdownRTE" ref={(richtexteditor) => { rteObj = richtexteditor; }} editorMode='Markdown' height='520px' valueTemplate={template} formatter={formatter} created={rendereComplete} toolbarSettings={toolbarSettings}>
