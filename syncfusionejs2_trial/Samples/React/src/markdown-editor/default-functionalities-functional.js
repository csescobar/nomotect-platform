...
function MarkDown() {
    ...
    function markdownConversion() {
        if (mdsource.classList.contains('e-active')) {
            ...
            htmlPreview.innerHTML = ej2_markdown_converter_1.MarkdownConverter.toHtml(rteObj.contentModule.getEditPanel().value, { lineBreak: true });
        }
    }
    ...
    return (React.createElement("div", { id: "markdownSample", className: 'control-pane' },
        React.createElement("div", { className: 'control-section', id: "rteMarkdown" },
            React.createElement("div", { className: "content-wrapper" },
                React.createElement(ej2_react_richtexteditor_1.RichTextEditorComponent, { id: "markdownRTE", ref: function (richtexteditor) { rteObj = richtexteditor; }, editorMode: 'Markdown', height: '520px', valueTemplate: template, formatter: formatter, created: rendereComplete, toolbarSettings: toolbarSettings },
