    ...
    Basic.prototype.render = function () {
        return (React.createElement("div", { id: "defaultSplitter", className: "control-section" },
            ...
            React.createElement("div", { id: "description" },
                React.createElement("p", null, "The split panes of the Splitter control can be oriented horizontally or vertically using the Orientation property."),
                ...
                React.createElement("p", null, "The splitter allows resizing its panes when the drag separator (divider) bar is used to increase its dimension."))));
    };
    return Basic;
