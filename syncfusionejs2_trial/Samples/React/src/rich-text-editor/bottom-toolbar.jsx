...
export class BottomToolbar extends SampleBase {
    ...
    footerTemplate = () => {
        ...
        <RichTextEditorComponent ref={(rte) => (this.chatRTE = rte)} toolbarSettings={{
                position: 'Bottom',
                items: [
                    'Bold',
                    'Italic',
    ...
    render() {
        return (<div className="control-section">
            ...
            <div className="chat-section">
                <ChatUIComponent ref={this.chatUIRef} headerText="Michale Suyama" headerIconCss="chat_user2_avatar" messages={this.chatMessages} user={this.currentUserModel} showTimeBreak={true} loadOnDemand={true} messageToolbarSettings={{
                items: [
