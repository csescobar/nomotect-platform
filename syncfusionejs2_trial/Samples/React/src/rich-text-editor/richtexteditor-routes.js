...
var bottom_toolbar_functional_1 = require("./bottom-toolbar-functional");
...
exports.richtexteditorRoutes = (React.createElement(React.Fragment, null,
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/rich-text-editor/ai-assistant', Component: ai_assistant_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/rich-text-editor/bottom-toolbar', Component: bottom_toolbar_functional_1.default }),
