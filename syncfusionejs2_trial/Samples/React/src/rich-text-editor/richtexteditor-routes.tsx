...
import AIAssistantEditor from './ai-assistant-functional';
...
import BottomToolbar from './bottom-toolbar-functional';
...
export const richtexteditorRoutes = (
    <>
         ...
         <Route  path='/:theme/rich-text-editor/ai-assistant' Component={ AIAssistantEditor }/>
         ...
         <Route  path='/:theme/rich-text-editor/bottom-toolbar' Component={ BottomToolbar }/>
