...
export class Overview extends SampleBase {
    ...
    mirrorConversion(e) {
        ...
        if (e.targetItem === 'Preview') {
            ...
            const editorVlaue = this.editor.element.querySelector('.e-rte-srctextarea').value;
            if (!mirrorView) {
    ...
    handleFullScreen(e) {
        ...
        const sideBarElem = document.body.querySelector('#left-sidebar');
        const sideBar = getComponent(sideBarElem, 'sidebar');
        let leftBar;
