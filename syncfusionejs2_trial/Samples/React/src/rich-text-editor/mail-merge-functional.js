...
function MailMerge() {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(ej2_react_splitbuttons_1.DropDownButtonComponent, { className: "e-rte-dropdown-btn e-control e-dropdown-btn e-lib e-btn e-rte-dropdown-popup e-rte-dropdown-items e-formats-tbar-btn e-rte-elements e-rte-dropdown-menu", items: itemsName, content: '<span style="display: inline-flex;"><span class="e-rte-dropdown-btn-text">Insert Field</span></span>', select: onItemSelect, close: onDropDownClose, id: "insertField" }),
