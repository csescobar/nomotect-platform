...
import { RichTextEditorComponent, Inject, HtmlEditor, Toolbar, Image, Link, NodeSelection, QuickToolbar, Table, PasteCleanup, ClipBoardCleanup, AutoFormat } from '@syncfusion/ej2-react-richtexteditor';
  ...
  <p>Best regards,<br>The <span contenteditable="false" class="e-mention-chip"><span>{{CompanyName}}</span></span> Team</p>`;
    ...
    render() {
        return (<div>
                ...
                <DropDownButtonComponent className="e-rte-dropdown-btn e-rte-dropdown-popup e-rte-dropdown-items e-rte-elements e-rte-dropdown-menu" items={this.itemsName} content='<span style="display: inline-flex;"><span class="e-rte-dropdown-btn-text">Insert Field</span></span>' select={this.onItemSelect} close={this.onDropDownClose} id="insertField"></DropDownButtonComponent>
