...
var MailMerge = /** @class */ (function (_super) {
    ...
    MailMerge.prototype.onDropDownClose = function () {
        if (this.rteObj) {
            this.rteObj.focusIn();
        }
    };
    ...
    MailMerge.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(ej2_react_splitbuttons_1.DropDownButtonComponent, { className: "e-rte-dropdown-btn e-rte-dropdown-popup e-rte-dropdown-items e-rte-elements e-rte-dropdown-menu", items: this.itemsName, content: '<span style="display: inline-flex;"><span class="e-rte-dropdown-btn-text">Insert Field</span></span>', select: this.onItemSelect, close: this.onDropDownClose, id: "insertField" }),
