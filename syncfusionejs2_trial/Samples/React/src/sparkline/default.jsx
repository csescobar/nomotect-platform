...
const titleStyle = { "width": "100%", "text-align": "center", "font-size": "17px", "margin": "auto" };
const width100 = { width: "100%" };
const sparklineStyle1 = { "height": "50px", "text-align": "center" };
    ...
    render() {
        return (<div className='control-pane'>
                            ...
                            <table style={width100} className="cols-sample-area row">
                                <tbody>
                                    ...
                                    <tr style={{ "height": "80px" }}>
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='a-spark1-container' height='50px' width='90%' lineWidth={2} type='Line' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' format={"n"} useGroupingSeparator={true} tooltipSettings={{
                ...
                { x: 9, xval: '2014', yval: 22507620 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='a-spark2-container' height='50px' width='90%' lineWidth={2} type='Area' valueType='Category' fill='#3C78EF' opacity={1} border={{ color: '#fc5070', width: 2 }} negativePointColor='#fc5070' tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                ...
                { x: 9, xval: '2014', yval: 2.91 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='a-spark3-container' height='50px' width='90%' lineWidth={2} type='WinLoss' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                ...
                { x: 9, xval: '2014', yval: -1 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='a-spark4-container' height='50px' width='90%' lineWidth={2} type='Column' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' axisSettings={{ minY: 12 }} tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                ...
                { x: 9, xval: '2014', yval: 12.19 },
                                    ...
                                    <tr style={{ "height": "80px" }}>
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='c-spark1-container' height='50px' width='90%' lineWidth={2} type='Line' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' format={"n"} useGroupingSeparator={true} tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
                trackLineSettings: {
                    visible: true,
                    color: '#fc5070',
                ...
                { x: 9, xval: '2014', yval: 34834840 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='c-spark2-container' height='50px' width='90%' lineWidth={2} type='Area' valueType='Category' fill='#3C78EF' opacity={1} border={{ color: '#fc5070', width: 2 }} negativePointColor='#fc5070' tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                ...
                { x: 9, xval: '2014', yval: 3.49 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='c-spark3-container' height='50px' width='90%' lineWidth={2} type='WinLoss' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                { x: 0, xval: '2005', yval: 1 },
                { x: 1, xval: '2006', yval: -1 },
                ...
                { x: 9, xval: '2014', yval: -1 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='c-spark4-container' height='50px' width='90%' lineWidth={2} type='Column' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' axisSettings={{ minY: 10.20 }} tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                ...
                { x: 9, xval: '2014', yval: 10.29 },
                                    ...
                                    <tr style={{ "height": "80px" }}>
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='ch-spark1-container' height='50px' width='90%' lineWidth={2} type='Line' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' format={"n"} useGroupingSeparator={true} tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
                trackLineSettings: {
                    visible: true,
                    color: '#fc5070',
                ...
                { x: 9, xval: '2014', yval: 1355693000 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='ch-spark2-container' height='50px' width='90%' lineWidth={2} type={'Area'} valueType='Category' fill='#3C78EF' opacity={1} border={{ color: '#fc5070', width: 2 }} negativePointColor='#fc5070' tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                ...
                { x: 9, xval: '2014', yval: 141.26 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='ch-spark3-container' height='50px' width='90%' lineWidth={2} type='WinLoss' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                { x: 0, xval: '2005', yval: 1 },
                { x: 1, xval: '2006', yval: 1 },
                ...
                { x: 9, xval: '2014', yval: -1 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='ch-spark4-container' height='50px' width='90%' lineWidth={2} type='Column' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' axisSettings={{ minY: 12 }} tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                ...
                { x: 9, xval: '2014', yval: 12.17 },
                                    ...
                                    <tr style={{ "height": "80px" }}>
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='f-spark1-container' height='50px' width='90%' lineWidth={2} type='Line' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' format={"n"} useGroupingSeparator={true} tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
                trackLineSettings: {
                    visible: true,
                    color: '#fc5070',
                ...
                { x: 9, xval: '2014', yval: 66259010 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='f-spark2-container' height='50px' width='90%' lineWidth={2} type={'Area'} valueType='Category' fill='#3C78EF' opacity={1} border={{ color: '#fc5070', width: 2 }} negativePointColor='#fc5070' tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                ...
                { x: 9, xval: '2014', yval: 102.92 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='f-spark3-container' height='50px' width='90%' lineWidth={2} type='WinLoss' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                { x: 0, xval: '2005', yval: 1 },
                { x: 1, xval: '2006', yval: -1 },
                ...
                { x: 9, xval: '2014', yval: -1 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='f-spark4-container' height='50px' width='90%' lineWidth={2} type='Column' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' axisSettings={{ minY: 11.5 }} tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                ...
                { x: 9, xval: '2014', yval: 12.6 },
                                    ...
                                    <tr style={{ "height": "80px" }}>
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='g-spark1-container' height='50px' width='90%' lineWidth={2} type='Line' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' format={"n"} useGroupingSeparator={true} tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
                trackLineSettings: {
                    visible: true,
                    color: '#fc5070',
                ...
                { x: 9, xval: '2014', yval: 80996690 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='g-spark2-container' height='50px' width='90%' lineWidth={2} type={'Area'} valueType='Category' fill='#3C78EF' opacity={1} border={{ color: '#fc5070', width: 2 }} negativePointColor='#fc5070' tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                ...
                { x: 9, xval: '2014', yval: 226.87 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='g-spark3-container' height='50px' width='90%' lineWidth={2} type='WinLoss' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                ...
                { x: 9, xval: '2014', yval: 1 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='g-spark4-container' height='50px' width='90%' lineWidth={2} type='Column' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' axisSettings={{ minY: 8 }} tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                ...
                { x: 9, xval: '2014', yval: 8.42 },
                                    ...
                                    <tr style={{ "height": "80px" }}>
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='i-spark1-container' height='50px' width='90%' lineWidth={2} type='Line' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' format={"n"} useGroupingSeparator={true} tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
                trackLineSettings: {
                    visible: true,
                    color: '#fc5070',
                ...
                { x: 9, xval: '2014', yval: 1236345000 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='i-spark2-container' height='50px' width='90%' lineWidth={2} type={'Area'} valueType='Category' fill='#3C78EF' opacity={1} border={{ color: '#fc5070', width: 2 }} negativePointColor='#fc5070' tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                ...
                { x: 9, xval: '2014', yval: 376.1 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='i-spark3-container' height='50px' width='90%' lineWidth={2} type='WinLoss' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                { x: 0, xval: '2005', yval: 1 },
                { x: 1, xval: '2006', yval: -1 },
                ...
                { x: 9, xval: '2014', yval: -1 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='i-spark4-container' height='50px' width='90%' lineWidth={2} type='Column' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' axisSettings={{ minY: 19 }} tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                ...
                { x: 9, xval: '2014', yval: 19.89 },
                                    ...
                                    <tr style={{ "height": "80px" }}>
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='r-spark1-container' height='50px' width='90%' lineWidth={2} type='Line' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' format={"n"} useGroupingSeparator={true} tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
                trackLineSettings: {
                    visible: true,
                    color: '#fc5070',
                ...
                { x: 9, xval: '2014', yval: 142470300 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='r-spark2-container' height='50px' width='90%' lineWidth={2} type={'Area'} valueType='Category' fill='#3C78EF' opacity={1} border={{ color: '#fc5070', width: 2 }} negativePointColor='#fc5070' tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                ...
                { x: 9, xval: '2014', yval: 8.33 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='r-spark3-container' height='50px' width='90%' lineWidth={2} type='WinLoss' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                { x: 0, xval: '2005', yval: 1 },
                ...
                { x: 9, xval: '2014', yval: -1 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='r-spark4-container' height='50px' width='90%' lineWidth={2} type='Column' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' axisSettings={{ minY: 9.5 }} tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                ...
                { x: 9, xval: '2014', yval: 11.87 },
                                    ...
                                    <tr style={{ "height": "80px" }}>
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='sw-spark1-container' height='50px' width='90%' lineWidth={2} type='Line' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' format={"n"} useGroupingSeparator={true} tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
                trackLineSettings: {
                    visible: true,
                    color: '#fc5070',
                ...
                { x: 9, xval: '2014', yval: 9723809 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='sw-spark2-container' height='50px' width='90%' lineWidth={2} type={'Area'} valueType='Category' fill='#3C78EF' opacity={1} border={{ color: '#fc5070', width: 2 }} negativePointColor='#fc5070' tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                ...
                { x: 9, xval: '2014', yval: 21.59 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='sw-spark3-container' height='50px' width='90%' lineWidth={2} type='WinLoss' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                { x: 0, xval: '2005', yval: 1 },
                { x: 1, xval: '2006', yval: -1 },
                ...
                { x: 9, xval: '2014', yval: 1 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='sw-spark4-container' height='50px' width='90%' lineWidth={2} type='Column' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' axisSettings={{ minY: 10 }} tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                ...
                { x: 9, xval: '2014', yval: 11.92 },
                                    ...
                                    <tr style={{ "height": "80px" }}>
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='uk-spark1-container' height='50px' width='90%' lineWidth={2} type='Line' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' format={"n"} useGroupingSeparator={true} tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
                trackLineSettings: {
                    visible: true,
                    color: '#fc5070',
                ...
                { x: 9, xval: '2014', yval: 63742980 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='uk-spark2-container' height='50px' width='90%' lineWidth={2} type={'Area'} valueType='Category' fill='#3C78EF' opacity={1} border={{ color: '#fc5070', width: 2 }} negativePointColor='#fc5070' tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                ...
                { x: 9, xval: '2014', yval: 261.66 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='uk-spark3-container' height='50px' width='90%' lineWidth={2} type='WinLoss' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                { x: 0, xval: '2005', yval: 1 },
                { x: 1, xval: '2006', yval: 0 },
                ...
                { x: 9, xval: '2014', yval: -1 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='uk-spark4-container' height='50px' width='90%' lineWidth={2} type='Column' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' axisSettings={{ minY: 10 }} tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                ...
                { x: 9, xval: '2014', yval: 12.22 },
                                    ...
                                    <tr style={{ "height": "80px" }}>
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='us-spark1-container' height='50px' width='90%' lineWidth={2} type='Line' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' format={"n"} useGroupingSeparator={true} tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
                trackLineSettings: {
                    visible: true,
                    color: '#fc5070',
                ...
                { x: 9, xval: '2014', yval: 318892100 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='us-spark2-container' height='50px' width='90%' lineWidth={2} type={'Area'} valueType='Category' fill='#3C78EF' opacity={1} border={{ color: '#fc5070', width: 2 }} negativePointColor='#fc5070' tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                ...
                { x: 9, xval: '2014', yval: 32.45 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='us-spark3-container' height='50px' width='90%' lineWidth={2} type='WinLoss' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
                { x: 0, xval: '2005', yval: 1 },
                { x: 1, xval: '2006', yval: -1 },
                ...
                { x: 9, xval: '2014', yval: -1 },
                                        ...
                                        <td>
                                            <SparklineComponent load={this.load.bind(this)} id='us-spark4-container' height='50px' width='90%' lineWidth={2} type='Column' valueType='Category' fill='#3C78EF' negativePointColor='#fc5070' axisSettings={{ minY: 13 }} tooltipSettings={{
                visible: true, format: '${xval} : ${yval}',
            }} dataSource={[
