...
let SynchronizedChart = () => {
    ...
    return (<div className="control-pane">
        ...
        }} zoomComplete={zoomComplete.bind(this)} chartMouseLeave={chartMouseLeave.bind(this)} chartMouseMove={chartMouseMove.bind(this)} chartMouseUp={chartMouseUp.bind(this)} load={load.bind(this)} loaded={onChartLoad.bind(this)} titleStyle={{ textAlignment: 'Near' }} tooltip={{ enable: true, fadeOutDuration: Browser.isDevice ? 2500 : 1000, showNearestTooltip: true, header: '', format: '<b>€${point.y}</b><br>${point.x} 2023', enableMarker: false, enableHighlight: true }} crosshair={{ enable: true, snapToData: true, lineType: 'Vertical', dashArray: '2,2' }} title="US to Euro">
            ...
            mode: 'X',
            toolbarItems: ['Pan', 'Reset']
        }} zoomComplete={zoomComplete.bind(this)} chartMouseLeave={chartobjMouseLeave.bind(this)} chartMouseMove={chartobjMouseMove.bind(this)} chartMouseUp={chart2MouseUp.bind(this)} load={load.bind(this)} loaded={onChartLoad2.bind(this)} titleStyle={{ textAlignment: 'Near' }} tooltip={{ enable: true, fadeOutDuration: Browser.isDevice ? 2500 : 1000, showNearestTooltip: true, header: '', format: '<b>¥${point.y}</b><br>${point.x} 2023', enableMarker: false, enableHighlight: true }} crosshair={{ enable: true, snapToData: true, lineType: 'Vertical', dashArray: '2,2' }} title="US to Yen">
                            <Inject services={[AreaSeries, LineSeries, DataLabel, DateTime, Tooltip, Zoom, Highlight, Legend, Selection, Crosshair]}/>
                            <SeriesCollectionDirective>
            ...
            mode: 'X',
            toolbarItems: ['Pan', 'Reset']
        }} zoomComplete={zoomComplete.bind(this)} chartMouseLeave={chart3MouseLeave.bind(this)} chartMouseMove={chart3MouseMove.bind(this)} chartMouseUp={chart3MouseUp.bind(this)} load={load.bind(this)} loaded={onChartLoad3.bind(this)} titleStyle={{ textAlignment: 'Near' }} tooltip={{ enable: true, fadeOutDuration: Browser.isDevice ? 2500 : 1000, showNearestTooltip: true, header: '', format: '<b>$${point.y}</b><br>${point.x} 2023', enableMarker: false }} crosshair={{ enable: true, snapToData: true, lineType: 'Vertical', dashArray: '2,2' }} title="US to SGD">
                            <Inject services={[AreaSeries, LineSeries, DataLabel, DateTime, Tooltip, Zoom, Highlight, Legend, Selection, Crosshair]}/>
                            <SeriesCollectionDirective>
            ...
            mode: 'X',
            toolbarItems: ['Pan', 'Reset']
        }} zoomComplete={zoomComplete.bind(this)} chartMouseLeave={chart4MouseLeave.bind(this)} chartMouseMove={chart4MouseMove.bind(this)} chartMouseUp={chart4MouseUp.bind(this)} load={load.bind(this)} loaded={onChartLoad4.bind(this)} titleStyle={{ textAlignment: 'Near' }} tooltip={{ enable: true, fadeOutDuration: Browser.isDevice ? 2500 : 1000, showNearestTooltip: true, header: '', format: '<b>₹${point.y}</b><br>${point.x} 2023', enableMarker: false }} crosshair={{ enable: true, snapToData: true, lineType: 'Vertical', dashArray: '2,2' }} title="US to INR">
                            <Inject services={[AreaSeries, LineSeries, DataLabel, DateTime, Tooltip, Zoom, Highlight, Legend, Selection, Crosshair]}/>
                            <SeriesCollectionDirective>
