...
const UpdateColumnDataSource = () => {
    ...
    return (<div className='control-pane'>
            ...
            lineStyle: { width: 0 },
            majorTickLines: { width: 0 }
        }} chartArea={{ border: { width: 0 } }} title='Nitrogen Fertilizer Use per Hectare of Cropland' pointRender={labelRender} width={Browser.isDevice ? '100%' : '75%'} load={load.bind(this)} axisRangeCalculated={axisRangeCalculated}>
