...
var AccumulationLegendTemplate = function () {
    ...
    var load = function (args) { (0, theme_color_1.loadAccumulationChartTheme)(args); };
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("style", null, SAMPLE_CSS),
        React.createElement("div", { className: 'control-section', style: { textAlign: "center" } },
            React.createElement(ej2_react_charts_1.AccumulationChartComponent, { style: { textAlign: "center" }, id: 'accumulationLegendFunctional', ref: function (chart) { chartRef.current = chart; }, title: 'Top 5 Oil Producing Countries (2023)', subTitle: 'Source: Wikipedia.org', titleStyle: {
                    position: 'Custom',
                    x: ej2_base_1.Browser.isDevice ? 150 : 492,
                    y: 22.75
                }, tooltip: {
                    enable: true,
                    header: '<b>${point.x}</b>',
