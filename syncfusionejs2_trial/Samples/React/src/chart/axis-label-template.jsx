...
export class AxisLabelTemplate extends SampleBase {
    xAxisLabelTemplate(props) {
        return (<div id="labelTemplate" className="light-bg" style={{ display: 'flex', alignItems: 'center', gap: '8px', borderRadius: '3px', width: '130px', justifyContent: 'space-between' }}>
    ...
    render() {
        ...
        <div className="control-section">
          <ChartComponent id="container" style={{ textAlign: 'center' }} title={"Olympic medal standings 2024"} subTitle={'Source: www.olympics.com'} titleStyle={{ textOverflow: 'Wrap' }} subTitleStyle={{ textOverflow: 'Wrap' }} width={Browser.isDevice ? '100%' : '75%'} legendSettings={{ visible: true }} isTransposed={true} chartArea={{ border: { width: 0 } }} tooltip={{ enable: true }} loaded={this.onChartLoad.bind(this)} load={this.load.bind(this)} primaryXAxis={{
                valueType: 'Category',
