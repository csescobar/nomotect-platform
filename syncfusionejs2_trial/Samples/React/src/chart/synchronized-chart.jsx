...
export class SynchronizedChart extends SampleBase {
    ...
    render() {
        return (<div className="control-pane">
            ...
            }} zoomComplete={this.zoomComplete.bind(this)} chartMouseLeave={this.chartMouseLeave.bind(this)} chartMouseMove={this.chartMouseMove.bind(this)} chartMouseUp={this.chartMouseUp.bind(this)} load={this.load.bind(this)} titleStyle={{ textAlignment: 'Near' }} tooltip={{ enable: true, fadeOutDuration: Browser.isDevice ? 2500 : 1000, showNearestTooltip: true, header: '', format: '<b>€${point.y}</b><br>${point.x} 2023', enableMarker: false, enableHighlight: true }} crosshair={{ enable: true, snapToData: true, lineType: 'Vertical', dashArray: '2,2' }} title="US to Euro">
                ...
                mode: 'X',
                toolbarItems: ['Pan', 'Reset']
            }} zoomComplete={this.zoomComplete.bind(this)} chartMouseLeave={this.chartobjMouseLeave.bind(this)} chartMouseMove={this.chartobjMouseMove.bind(this)} chartMouseUp={this.chartobjMouseUp.bind(this)} load={this.load.bind(this)} titleStyle={{ textAlignment: 'Near' }} tooltip={{ enable: true, fadeOutDuration: Browser.isDevice ? 2500 : 1000, showNearestTooltip: true, header: '', format: '<b>¥${point.y}</b><br>${point.x} 2023', enableMarker: false, enableHighlight: true }} crosshair={{ enable: true, snapToData: true, lineType: 'Vertical', dashArray: '2,2' }} title="US to Yen">
                                <Inject services={[AreaSeries, SplineAreaSeries, LineSeries, SplineSeries, DataLabel, DateTime, Tooltip, Zoom, Highlight, Legend, Selection, Crosshair]}/>
                                <SeriesCollectionDirective>
                ...
                mode: 'X',
                toolbarItems: ['Pan', 'Reset']
            }} zoomComplete={this.zoomComplete.bind(this)} chartMouseLeave={this.chart3MouseLeave.bind(this)} chartMouseMove={this.chart3MouseMove.bind(this)} chartMouseUp={this.chart3MouseUp.bind(this)} load={this.load.bind(this)} titleStyle={{ textAlignment: 'Near' }} tooltip={{ enable: true, fadeOutDuration: Browser.isDevice ? 2500 : 1000, showNearestTooltip: true, header: '', format: '<b>$${point.y}</b><br>${point.x} 2023', enableMarker: false }} crosshair={{ enable: true, snapToData: true, lineType: 'Vertical', dashArray: '2,2' }} title="US to SGD">
                                <Inject services={[AreaSeries, SplineAreaSeries, LineSeries, SplineSeries, DataLabel, DateTime, Tooltip, Zoom, Highlight, Legend, Selection, Crosshair]}/>
                                <SeriesCollectionDirective>
                ...
                mode: 'X',
                toolbarItems: ['Pan', 'Reset']
            }} zoomComplete={this.zoomComplete.bind(this)} chartMouseLeave={this.chart4MouseLeave.bind(this)} chartMouseMove={this.chart4MouseMove.bind(this)} chartMouseUp={this.chart4MouseUp.bind(this)} load={this.load.bind(this)} titleStyle={{ textAlignment: 'Near' }} tooltip={{ enable: true, fadeOutDuration: Browser.isDevice ? 2500 : 1000, showNearestTooltip: true, header: '', format: '<b>₹${point.y}</b><br>${point.x} 2023', enableMarker: false }} crosshair={{ enable: true, snapToData: true, lineType: 'Vertical', dashArray: '2,2' }} title="US to INR">
                                <Inject services={[AreaSeries, SplineAreaSeries, LineSeries, SplineSeries, DataLabel, DateTime, Tooltip, Zoom, Highlight, Legend, Selection, Crosshair]}/>
                                <SeriesCollectionDirective>
