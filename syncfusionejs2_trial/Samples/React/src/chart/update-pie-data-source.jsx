                ...
                textStyle: {
                    ...
                    size: Browser.isDevice ? '25px' : '40px'
                        ...
                        <AccumulationSeriesCollectionDirective>
                            <AccumulationSeriesDirective dataSource={updatedData} xName='x' yName='y' radius={Browser.isDevice ? '40%' : '75%'} innerRadius='65%' dataLabel={{ visible: true, position: 'Outside', font: { fontWeight: '600' }, connectorStyle: { type: 'Line', width: 2, length: '18' } }}/>
                        </AccumulationSeriesCollectionDirective>
