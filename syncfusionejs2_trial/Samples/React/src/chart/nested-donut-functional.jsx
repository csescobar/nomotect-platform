...
const NestedDonut = () => {
    ...
    return (<div className='control-pane'>
            <div className='control-section'>
                <AccumulationChartComponent id="container" load={load} loaded={onChartLoad} enableBorderOnMouseMove={false} title='The Population of Qatar by Nationality' tooltip={{
            enable: true,
            ...
            textStyle: { size: '12px', fontWeight: 'bold' }
                    ...
                    <AccumulationSeriesCollectionDirective>
                        <AccumulationSeriesDirective dataSource={countryData} type='Pie' xName='x' yName='y' pointColorMapping='color' radius='90%' innerRadius='75%' border={{ color: '#fff', width: 2 }} dataLabel={{
            visible: true,
            name: 'text',
            position: 'Outside'
        }} animation={{ enable: false }}/>
                        <AccumulationSeriesDirective dataSource={regionData} type='Pie' xName='x' yName='y' pointColorMapping='color' radius='67%' innerRadius='35%' border={{ color: '#fff', width: 2 }} dataLabel={{
            visible: true,
            name: 'text',
            position: 'Inside'
        }} animation={{ enable: false }}/>
