...
import BarWithGradient from './bar-with-gradient-functional';
...
import DonutWithGradient from './donut-with-gradient-functional';
import NestedDoughnut from './nested-donut-functional';
import Pyramid from './pyramid-functional';
import Funnel from './funnel-functional';
import Doughnut from './pie-legend-functional';
import AccumulationLegendTemplate from './accumulation-legend-template-functional';
...
import AxisLabelTemplate from './axis-label-template-functional';
...
import ChartLegendTemplate from './chart-legend-template-functional';
import NodataTemplate from './no-data-template-functional';
...
export const chartRoutes = (<>
         ...
         <Route path='/:theme/chart/bar-with-gradient' Component={BarWithGradient}/>
         ...
         <Route path='/:theme/chart/donut-with-gradient' Component={DonutWithGradient}/>
         <Route path='/:theme/chart/nested-donut' Component={NestedDoughnut}/>
         ...
         <Route path='/:theme/chart/accumulation-legend-template' Component={AccumulationLegendTemplate}/>
         ...
         <Route path='/:theme/chart/axis-label-template' Component={AxisLabelTemplate}/>
         ...
         <Route path='/:theme/chart/chart-legend-template' Component={ChartLegendTemplate}/>
         <Route path='/:theme/chart/no-data-template' Component={NodataTemplate}/>
