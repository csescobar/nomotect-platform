...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, Inject, SplineAreaSeries, DataLabel, Category, ChartAnnotation, AnnotationDirective, AnnotationsDirective } from '@syncfusion/ej2-react-charts';
...
export class UpdateDataSource extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section' style={{ textAlign: "center" }}>
          <ChartComponent id='container' style={{ textAlign: "center" }} ref={(chart) => this.chartInstance = chart} primaryXAxis={{
                interval: 1,
                zoomFactor: 0.2,
                zoomPosition: 0,
                ...
                majorGridLines: { width: 0 },
                visible: false
            }} titleStyle={{ textAlignment: 'Far', size: '20px' }} chartArea={{ border: { width: 0 } }} load={this.load.bind(this)} height={'60%'} width={Browser.isDevice ? '100%' : '75%'} title='USA, Texas' axisLabelRender={this.axisLabelRender.bind(this)} annotationRender={this.annotationRender.bind(this)}>
