...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, Inject, StackingColumnSeries, Category, Legend, Tooltip, DataLabel, ChartAnnotation, AnnotationsDirective, AnnotationDirective } from '@syncfusion/ej2-react-charts';
...
const AxisLabelTemplateFunctional = () => {
    ...
    let axisLabeltemplate = '<div id="labelTemplate" class="light-bg" style="display:flex;align-items:center;gap:8px;border-radius:3px;width:130px;justify-content:space-between;">' +
    ...
    return (<div className="control-pane">
      ...
      <div className="control-section">
        <ChartComponent id="container" style={{ textAlign: 'center' }} load={load.bind(this)} loaded={onChartLoad.bind(this)} title={"Olympic medal standings 2024"} subTitle={'Source: www.olympics.com'} titleStyle={{ textOverflow: 'Wrap' }} subTitleStyle={{ textOverflow: 'Wrap' }} width={Browser.isDevice ? '100%' : '75%'} legendSettings={{ visible: true }} isTransposed={true} chartArea={{ border: { width: 0 } }} tooltip={{ enable: true }} primaryXAxis={{
            valueType: 'Category',
