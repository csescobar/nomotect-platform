                ...
                <div className='control-section'>
                    ...
                    <AccumulationChartComponent id='pie-chart' ref={pie => this.pie = pie} title={this.title} enableSmartLabels={false} subTitle='Source: wikipedia.org' legendSettings={{ visible: false }} enableBorderOnMouseMove={false} tooltip={{ enable: false, format: '${point.x} <br> ${point.y} %' }} chartMouseClick={this.onChartMouseClick.bind(this)} textRender={this.onTextRender.bind(this)} load={this.load.bind(this)} loaded={this.onChartLoad.bind(this)}>
                        ...
                        <AccumulationSeriesCollectionDirective>
                            <AccumulationSeriesDirective dataSource={this.data} xName='x' yName='y' name='Automobile Sales' dataLabel={this.dataLabel} radius='70%' startAngle={-30} endAngle={330} borderRadius={3} border={{ color: '#ffffff', width: 1 }} explode={false}>
