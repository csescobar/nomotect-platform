...
export class TrackballChart extends SampleBase {
    render() {
        return (<div className='control-pane'>
                ...
                lineStyle: { width: 0 },
            }} title='Average Sales per Person' loaded={this.onChartLoad.bind(this)} tooltip={{ enable: true, shared: true }} crosshair={{ enable: true, snapToData: true, lineType: 'Vertical' }}>
