...
const AccumulationDoughnut = () => {
    ...
    return (<div className='control-pane'>
            <div className='control-section'>
                <AccumulationChartComponent id="container" load={load.bind(this)} loaded={onChartLoad.bind(this)} tooltip={{ enable: true, header: '', format: '${point.x} : <b>${point.y}%</b>' }} legendSettings={{ visible: true, position: 'Right' }} title='Share of E-commerce Orders by Country - 2025' subTitle='Source: Data provided by Eurostat European Statistics' titleStyle={{ position: 'Custom', x: Browser.isDevice ? 120 : 370, y: 15 }} enableSmartLabels={true} pointRender={pointRender} legendRender={legendRender}>
