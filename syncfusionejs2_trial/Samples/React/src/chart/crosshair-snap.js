        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_charts_1.ChartComponent, { id: 'charts', style: { textAlign: "center" }, primaryXAxis: {
                        ...
                        majorTickLines: { width: 0 },
                        lineStyle: { width: 0 }
                    }, chartArea: { border: { width: 0 } }, width: ej2_base_1.Browser.isDevice ? '100%' : '75%', title: 'Historical Gold Prices in USA: 2015 to 2024', tooltip: { enable: false, shared: false }, crosshair: { enable: true, snapToData: true, dashArray: '5,5' }, legendSettings: { visible: false } },
