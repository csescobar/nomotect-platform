...
exports.DonutWithGradient = exports.GradientDonutData = void 0;
...
var DonutWithGradient = /** @class */ (function (_super) {
    __extends(DonutWithGradient, _super);
    function DonutWithGradient() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DonutWithGradient.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_charts_1.AccumulationChartComponent, { id: "container", ref: function (chart) { return _this.pie = chart; }, load: this.load.bind(this), loaded: this.onChartLoad.bind(this), tooltip: { enable: true, header: '', format: '${point.x} : <b>${point.y}%</b>' }, legendSettings: { visible: true, position: 'Right' }, title: 'Share of E-commerce Orders by Country - 2025', subTitle: 'Source: Data provided by Eurostat European Statistics', titleStyle: { position: 'Custom', x: ej2_base_1.Browser.isDevice ? 120 : 370, y: 15 }, enableSmartLabels: true, pointRender: this.onPointRender.bind(this), legendRender: this.onLegendRender.bind(this) },
    ...
    DonutWithGradient.prototype.onPointRender = function (args) {
    ...
    DonutWithGradient.prototype.onLegendRender = function (args) {
    ...
    DonutWithGradient.prototype.onChartLoad = function (args) {
        document.getElementById('container').setAttribute('title', '');
    };
    ;
    DonutWithGradient.prototype.load = function (args) {
    ...
    ;
    return DonutWithGradient;
}(sample_base_1.SampleBase));
exports.DonutWithGradient = DonutWithGradient;
