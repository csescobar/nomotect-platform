...
export class AccumulationLegendTemplate extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section' style={{ textAlign: 'center' }}>
          <AccumulationChartComponent style={{ textAlign: 'center' }} id='accumulationLegend' ref={chart => this.chartInstance = chart} title='Top 5 Oil Producing Countries (2023)' subTitle='Source: Wikipedia.org' titleStyle={{
                position: 'Custom',
