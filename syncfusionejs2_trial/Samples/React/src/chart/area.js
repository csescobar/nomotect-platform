...
var content = ej2_base_1.Browser.isDevice ? '<div style="font-weight: bold; color: white; font-size: 7px;">8-TRACK</div>' : '<div style="font-weight: bold; color: white; font-size: 11px;">8-TRACK</div>';
var content1 = ej2_base_1.Browser.isDevice ? '<div style="font-weight: bold; color: white;font-size: 7px;">VINYL</div>' : '<div style="font-weight: bold; color: white;font-size: 11px;">VINYL</div>';
var content2 = ej2_base_1.Browser.isDevice ? '<div style="font-weight: bold; color: white;font-size: 7px;">CASSETTE</div>' : '<div style="font-weight: bold; color: white;font-size: 11px;">CASSETTE</div>';
var content3 = ej2_base_1.Browser.isDevice ? '<div style="font-weight: bold; color: white;font-size: 7px;">COMPACT DISC</div>' : '<div style="font-weight: bold; color: white;font-size: 11px;">COMPACT DISC</div>';
var content4 = ej2_base_1.Browser.isDevice ? '<div style="font-weight: bold; color: white;font-size: 7px;">OTHERS</div>' : '<div style="font-weight: bold; color: white;font-size: 11px;">OTHERS</div>';
var content5 = ej2_base_1.Browser.isDevice ? '<div style="font-weight: bold; color: white; font-size: 7px;">DOWNLOAD</div>' : '<div style="font-weight: bold; color: white; font-size: 11px;">DOWNLOAD</div>';
var content6 = ej2_base_1.Browser.isDevice ? '<div style="font-weight: bold; color: white;font-size: 7px;"></div>' : '<div style="font-weight: bold; color: white;font-size: 11px;">STREAMING</div>';
            ...
            React.createElement("div", { className: "control-section" },
                React.createElement(ej2_react_charts_1.ChartComponent, { id: "charts", style: { textAlign: 'center' }, primaryXAxis: { valueType: 'DateTime', minimum: new Date(1973, 1, 1), maximum: new Date(2018, 1, 1), interval: 5, labelFormat: 'y', majorGridLines: { width: 0 }, edgeLabelPlacement: 'Shift' }, primaryYAxis: { title: 'In Billions (USD)', labelFormat: '{value}M', interval: 5, minimum: 0, maximum: 25, lineStyle: { width: 0 }, majorTickLines: { width: 0 }, minorTickLines: { width: 0 } }, load: this.load.bind(this), width: ej2_base_1.Browser.isDevice ? '100%' : '75%', chartArea: { border: { width: 0 } }, title: "US Music Sales By Format", loaded: this.onChartLoad.bind(this) },
                    ...
                    React.createElement(ej2_react_charts_1.AnnotationsDirective, null,
                        React.createElement(ej2_react_charts_1.AnnotationDirective, { content: content, region: "Series", coordinateUnits: 'Point', x: new Date(1976, 1, 1), y: 1.5 }),
                        React.createElement(ej2_react_charts_1.AnnotationDirective, { content: content1, region: "Series", coordinateUnits: 'Point', x: new Date(1977, 1, 1), y: 5 }),
                        React.createElement(ej2_react_charts_1.AnnotationDirective, { content: content2, region: "Series", coordinateUnits: 'Point', x: new Date(1990, 1, 1), y: 3 }),
                        React.createElement(ej2_react_charts_1.AnnotationDirective, { content: content3, region: "Series", coordinateUnits: 'Point', x: new Date(2001, 1, 1), y: 10 }),
                        React.createElement(ej2_react_charts_1.AnnotationDirective, { content: content4, region: "Series", coordinateUnits: 'Point', x: new Date(2006, 1, 1), y: 0.50 }),
                        React.createElement(ej2_react_charts_1.AnnotationDirective, { content: content5, region: "Series", coordinateUnits: 'Point', x: new Date(2011, 6, 1), y: 1.8 }),
                        React.createElement(ej2_react_charts_1.AnnotationDirective, { content: content6, region: "Series", coordinateUnits: 'Point', x: new Date(2015, 1, 1), y: ej2_base_1.Browser.isDevice ? 1.3 : 1.2 })),
