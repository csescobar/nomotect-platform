...
var SmartLabels = function () {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement(ej2_react_charts_1.AccumulationChartComponent, { id: 'pie-chart', title: 'Summer Olympics 2024 - Gold Medals', subTitle: 'Source: wikipedia.org', tooltip: { enable: true, format: '<b>${point.x}</b><br> Gold Medals: <b>${point.y}</b>', enableHighlight: true, header: "" }, load: load.bind(_this), enableBorderOnMouseMove: false, enableSmartLabels: true, legendSettings: { visible: false }, loaded: onChartLoad.bind(_this) },
