...
export class ChartLegendTemplate extends SampleBase {
    ...
    render() {
        return (<div className='control-pane'>
                ...
                <div className='control-section'>
                    <ChartComponent id='legendTemplate' ref={chart => this.chartInstance = chart} style={{ textAlign: 'center' }} primaryXAxis={{
                valueType: 'Category',
            ...
            }} legendRender={this.legendRender.bind(this)} load={this.load.bind(this)} loaded={this.loaded.bind(this)} width={Browser.isDevice ? '100%' : '75%'}>
    ...
    loaded(args) {
        let chart = document.getElementById('legendTemplate');
