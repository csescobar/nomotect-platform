...
var bar_with_gradient_functional_1 = require("./bar-with-gradient-functional");
...
var donut_with_gradient_functional_1 = require("./donut-with-gradient-functional");
var nested_donut_functional_1 = require("./nested-donut-functional");
...
var accumulation_legend_template_functional_1 = require("./accumulation-legend-template-functional");
...
var axis_label_template_functional_1 = require("./axis-label-template-functional");
...
var chart_legend_template_functional_1 = require("./chart-legend-template-functional");
var no_data_template_functional_1 = require("./no-data-template-functional");
...
exports.chartRoutes = (React.createElement(React.Fragment, null,
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/chart/bar-with-gradient', Component: bar_with_gradient_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/chart/donut-with-gradient', Component: donut_with_gradient_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/chart/nested-donut', Component: nested_donut_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/chart/accumulation-legend-template', Component: accumulation_legend_template_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/chart/axis-label-template', Component: axis_label_template_functional_1.default }),
    ...
    React.createElement(react_router_dom_1.Route, { path: '/:theme/chart/chart-legend-template', Component: chart_legend_template_functional_1.default }),
    React.createElement(react_router_dom_1.Route, { path: '/:theme/chart/no-data-template', Component: no_data_template_functional_1.default }),
