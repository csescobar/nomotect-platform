        ...
        return (React.createElement("div", { className: "control-pane" },
            ...
            React.createElement("div", { className: "control-section" },
                React.createElement(ej2_react_charts_1.ChartComponent, { id: "charts", style: { textAlign: 'center' }, primaryXAxis: { valueType: 'Double', edgeLabelPlacement: 'Shift', majorGridLines: { width: 0 } }, load: this.load.bind(this), primaryYAxis: { title: 'Volume in million metric tons', labelFormat: '{value}', rangePadding: 'None', minimum: 0, maximum: 25, interval: 5, lineStyle: { width: 0 }, majorTickLines: { width: 0 }, minorTickLines: { width: 0 } }, chartArea: { border: { width: 0 }, margin: { bottom: 12 } }, tooltip: { enable: true, enableHighlight: true, showNearestTooltip: true, header: '<b>${series.name}</b>', format: '${point.x} : <b>${point.y}M</b>' }, legendSettings: { enableHighlight: true }, width: ej2_base_1.Browser.isDevice ? '100%' : '75%', title: "Annual Crude Steel Production by Country (2016\u20132024)", subTitle: "Source: wikipedia.org", loaded: this.onChartLoad.bind(this) },
                    React.createElement(ej2_react_charts_1.Inject, { services: [ej2_react_charts_1.LineSeries, ej2_react_charts_1.Double, ej2_react_charts_1.Legend, ej2_react_charts_1.Tooltip, ej2_react_charts_1.Highlight, ej2_react_charts_1.SeriesLabel] }),
                    React.createElement(ej2_react_charts_1.SeriesCollectionDirective, null,
                        React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.vietnamData, xName: "x", yName: "y", name: "Vietnam", width: 2, marker: { visible: true, width: 7, height: 7, shape: 'Circle', isFilled: true }, type: "Line", labelSettings: { visible: true } }),
                        React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.indonesiaData, xName: "x", yName: "y", name: "Indonesia", width: 2, marker: { visible: true, width: 6, height: 6, shape: 'Triangle', isFilled: true }, type: "Line", labelSettings: { visible: true } }),
                        React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.franceData, xName: "x", yName: "y", name: "France", width: 2, marker: { visible: true, width: 7, height: 7, shape: 'Diamond', isFilled: true }, type: "Line", labelSettings: { visible: true } }),
                        React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.polandData, xName: "x", yName: "y", name: "Poland", width: 2, marker: { visible: true, width: 5, height: 5, shape: 'Rectangle', isFilled: true }, type: "Line", labelSettings: { visible: true } }),
                        React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.mexicoData, xName: "x", yName: "y", name: "Mexico", width: 2, marker: { visible: true, width: 7, height: 7, shape: 'Pentagon', isFilled: true }, type: "Line", labelSettings: { visible: true } })))),
            ...
            React.createElement("div", { id: "description" },
                ...
                React.createElement("p", null,
                    React.createElement("code", null, "SeriesLabel"),
                    " is enabled in this example to display the name of each line series."),
                React.createElement("p", null,
