...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, LineSeries, Category, Tooltip, Inject } from '@syncfusion/ej2-react-charts';
...
export class NoDataTemplate extends SampleBase {
    chartInstance;
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        return (<div className='control-pane'>
                ...
                <div className='control-section row'>
                    <div>
                        <ChartComponent id='charts' ref={chart => this.chartInstance = chart} style={{ textAlign: "center" }} noDataTemplate={this.noDataTemplate} width='100%' primaryXAxis={{ valueType: 'Category',
                majorGridLines: {
                    width: 0
                },
                majorTickLines: {
