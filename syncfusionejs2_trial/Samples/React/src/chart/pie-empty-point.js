...
var PieEmptyPoint = /** @class */ (function (_super) {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section row' },
                React.createElement("div", { className: 'col-md-8' },
                    React.createElement(ej2_react_charts_1.AccumulationChartComponent, { id: 'pie-chart', ref: function (pie) { return _this.pie = pie; }, title: 'Movie Genre Revenue Share', load: this.load.bind(this), textRender: this.textRender.bind(this), legendSettings: { visible: false }, tooltip: { enable: true, header: "", format: '<b>${point.x}</b><br> Profit: <b>$${point.y}K</b>', enableHighlight: true }, enableBorderOnMouseMove: false, loaded: this.onChartLoad.bind(this) },
                        ...
                        React.createElement(ej2_react_charts_1.AccumulationSeriesCollectionDirective, null,
                            React.createElement(ej2_react_charts_1.AccumulationSeriesDirective, { dataSource: exports.data1, xName: 'x', yName: 'y', radius: "80%", name: 'Profit', borderRadius: 3, border: { width: 1, color: '#ffffff' }, dataLabel: { visible: true, position: 'Inside', enableRotation: true, font: { size: ej2_base_1.Browser.isDevice ? '8px' : '12px', fontWeight: '600' } }, emptyPointSettings: { fill: '#e6e6e6' } })))),
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null,
                    "This sample illustrates the movie genre revenue share with empty point functionality in the pie series. The Mode of empty point can be changed by using ",
    ...
    PieEmptyPoint.prototype.load = function (args) {
        ...
        args.chart.series[0].dataLabel.font.color = selectedTheme === 'bootstrap5-dark' || selectedTheme === 'tailwind-dark' ? 'black' : (_c = (_b = (_a = args.chart.series[0]) === null || _a === void 0 ? void 0 : _a.dataLabel) === null || _b === void 0 ? void 0 : _b.font) === null || _c === void 0 ? void 0 : _c.color;
    };
    ;
