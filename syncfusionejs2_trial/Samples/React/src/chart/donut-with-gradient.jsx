...
import { AccumulationChartComponent, AccumulationSeriesCollectionDirective, AccumulationSeriesDirective, PieSeries, AccumulationDataLabel, Inject, AccumulationAnnotation, AccumulationLegend, AccumulationTooltip } from '@syncfusion/ej2-react-charts';
import { Browser } from '@syncfusion/ej2-base';
export let GradientDonutData = [
    ...
    render() {
        return (<div className='control-pane'>
                <div className='control-section'>
                    <AccumulationChartComponent id="container" ref={chart => this.pie = chart} load={this.load.bind(this)} loaded={this.onChartLoad.bind(this)} tooltip={{ enable: true, header: '', format: '${point.x} : <b>${point.y}%</b>' }} legendSettings={{ visible: true, position: 'Right' }} title='Share of E-commerce Orders by Country - 2025' subTitle='Source: Data provided by Eurostat European Statistics' titleStyle={{ position: 'Custom', x: Browser.isDevice ? 120 : 370, y: 15 }} enableSmartLabels={true} pointRender={this.onPointRender.bind(this)} legendRender={this.onLegendRender.bind(this)}>
                        <Inject services={[PieSeries, AccumulationDataLabel, AccumulationAnnotation, AccumulationLegend, AccumulationTooltip]}/>
                        <AccumulationSeriesCollectionDirective>
                            <AccumulationSeriesDirective dataSource={GradientDonutData} xName='Country' yName='Share' type='Pie' innerRadius='65%' radius='70%' name='Share by country' dataLabel={{
