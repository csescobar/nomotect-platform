...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, Inject, ChartTheme, Category, ColumnSeries, ILoadedEventArgs, DataLabel, IPointRenderEventArgs, IAnnotationRenderEventArgs, IAxisLabelRenderEventArgs, SplineSeries, SplineAreaSeries, AccumulationAnnotationDirective, AccumulationAnnotationsDirective, ChartAnnotation, AnnotationsDirective, AnnotationDirective } from '@syncfusion/ej2-react-charts';
...
import { textAlignmentProperty } from "@syncfusion/ej2/documenteditor";
const SAMPLE_CSS = `
#control-container {
...
const Pagination = () => {
  ...
  let updateChart = (buttonId: string, img: string, tempCount: number, chartDay: string, zoomPos: number, zoomFactor: number) => {
    image = img;
    count = tempCount;
    day = chartDay
      ...
      <div className='control-section'  style={{ textAlign: "center" }}>
        <ChartComponent id='container'
         style={{ textAlign: "center" }}
          ...
          chartArea={{ border: { width: 0 } }} load={load.bind(this)} height={'60%'} width={Browser.isDevice ? '100%' : '75%'} title='USA, Texas'
