    ...
    return (React.createElement("div", { className: 'control-pane' },
        ...
        React.createElement("div", { className: 'control-section row' },
            React.createElement("div", { className: 'col-md-8' },
                React.createElement(ej2_react_charts_1.AccumulationChartComponent, { id: 'pie-chart', ref: pie, title: 'Movie Genre Revenue Share', load: load.bind(_this), textRender: textRender.bind(_this), legendSettings: { visible: false }, tooltip: { enable: true, header: "", format: '<b>${point.x}</b><br> Profit: <b>$${point.y}K</b>', enableHighlight: true }, enableBorderOnMouseMove: false, loaded: onChartLoad.bind(_this) },
