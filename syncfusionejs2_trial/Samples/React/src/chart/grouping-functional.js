...
exports.data1 = [
    ...
    { x: 'Japan', y: 20, text: ej2_base_1.Browser.isDevice ? 'Japan<br> 20' : 'Japan: 20' },
    { x: 'Australia', y: 18, text: ej2_base_1.Browser.isDevice ? 'Australia<br> 18' : 'Australia: 18' },
    ...
    { x: 'Germany', y: 12, text: ej2_base_1.Browser.isDevice ? 'Germany<br> 12' : 'Germany: 12' },
    { x: 'Italy', y: 12, text: ej2_base_1.Browser.isDevice ? 'Italy<br> 12' : 'Italy: 12' },
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section row' },
            React.createElement("div", { className: 'col-lg-9' },
                React.createElement(ej2_react_charts_1.AccumulationChartComponent, { id: 'pie-chart', ref: pie, title: 'Summer Olympic 2024 - Gold Medals', subTitle: 'Source: wikipedia.org', load: load.bind(_this), tooltip: { enable: true, header: "", format: "<b>${point.x}</b><br> Gold Medals: <b>${point.y}</b>", enableHighlight: true }, legendSettings: { visible: false }, enableSmartLabels: true, loaded: onChartLoad.bind(_this), enableBorderOnMouseMove: false },
                    ...
                    React.createElement(ej2_react_charts_1.AccumulationSeriesCollectionDirective, null,
                        React.createElement(ej2_react_charts_1.AccumulationSeriesDirective, { dataSource: exports.data1, xName: 'x', yName: 'y', name: 'Summer Olympics', animation: { enable: true }, explode: true, radius: ej2_base_1.Browser.isDevice ? '40%' : '55%', groupTo: '9', groupMode: 'Point', startAngle: -20, endAngle: 340, innerRadius: '0%', borderRadius: 3, border: { width: 1, color: '#ffffff' }, dataLabel: { visible: true, name: 'text', position: 'Outside', connectorStyle: { type: 'Curve', length: ej2_base_1.Browser.isDevice ? '10px' : '20px' }, font: { size: ej2_base_1.Browser.isDevice ? '8px' : '13px', fontWeight: '600' } } })))),
