            ...
            React.createElement("div", { className: "row", style: { margin: 0 } },
                React.createElement("div", { className: "col" },
                    React.createElement(ej2_react_charts_1.ChartComponent, { id: "container1", ref: function (chart) { return chart1 = chart; }, style: { textAlign: 'center' }, primaryXAxis: {
                        ...
                        }, zoomComplete: zoomComplete.bind(_this), chartMouseLeave: chartMouseLeave.bind(_this), chartMouseMove: chartMouseMove.bind(_this), chartMouseUp: chartMouseUp.bind(_this), load: load.bind(_this), loaded: onChartLoad.bind(_this), titleStyle: { textAlignment: 'Near' }, tooltip: { enable: true, fadeOutDuration: base_1.Browser.isDevice ? 2500 : 1000, showNearestTooltip: true, header: '', format: '<b>€${point.y}</b><br>${point.x} 2023', enableMarker: false, enableHighlight: true }, crosshair: { enable: true, snapToData: true, lineType: 'Vertical', dashArray: '2,2' }, title: "US to Euro" },
                ...
                React.createElement("div", { className: "col" },
                    React.createElement(ej2_react_charts_1.ChartComponent, { id: "container2", ref: function (chart) { return chart2 = chart; }, style: { textAlign: 'center' }, primaryXAxis: {
                            ...
                            mode: 'X',
                            toolbarItems: ['Pan', 'Reset']
                        }, zoomComplete: zoomComplete.bind(_this), chartMouseLeave: chartobjMouseLeave.bind(_this), chartMouseMove: chartobjMouseMove.bind(_this), chartMouseUp: chart2MouseUp.bind(_this), load: load.bind(_this), loaded: onChartLoad2.bind(_this), titleStyle: { textAlignment: 'Near' }, tooltip: { enable: true, fadeOutDuration: base_1.Browser.isDevice ? 2500 : 1000, showNearestTooltip: true, header: '', format: '<b>¥${point.y}</b><br>${point.x} 2023', enableMarker: false, enableHighlight: true }, crosshair: { enable: true, snapToData: true, lineType: 'Vertical', dashArray: '2,2' }, title: "US to Yen" },
                        React.createElement(ej2_react_charts_1.Inject, { services: [ej2_react_charts_1.AreaSeries, ej2_react_charts_1.LineSeries, ej2_react_charts_1.DataLabel, ej2_react_charts_1.DateTime, ej2_react_charts_1.Tooltip, ej2_react_charts_1.Zoom, ej2_react_charts_1.Highlight, ej2_react_charts_1.Legend, ej2_react_charts_1.Selection, ej2_react_charts_1.Crosshair] }),
                        React.createElement(ej2_react_charts_1.SeriesCollectionDirective, null,
            ...
            React.createElement("div", { className: "row", style: { margin: 0 } },
                React.createElement("div", { className: "col" },
                    React.createElement(ej2_react_charts_1.ChartComponent, { id: "container3", ref: function (chart) { return chart3 = chart; }, style: { textAlign: 'center' }, primaryXAxis: {
                            ...
                            mode: 'X',
                            toolbarItems: ['Pan', 'Reset']
                        }, zoomComplete: zoomComplete.bind(_this), chartMouseLeave: chart3MouseLeave.bind(_this), chartMouseMove: chart3MouseMove.bind(_this), chartMouseUp: chart3MouseUp.bind(_this), load: load.bind(_this), loaded: onChartLoad3.bind(_this), titleStyle: { textAlignment: 'Near' }, tooltip: { enable: true, fadeOutDuration: base_1.Browser.isDevice ? 2500 : 1000, showNearestTooltip: true, header: '', format: '<b>$${point.y}</b><br>${point.x} 2023', enableMarker: false }, crosshair: { enable: true, snapToData: true, lineType: 'Vertical', dashArray: '2,2' }, title: "US to SGD" },
                        React.createElement(ej2_react_charts_1.Inject, { services: [ej2_react_charts_1.AreaSeries, ej2_react_charts_1.LineSeries, ej2_react_charts_1.DataLabel, ej2_react_charts_1.DateTime, ej2_react_charts_1.Tooltip, ej2_react_charts_1.Zoom, ej2_react_charts_1.Highlight, ej2_react_charts_1.Legend, ej2_react_charts_1.Selection, ej2_react_charts_1.Crosshair] }),
                        React.createElement(ej2_react_charts_1.SeriesCollectionDirective, null,
                ...
                React.createElement("div", { className: "col" },
                    React.createElement(ej2_react_charts_1.ChartComponent, { id: "container4", ref: function (chart) { return chart4 = chart; }, style: { textAlign: 'center' }, primaryXAxis: {
                            ...
                            mode: 'X',
                            toolbarItems: ['Pan', 'Reset']
                        }, zoomComplete: zoomComplete.bind(_this), chartMouseLeave: chart4MouseLeave.bind(_this), chartMouseMove: chart4MouseMove.bind(_this), chartMouseUp: chart4MouseUp.bind(_this), load: load.bind(_this), loaded: onChartLoad4.bind(_this), titleStyle: { textAlignment: 'Near' }, tooltip: { enable: true, fadeOutDuration: base_1.Browser.isDevice ? 2500 : 1000, showNearestTooltip: true, header: '', format: '<b>₹${point.y}</b><br>${point.x} 2023', enableMarker: false }, crosshair: { enable: true, snapToData: true, lineType: 'Vertical', dashArray: '2,2' }, title: "US to INR" },
                        React.createElement(ej2_react_charts_1.Inject, { services: [ej2_react_charts_1.AreaSeries, ej2_react_charts_1.LineSeries, ej2_react_charts_1.DataLabel, ej2_react_charts_1.DateTime, ej2_react_charts_1.Tooltip, ej2_react_charts_1.Zoom, ej2_react_charts_1.Highlight, ej2_react_charts_1.Legend, ej2_react_charts_1.Selection, ej2_react_charts_1.Crosshair] }),
                        React.createElement(ej2_react_charts_1.SeriesCollectionDirective, null,
