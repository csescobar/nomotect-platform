...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, Inject, LineSeries, DateTime, Legend, Crosshair } from '@syncfusion/ej2-react-charts';
...
const CrosshairSnap = () => {
    ...
    return (<div className='control-pane'>
            ...
            majorTickLines: { width: 0 },
            lineStyle: { width: 0 }
        }} chartArea={{ border: { width: 0 } }} width={Browser.isDevice ? '100%' : '75%'} title='Historical Gold Prices in USA: 2015 to 2024' loaded={onChartLoad.bind(this)} tooltip={{ enable: false, shared: false }} crosshair={{ enable: true, snapToData: true, dashArray: '5,5' }} legendSettings={{ visible: false }}>
