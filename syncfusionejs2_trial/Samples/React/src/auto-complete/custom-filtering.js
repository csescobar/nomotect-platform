...
var CustomFiltering = /** @class */ (function (_super) {
    ...
    CustomFiltering.prototype.onChange = function (args) {
        ...
        return (React.createElement("div", { id: 'autocustom', className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement("div", { className: 'col-lg-8' },
                    React.createElement("div", { id: 'custom-filtering', style: { paddingTop: '50px' } },
                        React.createElement(ej2_react_dropdowns_1.AutoCompleteComponent, { id: "books", ref: function (AutoComplete) { _this.listObj = AutoComplete; }, dataSource: this.booksData, filtering: this.onFiltering.bind(this), fields: this.fields, placeholder: "e.g. Node.js Succinctly", debounceDelay: 300 }))),
            ...
            React.createElement("div", { id: "description" },
                React.createElement("p", null,
                    ...
                    " method. The debounce delay, in milliseconds, for filtering items in the AutoComplete component can be set using the ",
                    React.createElement("a", { href: "https://ej2.syncfusion.com/react/documentation/api/auto-complete/#debouncedelay", target: "_blank" }, "debounceDelay"),
                    " property."),
