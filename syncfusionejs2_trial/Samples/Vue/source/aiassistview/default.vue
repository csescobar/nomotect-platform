<template>
    <div class="col-lg-12 control-section">
        <div class="default-aiassistview">
            <ejs-aiassistview id="aiAssistView" ref="aiassist" :promptSuggestions="suggestion" :prompts="promptsData" :promptRequest="onPromptRequest" :toolbarSettings="assistToolbars" :created="onCreated"></ejs-aiassistview>
        </div>
    </div>
