  ...
  <div class="control-section visio-import-container">
    ...
    <div style="width: 100%">
      ...
      <div style="display: none">
        <ejs-uploader id="fileupload" name="UploadFiles" ref="uploaderObject" :asyncSettings="fileuploadasyncSettings"
          :success="fileuploadsuccess" :showFileList="showFile" :allowedExtensions="'.vsdx'"
...
export default {
  ...
  mounted: function () {
    ...
    uploader = this.$refs.uploaderObject.ej2Instances;
...
async function onUploadSuccess(args) {
  ...
  uploader.clearAll(); // clears the file list AND resets the internal input
}
