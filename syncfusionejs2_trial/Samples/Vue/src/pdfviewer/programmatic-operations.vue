<template>
  <div>
    <div class="pV-sb-content" style="display: flex; flex-direction: row;">
      <div class="col-lg-9 control-section pdfviewer-control-section" style="flex-grow: 1; flex: 0 0 75%;">
      ...
      <div class="col-lg-3 pdfviewer-property-section main-panel" style="flex: 0 0 25%;">
        ...
        <div class="e-pv-annot-inner-container" style="padding: 0 0 12px 0px">
            ...
            <tr :hidden="XYRowIstrue">
              <td class="left-item">
                <div class="pdfviewer-text-content">
                  ...
                  <div class="e-pv-input-item">
                    <ejs-numerictextbox id="annotation-x-position" :value="selectedAnnotation.x" format="###.##"
              ...
              <td class="right-item">
                <div class="pdfviewer-text-content">
                  ...
                  <div class="e-pv-input-item">
                    <ejs-numerictextbox id="annotation-y-position" :value="selectedAnnotation.y" format="###.##"
                      :decimals=2 :showSpinButton="false" :min="0"
            ...
            <tr :hidden="HeightwidthrowIstrue">
              <td class="left-item">
                <div class="pdfviewer-text-content">
                  <span>Width</span>
                  <div class="e-pv-input-item">
                    <ejs-numerictextbox id="annotation-width" :value="selectedAnnotation.width" format="###.##"
                      :decimals=2 :showSpinButton="false" :min="0"
          ...
          <div :hidden="deladdboundsButtonsIstrue">
            <div class="e-pv-annot-button-section" style="padding: 12px 12px 0px 0; border: 0px">
              <ejs-button style="text-transform: capitalize" cssClass="e-outline" :isPrimary="true"
                @click="onBoundsDelete" :disabled="disableDeleteButton">
                Delete
              </ejs-button>
          ...
          <div style="padding: 0px 12px 12px 12px" :hidden="LineIstrue">
            ...
            <div class="e-pv-input-item">
              <ejs-dropdownlist id="annotation-lineheadstart" :dataSource="lineHeadstatusList"
          ...
          <div :hidden="polygonIstrue">
            <div class="e-pv-annot-button-section" style="padding: 12px 12px 0px 0; border: 0px">
              <ejs-button style="text-transform: capitalize" cssClass="e-outline" :isPrimary="true"
                @click="onDeleteVertex" :disabled="disableDeleteButton">
                Delete
              </ejs-button>
        ...
        <div :hidden="!allowinstractionsIstrue">
          ...
          <div class="e-pv-input-item">
            <ejs-multiselect id="multiselect-checkbox" cssClass="e-specific" :dataSource="this.intractionsList"
              :fields="intractionsListfield" :mode="multiMode" :popupHeight="popHeight"
              :showDropDownIcon="showDropDownIcon" :showSelectAll="showSelectAll"
              :enableSelectionOrder="enableSelectionOrder" :filterBarPlaceholder="filterPlaceholder"
              :allowFiltering="allowFiltering" :value="selectedAnnotation.allowIntractions"
              @change="onAllowInteractionsChange"></ejs-multiselect>
          </div>
        </div>
        <!---->
        <!-- im iron man -->
        ...
        <div :hidden="!isReplyCommentsContainer">
          ...
          <ejs-contextmenu id="contextMenu" :items='menuItems' :select="contextMenuItemSelected"
            target="#contextmenutarget" ref="contextMenuElement"></ejs-contextmenu>
        </div>
        <div class="e-pv-annot-inner-container pdfViewer-checked-Content" style="padding: 10px"
          ...
          <div class="pdfviewer-input-title"><span>Content</span></div>
          <div class="e-pv-input-item">
            <ejs-textbox :value="selectedAnnotation.replyComment"
              @change="onpropertiesvaluechanges('replyComment', $event)" :placeholder="replyPlaceholder"></ejs-textbox>
          </div>
          <div class="pdfviewer-input-title"><span>Status</span></div>
          <div class="e-pv-input-item">
          ...
          <div class="e-pv-annot-button-section">
            <div :hidden="isEditing">
              <ejs-button :isPrimary="true" style="text-transform: capitalize" @click="updateReply()">Add
                Reply</ejs-button>
            </div>
...
export default {
  ...
  data: function () {
    return {
      ...
      pdfviewerApiPath: {
        saveUrl:
          "https://ej2services.syncfusion.com/vue/development/api/FileUploader/Save",
        removeUrl:
          "https://ej2services.syncfusion.com/vue/development/api/FileUploader/Remove",
      },
