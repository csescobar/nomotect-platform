<template>
    <div class="col-lg-12 control-section">
        <div class="default-aiassistview"> 
            <ejs-aiassistview id="default_aiAssist_view" ref="aiassist" :promptSuggestions="suggestion" :prompts="promptsData" :promptRequest="onPromptRequest" :toolbarSettings="assistToolbars" :created="onCreated"></ejs-aiassistview>
        </div>
    </div>
</template>
<script>
...
export default {
    ...
    methods: {
        ...
        onCreated: function() {
            var settingsDrpDownBtn = new DropDownButton({
                items: {
