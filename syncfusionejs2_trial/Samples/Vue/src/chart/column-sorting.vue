    ...
    <div class="control-section">
        <div align='center'>
            <ejs-chart ref="chart" style='display:block' :theme='theme' :load='load' align='center'
                ...
                :chartArea='chartArea' :width='width' :axisRangeCalculated='axisRangeCalculated' :pointRender='pointRender'>
                <e-series-collection>
        ...
        <div id="action-description">
            <p>
                This column chart demonstrates the dynamic sorting of data in real-time. The chart visualizes nitrogen
                fertilizer use per hectare of cropland, updating every few seconds to show sorted data from different
                datasets.
            </p>
        </div>
        <div id="description">
            <p>
                ...
                <code>setData</code> method. The data is sourced from multiple datasets, and the chart updates and sorts its
                data periodically to reflect the latest information.
            </p><br>
