...
export default {
  ...
  methods: {
    ...
    documentLoad: function (args) {
      ...
      var apiUrl = "https://ej2services.syncfusion.com/vue/development/api/pdfviewer/ValidateSignature";
    ...
    signDocument: function (args) {
      const url = "https://ej2services.syncfusion.com/vue/development/api/pdfviewer/AddSignature";
