<template>
    <div class="control-section">
        ...
        <div id="action-description">
            <p>
                This example demonstrates how to export the document to other formats like Pdf, Rtf, HTML, ODT, WordML etc. from document editor.
            </p>
        </div>
        <div id="description">
            <p>
    ...
    data: function () {
        ...
        let listviewInstance = new ListView({
            dataSource: [
                {
                    class: 'data',
                    text: 'Microsoft Word XML format (.docx)',
                    id: 'docx',
                ...
                {
                    class: 'data',
                    text: 'Microsoft word template format (.dotx)',
                    id: 'dotx',
                    category: 'Client side exporting',
                },
                {
        ...
        return {
            ...
            exportItems: [
                { text: 'Microsoft Word XML format (.docx)', id: 'word' },
                { text: 'Syncfusion Document Text (.sfdt)', id: 'sfdt' },
                { text: 'Plain Text Format (.txt)', id: 'txt'},
                { text: 'Microsoft Word Template Format (.dotx)', id: 'dotx'},
            ],
            toolbarItems: [
                'New',
                'Open',
                {
                    tooltipText: 'Export',
                    template:
                        '<button title="Export" class="e-tbar-btn e-tbtn-txt e-control e-btn e-lib e-dropdown-btn e-caret-hide" type="button" id="dropdownbtn"><span class="e-btn-icon e-icons e-save-as e-icon-left"></span><span class="e-tbar-btn-text">' +
                        'Export' +
        ...
        export: function (type) {
            ...
            http.onload = function () {
                if (http.status === 200) {
                    ...
                    downloadLink.download = documentName + format;
