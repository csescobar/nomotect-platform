  ...
  <div class="control-section">
    ...
    <div id="description">
        ...
        <p>
            ...
            <a target="_blank" href="https://help.syncfusion.com/document-processing/excel/spreadsheet/vue/data-binding#remote-data">
   ...
   data: () => {
    return {
        dataSource: new DataManager({
                    // Remote service url
                    url: "https://ej2services.syncfusion.com/vue/development/api/Orders",
