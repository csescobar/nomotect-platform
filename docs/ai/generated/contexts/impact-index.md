...
- `model:Role`: component:Application, controller:Application, document:Architecture::Decisions::0006-seal-application-role-and-grid-registries, document:Distribution::Operations, document:Extensions::Operations, job:Application, model:PlatformRole, model:Role, policy:Application, test:Models::PlatformRole, test:Models::Role, test:Operations::Roles
